---
title: 依 nomorehours 的 SlideHub 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: SlideHub 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA200001625" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Nomorehours 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | SlideHub |
| ID | WA200001625 |
| 支援Office 365用戶端 | PowerPoint 2013 年或更新版本的 Mac、PowerPoint 網頁版 或更新版本上的 PowerPoint 2016 或更新版本Windows |
| 合作夥伴公司名稱 | nomorehours |
| 公司的網站 | [https://nomorehours.com](https://nomorehours.com) |
| 應用程式的使用規定 | [https://nomorehours.com/eula](https://nomorehours.com/eula) |
| 應用程式的核心功能 | NoMore 供應商務使用者PowerPoint設計服務和PowerPoint增益集，都旨在讓他們在PowerPoint中更有效率。 作為設計服務的一部分，NoMore 會在 8 小時內將粗略草稿轉換成用戶端就緒投影片。 增益集有助於更快速地存取服務，但也可讓使用者存取預先製作的投影片設計、公司特定的投影片庫，以及包含不同生產力工具的&#8220;諮詢工具組&#8221;。 |
| 公司總部位置 | 丹麥 |
...
此資訊已由更多相關資訊提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 應用程式 | 電子郵件和名稱。 電子郵件會當做應用程式中的使用者名稱使用。 收集電子郵件有助於更快地註冊和登入應用程式。 註冊事件時會使用名稱。 | [33ccef75-8248-44e8-88d3-24526ca9c2d3](../azure/33ccef75-8248-44e8-88d3-24526ca9c2d3.md) |

---
title: Showmaster 的應用程式資訊（按 cherryware）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/27/2022
...
description: Showmaster 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。

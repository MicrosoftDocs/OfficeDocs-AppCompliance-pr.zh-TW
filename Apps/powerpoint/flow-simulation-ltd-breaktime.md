---
title: Flow Simulation Ltd 的停機時間應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: 停機時間、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "65229387"
---
# <a name="breaktime"></a>停機時間

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 4 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001661" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Flow Simulation Ltd. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Flow Simulation Ltd. |
| 公司的網站 | [https://www.flosim.com](https://www.flosim.com) |
| 應用程式的使用規定 | [https://www.flosim.com/breaktime/EULA.html](https://www.flosim.com/breaktime/EULA.html) |
| 應用程式的核心功能 | 快速告訴每個人何時回來，因為這是停機時間！ |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.flosim.com/breaktime/Breaktime.html](https://www.flosim.com/breaktime/Breaktime.html) |
...
這項資訊是由 Flow Simulation Ltd 所提供。關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

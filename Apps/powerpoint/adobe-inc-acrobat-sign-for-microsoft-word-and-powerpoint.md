---
title: adobe inc. 的 Microsoft Word 和 PowerPoint 的 adobe Acrobat 標記的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Adobe 的所有可用安全性和符合性資訊。 Microsoft Word 和 PowerPoint、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "64602465"
---
# <a name="adobe-acrobat-sign-for-microsoft-word-and-powerpoint"></a>Microsoft Word 和 PowerPoint 的 Adobe Acrobat 符號
...
| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Microsoft Word 和 PowerPoint 的 Adobe Acrobat 符號 |
| ID | WA104381155 |

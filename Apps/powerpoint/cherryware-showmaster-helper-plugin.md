---
title: Showmaster (Helper 外掛程式) 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Showmaster (Helper 外掛程式) 、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003676" target="_blank">在 AppSource 中檢視</a>
...
這項資訊是由有關此應用程式如何收集和儲存組織資料的工具所提供，以及貴組織對於應用程式所收集資料的控制。

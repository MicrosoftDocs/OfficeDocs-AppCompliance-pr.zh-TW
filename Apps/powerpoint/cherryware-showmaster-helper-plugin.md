---
title: Showmaster 的應用程式資訊 (Helper 外掛程式) 由 cherryware
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Showmaster (Helper 外掛程式所有可用的安全性和符合性資訊資訊) 、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63545241"
---
# <a name="showmaster-helper-plugin"></a>Showmaster (Helper 外掛程式) 
...
由 cherryware 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Showmaster (Helper 外掛程式)  |
| ID | WA200003676 |
...
| App 的使用條款 | [https://showmaster.app/terms/](https://showmaster.app/terms/) |
| 應用程式的核心功能 | Showmaster 是一 PowerPoint 的增益集，它會在等候時間內建立激動人心的框架，並中斷標題、倒計時、音樂等等。 |
...
此資訊是由 cherryware 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

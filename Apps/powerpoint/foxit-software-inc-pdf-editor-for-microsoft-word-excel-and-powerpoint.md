---
title: Foxit PDF 編輯器的應用程式資訊，供 Foxit 軟體 inc. 使用 Microsoft Word、Excel 及 PowerPoint。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Foxit PDF 編輯器的所有可用安全性和符合性資訊資訊，供 Microsoft Word、Excel 及 PowerPoint、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "64602462"
---
# <a name="foxit-pdf-editor-for-microsoft-word-excel-and-powerpoint"></a>Foxit Microsoft Word、Excel 及 PowerPoint 的 PDF 編輯器
...
Foxit 軟體 Inc. 所提供的資訊給 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Foxit Microsoft Word、Excel 及 PowerPoint 的 PDF 編輯器 |
| ID | WA200003206 |
| 支援 Office 365 用戶端 | Excel 2016 或更新版本的 mac、Excel 2013 或 Excel 網頁版 Windows 更新版本的 mac、Word 2016、Word 2013 或更新版本的 mac、Word 網頁版或更新 mac 上的 Windows 或更新版本。PowerPoint 網頁版，PowerPoint 2013 或更新版本 Windows |
| 合作夥伴公司名稱 | Foxit 軟體 Inc.。 |
| 公司的網站 | [https://www.foxit.com](https://www.foxit.com) |
| App 的使用條款 | [https://www.foxit.com/product/terms-of-service.html](https://www.foxit.com/product/terms-of-service.html) |
| 應用程式的核心功能 | 透過 Foxit PDF 編輯器 Microsoft Teams，您可以在不離開 Microsoft Teams 的情況下執行更多檔功能。安全共同作業-共用 PDF，並與您通道中的所有人共同作業，並在 Microsoft SharePoint 或一個磁片磁碟機&#65307; 2 中儲存的檔。高品質觀賞-以高品質觀賞的方式，安全地查看Microsoft Teams&#65307; 3. 透過文字標記並批註 PDF 工具，批註 PDF-Provide 對檔的意見反應; |
...
Foxit 軟體 Inc. 已提供此資訊。關於此應用程式如何收集和儲存組織的資料，以及您的組織將會透過應用程式收集的資料所產生的控制項。
...
| 啟用下列各要素驗證 (MFA) ： | CodeRepositories |
...
| 隱私權原則 URL | https://www.foxit.com/company/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委託 | 讀取使用者檔並儲存檔。 | [959a79dd-69d0-4d05-b9a8-b9f02e28c049](../azure/959a79dd-69d0-4d05-b9a8-b9f02e28c049.md) |

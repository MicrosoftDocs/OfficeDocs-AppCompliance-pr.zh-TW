...
ms.author: legerrar
manager: tonybal
description: Microsoft 365應用程式合規性計畫 SaaS 的 ISV 使用者指南
...
![合作夥伴中心的商業市集](../media/NewPChomepage.png)

  
**步驟 2**：選取 [Marketplace 供應專案] 之後，切換至 [商業市集]。

![在商業市集中選取應用程式](../media/NewPCOffersOffice.png)
...
## <a name="4---microsoft-365-certification-workflow"></a>4.Microsoft 365認證工作流程
  
合作夥伴可以選取核取方塊並按一下 [提交] 來開始認證程式
  
![開始Microsoft 365認證](../media/UserGuidePhotos/13.png) 
...
![初始檔提交 ](../media/UserGuidePhotos/14.png) 
 ![ 提交提交初始檔提交](../media/UserGuidePhotos/15.png)
  
按一下 [提交] 時，將會檢閱初始檔提交。

![正在檢閱的初始檔提交](../media/UserGuidePhotos/16.png)
...
![正在檢閱的提交](../media/UserGuidePhotos/21.png)
  
如果控制需求檔不足或不相關，分析師會要求修訂。 分析師將與合作夥伴合作，協助取得正確的檔以供核准。

![辨識項需要更新](../media/UserGuidePhotos/22.png)

![哪些控制項需要更新](../media/UserGuidePhotos/23.png)
  
![檢閱進行中](../media/UserGuidePhotos/24.png) 
 
如果提交不符合核准標準，分析師將會拒絕提交。
  
合作夥伴可以與分析師合作，以提供相關資訊和檔。

![認證遭拒](../media/UserGuidePhotos/25.png)
  
一旦符合所有安全性標準，分析師就會核准提交，而合作夥伴將會Microsoft 365認證。

![Microsoft 365應用程式認證已核准](../media/UserGuidePhotos/26.png)
  
**認證核准後：AppSource 中Microsoft 365認證徽章的範例。** 

![認證核准後](../media/UserGuidePhotos/27.png)
...
![證明更新](../media/UserGuidePhotos/32.png) 
...
![認證更新](../media/UserGuidePhotos/33.png) 
...
![認證拒絕](../media/UserGuidePhotos/34.png)

案例 1B： 

認證更新已核准

![認證更新核准](../media/UserGuidePhotos/35.png)

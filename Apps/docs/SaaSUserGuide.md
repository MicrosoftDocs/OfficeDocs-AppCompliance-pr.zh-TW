...
這份檔是為我們的合作夥伴做為逐步的使用者指南，註冊 Microsoft 365 應用程式規範計畫，想要對其 SaaS app 進行 Publisher 證明和認證，但夥伴中心入口網站。

## <a name="2-acronyms--definitions"></a>2. 縮寫 & 定義
| | |
|----|----|
|縮略字 | 定義 |
|) 合作夥伴中心的電腦 (合作夥伴中心 (https://partner.microsoft.com/)|所有 Microsoft 合作夥伴的入口網站。 合作夥伴會登入至夥伴中心，並提交 Self-Assessment 問卷。 Microsoft 365 應用程式相容性的合作夥伴中心 (microsoft.com)  (https://partner.microsoft.com/en-us/dashboard/home)|
|ISV | 獨立軟體廠商 a.k.a。 Partner or Developer |
|應用程式來源 |  (的應用程式目錄 AppSource) 範例： Now virtual agent (https://appsource.microsoft.com/en-us/product/office/WA104381816) |
...
**步驟 1** ：在頁面左側的導覽列上： a。    選取 [商業市場] b。    選取一覽
...
答：  Publisher證明拒絕 a。  若拒絕，協力廠商可以：•查看失敗報告 o 將透過電子郵件通知合作夥伴，他們可以在夥伴中心中查看失敗報告•更新並重新提交 Self-Assessment 問卷。
  
 ![10 ](https://github.com/MicrosoftDocs/OfficeDocs-AppCompliance-pr/blob/master/Apps/media/UserGuidePhotos/10.png)
  
B。  Publisher證明核准 a。  核准後，協力廠商可以：•更新並重新提交證明• View Publisher 證明•開始 M365 認證程式
...
**步驟 1** ：初始檔提交填寫所有詳細資料，上傳相關的檔，然後按一下 [提交]
...
若提交不符合核准標準，則分析員會拒絕提交。
  
合作夥伴可以與分析員搭配使用，以提供相關資訊和檔。
...
## <a name="5---microsoft-365-renewal-workflow"></a>5. Microsoft 365 更新工作流程：
...
**好處：** 
  ...
  •維護 AppSource 和團隊存放區中的憑證徽章，以將您的應用程式與其他使用者區別開來。 
  
  •使用認證的應用程式，提高客戶的信賴程度。 
  
  •協助 IT 管理員以更新的認證資訊作出合理的決策。

新的續訂程式可在夥伴中心 (https://partner.microsoft.com/en-us/dashboard/home) ，以提供無縫體驗。 在夥伴中心的到期日的開始90天之後，將會顯示更新提醒。 定期提醒也會透過電子郵件于到期的90、60和30天傳送。 
...
**步驟 2**：查看先前的 Publisher 認證答案，並視需要更新最新資訊。 
  
提交 Publisher 認證以于準備時進行更新。 M365 應用程式規範分析員會檢查它。
...
應用程式的資訊必須在到期日之前更新，以維護 Microsoft 檔上應用程式的 Publisher 認證頁面。及時更新也會確保 AppSource 和小組存放區中的應用程式持續聲譽徽章授予及圖示。
...
案例1A：憑證更新拒絕：如果：•應用程式沒有適當的工具、處理常式或設定，也無法在認證視窗中執行所需的變更，則可能會拒絕認證。 •應用程式有未完成的漏洞，無法在認證視窗內修正。 

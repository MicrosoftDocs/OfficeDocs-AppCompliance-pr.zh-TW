---
title: Foxit PDF 編輯器 for 雲端的應用程式資訊，Foxit 軟體結合在一起
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: 所有可用的安全性和符合性資訊，Foxit PDF 編輯器 for 雲端，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63773681"
---
# <a name="foxit-pdf-editor-for-cloud"></a>Foxit 雲端的 PDF 編輯器

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新日期：2021年8月19日</p>

* <a href="https://teams.microsoft.com/l/app/959a79dd-69d0-4d05-b9a8-b9f02e28c049" target="_blank">在 Teams 儲存區中查看</a>
...
Foxit 軟體所提供的資訊，併入 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Foxit 雲端的 PDF 編輯器 |
| ID | WA200003703 |
| 支援 Office 365 用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | 綜合 Foxit 軟體 |
...
此資訊已融入 Foxit 軟體如何收集和儲存組織資料，以及您的組織將透過應用程式收集的資料所產生的控制項。

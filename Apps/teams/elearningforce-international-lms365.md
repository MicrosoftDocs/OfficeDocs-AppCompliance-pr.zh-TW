...
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料 - 請參閱 https://trustcenter.elearningforce.com/hc/en-us/articles/360017659377 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者設定檔資料 &amp; 定型記錄 - 請參閱 https://trustcenter.elearningforce.com/hc/en-us/articles/360009394437 |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 荷蘭 () 、日本、澳大利亞、加拿大、愛爾蘭 () 、德國、英國和北愛爾蘭 |
| 您是否有已建立的資料租用和處置程式？ | 是 |

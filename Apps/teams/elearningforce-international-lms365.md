...
| App 的使用條款 | [https://lms365.com/lms365-saas-terms/](https://lms365.com/lms365-saas-terms/) |
| 應用程式的核心功能 | LMS365 可讓您的組織透過 SharePoint、Teams 和行動裝置，為您的員工、合作夥伴及客戶提供熟悉的環境，以在 Microsoft 365 平臺上傳遞和管理訓練 |
...
| 您的應用程式所處理的資料為何？ | 使用者設定檔資料-請參閱 https://trustcenter.elearningforce.com/hc/en-us/articles/360017659377 |
| App 是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 資料庫中儲存的資料為何？ | 使用者設定檔資料 &amp; 訓練記錄-請參閱 https://trustcenter.elearningforce.com/hc/en-us/articles/360009394437 |
| 如果基礎 infastructure 處理或儲存 Microsoft 客戶資料，該資料地理位置存放在何處？ | 荷蘭 (英國和北愛爾蘭 (的) 、德國、北愛爾蘭) ，日本，澳大利亞，加拿大，愛爾蘭 |
...
| 隱私權原則 URL | https://lms365.com/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| GroupMember Read。 All | 應用程式 | 允許此應用程式展開 AD 群組的成員，以將使用者群組註冊至訓練 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| 傳送郵件 | 委託 | 允許此應用程式傳送通知電子郵件。 在設定電子郵件帳戶以進行通知時，會動態要求許可權。 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| OnlineMeetings ReadWrite | 委託 | 允許此應用程式建立、讀取、更新和刪除線上會議事件。 在設定電子郵件帳戶以進行通知時，會動態要求許可權。 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| RoleManagement 讀取的目錄 | 應用程式 | 應用程式必須能夠讀取使用者所擁有的角色，以及其是否為 Office 365 全域系統管理員和/或 SharePoint 系統管理員。 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| 使用者. Invite。 | 委託 | 選用的功能：允許目錄管理員邀請來賓使用者加入訓練目錄。 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read | 委託 | 可讓使用者使用客戶&#8217;s Azure AD 登入 app，並允許此應用程式讀取已登入使用者的設定檔和基本公司資訊。 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read.All | 委託 | 允許此應用程式讀取完整的使用者設定檔。 &#8217; 管理員和組建階層的報表 &amp; 管理員儀表板&#8217;需要讀取使用者 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read.All | 應用程式 | 允許此應用程式讀取完整的使用者設定檔。 &#8217; 管理員和組建階層的報表 &amp; 管理員儀表板&#8217;需要讀取使用者 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| 設定檔 | 委託 | 若要讓使用者能夠向使用者顯示登入所使用的帳戶，LMS365 需要此許可權來顯示基本設定檔資訊，包括顯示名稱、名字和姓氏、電子郵件地址及照片。 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |

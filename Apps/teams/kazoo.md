...
description: Kazoo 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/afd11b2b-88b8-4f07-8902-a6e445b6e753" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002751" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Kazoo 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Kazoo |
| 公司的網站 | [https://www.kazoohr.com](https://www.kazoohr.com) |
| 應用程式的使用規定 | [https://www.kazoohr.com/terms-of-use](https://www.kazoohr.com/terms-of-use) |
| 應用程式的核心功能 | 員工參與和效能管理工具，可透過對等辨識和獎勵，加上持續效能管理來改善公司文化與員工滿意度。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
Kazoo 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

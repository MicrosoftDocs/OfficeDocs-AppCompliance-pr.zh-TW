---
title: Appfluence Inc 的議程上司的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2021
...
description: 議程上司的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64881010"
---
# <a name="agenda-boss"></a>Agenda Boss

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 5 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/ae645efa-0e64-47d9-91e4-b693a99f7f87" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002607" target="_blank">在 AppSource 中檢視</a>
...
| 公司的網站 | [https://agendaboss.com](https://agendaboss.com) |
| 應用程式的使用規定 | [https://agendaboss.com/eula](https://agendaboss.com/eula) |
| 應用程式的核心功能 | 將所有工作和行事曆事件放在一起，然後在簡單的線性清單中匯總它們。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://agendaboss.com/about](https://agendaboss.com/about) |

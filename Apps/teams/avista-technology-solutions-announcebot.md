---
title: AnnounceBot by Avista 技術解決方案的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/17/2022
...
description: AnnounceBot 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/d13120dd-5961-4589-b470-19d9d01c6668" target="_blank">在 Teams 儲存區中查看</a>
...
Avista 技術解決方案所提供的資訊給 Microsoft：
...
| App 的使用條款 | [https://announcebot.in/terms.html](https://announcebot.in/terms.html) |
| 應用程式的核心功能 | 使用 AnnounceBot 的及時生日、周年紀念日和 Greet Workmates |
...
此資訊已透過 Avista 技術解決方案提供，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

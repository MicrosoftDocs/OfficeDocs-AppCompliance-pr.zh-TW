---
title: Avista 技術解決方案之 AnnounceBot 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/17/2022
...
description: AnnounceBot 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/d13120dd-5961-4589-b470-19d9d01c6668" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003321" target="_blank">在 AppSource 中檢視</a>
...
| 公司的網站 | [https://announcebot.in](https://announcebot.in) |
| 應用程式的使用規定 | [https://announcebot.in/terms.html](https://announcebot.in/terms.html) |
| 應用程式的核心功能 | 使用 AnnounceBot 及時祝生日、紀念日和問候工友 |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | [https://announcebot.in](https://announcebot.in) |

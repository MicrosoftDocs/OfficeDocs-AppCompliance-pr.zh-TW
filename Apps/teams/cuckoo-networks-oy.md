---
title: Cuckoo Networks Oy 的 Cuckoo 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/22/2022
...
description: Cuckoo 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66547187"
---
# <a name="cuckoo"></a>Cuckoo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 20 日</p>

* <a href="https://teams.microsoft.com/l/app/71138876-8738-4935-95b6-ae7c2fbe4e54" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002750" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Cuckoo Networks Oy 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://cuckoo.fi](https://cuckoo.fi) |
| 應用程式的使用規定 | [https://cuckoo.fi/terms-of-use/](https://cuckoo.fi/terms-of-use/) |
| 應用程式的核心功能 | 有趣且簡單、簡便的微中斷點練習，可提升您的能源和大腦。 |
| 公司總部位置 | 芬蘭 |
| 應用程式資訊頁面 | [https://cuckoo.fi](https://cuckoo.fi) |
...
Cuckoo Networks Oy 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、租使用者識別碼、租使用者名稱 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者活動和使用者可識別資訊 |
...
| 隱私權原則 URL | https://cuckoo.fi/en/privacy-policy/ |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | passport-azure-ad， adal |
| 您的應用程式是否支援條件式存取原則？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 透過 Microsoft 登入向服務進行使用者驗證 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| 電子郵件 | 委託 | 連絡客戶，取得應用程式活動、可用競賽和客戶支援的相關資訊 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| offline_access | 委託 | 透過 Microsoft 登入向服務進行使用者驗證 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| openid | 委託 | 透過 Microsoft 登入向服務進行使用者驗證 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| 設定檔 | 委託 | 透過 Microsoft 登入向服務進行使用者驗證 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |

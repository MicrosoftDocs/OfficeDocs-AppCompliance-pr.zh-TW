---
title: Teamscast by Teamscast 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
description: Teamscast 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66892023"
---
# <a name="squadcast"></a>Teamscast

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 1 月 10 日</p>

* <a href="https://teams.microsoft.com/l/app/7792759a-43e8-4dc8-9f55-e7b0382c4a67" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004390" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Teamscast 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Teamscast |
| 公司的網站 | [https://www.squadcast.com](https://www.squadcast.com) |
| 應用程式的使用規定 | [https://www.squadcast.com/terms](https://www.squadcast.com/terms) |
| 應用程式的核心功能 | 直接從 MS Teams 進行有效的事件管理。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://support.squadcast.com/docs/msteams](https://support.squadcast.com/docs/msteams) |
...
Teamscast 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料 - 僅限使用者名稱、Email |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 小組識別碼、小組名稱、頻道識別碼、通道名稱、租使用者識別碼 |
...
| 隱私權原則 URL | https://www.squadcast.com/privacy |

...
| 合作夥伴公司名稱 | TMI 系統 |
| 合作夥伴網站的 URL | [https://www.vertocloud.co.uk](https://www.vertocloud.co.uk) |
| Teams 應用程式資訊頁面的 URL | [https://www.vertocloud.com](https://www.vertocloud.com) |
| 隱私權原則的 URL | [https://vertocloud.co.uk/privacy-policy/](https://vertocloud.co.uk/privacy-policy/) |
| 使用條款的 URL | [https://vertocloud.co.uk/terms-and-conditions/](https://vertocloud.co.uk/terms-and-conditions/) |
...
>組織名稱、名字、姓氏、公司電子郵件地址。 保留原則會根據客戶的內部原則靈活，但一定要在 GDPR 內。

#### <a name="organizational-controls-for-data-stored-by-partner"></a>夥伴所儲存資料的組織控制項

說明組織管理員如何在合作夥伴系統中控制其資訊？例如刪除、保留、審核、封存、使用者原則等等。

>透過存取控制清單的使用者權限。 系統管理員可以刪除或隱藏資料，使用者無法變更審核記錄。
...
此資訊是由 TMI 系統提供，此應用程式如何處理驗證、授權、應用程式註冊最佳作法及其他身分識別準則。

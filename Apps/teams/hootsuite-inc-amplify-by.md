...
description: 所有適用于 Amplify by Hootsuite、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/08d9aab9-a8f3-4f65-91e2-a33ef9bad6bb" target="_blank">在Teams存放區中檢視</a>
...
| 應用程式的核心功能 | 透過 Hootsuite Amplify 提供技術，將Microsoft Teams的內容分享到您的小組社交頻道。 |
| 公司總部位置 | 加拿大 |

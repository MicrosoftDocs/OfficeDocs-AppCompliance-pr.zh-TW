---
title: SimplyDo by SimplyDo 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: 所有可用的安全性與合規性資訊，適用于 SimplyDo、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66248832"
---
# <a name="simplydo"></a>SimplyDo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 3 月 14 日</p>

* <a href="https://teams.microsoft.com/l/app/dbf692fe-35c1-4511-9178-9131e6511712" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004248" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由 SimplyDo 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | SimplyDo |
| 公司的網站 | [https://www.simplydo.co.uk](https://www.simplydo.co.uk) |
| 應用程式的使用規定 | [https://www.simplydo.co.uk/terms-of-use](https://www.simplydo.co.uk/terms-of-use) |
| 應用程式的核心功能 | SimplyDo 可讓組織從各員工群擷取想法和見解，進而推動持續改進和創新。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.simplydo.co.uk/product](https://www.simplydo.co.uk/product) |
...
此資訊是由 SimplyDo 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料 (名稱、部門、職稱、電子郵件) 。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者設定檔資料 (名稱、部門、職稱、電子郵件)  |
...
| 隱私權原則 URL | https://www.simplydo.co.uk/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 存取單一登入的設定檔資料 | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| 電子郵件 | 委託 | 若要支援 OpenID Connect 功能/登入 | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| offline_access | 委託 | 若要支援 OpenID Connect 功能/登入 | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| openid | 委託 | 若要支援 OpenID Connect 功能/登入 | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |

---
title: LTAPPs SOFTWARE CO.，LTD 之多核准程式 LTAPP 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/31/2021
...
description: 多核准程式 LTAP、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c1ab19ab-6a95-4f02-b42f-c1df3415e8a8" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003188" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

LTAPPs SOFTWARE CO.，LTD 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://ltaddins.com](https://ltaddins.com) |
| 應用程式的使用規定 | [https://ltaddins.com/terms.html](https://ltaddins.com/terms.html) |
| 應用程式的核心功能 | 多核准程式是容易使用的應用程式，可讓使用者提出要求。 應用程式完全可自訂，可讓系統管理員維持其組織規格的一致性。 |
| 公司總部位置 | 越南 |
| 應用程式資訊頁面 | |
...
此資訊已由 LTAPPs SOFTWARE CO.，LTD 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 使用者資訊 &amp; 租使用者識別碼 | [d2682b2a-2037-4545-94b6-3e7216ecca5f](../azure/d2682b2a-2037-4545-94b6-3e7216ecca5f.md) |

---
title: Enboarder for Enboarder 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Enboarder、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/f6b1f54a-3e72-404f-9085-1d77c4151be0" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001980" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Enboarder 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Enboarder |
| 公司的網站 | [https://enboarder.com](https://enboarder.com) |
| 應用程式的使用規定 | [https://enboarder.com/terms/](https://enboarder.com/terms/) |
| 應用程式的核心功能 | Enboarder 是開啟Experience-Driven上線平臺，可變更上線體驗。 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | [https://enboarder.com/why-enboarder/](https://enboarder.com/why-enboarder/) |
...
Enboarder 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

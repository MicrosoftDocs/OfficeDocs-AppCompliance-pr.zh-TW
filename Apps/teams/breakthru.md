---
title: Breakthru by Breakthru 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2022
...
description: Breakthru 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65152090"
---
# <a name="breakthru"></a>Breakthru

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 4 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/693aa4f0-e16c-11ea-ab9b-11514b3de7ae" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002243" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Breakthru 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Breakthru |
| 公司的網站 | [https://breakthru.me](https://breakthru.me) |
| 應用程式的使用規定 | [https://breakthru.me/terms](https://breakthru.me/terms) |
| 應用程式的核心功能 | 分享和播放的極小中斷，建置在您的一天中。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://breakthru.me](https://breakthru.me) |
...
此資訊是由 Breakthru 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 電子郵件地址。 Microsoft Teams租使用者識別碼。 Microsoft Teams識別碼。 我們會維護您所選取的中斷記錄，並可讓您設定提醒以參與 Break。 |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 美國美國、德國、英國大英國和北愛爾蘭 ()  |
| 您是否有已建立的資料租用和處置程式？ | 是 |
...
| 隱私權原則 URL | https://breakthru.me/privacy#h.wc7yv5k6csnq |

---
title: Workboard Inc. 工作板的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2021
...
Workboard Inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Workboard Inc. |
| 公司的網站 | [https://www.workboard.com](https://www.workboard.com) |
| 應用程式的使用規定 | [https://www.workboard.com/license/terms_of_use_v1.php](https://www.workboard.com/license/terms_of_use_v1.php) |
| 應用程式的核心功能 | 透過組織調整策略優先順序，並將目標和關鍵結果當地語系化 () 跨功能小組和個人的 OKR。 圖表、計算和共用重要結果和成功計量的進度。  |
| 公司總部位置 | 美國美國 |
...
此資訊由 Workboard Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC1 認證日期 | 2020-07-31 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 認證日期 | 2020-10-30 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 電子郵件地址和使用者的識別碼。  它是用來將使用者對應至 WorkBoard 的使用者識別碼 | [](../azure/.md) |

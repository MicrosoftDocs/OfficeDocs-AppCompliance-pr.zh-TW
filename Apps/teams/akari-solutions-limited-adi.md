---
title: Akari 解決方案限制的 ADI 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: ADI 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/de5717a1-6884-4b96-8b1e-ee17b5d778f3" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002615" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Akari 解決方案僅限 Microsoft 提供的資訊：
...
| 公司的網站 | [https://akari.io](https://akari.io) |
| 應用程式的使用規定 | [https://akari.io/adi-terms-and-conditions/](https://akari.io/adi-terms-and-conditions/) |
| 應用程式的核心功能 | ADI 在這裡可協助您滿足所有協助工具需求，並增強變更管理程式。 您可以要求 ADI 提供解答、建議和資訊，以瞭解如何在Microsoft Teams內使用協助工具功能、瞭解隱藏和情境障礙，以及哪些工具和提示套件可以提供協助。 ADI 會以文字式對話式解答、位元組大小的影片和各種來源的概念性連結來回答您。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
...
Akari Solutions Limited 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

...
<p>上次於開發人員的更新日期：2022年1月28日</p>

* <a href="https://teams.microsoft.com/l/app/7da7691c-e47a-479e-9bb2-cda07cffd0e5" target="_blank">在 Teams 儲存區中查看</a>
...
此資訊是由 Aimful 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否可以處理與 Microsoft 客戶或其裝置相關的任何資料？ | 是 |
| 您的應用程式所處理的資料為何？ | Calendar 中的事件、使用者的電子郵件和時區 |
| App 是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 資料庫中儲存的資料為何？ | Calendar 中的事件、使用者的電子郵件和時區 |
...
| 隱私權原則 URL | https://aimful.io/policy/ |

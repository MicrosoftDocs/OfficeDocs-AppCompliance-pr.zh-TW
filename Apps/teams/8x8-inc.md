...
| App 的使用條款 | [https://www.8x8.com/terms-and-conditions](https://www.8x8.com/terms-and-conditions) |
| 應用程式的核心功能 | 8x8 Voice 是雲端式直接路由服務，可撥打/接收 PSTN 通話。 具備企業級電話語音 + 連絡人中心功能的原生體驗。 43國家/地區、分析、SMS、MMS 和 Fax 中的47國家 + PSTN 更換服務中的無限制通話方案。 以本機或跨國方式取得經濟通話方案，並將 PSTN 通話擴充至 Microsoft 沒有&#8217;尚未提供方案的國家/地區，以充分利用 Microsoft 365。 |
...
| 應用程式會使用哪一個主控雲端提供者？ | AWS、OracleCloud |

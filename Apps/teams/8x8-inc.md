...
description: 8x8 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64877330"
---
# <a name="8x8"></a>8x8

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 6 月 10 日</p>

* <a href="https://teams.microsoft.com/l/app/bab6487a-dbe6-426f-b329-b7ef0d0fd5ba" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002665" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

8x8， Inc 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 8x8, Inc |
| 公司的網站 | [https://www.8x8.com](https://www.8x8.com) |
| 應用程式的使用規定 | [https://www.8x8.com/terms-and-conditions](https://www.8x8.com/terms-and-conditions) |
| 應用程式的核心功能 | 8x8 語音是雲端式直接路由服務，可進行/接收 PSTN 通話。 具有企業級電話語音 + 連絡人中心功能的原生體驗。 47 個國家/地區的無限制通話方案 + 43 個國家/地區的 PSTN 取代服務、分析、簡訊、多媒體簡訊和傳真。 在本機或國際取得經濟實惠的通話方案，並將 PSTN 通話擴充至 Microsoft 尚未&#8217;提供方案的國家/地區，以充分利用Microsoft 365。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.8x8.com/products/integrations/8x8-voice-for-mic...](https://www.8x8.com/products/integrations/8x8-voice-for-microsoft-teams) |
| 用來執行應用程式的裝載環境或服務模型為何？ |  |
| 應用程式會使用哪些主控雲端提供者？ | AWS、OracleCloud |
...
此資訊是由 8x8， Inc 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

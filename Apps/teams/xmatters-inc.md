---
title: xMatters Inc. xMatters 的 xMatters 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: xMatters 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/ccfe5256-29b8-4cc2-95ed-6612c0e1b10d" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104382013" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

xMatters Inc. 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.xmatters.com](https://www.xmatters.com) |
| 應用程式的使用規定 | [https://www.xmatters.com/policy/terms-conditions](https://www.xmatters.com/policy/terms-conditions) |
| 應用程式的核心功能 | 透過將工具鏈間的通訊自動化，以防止、管理及解決 IT 問題 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://help.xmatters.com/integrations/socialchat/microsoft...](https://help.xmatters.com/integrations/socialchat/microsoftteams.htm) |
...
xMatters Inc. 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

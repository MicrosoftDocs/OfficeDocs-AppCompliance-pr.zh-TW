---
title: DELTAoverC 的 DELTAoverC 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/30/2021
...
description: DELTAoverC 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64878300"
---
# <a name="deltaoverc"></a>DELTAoverC

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 11 月 15 日</p>

* <a href="https://teams.microsoft.com/l/app/01b1eb1e-cb02-4a41-bb8d-6811bc514606" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003286" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

DELTAoverC 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | DELTAoverC |
| 公司的網站 | [https://DELTAoverC.into](https://DELTAoverC.into) |
| 應用程式的使用規定 | [https://go.microsoft.com](https://go.microsoft.com) |
| 應用程式的核心功能 | DELTAoverC 是設計來支援組織變更和轉換，方法是在變更計畫期間為內部領導者提供可採取動作的小組層級資料，讓他們能夠有效地解決變更抗拒或低參與度。 最大化參與 - 即時追蹤參與分數，以確保團隊在中斷期間成長。 降低風險和精力 - 分析員工層級資料，以在這些問題進入主要挑戰之前預測問題。 |
| 公司總部位置 | 加拿大 |
...
DELTAoverC 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 已針對下列專案啟用多重要素驗證 (MFA) ： | DNSManagement |
...
| 隱私權原則 URL | https://DELTAoverC.info/terms |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | 兩者 | 讀取所有群組 | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| Group.ReadWrite.All | 兩者 | 讀取和寫入所有群組 | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
...
>| User.ReadWrite | 委託 | 使用者設定檔的讀取和寫入存取權 | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.ReadWrite.All | 兩者 | 讀取和寫入所有使用者的完整設定檔 | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |

---
title: eformity |的應用程式資訊依 eformity 的範本管理
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: eformity |的所有可用安全性與合規性資訊範本管理、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64771442"
---
# <a name="eformity--template-management"></a>eformity |範本管理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 11 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/74843469-2e76-45e6-acdc-b755a4a4adf0" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003519" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

eformity 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | eformity - 範本管理 |
| ID | WA200003519 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | eformity |
| 公司的網站 | [https://eformity.nl](https://eformity.nl) |
| 應用程式的使用規定 | [https://eformity.net/policies/terms-of-use](https://eformity.net/policies/terms-of-use) |
| 應用程式的核心功能 | 使用集中管理的範本從Microsoft Teams建立檔和簡報。 |
| 公司總部位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | |
...
這項資訊是由 eformity 所提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者郵件、使用者名稱、使用者名字、使用者姓氏 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者郵件、使用者名稱、使用者名字、使用者姓氏 |
...
| 隱私權原則 URL | https://eformity.net/policies/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委託 | 儲存產生的範本 | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| User.Read | 委託 | 收集資料以更新我們平臺上的使用者設定檔 | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| openid | 委託 | 登入使用者 | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| 設定檔 | 委託 | 登入使用者 | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |

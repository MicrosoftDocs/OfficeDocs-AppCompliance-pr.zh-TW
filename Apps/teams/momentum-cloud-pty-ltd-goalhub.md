---
title: 依雲端 Pty Ltd 之 Goalhub 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Goalhub 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/593a90d6-6630-4376-8745-55d7c2c3f0c9" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002400" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

雲端 Pty Ltd 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.momentumcloud.com.au](https://www.momentumcloud.com.au) |
| 應用程式的使用規定 | [https://www.goalhub.com/terms](https://www.goalhub.com/terms) |
| 應用程式的核心功能 | 連線並獲得支援，以達成您的目標。 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | [https://www.goalhub.com/about-1](https://www.goalhub.com/about-1) |
...
這項資訊是由企業雲端 Pty Ltd 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

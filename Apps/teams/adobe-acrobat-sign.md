---
title: Adobe Acrobat 符號的應用程式資訊（Adobe）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: 在 CSA 星型登錄中，Adobe Acrobat 標記的所有可用安全性和符合性資訊資訊，其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及安全性/符合性資訊。
...
---
# <a name="adobe-acrobat-sign"></a>Adobe Acrobat 符號
...
| 應用程式的核心功能 | 簡化檔簽署工作流程，並在 Teams 中利用 Adobe 簽署功能時，提供令人驚歎的員工和客戶體驗。 您可以簽署檔、傳送郵件以取得合法的系結電子簽章和核准，並追蹤其狀態 &#8212; 所有的 Adobe sign for Teams，Microsoft 慣用的電子簽名解決方案。 |
...
Adobe 會提供此資訊，以供 Adobe 使用此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
>| offline_access | 委託 | 若要在目前的憑證到期時重新整理存取權杖。 例如，當使用者在 [傳送 &quot; 簽章] 視窗中，並保持停用狀態的時間過長時，我們需要重新整理新的權杖，讓使用者保持使用中 &quot; 狀態。 | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |

---
title: Adobe Acrobat Sign by Adobe 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Adobe Acrobat Sign 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2021 年 10 月 15 日</p>

* <a href="https://teams.microsoft.com/l/app/0f56a9d1-f502-40f9-a9e8-816d7adbb68b" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381233" target="_blank">在 AppSource 中檢視</a>
...
| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Adobe Acrobat Sign |
| ID | WA104381233 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Adobe |
| 公司的網站 | [https://acrobat.adobe.com/us/en/sign.html](https://acrobat.adobe.com/us/en/sign.html) |
| 應用程式的使用規定 | [https://www.adobe.com/legal/terms.html](https://www.adobe.com/legal/terms.html) |
| 應用程式的核心功能 | 當您在Teams中運用 Adobe Sign 功能時，簡化檔簽署工作流程，並提供絕佳的員工和客戶體驗。 您可以簽署檔、傳送檔以進行合法系結電子簽章和核准，以及追蹤其狀態&#8212;全部使用 Microsoft 慣用的 e-sign 解決方案 Adobe Sign for Teams。 |
| 公司總部位置 | 美國美國 |
...
>| offline_access | 委託 | 若要重新整理存取權杖，請在目前的權杖過期時重新整理。 例如，當使用者在 [傳送以進行簽章 &quot; ] 視窗中，且將它保持在非使用中狀態太久時，我們需要重新整理新的權杖，讓使用者保持作用中 &quot; | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |

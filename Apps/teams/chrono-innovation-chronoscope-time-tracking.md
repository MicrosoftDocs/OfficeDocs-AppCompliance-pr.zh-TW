...
| App 的使用條款 | [https://www.chronoscope.app/terms-of-service](https://www.chronoscope.app/terms-of-service) |
| 應用程式的核心功能 | Chronoscope 是一個智慧時間管理平臺，可提高資料準確性，並減少時間專案錯誤。 透過與現有生態系統整合的智慧小幫手，Chronoscope 可協助時間專案，並提供資料的可見度，以便改善商務決策。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview Read。 All | 應用程式 | 在 tenantId 中，團隊會 addObjectId 及小組使用者帳戶資訊。 當連結 Chronoscope 使用者時，我們會驗證電子郵件是否符合 Teams 帳戶，所以我們可以連結帳戶，而不需使用者手動步驟。 | [9bc8244d-a186-4b12-809e-c47b3eee73c6](../azure/9bc8244d-a186-4b12-809e-c47b3eee73c6.md) |

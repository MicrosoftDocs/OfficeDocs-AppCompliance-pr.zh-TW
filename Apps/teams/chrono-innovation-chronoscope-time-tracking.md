---
title: Chrono Innovation 的 Chronoscope 時間追蹤應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Chronoscope 時間追蹤、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/5b3ded07-fa1a-4fd8-a323-e5fe3f8cf740" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003095" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Chrono Innovation 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Chrono 創新 |
| 公司的網站 | [https://www.chronoinnovation.com](https://www.chronoinnovation.com) |
| 應用程式的使用規定 | [https://www.chronoscope.app/terms-of-service](https://www.chronoscope.app/terms-of-service) |
| 應用程式的核心功能 | Chronoscope 是智慧型時間管理平臺，可提高資料精確度並減少時間輸入錯誤。 透過與現有生態系統整合的智慧型助理，Chronoscope 可促進時間輸入，並提供資料的可見度，以做出更好的商務決策。 |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | [https://www.chronoscope.app](https://www.chronoscope.app) |
...
Chrono Innovation 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | 應用程式 | teams tenantId、teams addObjectId 和 teams 使用者帳戶資訊。 連結 Chronoscope 使用者時，我們會驗證電子郵件是否符合Teams帳戶，因此我們可以連結帳戶，而不需要使用者手動執行步驟 | [9bc8244d-a186-4b12-809e-c47b3eee73c6](../azure/9bc8244d-a186-4b12-809e-c47b3eee73c6.md) |

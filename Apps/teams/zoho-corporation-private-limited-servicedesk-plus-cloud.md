...
| App 的使用條款 | [https://ondemand.manageengine.com/terms.html](https://ondemand.manageengine.com/terms.html) |
| 應用程式的核心功能 | ServiceDesk Plus 是一 SaaS IT 問訊台管理軟體。 It 服務管理的功能 plethora，可協助 IT 管理員有效地組織組織內的服務台作業。 根據預設，ServiceDesk Plus (Cloud) 會搭配 Azure AD 使用。 若要開始，請使用 Azure AD 實例中的帳戶，註冊 ServiceDesk Plus (Cloud) 。 |

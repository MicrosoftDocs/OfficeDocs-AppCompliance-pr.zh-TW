---
title: ServiceDesk Plus Cloud by Zoho Corporation Private Limited 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/10/2022
...
description: ServiceDesk Plus Cloud 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/04fdcea1-3511-499c-966d-099d59aef45f" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000037" target="_blank">在 AppSource 中檢視</a>
...
| 公司的網站 | [https://www.manageengine.com/products/service-desk](https://www.manageengine.com/products/service-desk) |
| 應用程式的使用規定 | [https://ondemand.manageengine.com/terms.html](https://ondemand.manageengine.com/terms.html) |
| 應用程式的核心功能 | ServiceDesk Plus 是 SaaS IT 技術支援中心管理軟體。 透過 IT 服務管理的功能，它可協助 IT 管理員有效地組織組織組織內的技術支援人員作業。 根據預設，ServiceDesk Plus (Cloud) 可與Azure AD搭配使用。 若要開始使用，請在您的 Azure AD 實例中使用帳戶註冊 ServiceDesk Plus (Cloud) 。 |
| 公司總部位置 | 美國美國 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 登入並讀取使用者設定檔 | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
>| offline_access | 委託 | 維護您有權存取資料的存取權限 | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |

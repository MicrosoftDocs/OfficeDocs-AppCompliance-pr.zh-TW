---
title: Loopio by Loopio Inc. 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: Loopio 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c2f87ddb-d2e0-4268-851f-88d57ac6e0a0" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004103" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Loopio Inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Loopio Inc. |
| 公司的網站 | [https://www.loopio.com](https://www.loopio.com) |
| 應用程式的使用規定 | [https://loopio.com/terms/](https://loopio.com/terms/) |
| 應用程式的核心功能 | 搜尋及共用 Loopio 程式庫內容，同時使用 Loopio 通知繼續進行工作！ |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | |
...
Loopio Inc.提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者Teams識別碼 |
...
| 隱私權原則 URL | https://loopio.com/privacy/ |

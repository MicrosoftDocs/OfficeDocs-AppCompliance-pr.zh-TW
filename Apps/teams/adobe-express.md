---
title: Adobe Express by Adobe 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Adobe Express 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/85d6a7d0-94aa-11ea-a1d7-2f19374441f9" target="_blank">在 Teams 市集中檢視</a>
...
| 應用程式的核心功能 | Adobe Spark 可讓您在幾分鐘內建立令人驚豔的視覺故事、具影響力的社交圖形、網頁和短片。 現在在 Microsoft Teams 中輕鬆地共用 |
| 公司總部位置 | 美國美國 |

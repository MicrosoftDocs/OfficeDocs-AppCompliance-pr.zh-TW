---
title: 依&#174;咖啡公司之依預設的 Application Information
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/17/2022
...
* <a href="https://teams.microsoft.com/l/app/aa2600a7-aedf-447c-b15b-8ea2daf68a09" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002412" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由&#174; Coffee 公司提供給 Microsoft 的資訊：
...
| 應用程式的使用規定 | [https://www.starbucks.com/gift-cards/manage/card-terms-and-...](https://www.starbucks.com/gift-cards/manage/card-terms-and-conditions) |
| 應用程式的核心功能 | 感謝、恭喜您或感謝具有一個具有一個使用者 eGift 的小組成員。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
這項資訊是由&#174;咖啡公司提供的，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

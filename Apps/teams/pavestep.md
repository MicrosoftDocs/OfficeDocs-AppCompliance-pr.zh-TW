---
title: 依布利步驟的 Application Information
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/23/2022
...
description: 在 CSA STAR 登錄中，所有可用的安全性與合規性資訊都適用于擴音步驟、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及安全性/合規性資訊。
...
ms.locfileid: "65692395"
---
# <a name="pavestep"></a>平路

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 11 日</p>

* <a href="https://teams.microsoft.com/l/app/aaa83b14-3857-43e0-88ca-b726f5df5db3" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004114" target="_blank">在 AppSource 中檢視</a>
...
| 合作夥伴公司名稱 | 平路 |
| 公司的網站 | [https://www.pavestep.com](https://www.pavestep.com) |
| 應用程式的使用規定 | [https://www.pavestep.com/user-agreement](https://www.pavestep.com/user-agreement) |
| 應用程式的核心功能 | Expensestep 是直覺式效能管理解決方案。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
此資訊由擴充步驟提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 名字、姓氏、電子郵件、作業角色 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 名字、姓氏、電子郵件、作業角色 |

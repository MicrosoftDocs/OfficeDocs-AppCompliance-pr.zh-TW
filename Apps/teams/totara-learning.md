---
title: Totara by Totara Learning的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/09/2021
...
description: Totara 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/5022e09d-d2f9-499f-8925-554c324ad23a" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003222" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Totara Learning提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.totaralearning.com](https://www.totaralearning.com) |
| 應用程式的使用規定 | [https://www.totaralearning.com/en/solutions/totara-cloud/te...](https://www.totaralearning.com/en/solutions/totara-cloud/terms-of-service) |
| 應用程式的核心功能 | 適用于 Microsoft Teams 的 Totara 應用程式可讓 Totara Cloud 訂閱者存取學習，並與Microsoft Teams內的其他人共同作業。 此應用程式可讓使用者存取指派的學習、探索學習內容，以及建立、互動及共用播放清單和資源 ，全都在Microsoft Teams內。 |
| 公司總部位置 | 紐西蘭 |
| 應用程式資訊頁面 | [https://www.totaralearning.com/products/totara-talent-exper...](https://www.totaralearning.com/products/totara-talent-experience-platform) |
...
Totara Learning提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 透過電子郵件地址將小組使用者連線到本機系統使用者 | [5022e09d-d2f9-499f-8925-554c324ad23a](../azure/5022e09d-d2f9-499f-8925-554c324ad23a.md) |

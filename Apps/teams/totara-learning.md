...
| App 的使用條款 | [https://www.totaralearning.com/en/solutions/totara-cloud/te...](https://www.totaralearning.com/en/solutions/totara-cloud/terms-of-service) |
| 應用程式的核心功能 | Totara 應用 Microsoft Teams 程式可讓 Totara 雲端訂閱者存取 Microsoft Teams 中的人員，以及與其他人共同作業的能力。 此應用程式可讓使用者存取指派的教學、探索教學內容，以及與共享及共用播放清單和資源，全部都在 Microsoft Teams 內。 |
| 公司 headquarter 位置 | 紐西蘭 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 透過電子郵件地址將團隊使用者連線至本機系統使用者 | [5022e09d-d2f9-499f-8925-554c324ad23a](../azure/5022e09d-d2f9-499f-8925-554c324ad23a.md) |

---
title: Paixon GmbH 的 Micromate 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Micromate、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/4112cc9a-d683-4ffd-b0bc-2013af7c7497" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002981" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Paixon GmbH 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Paixon GmbH |
| 公司的網站 | [https://paixon.ch](https://paixon.ch) |
| 應用程式的使用規定 | [https://micromate.ai/de/nutzungsbedingungen/](https://micromate.ai/de/nutzungsbedingungen/) |
| 應用程式的核心功能 | Micromate vermittelt durch personalisierte Lerneinheiten direkt im Chat nachhaltig Wissen. Micromate setzt damate auf Microlearning durch die Ausspielung von Quizzes in Form von Adaptive Cards. Die pers&#246;nliche Ansprache des Lernenden， ein Tutorial zur Funktionsweise der App und die Integration spannender Gamification Elemente motivieren den Lernenden zur nachhaltigen Nutzung. |
| 公司總部位置 | 瑞士 |
| 應用程式資訊頁面 | [https://micromate.ai/de/produkt/](https://micromate.ai/de/produkt/) |
| 用來執行應用程式的裝載環境或服務模型為何？ |  |
| 應用程式會使用哪些主控雲端提供者？ | Cloudscale |
...
Paixon GmbH 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

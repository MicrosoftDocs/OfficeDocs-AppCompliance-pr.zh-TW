---
title: Micromate 的應用程式資訊（按 Paixon GmbH）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Micromate 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/4112cc9a-d683-4ffd-b0bc-2013af7c7497" target="_blank">在 Teams 儲存區中查看</a>
...
由 Paixon GmbH 所提供的資訊給 Microsoft：
...
| App 的使用條款 | [https://micromate.ai/de/nutzungsbedingungen/](https://micromate.ai/de/nutzungsbedingungen/) |
| 應用程式的核心功能 | Micromate vermittelt durch personalisierte Lerneinheiten direkt im 聊天室 nachhaltig Wissen。 Micromate setzt dabei auf Microlearning durch 在表單 Ausspielung 自我調整卡中 von von 測驗。 骰子 pers&#246;nliche Ansprache des Lernenden，ein 教學 zur Funktionsweise der 應用程式 und 片整合 spannender Gamification Elemente motivieren den Lernenden zur nachhaltigen Nutzung。 |
| 公司 headquarter 位置 | 瑞士 |
| 應用程式資訊頁面 | [https://micromate.ai/de/produkt/](https://micromate.ai/de/produkt/) |
| 用來執行應用程式的主控環境或服務模型為何？ |  |
| 應用程式會使用哪一個主控雲端提供者？ | Cloudscale |
...
此資訊是由 Paixon GmbH 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

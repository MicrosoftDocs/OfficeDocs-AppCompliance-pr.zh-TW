---
title: 依 Quadrasystems.net 的 Quadra Visitorz 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Quadra Visitorz 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/86458973-657f-4072-8e6a-f1baf684c62f" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004199" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的核心功能 | Visitorz 是直覺式、便於使用且可調整的訪客管理解決方案。 |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | |

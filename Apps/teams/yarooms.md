...
| 合作夥伴公司名稱 | YAROOMS |
| 公司的網站 | [https://yarooms.com](https://yarooms.com) |
| App 的使用條款 | [https://www.yarooms.com/legal/terms-conditions/](https://www.yarooms.com/legal/terms-conditions/) |
| 應用程式的核心功能 | 聊天室 &amp; 預約軟體 |
| 公司 headquarter 位置 | 羅馬尼亞 |
| 應用程式資訊頁面 | [https://yarooms.com/help](https://yarooms.com/help) |
| 用來執行應用程式的主控環境或服務模型為何？ | Iaas |
| 應用程式會使用哪一個主控雲端提供者？ | Aws，Azure，GCP |
...
| 隱私權原則 URL | https://www.yarooms.com/legal/privacy-policy |

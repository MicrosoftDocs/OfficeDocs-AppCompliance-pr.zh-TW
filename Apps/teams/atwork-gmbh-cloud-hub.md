...
description: 雲端中樞的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64877780"
---
# <a name="cloud-hub"></a>Cloud Hub

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 11 月 22 日</p>

* <a href="https://teams.microsoft.com/l/app/0c46172d-7923-422d-902e-f27aaad6994d" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003034" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

atwork GmbH 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.atwork-it.com](https://www.atwork-it.com) |
| 應用程式的使用規定 | [https://www.atwork-it.com/eula](https://www.atwork-it.com/eula) |
| 應用程式的核心功能 | 雲端中樞是適用于Microsoft Teams的商務應用程式。 它可讓使用者追蹤即將進行的變更，包括新功能和變更的功能、計劃性維護，以及來自 Microsoft 訊息中心的其他重要公告。 您可以將雲端中樞應用程式釘選到Microsoft Teams中的應用程式行。 應用程式目前支援英文版，不需任何費用。  |
| 公司總部位置 | 奧地利 |
...
atwork GmbH 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者資料、登入資料、驗證資料、租使用者資料、Azure 服務資料、Graph資料、Office 365管理資料 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | Graph資料，Office 365管理資料 |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 奧地利 |
| 您是否有已建立的資料租用和處置程式？ | 是 |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | 最新版本 |
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | 多租使用者應用程式，取決於客戶&#180;設定 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 應用程式 | 用於選取您要從訊息中心張貼訊息的通道。 | [b5d4e933-e001-4168-83f8-dfd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
>| Mail.Send | 應用程式 | 用於將郵件直接從應用程式傳送至通道或個別人員。  | [b5d4e933-e001-4168-83f8-dfd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
>| TeamSettings.Read.All | 應用程式 | 用於選取您要從訊息中心張貼訊息的小組。 | [b5d4e933-e001-4168-83f8-dfd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
>| User.Read.All | 應用程式 | 用於選取您要傳送電子郵件的人員。 | [b5d4e933-e001-4168-83f8-dfd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |

...
description: 財務時間的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65357068"
---
# <a name="financial-times"></a>財務時間

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 3 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/53992bb2-b879-45ef-99de-68fc094f7bbf" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004054" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

財務時間提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 財務時間 |
| 公司的網站 | [https://www.ft.com](https://www.ft.com) |
| 應用程式的使用規定 | [https://help.ft.com/legal-privacy/terms-and-conditions/](https://help.ft.com/legal-privacy/terms-and-conditions/) |
| 應用程式的核心功能 | 在Microsoft Teams中探索、儲存及分享《金融報》新聞。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | |
| 用來執行應用程式的裝載環境或服務模型為何？ | Paas |
| 應用程式會使用哪些主控雲端提供者？ | Aws，其他 |
...
財務報表提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | userId、tenantId |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | userId |
...
| 隱私權原則 URL | https://help.ft.com/legal-privacy/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 單一登入的必要專案 | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
>| 電子郵件 | 委託 | 單一登入的必要專案 | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
>| offline_access | 委託 | 單一登入的必要專案 | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
>| openid | 委託 | 單一登入的必要專案 | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
>| 設定檔 | 委託 | 單一登入的必要專案 | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |

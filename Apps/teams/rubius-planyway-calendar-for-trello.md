...
| 合作夥伴公司名稱 | Rubius |
| 公司的網站 | [https://rubius.com](https://rubius.com) |
| App 的使用條款 | [https://planyway.com/legal/terms-of-use](https://planyway.com/legal/terms-of-use) |
| 應用程式的核心功能 | Planyway 是小組行事曆、時程表和時間追蹤工具，可供 Trello 管理排程、追蹤專案及規劃資源。 透過 Planyway，您可以在一個位置以視覺方式組織和簡化所有小組工作：規劃及排定即將開始的工作、在行事曆或時程表上指派及排程工作、在專案中追蹤小組工作負載、管理小組可用性、追蹤工作和專案所花費的時間，以及同步處理工作和個人排程。 |

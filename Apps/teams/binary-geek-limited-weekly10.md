...
| App 的使用條款 | [https://www.weekly10.com/terms/customer](https://www.weekly10.com/terms/customer) |
| 應用程式的核心功能 | 增加意見反應、管理效能，以及透過每週簽入來測量員工參與。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 應用程式 | Azure AD (選用) 中的使用者同步到 Weekly10 | [2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb](https://docs.microsoft.com/microsoft-365-app-certification/azure/2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb) |
>| ReadWrite 的行事曆 | 應用程式 | 檢查員工可用性和自動預約會議 (選用) 。 | [494610b2-b490-4f54-8384-312d6f9b4869](https://docs.microsoft.com/microsoft-365-app-certification/azure/494610b2-b490-4f54-8384-312d6f9b4869) |
>| User.Read | 委託 | 在 Azure AD 上驗證使用者的 SSO 目的。 | [6fd1421e-89e8-4a8b-bd01-9397656a50d5](https://docs.microsoft.com/microsoft-365-app-certification/azure/6fd1421e-89e8-4a8b-bd01-9397656a50d5) |

---
title: Binary Geek Limited 的 Weekly10 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Weekly10、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c80cee99-d17f-4b2d-a2a4-57652ffd2a4b" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001441" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Binary Geek Limited to Microsoft 所提供的資訊：
...
| 公司的網站 | [https://www.weekly10.com](https://www.weekly10.com) |
| 應用程式的使用規定 | [https://www.weekly10.com/terms/customer](https://www.weekly10.com/terms/customer) |
| 應用程式的核心功能 | 透過每週簽入來增加意見反應、管理效能及測量員工參與度。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.weekly10.com/integrations/microsoft-teams/](https://www.weekly10.com/integrations/microsoft-teams/) |
...
這項資訊是由 Binary Geek Limited 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 應用程式 | 將使用者從 Azure AD 同步處理至 Weekly10 (選擇性)  | [2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb](../azure/2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb.md) |
>| Calendars.ReadWrite | 應用程式 | 檢查員工可用性和自動預約會議 (選擇性) 。 | [494610b2-b490-4f54-8384-312d6f9b4869](../azure/494610b2-b490-4f54-8384-312d6f9b4869.md) |
>| User.Read | 委託 | 在Azure AD上驗證使用者的 SSO 用途。 | [6fd1421e-89e8-4a8b-bd01-9397656a50d5](../azure/6fd1421e-89e8-4a8b-bd01-9397656a50d5.md) |

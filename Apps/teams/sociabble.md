---
title: Sociabble by Sociabble 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Sociabble 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/afe63f50-aadc-4139-82dc-ba8da6270be9" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381258" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Sociabble 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Sociabble |
| 公司的網站 | [https://www.sociabble.com](https://www.sociabble.com) |
| 應用程式的使用規定 | [https://www.sociabble.com/terms-of-use/](https://www.sociabble.com/terms-of-use/) |
| 應用程式的核心功能 | 透過員工宣傳來展示內容並擴大聯繫。 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://www.sociabble.com/features/](https://www.sociabble.com/features/) |
...
Sociabble 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

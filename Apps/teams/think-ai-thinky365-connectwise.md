---
title: Think AI 所Thinky365-ConnectWise的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Thinky365-ConnectWise 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/1191b3d5-ea1d-4605-9a94-ac4523b85c06" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004299" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的核心功能 | 以全新的創新方式與客戶互動，同時改善整體客戶體驗 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |

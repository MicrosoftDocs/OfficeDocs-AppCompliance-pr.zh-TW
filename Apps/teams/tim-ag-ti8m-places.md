...
description: 所有可用的安全性與合規性資訊，適用于 ti8m 位置、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/9e384ce2-2db2-412e-8da7-08c5cf4c418e" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003311" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

tim &amp; AG 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | ti&amp;m AG |
| 公司的網站 | [https://www.ti8m.com/places](https://www.ti8m.com/places) |
| 應用程式的使用規定 | [https://ti8m.com/products/places/places-nutzungsbedingungen](https://ti8m.com/products/places/places-nutzungsbedingungen) |
| 應用程式的核心功能 | 地點是用來在混合式工作場所設定中預約工作場所的應用程式。 我們會在地圖或以行事曆為基礎的檢視中提供預約。 應用程式完全整合在Microsoft Teams內，並使用以 Microsoft 服務為基礎的所有驗證。 |
| 公司總部位置 | 瑞士 |
| 應用程式資訊頁面 | [https://www.ti8m.ch/places](https://www.ti8m.ch/places) |
...
tim AG 已提供 &amp; 此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite.Shared | 委託 | 取消工作場所和使用者行事曆上的事件  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
>| Directory.ReadWrite.All | 委託 | 安裝和建立系統管理AAD群組 - 安全性群組  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
>| Place.ReadWrite.All | 委託 | 工作場所和地圖名稱的清單  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
>| User.Read | 委託 | 使用者名稱、電子郵件和顯示名稱，在應用程式中顯示 Userdata 的必要專案 | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |

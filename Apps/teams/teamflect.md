---
title: Teamflect by Teamflect 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
* <a href="https://teams.microsoft.com/l/app/e46015e9-f2ae-4dbc-be6b-f05043192e62" target="_blank">在 Teams 市集中檢視</a>
...
| 應用程式的核心功能 | Teamflect 是專為 Microsoft Teams 建置的一切效能管理和員工參與解決方案。 它可讓人員更有效率且更深入地參與其 1 對 1 會議、目標/確定、意見反應、辨識和工作模組 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
Teamflect 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

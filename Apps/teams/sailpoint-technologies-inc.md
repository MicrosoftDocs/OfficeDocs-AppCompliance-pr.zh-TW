...
| App 的使用條款 | [https://www.sailpoint.com/legal/customer-agreements/](https://www.sailpoint.com/legal/customer-agreements/) |
| 應用程式的核心功能 | SailPoint 的身分識別安全性解決方案將存取管理與身分識別安全性耦合在一起，可確保工作者具有適當的存取權來執行工作&#8211;不太少。 |

---
title: SailPoint Technologies， Inc. 的 Sailpoint 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2021
...
description: Sailpoint 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/ceca14aa-4fd9-4a8b-b51f-ee05bf98accc" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002761" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

SailPoint Technologies， Inc. 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://sailpoint.com](https://sailpoint.com) |
| 應用程式的使用規定 | [https://www.sailpoint.com/legal/customer-agreements/](https://www.sailpoint.com/legal/customer-agreements/) |
| 應用程式的核心功能 | SailPoint 的身分識別安全性解決方案將存取管理與身分識別安全性結合在一起，確保背景工作角色擁有正確的存取權來執行其工作&#8211;無須再用。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
這項資訊是由 SailPoint Technologies， Inc. 所提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

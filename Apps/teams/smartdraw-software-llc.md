---
title: SmartDraw by SmartDraw Software、LLC 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: SmartDraw 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/b1879f1f-dba8-49d6-81a1-21ec15e4f94b" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003505" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

SmartDraw Software、LLC 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | SmartDraw 軟體，LLC |
| 公司的網站 | [https://www.smartdraw.com](https://www.smartdraw.com) |
| 應用程式的使用規定 | [https://www.smartdraw.com/support/terms-of-service.pdf](https://www.smartdraw.com/support/terms-of-service.pdf) |
| 應用程式的核心功能 | 簡單的 &amp; 強大工具，可製作流程圖、UML、ERD、技術圖表等等。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.smartdraw.com/features](https://www.smartdraw.com/features) |
...
此資訊已由 SmartDraw Software、LLC 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | sso auth meta data， oauth token  |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 否 |

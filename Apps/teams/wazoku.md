---
title: Wazoku by Wazoku 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Wazoku 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/f060d814-1813-4135-bbef-4cda4251abec" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003384" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Wazoku 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Wazoku |
| 公司的網站 | [https://www.wazoku.com](https://www.wazoku.com) |
| 應用程式的使用規定 | [https://www.wazoku.com/terms-of-use/](https://www.wazoku.com/terms-of-use/) |
| 應用程式的核心功能 | Wazoku Idea Management Platform |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
...
Wazoku 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.wazoku.com/privacy-policy/ |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | SSO |
| 您的應用程式是否支援條件式存取原則？ | 否 |

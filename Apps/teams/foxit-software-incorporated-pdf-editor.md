---
title: Foxit Software Incorporated 的 Foxit PDF 編輯器應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Foxit PDF 編輯器的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66249724"
---
# <a name="foxit-pdf-editor"></a>Foxit PDF 編輯器

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 8 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/959a79dd-69d0-4d05-b9a8-b9f02e28c049" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003703" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Foxit Software Incorporated 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Foxit PDF 編輯器 |
| ID | WA200003703 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Foxit Software Incorporated |
| 公司的網站 | [https://www.foxit.com](https://www.foxit.com) |
| 應用程式的使用規定 | [https://www.foxit.com/product/terms-of-service.html](https://www.foxit.com/product/terms-of-service.html) |
| 應用程式的核心功能 | 使用適用于 Microsoft Teams 的 Foxit PDF 編輯器，您可以在不離開 Microsoft Teams 的情況下執行更多檔：1.安全共同作業-共用 PDF，並與頻道中的每個人共同作業，以及將檔儲存在 Microsoft SharePoint 或一個磁片磁碟機&#65307; 2.高品質檢視-在 Microsoft Teams&#65307; 3 中安全且輕鬆地檢視 PDF。透過文字標記和標注 PDF 工具，標注PDF-Provide檔的意見反應; |
| 公司總部位置 | 中國 |
| 應用程式資訊頁面 | |
...
Foxit Software Incorporated 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 電子郵件和使用者名稱 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 電子郵件、使用者名稱、使用者識別碼 |

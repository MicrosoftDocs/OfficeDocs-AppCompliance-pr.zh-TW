---
title: Voice Elements Corporation 的電子郵件簡訊應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: 所有可用的安全性與合規性資訊，適用于電子郵件簡訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64877050"
---
# <a name="email-texting"></a>電子郵件-傳送簡訊

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 7 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/f76a92ed-2c10-4e37-ac84-f2474958d933" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003086" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Voice Elements Corporation 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.email-texting.com](https://www.email-texting.com) |
| 應用程式的使用規定 | [https://www.email-texting.com/terms-of-use](https://www.email-texting.com/terms-of-use) |
| 應用程式的核心功能 | 在您的商務電話上啟用文字 - 使用電子郵件接收和傳送文字 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.email-texting.com](https://www.email-texting.com) |
...
Voice Elements Corporation 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 需要來自 Teams 的 SSO | [806359be-da23-4538-80bb-baa82107ec2d](../azure/806359be-da23-4538-80bb-baa82107ec2d.md) |
>| 電子郵件 | 委託 | 需要來自 Teams 的 SSO | [806359be-da23-4538-80bb-baa82107ec2d](../azure/806359be-da23-4538-80bb-baa82107ec2d.md) |
>| openid | 委託 | 需要來自 Teams 的 SSO | [806359be-da23-4538-80bb-baa82107ec2d](../azure/806359be-da23-4538-80bb-baa82107ec2d.md) |
>| 設定檔 | 委託 | 需要來自 Teams 的 SSO | [806359be-da23-4538-80bb-baa82107ec2d](../azure/806359be-da23-4538-80bb-baa82107ec2d.md) |

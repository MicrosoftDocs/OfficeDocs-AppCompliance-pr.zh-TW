...
| 應用程式會使用哪一個主控雲端提供者？ | SelfHosted，Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委託 | 可讓使用者向同事顯示其 calandar 的行事曆，以及使用會議來設定其電話語音 | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| 連絡人。已讀取 | 委託 | 如果使用者想要在應用程式中顯示使用者連絡人，讓使用者可以更輕鬆地撥號聯繫 | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| User.Read | 委託 | 此應用程式中的使用者已讀取是用來識別的目的。 | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| User.Read | 委託 | 我們不會儲存資料。 應用程式只用于驗證目的 | [f0199b83-0ca3-4b41-a23b-d9b234484438](../azure/f0199b83-0ca3-4b41-a23b-d9b234484438.md) |

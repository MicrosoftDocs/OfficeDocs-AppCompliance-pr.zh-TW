---
title: Flexfone 的 Myfone 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Myfone、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/5f447fa4-da1f-4651-a0da-d2488a404c19" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000716" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Flexfone 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Flexfone |
| 公司的網站 | [https://flexfone.dk](https://flexfone.dk) |
| 應用程式的使用規定 | [https://flexfone.dk/Content/pdf/Slutkundebetingelser.pdf](https://flexfone.dk/Content/pdf/Slutkundebetingelser.pdf) |
| 應用程式的核心功能 | H&#229;ndter ine telefonopkald i Teams， og f&#229; overblik over ine kolleger. |
| 公司總部位置 | 丹麥 |
| 應用程式資訊頁面 | [https://faq.flexfone.dk/da](https://faq.flexfone.dk/da) |
| 用來執行應用程式的裝載環境或服務模型為何？ |  |
| 應用程式會使用哪些主控雲端提供者？ | SelfHosted、Azure |
...
Flexfone 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委託 | 行事曆可用來讓使用者向同事顯示其快取性，並使用會議來設定其電話語音 | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| Contacts.Read | 委託 | 如果使用者想要在應用程式中顯示連絡人，以便更輕鬆地撥打連絡人，就可以儲存這些連絡人。 | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| User.Read | 委託 | 在此應用程式中讀取的使用者是用於識別用途。 | [cdd5ed6f-ceda-4d46-a522-b7526d6d9e50](../azure/cdd5ed6f-ceda-4d46-a522-b7526d6d9e50.md) |
>| User.Read | 委託 | 我們不會儲存資料。 應用程式僅用於驗證用途 | [f0199b83-0ca3-4b41-a23b-d9b234484438](../azure/f0199b83-0ca3-4b41-a23b-d9b234484438.md) |

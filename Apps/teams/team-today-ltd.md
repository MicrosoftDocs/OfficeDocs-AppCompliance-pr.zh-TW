---
title: Team Today Ltd 的 Team Today 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: 現今小組的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66249728"
---
# <a name="team-today"></a>現今團隊

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 11 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003572" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Team Today Ltd 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Team Today Ltd |
| 公司的網站 | [https://team-tracker.com](https://team-tracker.com) |
| 應用程式的使用規定 | [https://team-tracker.com/terms-and-conditions.html](https://team-tracker.com/terms-and-conditions.html) |
| 應用程式的核心功能 | Team Tracker 是預約經常性桌面並查看其運作情況的第一個使用者應用程式 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | |
...
Team Today Ltd 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 行事曆事件識別碼 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委託 | 一旦使用者設定其未來幾周的活動，Team Tracker 會根據使用者的選取專案來更新使用者行事曆和可用性。  | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| MailboxSettings.Read | 委託 | 用來取得建立行事曆事件的時區 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| User.Read | 委託 | 根據其設定檔驗證使用者資訊 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| 電子郵件 | 委託 | 用來驗證使用者電子郵件 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| openid | 委託 | 允許使用者使用其Office 365帳戶登入 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| 設定檔 | 委託 | 根據使用者的設定檔驗證使用者的基本資訊 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |

...
* <a href="https://teams.microsoft.com/l/app/be4751a5-db56-4e45-bb27-397e0aa614b1" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002015" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Nimbella 提供給 Microsoft 的資訊：
...
| 應用程式的使用規定 | [https://nimbella.com/terms](https://nimbella.com/terms) |
| 應用程式的核心功能 | 建置、執行和共用自訂命令。 |
| 公司總部位置 | 美國美國 |
...
| 應用程式會使用哪些主控雲端提供者？ | Azure、GCP、DigitalOcean |
...
此資訊由 Nimbella 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

...
| 合作夥伴公司名稱 | Nimbella |
| 公司的網站 | [https://www.nimbella.com](https://www.nimbella.com) |
| App 的使用條款 | [https://nimbella.com/terms](https://nimbella.com/terms) |
| 應用程式的核心功能 | 建立、執行及共用自訂命令。 |
| 公司 headquarter 位置 | 美國地區 |
| 應用程式資訊頁面 | [https://nimbella.com/integrations/commander/microsoft-teams](https://nimbella.com/integrations/commander/microsoft-teams) |
| 用來執行應用程式的主控環境或服務模型為何？ |  |
| 應用程式會使用哪一個主控雲端提供者？ | Azure、GCP、DigitalOcean |

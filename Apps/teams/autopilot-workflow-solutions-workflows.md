...
* <a href="https://teams.microsoft.com/l/app/5aa677bf-b5a6-48bc-9a47-8892dbd316cb" target="_blank">在 Teams 儲存區中查看</a>
...
Autopilot 工作流程解決方案所提供的資訊給 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Autopilot 工作流程 |
| ID | WA200003745 |
| 支援 Office 365 用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Autopilot 工作流程解決方案 |
| 公司的網站 | [https://www.autopilot.co.za](https://www.autopilot.co.za) |
...
此資訊已透過 Autopilot 工作流程解決方案提供，此應用程式是關於此應用程式如何收集及儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

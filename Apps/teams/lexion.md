---
title: Lexion by Lexion 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/20/2021
...
description: Lexion 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/e2b7f512-12eb-4ba7-8705-b512fb3c05ee" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003176" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Lexion 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Lexion |
| 公司的網站 | [https://lexion.ai](https://lexion.ai) |
| 應用程式的使用規定 | [https://lexion.ai/terms](https://lexion.ai/terms) |
| 應用程式的核心功能 | Microsoft Teams適用于 Lexion AI 技術合約生命週期管理的 Bot。  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://lexion.ai](https://lexion.ai) |
...
Lexion 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

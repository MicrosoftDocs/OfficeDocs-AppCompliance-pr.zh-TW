---
title: Passport 360 by Passport 360 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Passport 360 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/585570bb-e996-4b0b-89cf-0b5d610ecb65" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004322" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Passport 360 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Passport 360 |
| 公司的網站 | [https://www.passport360.com](https://www.passport360.com) |
| 應用程式的使用規定 | [https://www.passport360.com/privacy-policy/](https://www.passport360.com/privacy-policy/) |
| 應用程式的核心功能 | 跨供應商數位化健全狀況和安全程式的 SaaS 解決方案 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | |
...
Passport 360 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 租使用者識別碼;使用者主體名稱 |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 澳大利亞、南非、加拿大 |
| 您是否有已建立的資料租用和處置程式？ | 是 |
| 帳戶終止之後，資料會保留多久？ | 未保留 |
| 您是否有已建立的資料存取管理程式？ | 是 |
...
| 隱私權原則 URL | https://www.passport360.com/privacy-policy-2/ |

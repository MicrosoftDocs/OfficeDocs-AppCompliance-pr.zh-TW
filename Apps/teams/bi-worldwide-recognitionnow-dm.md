---
title: BI 全球 BI DM 的應用程式資訊 RecognitionNow DM
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/22/2022
...
description: RecognitionNow DM 的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/af14ac7f-7a33-4d98-9c90-1e31285a5aa9" target="_blank">在 Teams 儲存區中查看</a>
...
BI 全球的資訊提供給 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | RecognitionNow DM |
| ID | WA200003647 |
| 支援 Office 365 用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | BI 全球 |
| 公司的網站 | [https://www.biworldwide.com](https://www.biworldwide.com) |
| App 的使用條款 | [https://recognition-now.biw.cloud/terms-and-conditions-dm](https://recognition-now.biw.cloud/terms-and-conditions-dm) |
| 應用程式的核心功能 | 透過 Teams 將識別直接傳送至相同識別計畫中的其他參與者。 此增益集隨附于組織的認可計畫。 |
...
BI 全球已提供此資訊，瞭解此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://teams.recognitionnow.com/assets/images/privacy-policy.pdf |

...
| 合作夥伴公司名稱 | MailClark |
| 公司的網站 | [https://mailclark.ai/microsoft-teams-integration](https://mailclark.ai/microsoft-teams-integration) |
| App 的使用條款 | [https://mailclark.ai/tos](https://mailclark.ai/tos) |
| 應用程式的核心功能 | 管理 &amp; Microsoft Teams 中的電子郵件、Facebook 和 Twitter 郵件的回應。 |
| 公司 headquarter 位置 |  |
| 應用程式資訊頁面 | |

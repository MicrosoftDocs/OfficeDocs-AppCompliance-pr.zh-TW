...
description: Docuo 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/2b4ebe4e-7500-4aa5-be83-3857bb2bff2e" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002937" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

R2 Docuo 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | R2 Docuo |
| 公司的網站 | [https://www.r2docuo.com](https://www.r2docuo.com) |
| 應用程式的使用規定 | [https://www.r2docuo.com/en/legal-advice](https://www.r2docuo.com/en/legal-advice) |
| 應用程式的核心功能 | 與您的小組連線，而不需要離開Teams並以敏捷且有效的方式管理您的工作流程。 |
| 公司總部位置 | 西班牙 |
| 應用程式資訊頁面 | [https://www.r2docuo.com](https://www.r2docuo.com) |
...
R2 Docuo 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: Pandos Intelligence Inc 的 Pandos 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/05/2022
...
Pandos Intelligence Inc 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Pandos Intelligence Inc |
| 公司的網站 | [https://pandos.io](https://pandos.io) |
| 應用程式的使用規定 | [https://app.pandos.io/terms-of-use](https://app.pandos.io/terms-of-use) |
| 應用程式的核心功能 | Pandos 是一站式學習與開發平臺，適用于團隊和人員經理、專案負責人、訓練人員和教育講師。 它支援基本功能，例如以準則為基礎的小組組建 (包括可用性、特質、技能或任何自訂準則) 、小組工作管理和對等評量。 平臺會自動為成員的軟技能產生設定檔，並由同儕驗證。  |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | [https://pandos.io](https://pandos.io) |
...
Pandos Intelligence Inc 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

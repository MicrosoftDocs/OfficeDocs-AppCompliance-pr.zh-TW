...
description: 所有可用的安全性與合規性資訊，適用于Loop、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64879750"
---
# <a name="loop"></a>Loop

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 11 月 10 日</p>

* <a href="https://teams.microsoft.com/l/app/5dcf4bd7-eccd-4f6d-b5f0-a4e04aab4ff9" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003480" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由易記流程提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 好用流程 |
| 公司的網站 | [https://friendlyflows.com](https://friendlyflows.com) |
| 應用程式的使用規定 | [https://friendlyflows.com/terms-of-use/](https://friendlyflows.com/terms-of-use/) |
| 應用程式的核心功能 | 在正確的時間將人員結合在一起，以處理專案。 |
| 公司總部位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | [https://friendlyflows.com/loop/](https://friendlyflows.com/loop/) |
...
[易記流程] 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔，使用者輸入 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者設定檔，使用者輸入 |
...
| 隱私權原則 URL | https://friendlyflows.com/privacy-policy/ |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | 無 |
| 您的應用程式是否支援條件式存取原則？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 驗證 | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
>| 電子郵件 | 委託 | 註冊 | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
>| 設定檔 | 委託 | 驗證 | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |

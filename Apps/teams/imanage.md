---
title: iManage by iManage 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: iManage 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c941fa60-c3a3-4bc6-b846-a63406009c15" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003178" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

iManage 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | iManage |
| 公司的網站 | [https://imanage.com](https://imanage.com) |
| 應用程式的使用規定 | [https://support.imanage.com/worksite/iManage_Cloud_Services...](https://support.imanage.com/worksite/iManage_Cloud_Services_Agreement.pdf) |
| 應用程式的核心功能 | 在 iManage 中儲存及控管您的內容時，自由地共同作業。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://imanage.com/products/work/](https://imanage.com/products/work/) |
...
iManage 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC2 認證日期 | 2021-04-16 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 認證日期 | 2021-04-16 |

...
| App 的使用條款 | [https://support.imanage.com/worksite/iManage_Cloud_Services...](https://support.imanage.com/worksite/iManage_Cloud_Services_Agreement.pdf) |
| 應用程式的核心功能 | 在儲存內容和管理 iManage 時，可自由地進行共同作業。 |
...
| 您已完成哪一種 SOC 2 憑證？ |   |
| 最近的 SOC2 認證日期 |  2021-04-16 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最近的 SOC3 認證日期 |  2021-04-16 |

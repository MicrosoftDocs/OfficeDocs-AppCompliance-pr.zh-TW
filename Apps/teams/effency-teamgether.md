---
title: TeamGether by EFFENCY 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/12/2021
...
description: TeamGether 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/5a0547cc-ea63-4425-acc8-08b89a8fc1a1" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002660" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

EFFENCY 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | EFFENCY |
| 公司的網站 | [https://www.effency.fr](https://www.effency.fr) |
| 應用程式的使用規定 | [https://www.effency.fr/conditions-generales/](https://www.effency.fr/conditions-generales/) |
| 應用程式的核心功能 | TeamGether 是 EFFENCY 所開發之集體效率中領先的數位指導應用程式 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://www.effency.fr/teams/](https://www.effency.fr/teams/) |
...
EFFENCY 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

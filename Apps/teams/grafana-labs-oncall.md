---
title: Grafana OnCall by Grafana Labs 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Grafana OnCall 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/ed13a4a6-7d9c-4904-913c-402dbca12d1e" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004307" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Grafana Labs 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Grafana OnCall |
| ID | WA200004307 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Grafana Labs |
| 公司的網站 | [https://grafana.com](https://grafana.com) |
| 應用程式的使用規定 | [https://grafana.com/legal/terms/](https://grafana.com/legal/terms/) |
| 應用程式的核心功能 | 執行待命管理的最簡單方式 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
Grafana Labs 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://grafana.com/legal/terms |

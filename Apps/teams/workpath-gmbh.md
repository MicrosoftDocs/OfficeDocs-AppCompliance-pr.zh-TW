---
title: Workpath by Workpath GmbH 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Workpath 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/8562f79a-0ba8-4555-a967-6e34bdfecca9" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003898" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Workpath GmbH 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Workpath GmbH |
| 公司的網站 | [https://www.workpath.com/en/home](https://www.workpath.com/en/home) |
| 應用程式的使用規定 | [https://www.workpath.com/en/workpath-ms](https://www.workpath.com/en/workpath-ms) |
| 應用程式的核心功能 | 使用 Workpath OKR 掌握您的策略目標。 |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | [https://workpath.zendesk.com/hc/en-us/articles/455508104360...](https://workpath.zendesk.com/hc/en-us/articles/4555081043602-Using-the-MS-Teams-integration) |
...
Workpath GmbH 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.workpath.com/en/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 讀取已登入使用者的租使用者 | [dc8facfc-c606-44b4-a0ad-04f81446845c](../azure/dc8facfc-c606-44b4-a0ad-04f81446845c.md) |

...
* <a href="https://teams.microsoft.com/l/app/0587c0da-1445-4875-a9f3-2b8083b7338f" target="_blank">在 Teams 儲存區中查看</a>
...
| App 的使用條款 | [https://heedify.io/terms](https://heedify.io/terms) |
| 應用程式的核心功能 | Microsoft Teams 的原生接待員語音應答和話務中心代理人。 |
...
此資訊是由 Heedify 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 「話務中心」 (的目前狀態資訊和通話詳細資料 )   |

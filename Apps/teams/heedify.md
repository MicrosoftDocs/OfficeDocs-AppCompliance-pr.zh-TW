---
title: Heedify 的 Heedify 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/24/2021
...
description: Heedify 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64877270"
---
# <a name="heedify"></a>Heedify

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 8 月 2 日</p>

* <a href="https://teams.microsoft.com/l/app/0587c0da-1445-4875-a9f3-2b8083b7338f" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003512" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Heedify 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Heedify |
| 公司的網站 | [https://heedify.io](https://heedify.io) |
| 應用程式的使用規定 | [https://heedify.io/terms](https://heedify.io/terms) |
| 應用程式的核心功能 | 適用于 Microsoft Teams 的原生接收員語音應答和話務中心代理程式。 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | |
...
Heedify 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 從話務中心 (顯示資訊和通話詳細資料)   |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 從話務中心 (顯示資訊和通話詳細資料)   |
...
| 隱私權原則 URL | https://heedify.io/privacy |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | 我們使用 ADAL (JAVAscript) ，因為 MSAL 尚不支援使用 ADFS 進行驗證  |
| 您的應用程式是否支援條件式存取原則？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委託 | 接聽者必須先檢查使用者行事曆，再轉接電話或與客戶在電話上共用資訊 | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Contacts.ReadWrite | 委託 | 應用程式必須能夠將連絡人新增至使用者 (代理程式) ，同時讀取其連絡人  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Contacts.ReadWrite.Shared | 委託 | 應用程式必須能夠新增與其他使用者的共用連絡人 (代理程式) ，並同時讀取其共用連絡人  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Presence.Read.All | 委託 | 連絡人中心代理程式需要目前狀態資訊，才能更妥善地管理通話和連絡人，特別是在電話轉接時  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| User.Read.All | 委託 | 若要管理連絡人，記錄的使用者必須能夠流覽使用者並讀取其資訊，包括其離職和經理 (，以防發生接收者)   | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |

---
title: Wisembly for Wisembly 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Wisembly、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/b63d5c73-8c76-4d8b-b0dc-ca35c6e37a90" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001554" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Wisembly 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Wisembly |
| 公司的網站 | [https://wisembly.com](https://wisembly.com) |
| 應用程式的使用規定 | [https://wisembly.com/en/condition-of-sale.html](https://wisembly.com/en/condition-of-sale.html) |
| 應用程式的核心功能 | 建立簡單且吸引人的虛擬和混合式活動、會議、研討會...從頭到尾，不論您的需求為何，明智地引導您完成活動專案：可自訂的首頁、註冊、研討會和研討會的組織、視訊工具、互動式功能等等。 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://wisembly.com](https://wisembly.com) |
...
Wisembly 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

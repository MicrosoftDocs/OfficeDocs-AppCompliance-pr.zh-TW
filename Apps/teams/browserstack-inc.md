---
title: BrowserStack by BrowserStack Inc 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: BrowserStack 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/180f19aa-1b79-4b4a-b716-068b81cfb145" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004404" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

BrowserStack Inc 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | BrowserStack Inc |
| 公司的網站 | [https://www.browserstack.com](https://www.browserstack.com) |
| 應用程式的使用規定 | [https://www.browserstack.com/terms](https://www.browserstack.com/terms) |
| 應用程式的核心功能 | 將您的 BrowserStack 深入解析直接帶入 Microsoft Teams！ |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | [https://www.browserstack.com/docs/automate/selenium/microso...](https://www.browserstack.com/docs/automate/selenium/microsoft-teams) |
...
此資訊由 BrowserStack Inc 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.browserstack.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 登入和讀取用於驗證目的的使用者設定檔 | [180f19aa-1b79-4b4a-b716-068b81cfb145](../azure/180f19aa-1b79-4b4a-b716-068b81cfb145.md) |

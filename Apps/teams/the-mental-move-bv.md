---
title: 由「心智移動 B.V」進行之「心智移動」的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/02/2022
...
description: '[心智移動]、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。'
...
ms.locfileid: "65645642"
---
# <a name="the-mental-move"></a>The Mental Move

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 2 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/c5c971cc-3589-4338-a3be-1326db95cb24" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004016" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由「心智移動 B.V」所提供的資訊。 至 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | The Mental Move |
| ID | WA200004016 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | The Mental Move B.V. |
| 公司的網站 | [https://www.thementalmove.nl](https://www.thementalmove.nl) |
| 應用程式的使用規定 | [https://www.thementalmove.nl/gebruikersvoorwaarden/](https://www.thementalmove.nl/gebruikersvoorwaarden/) |
| 應用程式的核心功能 | Snel aan de slag met jouw mentale conditie binnen Teams！ |
| 公司總部位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | [https://www.thementalmove.nl/ons-aanbod/online-preventiepla...](https://www.thementalmove.nl/ons-aanbod/online-preventieplatform/) |
...
這項資訊是由「心智移動 B.V」所提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.thementalmove.nl/privacy-statement/ |

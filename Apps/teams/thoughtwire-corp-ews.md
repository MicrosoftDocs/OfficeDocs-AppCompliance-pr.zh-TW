...
| 公司的網站 | [https://thoughtwire.com](https://thoughtwire.com) |
| App 的使用條款 | [https://www.thoughtwire.com/end-user-license-agreement/](https://www.thoughtwire.com/end-user-license-agreement/) |
| 應用程式的核心功能 | ThoughtWire 應用程式支援 EarlyWarning-已證實可減少61% 的程式碼藍色事件的高級偵測和干預工具。 早期的警告解決方案設計為根據患者 vitals 偵測患者 deterioration、通知臨床醫師不良健康情況事件，並讓他們採取行動。 回應小組人員可以存取患者內容，並瞭解回應小組的狀態和可用性，以簡化回應和病人護理工作流程。 |
...
| 您已完成哪一種 SOC 2 憑證？ |   |
| 最近的 SOC2 認證日期 |  2021-03-31 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最近的 SOC3 認證日期 |  2021-03-31 |

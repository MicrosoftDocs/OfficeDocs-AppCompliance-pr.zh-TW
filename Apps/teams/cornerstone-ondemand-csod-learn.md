---
title: CSOD Learn by Cornerstone OnDemand 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: CSOD Learn 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/81726ee9-4d27-47ad-8b22-08147c6f8613" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003020" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Cornerstone OnDemand 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.cornerstoneondemand.com](https://www.cornerstoneondemand.com) |
| 應用程式的使用規定 | [https://www.microsoft.com/en-us/microsoft-teams/group-chat-...](https://www.microsoft.com/en-us/microsoft-teams/group-chat-software) |
| 應用程式的核心功能 | 直接在 Teams 內Learning管理系統的基本概念 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
| 用來執行應用程式的裝載環境或服務模型為何？ |  |
| 應用程式會使用哪些主控雲端提供者？ | AWS、SelfHosted |
...
Cornerstone OnDemand 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC1 認證日期 | 2020-01-01 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 認證日期 | 2020-01-01 |

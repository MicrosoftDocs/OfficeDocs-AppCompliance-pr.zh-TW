---
title: DSMN8 by DSMN8 員工宣傳的應用程式資訊8
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
| 應用程式的使用規定 | [https://dsmn8.com/terms-and-conditions](https://dsmn8.com/terms-and-conditions) |
| 應用程式的核心功能 |  DSMN8 是以應用程式為基礎的平臺，可讓員工透過在自己的社交媒體頻道上共用公司核准的公司內容，成為公司影響者。  |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | |
...
DSMN8 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 職稱、名字、姓氏、電子郵件地址 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 職稱、名字、姓氏、電子郵件地址 |

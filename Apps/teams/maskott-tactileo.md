---
title: Tactileo by Maskott 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2021
...
description: Tactileo 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/55388bc6-eeba-4877-8af5-3ba103402555" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002624" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Maskott 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Maskott |
| 公司的網站 | [https://www.maskott.com](https://www.maskott.com) |
| 應用程式的使用規定 | [https://support.tactileo.com/cgu/cgu_services_tactileo.pdf](https://support.tactileo.com/cgu/cgu_services_tactileo.pdf) |
| 應用程式的核心功能 | 與您的小組共同作業並共用教育內容 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://www.tactileo.com](https://www.tactileo.com) |
...
Maskott 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC1 認證日期 | 2020-11-05 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 認證日期 | 2020-11-04 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 認證日期 | 2020-11-04 |

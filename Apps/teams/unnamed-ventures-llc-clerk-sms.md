---
title: 未具名的 LlC 的 Clerk SMS 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Clerk SMS 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64682132"
---
# <a name="clerk-sms"></a>Clerk SMS

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 10 月 6 日</p>

* <a href="https://teams.microsoft.com/l/app/88c50b69-8e4b-4383-b70f-c8295d5431a0" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003376" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

未具名的 LlC，未命名的 LlC 所提供的資訊。 至 Microsoft：
...
| 合作夥伴公司名稱 | 未具名的一般，LLC。 |
| 公司的網站 | [https://clerk.chat/teams](https://clerk.chat/teams) |
| 應用程式的使用規定 | [https://clerk.chat/legal/terms/](https://clerk.chat/legal/terms/) |
| 應用程式的核心功能 | 傳送和接收簡訊 (簡訊/多媒體簡訊) 全部在Microsoft Teams內。  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://clerk.chat/teams](https://clerk.chat/teams) |
...
這項資訊已由未命名的布希、LLC 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://clerk.chat/legal/privacy |

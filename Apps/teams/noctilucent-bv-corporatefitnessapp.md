---
title: Noctilucent BV 所 CorporateFitness.app 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/19/2022
...
description: 所有可用的安全性與合規性資訊，適用于 CorporateFitness.app、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/3b51162a-9157-40b8-91b5-0f29efeaf1ec" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004093" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Noctilucent BV 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | CorporateFitness.app |
| ID | WA200004093 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Noctilucent BV |
| 公司的網站 | [https://corporatefitness.app](https://corporatefitness.app) |
| 應用程式的使用規定 | [https://corporatefitness.app/termsofservice](https://corporatefitness.app/termsofservice) |
| 應用程式的核心功能 | 挑戰您的小組！ 提升健康情況的步驟和健身挑戰。 10 個以上的應用程式和監看整合 |
| 公司總部位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | [https://corporatefitness.app/microsoft-teams](https://corporatefitness.app/microsoft-teams) |
...
Noctilucent BV 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用設定檔資料 |
...
| 隱私權原則 URL | https://corporatefitness.app/privacypolicy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 取得使用者設定檔資料 | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
>| 電子郵件 | 委託 | 取得使用者電子郵件 | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
>| offline_access | 委託 | 取得使用者設定檔資料 | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
>| openid | 委託 | 取得使用者設定檔資料 | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
>| 設定檔 | 委託 | 取得使用者設定檔資料 | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |

---
title: ImDocShare 的應用程式資訊，由 KL 軟體技術
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/24/2021
...
description: imDocShare 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c817ecec-e67e-4b32-aca1-192989539b2d" target="_blank">在 Teams 儲存區中查看</a>
...
| 公司的網站 | [https://www.imdocshare.com](https://www.imdocshare.com) |
| App 的使用條款 | [https://www.imdocshare.com/eula](https://www.imdocshare.com/eula) |
| 應用程式的核心功能 | imDocShare Teams 應用程式可讓使用者在 Microsoft Teams 中查看 &amp; 編輯 iManage 內容 |
| 公司 headquarter 位置 | 美國地區 |
| 應用程式資訊頁面 | [https://www.imdocshare.com](https://www.imdocshare.com) |
...
| 隱私權原則 URL | https://imdocshare.com/privacy-policy |

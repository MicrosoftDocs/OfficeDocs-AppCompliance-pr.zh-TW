...
description: Projectplace 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/256e5166-0ac6-4803-93b2-6ab29001f6ee" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000103" target="_blank">在 AppSource 中檢視</a>
...
| 公司的網站 | [https://www.planview.com](https://www.planview.com) |
| 應用程式的使用規定 | [https://www.planview.com/legal/agreements/#terms-use](https://www.planview.com/legal/agreements/#terms-use) |
| 應用程式的核心功能 | 在 Microsoft Teams 中使用 Projectplace。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.planview.com/products-solutions/products/projec...](https://www.planview.com/products-solutions/products/projectplace/) |
...
此資訊由 Planview， Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

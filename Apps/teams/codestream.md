---
title: CodeStream by CodeStream 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
description: CodeStream 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64880250"
---
# <a name="codestream"></a>CodeStream

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 5 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/7cf49ab7-8b65-4407-b494-f02b525eef2b" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001475" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

CodeStream 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | CodeStream |
| 公司的網站 | [https://www.codestream.com](https://www.codestream.com) |
| 應用程式的使用規定 | [https://www.codestream.com/terms](https://www.codestream.com/terms) |
| 應用程式的核心功能 | CodeStream 可讓您檢閱 &amp; IDE 內的討論程式碼。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
CodeStream 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

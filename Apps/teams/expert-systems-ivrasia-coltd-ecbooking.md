---
title: 由專家系統 IVR (亞洲) Co.Ltd ecBooking 的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: ecBooking 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64878261"
---
# <a name="ecbooking"></a>ecBooking

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 1 月 17 日</p>

* <a href="https://teams.microsoft.com/l/app/fe9627db-f23e-42b1-b454-d4d1ca5af33e" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002096" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

專家系統 IVR (亞洲) Co.Ltd 所提供的資訊。至 Microsoft：
...
| 公司的網站 | [https://www.esi-asia.com](https://www.esi-asia.com) |
| 應用程式的使用規定 | [https://www.esi-asia.com/product/intelligent-room-booking-s...](https://www.esi-asia.com/product/intelligent-room-booking-system/#1598241760681-29d114e0-5c2b) |
| 應用程式的核心功能 | 使用智慧型系統將會議空間優化的有效預約體驗。 |
| 公司總部位置 | 香港 |
| 應用程式資訊頁面 | [https://www.esi-asia.com/product/intelligent-room-booking-s...](https://www.esi-asia.com/product/intelligent-room-booking-system/) |
...
這項資訊是由亞洲) Co.Ltd 專家系統 IVR (提供。關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 香港 |
| 您是否有已建立的資料租用和處置程式？ | 否 |
| 帳戶終止之後，資料會保留多久？ | 未保留 |
| 您是否有已建立的資料存取管理程式？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 應用程式 | 行事曆讀寫 | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| Calendars.ReadWrite | 委託 | 行事曆讀寫 | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| Mail.Send | 委託 | 傳送郵件 | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| Mail.Send | 應用程式 | 傳送郵件 | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| User.Read | 委託 | 讀取使用者 | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| User.Read.All | 應用程式 | 讀取使用者 | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |

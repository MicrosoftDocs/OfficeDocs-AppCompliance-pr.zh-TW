---
title: Smartnotation B.V 的 Smartnotation 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/09/2021
...
description: Smartnotation 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/424b1333-fbf0-4941-acbe-336bf1f316ae" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000681" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Smartnotation B.V 所提供的資訊。 至 Microsoft：
...
| 公司的網站 | [https://www.smartnotation.com/landing/](https://www.smartnotation.com/landing/) |
| 應用程式的使用規定 | [https://www.smartnotation.com/public/tos.pdf](https://www.smartnotation.com/public/tos.pdf) |
| 應用程式的核心功能 | Smartnotation 是容易使用的語音啟用會議分鐘解決方案。 您的筆記、動作和決策很容易管理，而且您的資訊一律可供使用。 最重要的是，這會消除不必要的額外負荷，讓您和您的小組專注于核心業務。 您可以完全整合 Smartnotation 與 MS Teams。 新增連接器，以取得特定專案所有重要更新、新附注、動作和決策的通知、設定索引標籤或直接使用 Smartnotation。 |
| 公司總部位置 | 荷蘭 ()  |
...
| 應用程式會使用哪些主控雲端提供者？ | Totaaldomein B.V. |
...
此資訊已由 Smartnotation B.V 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: LawVu Europe by LawVu 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: 所有適用于 LawVu Europe 的可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64769069"
---
# <a name="lawvu-europe"></a>LawVu Europe

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 2 月 22 日</p>

* <a href="https://teams.microsoft.com/l/app/ce6fa59d-9c48-492c-b0e2-434abe99c355" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003931" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

LawVu 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | LawVu |
| 公司的網站 | [https://lawvu.com](https://lawvu.com) |
| 應用程式的使用規定 | [https://lawvu.com/wp-content/uploads/Std-Saas-Agreement-202...](https://lawvu.com/wp-content/uploads/Std-Saas-Agreement-2021.pdf) |
| 應用程式的核心功能 | 商務使用者可以向Teams提出法律要求。  整合會擷取所有相關欄位，包括原始訊息中的內容和任何附件，並在 LawVu 中建立問題，使其&#8217;法律小組&#8217;記錄系統的一部分。 |
| 公司總部位置 | 紐西蘭 |
| 應用程式資訊頁面 | [https://help.lawvu.com/en/articles/5953276-microsoft-teams-...](https://help.lawvu.com/en/articles/5953276-microsoft-teams-integration-coming-soon) |
...
此資訊由 LawVu 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | MS Teams中的附件檔案。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | MS 小組中的附件檔案會提取到我們的資料存放區。 |
...
| 最新的 SOC1 認證日期 | 2021-02-28 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 您達成哪一個 SOC 2 認證？ | type2 |
| 最新的 SOC2 認證日期 | 2021-02-11 |
...
| 隱私權原則 URL | https://lawvu.com/trust-center/privacy/gdpr |

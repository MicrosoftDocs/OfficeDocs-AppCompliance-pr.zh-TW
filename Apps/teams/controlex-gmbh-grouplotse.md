---
title: GroupLotse by controlex GmbH 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: GroupLotse 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/0ec566bc-a37a-46ca-a252-54af50dfa86e" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002304" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Controlex GmbH 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://grouplotse.com](https://grouplotse.com) |
| 應用程式的使用規定 | [https://grouplotse.com/en/user-terms-of-service/](https://grouplotse.com/en/user-terms-of-service/) |
| 應用程式的核心功能 | 快速厘清責任。 包含 AI、IoT 和雲端服務的介面！ |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | [https://grouplotse.com/en/product/](https://grouplotse.com/en/product/) |
...
Controlex GmbH 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

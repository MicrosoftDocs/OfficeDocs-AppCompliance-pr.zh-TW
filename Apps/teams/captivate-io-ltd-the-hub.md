...
* <a href="https://teams.microsoft.com/l/app/0ea8ef28-454a-4796-84dc-06c775639565" target="_blank">在 Teams 儲存區中查看</a>
...
由 Captivate IO 公司所提供的資訊給 Microsoft：
...
| 合作夥伴公司名稱 | Captivate IO 有限公司 |
| 公司的網站 | [https://captivat.io](https://captivat.io) |
...
此資訊是由 Captivate IO 公司所提供，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 加入至應用程式之團隊群組的承租人識別碼、Teams 群組、通道群組和使用者 |
...
| 隱私權原則 URL | https://www.captivat.io/privacy-policy/ |

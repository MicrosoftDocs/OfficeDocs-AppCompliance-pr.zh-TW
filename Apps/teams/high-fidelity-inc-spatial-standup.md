---
title: 高保真 Inc. 的空間 Standup 應用程式資訊
ms.author: elmalova
author: elenamalova
ms.date: 08/25/2021
ms.topic: article
...
* <a href="https://teams.microsoft.com/l/app/52f9c87d-262c-4e33-b5b6-fc84b35df529" target="_blank">在 Teams 儲存區中查看</a>
...
| App 的使用條款 | [https://www.highfidelity.com/terms-of-service](https://www.highfidelity.com/terms-of-service) |
| 應用程式的核心功能 | Standup 會議的空間音訊、影片和螢幕共用 |
...
此資訊已由高保真 Inc. 提供，以供高保真 Inc. 使用此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

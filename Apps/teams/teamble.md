---
title: Teamble by Teamble 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Teamble 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/ee7907e3-f0b3-4e18-b882-baa83e87812f" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002259" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Teamble 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Teamble |
| 公司的網站 | [https://teamble.com](https://teamble.com) |
| 應用程式的使用規定 | [https://teamble.com/#/terms-of-service](https://teamble.com/#/terms-of-service) |
| 應用程式的核心功能 | Teamble 讓 360 意見反應變得簡單、連續且具影響力。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://teamble.com](https://teamble.com) |
...
Teamble 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

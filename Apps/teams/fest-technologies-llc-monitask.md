---
title: FEST Technologies、LLC 的 Monitask 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Monitask 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/0b49493f-fc40-49e1-9e3b-6515588af2b5" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002986" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

FEST Technologies、LLC 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.monitask.com](https://www.monitask.com) |
| 應用程式的使用規定 | [https://www.monitask.com/en/home/termsofservice](https://www.monitask.com/en/home/termsofservice) |
| 應用程式的核心功能 | Monitask 是 All-In-One 遠端商務生產力工具組 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
此資訊已由 FEST Technologies、LLC 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

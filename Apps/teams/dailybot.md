---
title: DailyBot by DailyBot 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: DailyBot 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66915649"
---
# <a name="dailybot"></a>DailyBot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 4 月 27 日</p>

* <a href="https://teams.microsoft.com/l/app/82bfb2e1-cad3-4e99-8995-5d140f295ef2" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001492" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

DailyBot 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | DailyBot |
| 公司的網站 | [https://www.dailybot.com](https://www.dailybot.com) |
| 應用程式的使用規定 | [https://www.dailybot.com/legal/terms-and-conditions](https://www.dailybot.com/legal/terms-and-conditions) |
| 應用程式的核心功能 | DailyBot 藉由自動化待命、每日狀態報表、回顧和定期簽入，來減少會議的需求。其會追蹤團隊動機，並利用 kudos 和感謝來提升正面的意見反應。 DailyBot 包含額外的功能，可建立快捷方式/命令，並將聊天工作流程自動化。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.dailybot.com/integrations/msteams](https://www.dailybot.com/integrations/msteams) |
...
DailyBot 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者Email、租使用者識別碼、MS 小組資源識別碼和名稱、小組頻道識別碼 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者Email、租使用者識別碼、MS 小組資源識別碼和名稱、小組頻道識別碼、DailyBot 功能和工作流程所收集的使用者回應內容，例如：簽入、問卷、表單或 Kudos。 |
...
| 隱私權原則 URL | https://www.dailybot.com/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | DailyBot 需要從小組讀取使用者的基本資訊，這可用來提供良好的使用者上執行緒序體驗，並讓成員邀請程式更容易。 | [82bfb2e1-cad3-4e99-8995-5d140f295ef2](../azure/82bfb2e1-cad3-4e99-8995-5d140f295ef2.md) |

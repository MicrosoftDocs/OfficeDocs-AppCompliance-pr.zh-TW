---
title: Absentify by BrainCore 解決方案的應用程式資訊 GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
BrainCore 解決方案所提供的資訊 GmbH 至 Microsoft：
...
此資訊是由 BrainCore 解決方案 GmbH 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

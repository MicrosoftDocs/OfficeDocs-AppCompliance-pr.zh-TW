---
title: COR Global Ltd 的 COR 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: COR 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2021 年 9 月 6 日</p>

* <a href="https://teams.microsoft.com/l/app/1ff72075-1e25-4b42-bd88-3fdbc9d6d34e" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004235" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

COR Global Ltd. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | COR Global Ltd. |
| 公司的網站 | [https://projectcor.com](https://projectcor.com) |
| 應用程式的使用規定 | [https://projectcor.com/cor-terms-of-service/](https://projectcor.com/cor-terms-of-service/) |
| 應用程式的核心功能 | 即時可見度。 COR 是以專業人員和創意團隊為目標的管理解決方案，可智慧地建議如何使用人工智慧來管理專案、團隊和財務。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://cor.zendesk.com/hc/en-us](https://cor.zendesk.com/hc/en-us) |
...
COR Global Ltd 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://projectcor.com/cor-privacy-and-personal-data/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read.All | 應用程式 | 與單一磁片磁碟機整合 | [e73458d3-c732-4460-bfb2-9da9086fc714](../azure/e73458d3-c732-4460-bfb2-9da9086fc714.md) |

---
title: Haptivity Technologies Pvt Ltd 的 SuperBeings 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: SuperBeings 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2021 年 9 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/1e7931be-a76f-4b12-b1b3-8914c7860aec" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003246" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Haptivity Technologies Pvt Ltd 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.superbeings.ai](https://www.superbeings.ai) |
| 應用程式的使用規定 | [https://www.superbeings.ai/terms-of-use](https://www.superbeings.ai/terms-of-use) |
| 應用程式的核心功能 | 使用工具/學習/深入解析讓您的領導者能夠持續強化其小組。 |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | [https://www.superbeings.ai](https://www.superbeings.ai) |
...
這項資訊是由 Haptivity Technologies Pvt Ltd 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| ReadWrite 共用 | 委託 | 無 | 搜尋使用者的電子郵件，並將電子郵件移至指定的資料夾 | 6f30434d-3cfa-4cf8-9810-6fcf79ae750a |
>| User.Read | 委託 |  使用者的存取權杖-用於搜尋及還原使用者的資料 | 允許使用者登入並將存取權杖授與應用程式 | 6f30434d-3cfa-4cf8-9810-6fcf79ae750a |
>| User.ReadWrite | 委託 | DisplayName，UserPrincipalName，JobTitle，Organization，Country，MySiteUrl-record 使用此應用程式之使用者的基本資訊 | 取得使用者的基本設定檔資訊 | 6f30434d-3cfa-4cf8-9810-6fcf79ae750a |

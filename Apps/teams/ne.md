...
description: NE 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/bd4bd4f6-ec6c-42b3-b296-bf39b8b758b3" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000840" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

NE 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | NE |
| 公司的網站 | [https://www.ne.se](https://www.ne.se) |
| 應用程式的使用規定 | [https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillk...](https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillkor/fleranv%c3%a4ndare/) |
| 應用程式的核心功能 | 可讓 NE 客戶從小組記憶體取其內容服務的 Teams 應用程式。 它也會新增小組訊息擴充功能，讓使用者在聊天中輸入@ne來搜尋 NE 百科全書。 |
| 公司總部位置 | 瑞典 |
| 應用程式資訊頁面 | [https://www.ne.se/info/om-oss/](https://www.ne.se/info/om-oss/) |
...
NE 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

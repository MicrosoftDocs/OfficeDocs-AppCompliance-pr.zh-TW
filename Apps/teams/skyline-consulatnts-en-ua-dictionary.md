---
title: Skyline Consulatnts 的 EN-UA 字典應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: EN-UA 字典的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/1a24a3a3-1fda-4f70-abee-40bba8c638e8" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004310" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Skyline Consulatnts 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Skyline Consulatnts |
| 公司的網站 | [https://skylineconsultants.com](https://skylineconsultants.com) |
| 應用程式的使用規定 | [https://skylineconsultants.com/terms-and-conditions/](https://skylineconsultants.com/terms-and-conditions/) |
| 應用程式的核心功能 | Skyline 顧問English-Ukrainian字典應用程式會完整組織，讓使用者在 Microsoft Teams 中工作時搜尋未知的字詞。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
Skyline Consulatnts 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 哪些資料會儲存在您的資料庫中？ | 我們的資料庫會保留資訊：使用者在應用程式中停止的位置，並在使用者下次進入應用程式時還原該位置。 圖形使用者識別碼 |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | Microsoft.Graph;Microsoft.TeamsFx; |
| 您的應用程式是否支援條件式存取原則？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 存取使用者設定檔 | [2da850e4-5b9d-455c-ae32-bec270de4b60](../azure/2da850e4-5b9d-455c-ae32-bec270de4b60.md) |

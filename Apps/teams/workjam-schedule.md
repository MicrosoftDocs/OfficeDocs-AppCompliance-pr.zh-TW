---
title: WorkJam Schedule by WorkJam 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: WorkJam 排程的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64880110"
---
# <a name="workjam-schedule"></a>WorkJam 排程

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 7 月 13 日</p>

* <a href="https://teams.microsoft.com/l/app/02cc7d46-7636-4f30-bae2-c5dfde32751c" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003058" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

WorkJam 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | WorkJam |
| 公司的網站 | [https://www.workjam.com](https://www.workjam.com) |
| 應用程式的使用規定 | [https://appcontent.workjam.com/en/terms-of-use/](https://appcontent.workjam.com/en/terms-of-use/) |
| 應用程式的核心功能 | WorkJam 是數位工作場所解決方案產業領導者，可選擇將其一線員工&#8212;協調為您的第一線生產力平臺或一線員工解決方案內。 WorkJam 提供超過 37 種語言，並部署于超過 38 個國家/地區，透過領先市場的工作管理、班次管理、問卷和微學習工具，提供總員工協調流程。  |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | [https://www.workjam.com/portfolio-items/workjam-microsoft-t...](https://www.workjam.com/portfolio-items/workjam-microsoft-teams/) |
...
WorkJam 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | 應用程式 | 傳送通知給使用者。 | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
>| User.Read | 委託 | 用於識別和驗證 | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |

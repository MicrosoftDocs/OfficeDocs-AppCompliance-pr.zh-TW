...
description: Isolved 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/287fab70-2e10-4bc3-9049-8991d7796d81" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004410" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Isolved 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | isolved |
| 公司的網站 | [https://www.isolvedhcm.com](https://www.isolvedhcm.com) |
| 應用程式的使用規定 | [https://www.isolvedhcm.com/legal/agreements/employee-terms-...](https://www.isolvedhcm.com/legal/agreements/employee-terms-and-conditions-for-use) |
| 應用程式的核心功能 | 讓您的人員能夠在 Microsoft Teams 內快速取得 HR 問題的解答 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.isolvedhcm.com/platform/enhancements/conversati...](https://www.isolvedhcm.com/platform/enhancements/conversational-virtual-assistant) |
...
此資訊由 isolved 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | Microsoft Azure 租使用者識別碼、Microsoft Azure 使用者識別碼  |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | Microsoft Azure 租使用者識別碼、Microsoft Azure 使用者識別碼  |
...
| 最新的 SOC1 認證日期 | 2021-08-31 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 您達成哪一個 SOC 2 認證？ | type1 |
| 最新的 SOC2 認證日期 | 2022-01-31 |

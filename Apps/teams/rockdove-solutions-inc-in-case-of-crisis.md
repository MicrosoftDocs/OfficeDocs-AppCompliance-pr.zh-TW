...
description: 在危機時，其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/cf430644-447e-4572-8467-3892596d05c7" target="_blank">在Teams存放區中檢視</a>
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委託 | 這可讓您完整存取使用者的行事曆。 我們的應用程式會顯示描述、會議連結，以及開始和結束日期。 我們的應用程式也可讓使用者在 Outlook 行事曆上建立活動 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Channel.ReadBasic.All | 委託 | 提供使用者通道的存取權。  通道的使用者清單可用來選取要上傳檔案的通道 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Files.ReadWrite | 委託 | 不適用 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Files.ReadWrite.All | 委託 | 我們允許使用者將檔案從問題管理上傳至 Teams | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Sites.ReadWrite.All | 委託 | 上傳至私人通道需要此專案 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Team.ReadBasic.All | 委託 | 需要小組清單，才能取得使用者所屬的通道清單。 這可讓我們檢視可用上傳通道的清單。 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| 電子郵件 | 委託 | 需要在驗證之後取得使用者的電子郵件，才能與資料庫中的電子郵件進行比較。 如果使用者在我們的系統中沒有帳戶，我們會建立一個帳戶。 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| offline_access | 委託 | 這可讓我們重新整理圖形存取權杖 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| openid | 委託 | 透過 openid 進行驗證所需的許可權 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |

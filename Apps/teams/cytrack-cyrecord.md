---
title: CyRecord by CyTrack 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: CyRecord 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/4073224c-6e1d-4e72-a754-510d91279b3b" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004280" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的核心功能 | CyRecord 的目標是需要進階功能來錄製外部 Microsoft Teams 通話的商務使用者。   通話錄製提供電話的未討論事實，進而更快速地解決爭議。 透過接聽和訓練來改善客戶服務，並符合法規需求的合規性。 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | [https://web.cytrack.com/microsoft-teams/call-recording-for-...](https://web.cytrack.com/microsoft-teams/call-recording-for-microsoft-teams/) |

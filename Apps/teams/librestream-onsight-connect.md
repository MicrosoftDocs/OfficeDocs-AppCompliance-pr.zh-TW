...
| App 的使用條款 | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
| 應用程式的核心功能 | 增強您的數位轉換策略，讓您的員工及客戶可以立即存取內容、人員、智慧資料和指南，以快速檢查及解決問題。 Onsight 擴充的現實平臺已全域部署，可提高工業（如製造、航空、能源、繁重的設備及現場服務）的運作效率。 |

---
title: Librestream 的 Onsight 連線應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Onsight 連線的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64876330"
---
# <a name="onsight-connect"></a>Onsight Connect

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 4 月 13 日</p>

* <a href="https://teams.microsoft.com/l/app/c01f5608-4ade-4749-aafa-9e5449a5bcb4" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002769" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Librestream 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://librestream.com](https://librestream.com) |
| 應用程式的使用規定 | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
| 應用程式的核心功能 | 增強您的數位轉型策略，讓您的工作者和客戶能夠立即存取快速檢查和解決問題所需的內容、人員、智慧資料和指引。 Onsight 擴增實境平臺部署于全球，可提高製造、電力、能源、大量設備和現場服務等產業的營運效率。 |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | |
...
Librestream 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: Brightcove Video 連線的應用程式資訊，由 Brightcove Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: Brightcove Video 連線的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64879792"
---
# <a name="brightcove-video-connect"></a>Brightcove 影片連線

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 9 月 15 日</p>

* <a href="https://teams.microsoft.com/l/app/af7b350c-9e21-49a2-98b8-679327ed31c3" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003247" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Brightcove Inc. 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.brightcove.com/en/](https://www.brightcove.com/en/) |
| 應用程式的使用規定 | [https://www.brightcove.com/en/terms-and-conditions/](https://www.brightcove.com/en/terms-and-conditions/) |
| 應用程式的核心功能 | Brightcove 影片連線支援直接在Microsoft Teams內的視訊和媒體資產共同作業選項 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://integrations.support.brightcove.com/teams/installat...](https://integrations.support.brightcove.com/teams/installation.html) |
...
這項資訊由 Brightcove Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

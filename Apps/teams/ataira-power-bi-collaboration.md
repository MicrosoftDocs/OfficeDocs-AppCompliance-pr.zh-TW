...
* <a href="https://teams.microsoft.com/l/app/90381cb0-998f-4ba3-9699-130201de5ddb" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381384" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Ataira 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Ataira |
| 公司的網站 | [https://www.ataira.com](https://www.ataira.com) |
| 應用程式的使用規定 | [https://www.ataira.com/TermsofUse](https://www.ataira.com/TermsofUse) |
| 應用程式的核心功能 | Ataira 增益集可讓您檢視Power BI儀表板和報表。 將通知傳送給您的公司群組和小組、新增後續動作、內嵌Power BI公用連結、將批註新增至報表中的資料點，以及將資料檔案當做資料來源新增至Power BI報表，並即時更新。 可讓商業智慧小組在一個位置更緊密地共同作業您的商業智慧工作。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.ataira.com/Microsoft/PowerBI/Collaboration](https://www.ataira.com/Microsoft/PowerBI/Collaboration) |
...
Ataira 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | 多重要素驗證 只允許Intune註冊的裝置存取特定服務限制使用者位置和 IP 範圍 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 也是 ChannelMessage.Send Team.ReadBasic.All User.Read 的許可權。 這些可用來允許使用者選取通知的Teams群組和通道 | [00738e07-f9a4-4bf5-b6f9-851ec7ea31d5](../azure/00738e07-f9a4-4bf5-b6f9-851ec7ea31d5.md) |

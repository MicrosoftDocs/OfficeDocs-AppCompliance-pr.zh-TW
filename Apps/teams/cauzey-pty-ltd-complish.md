---
title: Cauzey Pty Ltd 的 Complish 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2021
...
description: Complish 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64877760"
---
# <a name="complish"></a>Complish

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 5 月 17 日</p>

* <a href="https://teams.microsoft.com/l/app/e840a6b7-6a38-4404-baa5-e404eb0c98b3" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001641" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Cauzey Pty Ltd 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.complish.app](https://www.complish.app) |
| 應用程式的使用規定 | [https://www.complish.app/privacy-and-terms](https://www.complish.app/privacy-and-terms) |
| 應用程式的核心功能 | Complish 可讓您輕鬆地建立良好的遠端習慣，方法是讓工作可見、連線到目標，以及促進焦點討論。 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | [https://www.complish.app](https://www.complish.app) |
...
Cauzey Pty Ltd 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

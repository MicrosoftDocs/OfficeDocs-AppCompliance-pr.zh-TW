...
description: 適用于裝訂的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64878310"
---
# <a name="staple"></a>Staple

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 9 月 27 日</p>

* <a href="https://teams.microsoft.com/l/app/ac9ca94a-e666-4f61-959a-12c063e13e69" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003281" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由群組轉換，Ltd. 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://crowdcast.jp/ja/](https://crowdcast.jp/ja/) |
| 應用程式的使用規定 | [https://go.microsoft.com](https://go.microsoft.com) |
| 應用程式的核心功能 | 使用即時費用管理來變更您的工作樣式。 裝訂可讓您為公司輕鬆提交、核准和追蹤費用。 與Microsoft 服務連結，以輕鬆地與我們的產品互動。 |
| 公司總部位置 | 日本 |
| 應用程式資訊頁面 | [https://intercom.help/staple/ja](https://intercom.help/staple/ja) |
...
這項資訊是由人群轉型，Ltd.提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Organization.Read.All | 應用程式 | 用於收集租使用者識別碼。用來確保向我們的平臺進行驗證的使用者是特定租使用者的成員。 | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 應用程式 | Teams應用程式會將自我安裝至使用者的小組 | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| AppCatalog.Read.All | 委託 | 讀取使用者的應用程式目錄，以查看是否已安裝 Teams 應用程式。 | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| User.Read | 委託 | 用來讀取使用者的識別碼，以確保訊息會傳送給正確的使用者。 | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| openid | 委託 | 登入使用者以讀取其基本設定檔資訊 | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |

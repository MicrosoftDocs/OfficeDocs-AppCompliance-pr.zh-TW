...
>| AppCatalog Read。 All | 委託 | 讀取使用者的應用程式目錄，以查看是否已安裝團隊應用程式。 | 不適用 | [bbdcd676-7448-453c-bec7-70e5384bc290](https://docs.microsoft.com/microsoft-365-app-certification/azure/bbdcd676-7448-453c-bec7-70e5384bc290) |
>| User.Read | 委託 | 用來讀取使用者的識別碼，以確保郵件傳送給正確的使用者。 | 儲存以傳送主動消息給使用者的使用者識別碼。 | [bbdcd676-7448-453c-bec7-70e5384bc290](https://docs.microsoft.com/microsoft-365-app-certification/azure/bbdcd676-7448-453c-bec7-70e5384bc290) |
>| openid | 委託 | 登入使用者以閱讀其基本設定檔資訊 | 不適用 | [bbdcd676-7448-453c-bec7-70e5384bc290](https://docs.microsoft.com/microsoft-365-app-certification/azure/bbdcd676-7448-453c-bec7-70e5384bc290) |
...
>組織的系統管理員會在夥伴的系統 (AWS，Heroku) 中控制資料。
...
此資訊已由使用中的 Cast （公司）提供。關於此應用程式如何處理驗證、授權、應用程式註冊最佳作法及其他身分識別準則。

---
title: Workday Peakon Employee Voice by Workday 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/26/2022
...
description: Workday Peakon Employee Voice 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65125316"
---
# <a name="workday-peakon-employee-voice"></a>Workday Peakon 員工語音

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 7 月 20 日</p>

* <a href="https://teams.microsoft.com/l/app/1c37bec0-d522-4cba-9643-ddc79d841729" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003453" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Workday 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Workday Peakon 員工語音 |
| ID | WA200003453 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Workday |
| 公司的網站 | [https://www.workday.com/en-us/homepage.html](https://www.workday.com/en-us/homepage.html) |
| 應用程式的使用規定 | [https://nw.myworkday.com/workdaypeakonemployeevoiceforteams...](https://nw.myworkday.com/workdaypeakonemployeevoiceforteams/post-license/) |
| 應用程式的核心功能 | 取得有關新問卷的通知 直接透過傳送問卷回應Microsoft Teams請注意您尚未完成的問卷。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://nw.myworkday.com/workdaypeakonemployeevoiceforteams](https://nw.myworkday.com/workdaypeakonemployeevoiceforteams) |
...
Workday 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 電子郵件和 Azure Active Director 識別碼 - MS Teams 應用程式的 Peakon 不會直接處理資料。  |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 公司識別碼、應用程式記錄 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser.All | 應用程式 | 在 Azure 資料庫內安裝應用程式並尋找使用者   | [075a01db-a69f-4975-a713-aa85d004f3b5](../azure/075a01db-a69f-4975-a713-aa85d004f3b5.md) |

---
title: Cegid Cegid HR 體驗的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Cegid HR 體驗、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "66655953"
---
# <a name="cegid-hr-experience"></a>Cegid HR 體驗

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 4 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/85abfb80-c2a7-4b98-b2f4-1a1de6ed042f" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004302" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Cegid 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Cegid |
| 公司的網站 | [https://www.cegid.com](https://www.cegid.com) |
| 應用程式的使用規定 | [https://www.hr-experience.cegid.com/exp/appteams.pdf](https://www.hr-experience.cegid.com/exp/appteams.pdf) |
| 應用程式的核心功能 | 您無法執行的 HR 工具。 簡化您的工作並提高效率。 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://www.meta4.com/core-hr-software/](https://www.meta4.com/core-hr-software/) |
...
Cegid 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.cegid.com/en/privacy-policy/ |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | Teams SDK |
| 您的應用程式是否支援條件式存取原則？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | Teams 檔的必要專案 | [342f90c0-6377-4d59-af95-5e1d8c35af4e](../azure/342f90c0-6377-4d59-af95-5e1d8c35af4e.md) |
>| 電子郵件 | 委託 | Teams 的必要專案 | [342f90c0-6377-4d59-af95-5e1d8c35af4e](../azure/342f90c0-6377-4d59-af95-5e1d8c35af4e.md) |
>| offline_access | 委託 | Teams 的必要專案 | [342f90c0-6377-4d59-af95-5e1d8c35af4e](../azure/342f90c0-6377-4d59-af95-5e1d8c35af4e.md) |
>| openid | 委託 | Teams 的必要專案 | [342f90c0-6377-4d59-af95-5e1d8c35af4e](../azure/342f90c0-6377-4d59-af95-5e1d8c35af4e.md) |

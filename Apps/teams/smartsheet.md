---
title: Smartsheet by Smartsheet 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: Smartsheet 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/f4d81e8e-4500-44c2-8328-9e06cbe037c5" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104380975" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Smartsheet 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Smartsheet |
| 公司的網站 | [https://www.smartsheet.com](https://www.smartsheet.com) |
| 應用程式的使用規定 | [https://pinpointprod.blob.core.windows.net/marketing/Partne...](https://pinpointprod.blob.core.windows.net/marketing/Partner_21474843641/Product_42949680935/Asset_06f25ae6-b277-42aa-b769-38e17926ebb4/SmartsheetUserAgreementSmartsh.pdf) |
| 應用程式的核心功能 | Smartsheet 是組織成就的前置雲端式平臺，可讓小組和組織大規模規劃、擷取、管理、自動化和報告工作，進而產生更有效的流程和更好的業務成果。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://help.smartsheet.com/articles/2476201-interact-with-...](https://help.smartsheet.com/articles/2476201-interact-with-smartsheet-items-in-microsoft-teams) |
...
Smartsheet 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC2 認證日期 | 2021-12-06 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 認證日期 | 2021-12-06 |
...
| 隱私權原則 URL | https://www.smartsheet.com/legal/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | 應用程式 | 若要讓 Smartsheet 索引標籤應用程式能夠讀取頻道成員來共用 Smartsheet 資產。 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Directory.Read.All | 委託 | 允許應用程式讀取組織中的資料，例如使用者和群組。 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Group.Read.All | 委託 | 這是用來讀取群組的成員。 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Group.ReadWrite.All | 委託 | 將通知傳送至群組。 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| User.Read.All | 委託 | 這是用來根據使用者的電子郵件地址傳送通知。 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| offline_access | 委託 | 允許離線使用。 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |

...
Appraisd 有限公司所提供的資訊給 Microsoft：
...
| App 的使用條款 | [https://www.appraisd.com/terms](https://www.appraisd.com/terms) |
| 應用程式的核心功能 | Supercharge 您的效能文化，包含效能評論、目標與意見反應 |
...
Appraisd 有限公司已提供此資訊。關於此應用程式如何收集和儲存組織的資料，以及您的組織將會對應用程式所收集的資料所做的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 個人讀取 | 委託 | [人員選擇] 會向使用者呈現其小組成員的清單。 這是為了支援 Appraisd 中的核心功能。 | [4f037969-20ef-4a41-8330-422b7b115eb6](https://docs.microsoft.com/microsoft-365-app-certification/azure/4f037969-20ef-4a41-8330-422b7b115eb6) |
>| User.Read | 委託 | 使用者的電子郵件地址 (upn) 和使用者識別碼，目的是用來尋找 Appraisd 內的使用者，並將其連結至其 Teams 帳戶。 | [4f037969-20ef-4a41-8330-422b7b115eb6](https://docs.microsoft.com/microsoft-365-app-certification/azure/4f037969-20ef-4a41-8330-422b7b115eb6) |
>| User.ReadBasic.All | 委託 | 「人員選擇」為使用者提供有關其團隊成員的基本資訊。 這是為了支援 Appraisd 中的核心功能。 | [4f037969-20ef-4a41-8330-422b7b115eb6](https://docs.microsoft.com/microsoft-365-app-certification/azure/4f037969-20ef-4a41-8330-422b7b115eb6) |

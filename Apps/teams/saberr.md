...
<p>上次於開發人員更新：2021年2月11日</p>

* <a href="https://teams.microsoft.com/l/app/d3a07709-eb0e-421c-8609-b61b0600e645" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | Saberr |
| 合作夥伴網站的 URL | [https://saberr.com](https://saberr.com) |
| Teams 應用程式資訊頁面的 URL | [https://help.saberr.com/en/articles/3854472-use-coachbot-in...](https://help.saberr.com/en/articles/3854472-use-coachbot-in-microsoft-teams-to-get-notifications-and-quick-actions) |
...
| 使用條款的 URL | [https://help.saberr.com/en/articles/3853596-terms-and-condi...](https://help.saberr.com/en/articles/3853596-terms-and-conditions) |
...
此資訊是由 Saberr 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
>我們會在任何合作夥伴系統中設定保留原則，並強制使用 (的最大安全性設定，例如，2FA) 
...
<iframe height='1020' title='Microsoft Cloud App Security資訊' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36430' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36430" target="_blank">在新的索引標籤中查看</a>
...
Saberr 此資訊的提供方式是關於此應用程式如何處理驗證、授權、應用程式註冊最佳作法和其他身分識別準則。

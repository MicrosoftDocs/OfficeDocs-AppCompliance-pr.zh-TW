---
title: Media Interactiva Solutions 之 MeasureUp 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: MeasureUp 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/bb1f94be-57aa-452c-9073-7fbb6b8b1797" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003111" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Media Interactiva Solutions 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.measureup.com](https://www.measureup.com) |
| 應用程式的使用規定 | [https://www.measureup.com/legal-notice](https://www.measureup.com/legal-notice) |
| 應用程式的核心功能 | 使用 MeasureUp 更有效率地評估小組的技能！ |
| 公司總部位置 | 西班牙 |
| 應用程式資訊頁面 | [https://docs.measureup.com](https://docs.measureup.com) |
...
此資訊已由媒體互動解決方案提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 要註冊和允許登入的設定檔資訊。 當使用者存取應用程式時，必須要有來自 Microsoft 設定檔的資料，才能在我們的平臺中建立使用者設定檔。 | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| openid | 委託 | 要註冊和允許登入的設定檔資訊。 當使用者存取應用程式時，必須要有來自 Microsoft 設定檔的資料，才能在我們的平臺中建立使用者設定檔。 | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| 設定檔 | 委託 | 要註冊和允許登入的設定檔資訊。 當使用者存取應用程式時，必須要有來自 Microsoft 設定檔的資料，才能在我們的平臺中建立使用者設定檔。 | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |

...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 要註冊並允許登入的設定檔資訊。 當使用者存取應用程式時，需要使用來自 Microsoft 設定檔的資料，以在我們的平臺中建立使用者設定檔。 | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| openid | 委託 | 要註冊並允許登入的設定檔資訊。 當使用者存取應用程式時，需要使用來自 Microsoft 設定檔的資料，以在我們的平臺中建立使用者設定檔。 | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| 設定檔 | 委託 | 要註冊並允許登入的設定檔資訊。 當使用者存取應用程式時，需要使用來自 Microsoft 設定檔的資料，以在我們的平臺中建立使用者設定檔。 | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |

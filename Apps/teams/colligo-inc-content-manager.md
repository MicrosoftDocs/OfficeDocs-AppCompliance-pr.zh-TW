...
* <a href="https://teams.microsoft.com/l/app/36ad88c6-ffce-4c52-a5a5-3eae64ed65bf" target="_blank">在 Teams 儲存區中查看</a>
...
由 Colligo Inc. 提供給 Microsoft 的資訊：
...
| App 的使用條款 | [https://www.colligo.com/media/Colligo-Software-License-Agre...](https://www.colligo.com/media/Colligo-Software-License-Agreement-Schedule-A.pdf) |
| 應用程式的核心功能 | 內容管理員可讓您直接在 Microsoft Teams 記憶體取 Microsoft 365 檔案 |
...
Colligo Inc. 已提供此資訊，供 Inc. 使用此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

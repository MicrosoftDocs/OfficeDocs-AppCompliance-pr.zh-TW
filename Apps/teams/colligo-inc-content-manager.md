---
title: Colligo Inc for Content Manager 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: 內容管理員的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/36ad88c6-ffce-4c52-a5a5-3eae64ed65bf" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003250" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Colligo Inc 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.colligo.com](https://www.colligo.com) |
| 應用程式的使用規定 | [https://www.colligo.com/media/Colligo-Software-License-Agre...](https://www.colligo.com/media/Colligo-Software-License-Agreement-Schedule-A.pdf) |
| 應用程式的核心功能 | 內容管理員可讓您直接在Microsoft Teams記憶體取Microsoft 365檔案 |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | |
...
Colligo Inc 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

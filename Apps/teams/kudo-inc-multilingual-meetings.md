---
title: KUDO，Inc. KUDO 多語系會議的應用程式資訊。
ms.author: elmalova
author: elenamalova
ms.date: 11/15/2021
ms.topic: article
...
description: 所有可用的安全性和符合性資訊，供 KUDO 多語系會議、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "60969179"
---
# <a name="kudo-multilingual-meetings"></a>KUDO 多語系會議

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新：2021年11月12日</p>

* <a href="https://teams.microsoft.com/l/app/9ae3d116-3feb-48c6-b3c4-b61dceb760af" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | KUDO，Inc.。 |
| 公司的網站 | [https://kudoway.com](https://kudoway.com) |
| App 的使用條款 | [https://kudoway.com/terms-of-use/](https://kudoway.com/terms-of-use/) |
| 應用程式的核心功能 | KUDO 可讓企業以多種語言進行全球通訊。 |
...
KUDO，Inc. 已提供此資訊。關於此應用程式如何收集和儲存組織的資料，以及您的組織將會透過應用程式收集的資料所產生的控制項。
...
| 隱私權原則 URL | https://kudoway.com/privacy-policy/ |

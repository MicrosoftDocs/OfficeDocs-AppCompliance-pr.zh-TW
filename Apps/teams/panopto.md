---
title: Panopto 的應用程式資訊（按 Panopto）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
description: Panopto 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63551972"
---
# <a name="panopto"></a>Panopto

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員更新：2022年2月22日</p>

* <a href="https://teams.microsoft.com/l/app/adb3c870-c01c-11eb-a2cc-4dbd838985a1" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | Panopto |
| 公司的網站 | [https://www.panopto.com](https://www.panopto.com) |
| App 的使用條款 | [https://www.panopto.com/terms-of-service/](https://www.panopto.com/terms-of-service/) |
| 應用程式的核心功能 | 匯出 Teams 錄製，以 Panopto 及搜尋、共用及流覽 Panopto 影片，但不需離開 Teams。  新增功能，例如每個會議和以人員驗證的關閉字幕的視覺索引。 存取 Panopto 功能，但不留下 Teams：建立對應至 Panopto 資料夾的新通道索引標籤; 搜尋和共用 Panopto 影片; 在排程的會議中呈現 Panopto 影片; 並在新的 Panopto 影片準備好時收到通知。 需要 Panopto 網站嗎？ 立即流覽 www.panopto.com/plans 以開始。 |
...
此資訊是由 Panopto 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否可以處理與 Microsoft 客戶或其裝置相關的任何資料？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 資料庫中儲存的資料為何？ | Teams 會議錄製和 Teams 通道上的中繼資料。 |
...
| 最近的 SOC2 認證日期 |  2021-08-19 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最近的 SOC3 認證日期 |  2021-10-13 |
...
| 隱私權原則 URL | https://www.panopto.com/privacy/ |

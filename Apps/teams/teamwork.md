---
title: Teamwork 的 Teamwork 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: 所有可用的安全性與合規性資訊，適用于 Teamwork、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/f051cf68-e4e7-45d8-960c-a17f52cc4b52" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001552" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Teamwork 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 團隊工作 |
| 公司的網站 | [https://www.teamwork.com](https://www.teamwork.com) |
| 應用程式的使用規定 | [https://www.teamwork.com/legal/terms-of-service/](https://www.teamwork.com/legal/terms-of-service/) |
| 應用程式的核心功能 | 直接將 Teamwork 內嵌到您的Teams頻道，以保持最新狀態。  |
| 公司總部位置 | 愛爾蘭 |
| 應用程式資訊頁面 | [https://support.teamwork.com/projects/microsoft-teams/conne...](https://support.teamwork.com/projects/microsoft-teams/connecting-to-teamwork-in-microsoft-teams) |
...
Teamwork 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

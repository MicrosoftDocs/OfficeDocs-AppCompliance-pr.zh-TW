---
title: 適用于 B12 by Apprentx 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/11/2022
...
description: B12、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "65548868"
---
# <a name="b12"></a>B12

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 4 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/a4a2213d-2466-473b-8772-021094c5f013" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004073" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Apprentx 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Apprentx |
| 公司的網站 | [https://apprentx.rocks](https://apprentx.rocks) |
| 應用程式的使用規定 | [https://blogue.apprentx.rocks/terms-and-conditions](https://blogue.apprentx.rocks/terms-and-conditions) |
| 應用程式的核心功能 | B12 結合了知識增強和實務，以最大化影響。 |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | [https://apprentx.rocks/en/nos-solutions](https://apprentx.rocks/en/nos-solutions) |
...
Apprentx 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 我們會處理識別碼權杖，其中包含選擇性 SSO 功能的使用者名稱和電子郵件 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 我們會儲存選擇性行事曆同步處理功能的存取權杖 |
...
| 隱私權原則 URL | https://blogue.apprentx.rocks/en/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| 電子郵件 | 委託 | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| offline_access | 委託 | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| openid | 委託 | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| 設定檔 | 委託 | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| Calendars.ReadWrite | 委託 | 行事曆同步處理 | [75932bb9-5e71-449a-b584-b5cc01c2d118](../azure/75932bb9-5e71-449a-b584-b5cc01c2d118.md) |
>| User.Read | 委託 | 行事曆同步處理 | [75932bb9-5e71-449a-b584-b5cc01c2d118](../azure/75932bb9-5e71-449a-b584-b5cc01c2d118.md) |

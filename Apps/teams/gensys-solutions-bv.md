---
title: Gensys 解決方案 BV 的 Gensys 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Gensys 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/bc1e8e2d-bb5c-47d7-a9e6-f0be9eb83c5a" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003044" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Gensys 解決方案 BV 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://gensys.nl](https://gensys.nl) |
| 應用程式的使用規定 | [https://gensys.nl/terms-of-use/](https://gensys.nl/terms-of-use/) |
| 應用程式的核心功能 | Gensys 應用程式，用於整合 Gensys Anywhere 與 Microsoft Teams |
| 公司總部位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | |
...
Gensys 解決方案 BV 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: Semos Cloud Insighttions 的 JobPts 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: JobPts 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64879630"
---
# <a name="jobpts"></a>JobPts

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 7 月 7 日</p>

* <a href="https://teams.microsoft.com/l/app/601a47bc-f201-4398-a0cb-593ea081f265" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001849" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Semos Cloud Inherittions 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://semoscloud.com](https://semoscloud.com) |
| 應用程式的使用規定 | [https://semoscloud.com/terms-of-use/](https://semoscloud.com/terms-of-use/) |
| 應用程式的核心功能 | 在不離開 MsTeams 的情況下，輕鬆地辨識您的同事以完成工作 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://semoscloud.com/product/jobpts](https://semoscloud.com/product/jobpts) |
...
此資訊已由 Semos Cloud Insighttions 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 讀取基本的公司資訊 | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| 電子郵件 | 委託 | 這用於對應 AzureAD 使用者與 JobPts 工具中的使用者 | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| offline_access | 委託 | 維護對資料的存取 | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| openid | 委託 | 讓使用者能夠使用其工作帳戶登入 | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| 設定檔 | 委託 | 若要能夠讓 JobPts 查看使用者的基本資訊，請 (使用者名稱)  | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |

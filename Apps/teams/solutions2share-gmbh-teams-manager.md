---
title: Teams Manager by Solutions2Share GmbH 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/27/2021
...
description: 適用于 Teams Manager 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2021 年 9 月 24 日</p>

* <a href="https://teams.microsoft.com/l/app/87000000-3db9-bb44-5015-0b4a327a6597" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000764" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Solutions2Share GmbH 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://teams-manager.com](https://teams-manager.com) |
| 應用程式的使用規定 | [https://www.teams-manager.com/terms-of-use/](https://www.teams-manager.com/terms-of-use/) |
| 應用程式的核心功能 | 根據具有核准工作流程的複雜、可自訂範本，建立新的Teams。 Teams管理員可協助公司透過治理功能持續控制其Microsoft Teams，並停止不受控制的成長，同時仍可讓使用者建立新的Teams。 |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | [https://teams-manager.com](https://teams-manager.com) |
...
此資訊已由 Solutions2Share GmbH 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | 兩者 | 我們會儲存 TenantID 和 TeamId 來對應範本。  | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| Notes.ReadWrite.All | 應用程式 | 無 | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.Read | 委託 | 無 | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.Read.All | 兩者 | 我們會儲存在核准者/系統管理員區段中輸入之使用者的識別碼。 | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.ReadBasic.All | 委託 | 無 | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |

---
title: 迴圈的應用程式資訊 - Skooler 的創意Learning
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: 迴圈的所有可用安全性與合規性資訊 - 創意Learning、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/d612b92e-2828-4a94-9e83-92dee316bdb3" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003074" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Skooler 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Skooler |
| 公司的網站 | [https://www.loopseducation.com](https://www.loopseducation.com) |
| 應用程式的使用規定 | [https://www.loopseducation.com/assets/terms.en-US.201126.pdf](https://www.loopseducation.com/assets/terms.en-US.201126.pdf) |
| 應用程式的核心功能 | 迴圈是透過互動式思維圖進行教學和學習的工具。 |
| 公司總部位置 | 瑞典 |
| 應用程式資訊頁面 | |
| 用來執行應用程式的裝載環境或服務模型為何？ |  |
| 應用程式會使用哪些主控雲端提供者？ | AWS、GleSYS |
...
Skooler 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 允許使用 Microsoft 登入的 UPN。 設定檔預先填入的指定名稱和姓氏。 | [dc171e47-c074-4bc2-9e7b-3856b71e0630](../azure/dc171e47-c074-4bc2-9e7b-3856b71e0630.md) |

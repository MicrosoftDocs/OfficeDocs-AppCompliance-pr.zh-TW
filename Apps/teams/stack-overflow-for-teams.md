---
title: Stack Overflow for Teams 的 Stack Overflow 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: 適用于 Teams 的 Stack Overflow、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "66655996"
---
# <a name="stack-overflow-for-teams"></a>Teams 的 Stack Overflow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 10 月 11 日</p>

* <a href="https://teams.microsoft.com/l/app/4783e622-5303-4ea7-a211-ef0dd405da73" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000739" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Stack Overflow 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.stackoverflow.com](https://www.stackoverflow.com) |
| 應用程式的使用規定 | [https://stackoverflow.com/legal/terms-of-service/teams](https://stackoverflow.com/legal/terms-of-service/teams) |
| 應用程式的核心功能 | 適用于 Teams 的 Stack Overflow 是小組&#8217;問題和解答的私人、安全首頁。 不再鑽研過時的 Wiki，並遺失電子郵件&#8212;讓您的小組還原建置更佳產品所需的時間。 Stack Overflow for Teams&#8217;與 Microsoft Teams 整合會連接您的 Microsoft Teams 聊天和內部知識存放庫。 隨時掌握新資訊的通知、搜尋現有的答案，甚至直接從 Microsoft Teams 平臺啟動您的問題。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://stackoverflow.co/teams/integrations/microsoft-teams](https://stackoverflow.co/teams/integrations/microsoft-teams) |
...
Stack Overflow 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | MS Teams 資訊會由應用程式收集和處理，以在客戶的 Stack Overflow for Teams 環境中顯示和參考。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | MS Teams API 存取訊號 |
...
| 隱私權原則 URL | https://stackoverflow.com/legal/privacy-policy/integrations/ms-teams/teams-basic-business |

---
title: Serrala 群組 GmbH 的 Alevate AP 核准應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Alevate AP 核准、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "66656011"
---
# <a name="alevate-ap-approval"></a>相關 AP 核准

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 2 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/43fba60e-6ec6-4f68-b601-79a598a6643e" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004348" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Serrala Group GmbH 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Serrala Group GmbH |
| 公司的網站 | [https://www.serrala.com](https://www.serrala.com) |
| 應用程式的使用規定 | [https://www2.serrala.com/rs/275-EMU-744/images/Serrala-Paym...](https://www2.serrala.com/rs/275-EMU-744/images/Serrala-Payment-Solutions-GmbH-AGB-Softwaremiete-Cash-Management-pro.pdf) |
| 應用程式的核心功能 | 輕鬆地直接在 Microsoft Teams 中檢閱和核准 AP 發票，並檢查目前的狀態。 |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | |
...
Serrala Group GmbH 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對應用程式所收集資料的控制。

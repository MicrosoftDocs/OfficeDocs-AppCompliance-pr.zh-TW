---
title: KLIPPAS Technologies inc. 的 Kippa 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/13/2021
...
description: Kippa 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/49d0e480-ede2-11ea-85fc-27f7e2c29730" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003327" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

KLIPPAS Technologies inc. 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.kippa.app](https://www.kippa.app) |
| 應用程式的使用規定 | [https://www.kippa.app/terms-of-service/](https://www.kippa.app/terms-of-service/) |
| 應用程式的核心功能 | 從內部快速設定一次性或週期性的個人、共用或頻道提醒Microsoft Teams |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | [https://www.kippa.app/kippa-app/](https://www.kippa.app/kippa-app/) |
...
這項資訊已由 KLIPPAS Technologies inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | 與Microsoft Teams相同，因為使用者必須登入Teams才能存取 Kippa。 |

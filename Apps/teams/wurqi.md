...
description: Wurqi 的所有可用安全性與合規性資訊、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/5173558d-bfb0-40dd-b75c-3cfac117ce72" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004161" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Wurqi 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Wurqi |
| 公司的網站 | [https://wurqi.com](https://wurqi.com) |
| 應用程式的使用規定 | [https://wurqi.com/terms/](https://wurqi.com/terms/) |
| 應用程式的核心功能 | Wurqi 是一個整合您所有工作、專案和通訊的工作管理平臺。 Teams 應用程式為使用者提供僅限檢視頁面，其中會顯示其正在處理之專案的相關所有資訊，讓小組中的所有使用者查看專案進度。  |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | |
...
Wurqi 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 已針對下列專案啟用多重要素驗證 (MFA) ： | DNSManagement、CodeRepositories |
...
| 隱私權原則 URL | https://wurqi.com/privacy-policy/ |

---
title: JustLogin by JustLogin 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: JustLogin 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/cfbb8888-3227-45fc-a4b7-423af170defa" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004314" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

JustLogin 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | JustLogin |
| 公司的網站 | [https://justlogin.com](https://justlogin.com) |
| 應用程式的使用規定 | [https://justlogin.com/terms/](https://justlogin.com/terms/) |
| 應用程式的核心功能 | JustLogin - 您的員工易記 HR Software。 |
| 公司總部位置 | 新加坡 |
| 應用程式資訊頁面 | |
...
此資訊由 JustLogin 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://justlogin.com/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 電子郵件 | 委託 | 需要電子郵件才能透過 SSO 登入 JustLogin | [af5883db-bda9-4d1a-b1ce-022bea20f021](../azure/af5883db-bda9-4d1a-b1ce-022bea20f021.md) |

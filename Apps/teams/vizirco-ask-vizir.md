---
title: 依 Vizir.co 詢問 Vizir 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/25/2022
...
description: 所有可用的安全性和合規性資訊，適用于 Ask Vizir、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65069689"
---
# <a name="ask-vizir"></a>詢問 Vizir

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 4 月 22 日</p>

* <a href="https://teams.microsoft.com/l/app/7b0641d9-8e1f-4415-99da-c80f8c175c69" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003119" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Vizir.co 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Vizir.co |
| 公司的網站 | [https://www.vizir.co](https://www.vizir.co) |
| 應用程式的使用規定 | [https://vizir.co/mentions-legales](https://vizir.co/mentions-legales) |
| 應用程式的核心功能 | 詢問 Vizir Bot 可協助法國的小組使用者使用Microsoft Office 365產品。 與 Microsoft France 合作建立 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://www.vizir.co](https://www.vizir.co) |
| 用來執行應用程式的裝載環境或服務模型為何？ | Paas |
| 應用程式會使用哪些主控雲端提供者？ | OVH、Aws |
...
此資訊是由 Vizir.co 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者電子郵件、名稱、姓氏 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者電子郵件、名稱、姓氏 |
...
| 隱私權原則 URL | https://www.vizir.co/politique-confidentialite/ |

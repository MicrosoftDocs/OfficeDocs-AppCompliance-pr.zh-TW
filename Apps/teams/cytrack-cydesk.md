---
title: CyDesk by CyTrack 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: CyDesk 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66547055"
---
# <a name="cydesk"></a>CyDesk

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 26 日</p>

* <a href="https://teams.microsoft.com/l/app/14888773-cbfd-439f-91e3-227947655a47" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004281" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的核心功能 | CyDesk 的目標是需要將 Microsoft Teams 電話 System 與其 CRM 解決方案整合的企業使用者。  CyDesk 會將企業已經依賴的軟體整合到您的通訊系統中。  整合超過 100 個領先企業應用程式&#8211;，以及貴公司&#8217;現有的內部解決方案&#8211;立即推出。 或建立自訂整合和應用程式，以符合商務&#8217;的獨特需求。  |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | [https://web.cytrack.com/microsoft-teams/crm-integration-for...](https://web.cytrack.com/microsoft-teams/crm-integration-for-microsoft-teams/) |

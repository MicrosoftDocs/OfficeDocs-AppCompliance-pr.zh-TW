---
title: ConsenSys AG&#8217;S Sobol 的 Sobol 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
| 公司的網站 | [https://sobol.io](https://sobol.io) |
| 應用程式的使用規定 | [https://sobol.io/terms-of-service/](https://sobol.io/terms-of-service/) |
| 應用程式的核心功能 | Sobol 是一種 Web 應用程式，可協助組織將其角色、小組、目標、使用者和合約視覺化及對應。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://sobol.io/features](https://sobol.io/features) |

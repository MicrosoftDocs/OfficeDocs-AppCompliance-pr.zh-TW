...
| App 的使用條款 | [https://sobol.io/terms-of-service/](https://sobol.io/terms-of-service/) |
| 應用程式的核心功能 | Sobol 是一種 web 應用程式，可協助組織形象化及對應其角色、小組、目標、使用者和協定。 |

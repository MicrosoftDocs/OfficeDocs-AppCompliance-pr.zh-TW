---
title: Perflo by Perflo 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Perflo 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/374c7844-f88a-43f3-b6d5-5cf58b5b293e" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004251" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Perflo 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Perflo |
| 公司的網站 | [https://www.perflo.co](https://www.perflo.co) |
| 應用程式的使用規定 | [https://www.perflo.co/terms](https://www.perflo.co/terms) |
| 應用程式的核心功能 | 最終的團隊診斷解決方案，可讓小組持續改善。 |
| 公司總部位置 | 美國美國 |
...
Perflo 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | MS Teams 識別碼， 設定檔圖片 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | MS Teams 識別碼， 設定檔圖片 |

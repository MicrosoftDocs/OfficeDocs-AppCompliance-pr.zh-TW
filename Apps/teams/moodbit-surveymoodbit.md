---
title: 依 Moodbit 的 SurveyMoodbit 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: SurveyMoodbit 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/86425243-0129-41f7-bf74-971bee7ff3d3" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003925" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Moodbit 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | SurveyMoodbit |
| ID | WA200003925 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Moodbit |
| 公司的網站 | [https://mymoodbit.com](https://mymoodbit.com) |
| 應用程式的使用規定 | [https://mymoodbit.com/terms](https://mymoodbit.com/terms) |
| 應用程式的核心功能 | 快速取得意見反應 &amp; ，直接在Microsoft Teams內運用 People Analytics |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://mymoodbit.com](https://mymoodbit.com) |
...
Moodbit 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 已針對下列專案啟用多重要素驗證 (MFA) ： | Credential、CodeRepositories、DNSManagement |
...
| 隱私權原則 URL | https://mymoodbit.com/terms |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 若要從使用者取得資訊，以便在 UI 的應用程式上顯示該資訊，並提供個人化的 UX | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
>| 電子郵件 | 委託 | Msal Auth | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
>| openid | 委託 | Msal Auth | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
>| 設定檔 | 委託 | Msal Auth | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |

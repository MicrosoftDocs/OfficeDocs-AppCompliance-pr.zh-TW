...
| App 的使用條款 | [https://www.intumit.com/english/TermsOfUse.html](https://www.intumit.com/english/TermsOfUse.html) |
| 應用程式的核心功能 | SmartWork 是可以接聽 Microsoft Office 365 相關問題的對話方塊 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 使用 userPrincipalName 來識別使用者的郵件是否來自有效的 AAD | [a938ae1e-a791-4751-9e6a-178c991fa0fa](https://docs.microsoft.com/microsoft-365-app-certification/azure/a938ae1e-a791-4751-9e6a-178c991fa0fa) |

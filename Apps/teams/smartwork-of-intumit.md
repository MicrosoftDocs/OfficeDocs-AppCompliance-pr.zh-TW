---
title: SmartWork by SmartWork of Intumit 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: SmartWork 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/a938ae1e-a791-4751-9e6a-178c991fa0fa" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001149" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Intumit 的 SmartWork 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.intumit.com/english/](https://www.intumit.com/english/) |
| 應用程式的使用規定 | [https://www.intumit.com/english/TermsOfUse.html](https://www.intumit.com/english/TermsOfUse.html) |
| 應用程式的核心功能 | SmartWork 是可回答與Microsoft Office 365相關問題的對話機器人 |
| 公司總部位置 | 臺灣 (中國省)  |
| 應用程式資訊頁面 | |
...
這項資訊是由 Intumit 的 SmartWork 所提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 使用 userPrincipalName 識別使用者的郵件是否來自有效的AAD | [a938ae1e-a791-4751-9e6a-178c991fa0fa](../azure/a938ae1e-a791-4751-9e6a-178c991fa0fa.md) |

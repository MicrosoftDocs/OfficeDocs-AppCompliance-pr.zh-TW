...
ms.locfileid: "60874821"
---
# <a name="natterhub"></a>Natterhub

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新：2021年9月10日</p>

* <a href="https://teams.microsoft.com/l/app/ba5cb8a1-85ca-426c-99fe-9b73cca34128" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | Natterhub |
| 公司的網站 | [https://natterhub.com](https://natterhub.com) |
...
此資訊是由 Natterhub 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 租使用者識別碼、user first name、user last name、user email。 |
...
| 隱私權原則 URL | https://natterhub.com/legal#privacy |

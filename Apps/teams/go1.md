...
description: Go1 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c859de61-8a6b-42e6-ba88-f639df33bc72" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001484" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Go1 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Go1 |
| 公司的網站 | [https://www.go1.com/user/login](https://www.go1.com/user/login) |
| 應用程式的使用規定 | [https://www.go1.com/en-au/terms/user-terms](https://www.go1.com/en-au/terms/user-terms) |
| 應用程式的核心功能 | GO1 Teams應用程式可協助您從Microsoft Teams內尋找、取用、共用及討論學習資源 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | |
...
Go1 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 應用程式 | 應用程式不會儲存檔案資料 | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| Group.ReadWrite.All | 應用程式 | Teams和通道名稱，以及儲存的唯一識別碼，以支援管理學習環境的應用程式 | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| User.Read.All | 應用程式 | 使用者名稱、電子郵件和 UPN 儲存以提供直接的個人學習者體驗 | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |

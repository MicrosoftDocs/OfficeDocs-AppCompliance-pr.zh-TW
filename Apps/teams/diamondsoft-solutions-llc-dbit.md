---
title: DBit by Diamondsoft Solutions、 LLC 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: DBit、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "64876430"
---
# <a name="dbit"></a>DBit

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 11 月 24 日</p>

* <a href="https://teams.microsoft.com/l/app/b28bb657-8edd-47ae-a912-c5fc11b3e89e" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001536" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Diamondsoft Solutions、LLC 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.diamondsoftsolutions.com](https://www.diamondsoftsolutions.com) |
| 應用程式的使用規定 | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| 應用程式的核心功能 | 較不麻煩的 DBit 密碼管理解決方案。 DBit 是適用于小型到大型小組的密碼管理工具。 使用 DBit，您可以安全地在小組成員之間共用密碼。 產生的共用密碼和密碼會在設定的分鐘期間之後自動過期。 您的密碼會在我們的伺服器的記憶體中加密，而且永遠不會儲存到磁片儲存體。 一旦您的密碼過期，它們就會從伺服器的記憶體中移除。 此應用程式是由 Diamondsoft Solutions， LLC 所開發 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
這項資訊是由 Diamondsoft Solutions、LLC 提供，其中包含此應用程式收集和儲存組織資料的方式，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | TenantId |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | TenantId |

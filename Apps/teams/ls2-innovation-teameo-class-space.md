...
ms.locfileid: "61711460"
---
# <a name="teameo-class-space"></a>Teameo 類別空間

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新日期：2021年11月30日</p>

* <a href="https://teams.microsoft.com/l/app/ec7d1cd2-2a06-4f96-baa5-1cc88026a835" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | LS2 創新 |
| 公司的網站 | [https://teameo.io](https://teameo.io) |
| App 的使用條款 | [https://teameo.io/legal/terms-of-service.html](https://teameo.io/legal/terms-of-service.html) |
| 應用程式的核心功能 | Teameo 類別空間可讓教師顯示課程詳細資料、應用程式和連結。 |
...
LS2 創新已提供此資訊，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 使用者資訊 (名稱、電子郵件) 、租使用者資訊 (識別碼、名稱)  |
...
| 隱私權原則 URL | https://teameo.io/legal/privacy-policy.html |

---
title: Cuckoo Networks Oy 之 Cuckoo 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Cuckoo 發行者的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64879390"
---
# <a name="cuckoo-workout"></a>Cuckoo Workout

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 6 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/71138876-8738-4935-95b6-ae7c2fbe4e54" target="_blank">在Teams存放區中檢視</a>
...
| 公司的網站 | [https://cuckooworkout.com](https://cuckooworkout.com) |
| 應用程式的使用規定 | [https://cuckooworkout.com/terms-of-service/](https://cuckooworkout.com/terms-of-service/) |
| 應用程式的核心功能 | 有趣且簡單、簡便的微中斷點練習，可提升您的能源和大腦。 |
| 公司總部位置 | 芬蘭 |
| 應用程式資訊頁面 | [https://cuckooworkout.com](https://cuckooworkout.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 通訊和訂用帳戶對應的使用者名稱、租使用者識別碼 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| 電子郵件 | 委託 | 驗證和支援所需的電子郵件 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| offline_access | 委託 | 不適用 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| openid | 委託 | 用於驗證的使用者識別碼 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| 設定檔 | 委託 | 用於驗證的設定檔識別碼 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |

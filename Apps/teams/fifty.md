...
ms.locfileid: "63541761"
---
# <a name="fifty"></a>Fifty

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員的更新日期：2021年6月7日</p>

* <a href="https://teams.microsoft.com/l/app/383cc171-22d5-4df5-87d0-6c656ddcff32" target="_blank">在 Teams 儲存區中查看</a>
...
| App 的使用條款 | [https://app.fifty.do/CGUV.pdf](https://app.fifty.do/CGUV.pdf) |
| 應用程式的核心功能 | 50提供個人化的挑戰，協助您從知識移至動作。 這些挑戰可協助整合或改進某些核心技能。 |
...
此資訊已由50提供，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

---
title: Offishall Planning by Offishall 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Offishall Planning 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65455024"
---
# <a name="offishall-planning"></a>Offishall Planning

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 3 月 31 日</p>

* <a href="https://teams.microsoft.com/l/app/cbdfe641-3e2e-449d-b4f7-7e377c7060aa" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004048" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Offishall 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Offishall Planning |
| ID | WA200004048 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Offishall |
| 公司的網站 | [https://www.offishall.io](https://www.offishall.io) |
| 應用程式的使用規定 | [https://en.offishall.io/conditions-generales-dutilisation-d...](https://en.offishall.io/conditions-generales-dutilisation-du-compte) |
| 應用程式的核心功能 | 混合式辦公室的彈性規劃、排程和工作場所管理解決方案 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | |
...
此資訊由 Offishall 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 如果 (行事曆事件。 系統管理員選擇啟用 Offishall - Outlook 行事曆 Integration) ;Teams聊天成員;使用者電子郵件 ;使用者名稱 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者電子郵件、使用者名稱 |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 德國、荷蘭 () 、法國 |
| 您是否有已建立的資料租用和處置程式？ | 是 |
| 帳戶終止之後，資料會保留多久？ | 未保留 |
| 您是否有已建立的資料存取管理程式？ | 是 |
...
| 隱私權原則 URL | https://www.offishall.io/politique-de-confidentialite |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | 應用程式 | 我們會將通道的成員使用至 1 - 如果成員還不是 2，請加以布建 - 擷取並顯示其工作模式資訊  | [函式fe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| Directory.Read.All | 應用程式 | 如果未設定使用者電子郵件，我們必須存取身分識別清單來擷取它 | [函式fe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| User.Read | 委託 | 與上述相同 | [函式fe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| 電子郵件 | 委託 | 我們會根據使用者的主要電子郵件來識別使用者  | [函式fe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| offline_access | 委託 | 我們可能想要在使用者離線時從使用者擷取資料 | [函式fe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| openid | 應用程式 | 讓使用者登入 | [函式fe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| 設定檔 | 委託 | 我們擷取使用者基本設定檔資訊，只儲存電子郵件和名稱 | [函式fe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |

---
title: 可採取動作的科學 Rezolve.ai 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: 所有可用的安全性與合規性資訊，適用于 Rezolve.ai、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/762a660d-9fa5-461b-be81-310c102ba820" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002724" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

可採取動作的科學提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 可採取動作的步驟 |
| 公司的網站 | [https://www.rezolve.ai](https://www.rezolve.ai) |
| 應用程式的使用規定 | [https://www.rezolve.ai/generalTerms](https://www.rezolve.ai/generalTerms) |
| 應用程式的核心功能 | 應用程式提供完整的員工服務台功能 - 包括) 建立和更新票證的能力 b) 解答常式問題 c) 自動化布建或上線等常見工作  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
這項資訊已由可採取動作的科學提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC1 認證日期 | 2019-12-31 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 認證日期 | 2019-12-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 登入並讀取使用者設定檔 | [eb628055-f790-4ef0-9fce-ac95b4c61466](../azure/eb628055-f790-4ef0-9fce-ac95b4c61466.md) |

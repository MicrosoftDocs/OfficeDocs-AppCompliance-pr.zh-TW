...
| App 的使用條款 | [https://www.rezolve.ai/generalTerms](https://www.rezolve.ai/generalTerms) |
| 應用程式的核心功能 | 該應用程式提供全面的員工服務中心功能，包括) 建立和更新票據 b 的功能) 解答常式問題 c) 自動化一般工作，例如布建或上架  |
...
| 最近的 SOC1 認證日期 |  2019-12-31 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 您已完成哪一種 SOC 2 憑證？ |   |
| 最近的 SOC2 認證日期 |  2019-12-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 登入並讀取使用者設定檔 | [eb628055-f790-4ef0-9fce-ac95b4c61466](https://docs.microsoft.com/microsoft-365-app-certification/azure/eb628055-f790-4ef0-9fce-ac95b4c61466) |

---
title: 適用于 Feeder 的應用程式資訊，方法是簡易 i 項 AB
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: 摘要器的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/6810f6a8-1f9a-4504-a916-e2d9814062e0" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004254" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由 Simple i 或 AB 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 真的簡單 i 或 AB |
| 公司的網站 | [https://feeder.co](https://feeder.co) |
| 應用程式的使用規定 | [https://feeder.co/teams-license](https://feeder.co/teams-license) |
| 應用程式的核心功能 | 從 RSS 摘要和其他數位來源取得新聞更新 |
| 公司總部位置 | 瑞典 |
| 應用程式資訊頁面 | |
| 用來執行應用程式的裝載環境或服務模型為何？ | Iaas |
| 應用程式會使用哪些主控雲端提供者？ | OVH、DigitalOcean、Aws |
...
這項資訊是由「真簡易的 i 項 Ab」所提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 電子郵件、IP 位址、租使用者識別碼 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 電子郵件、租使用者識別碼 |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 加拿大、法國 |
| 您是否有已建立的資料租用和處置程式？ | 是 |
| 帳戶終止之後，資料會保留多久？ | 未保留 |
| 您是否有已建立的資料存取管理程式？ | 是 |
...
| 隱私權原則 URL | https://feeder.co/help/legal/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 兩者皆是 | 使用者驗證和登入 | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| 電子郵件 | 委託 | 使用者驗證和登入 | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| openid | 兩者皆是 | 使用者驗證和登入 | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| 設定檔 | 兩者皆是 | 使用者驗證和登入 | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |

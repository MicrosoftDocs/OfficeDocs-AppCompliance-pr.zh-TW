...
description: Slido 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/1517b59d-6d65-4316-a708-035adc659394" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002357" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Slido 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Slido |
| 公司的網站 | [https://www.sli.do](https://www.sli.do) |
| 應用程式的使用規定 | [https://www.sli.do/terms](https://www.sli.do/terms) |
| 應用程式的核心功能 | Slido 是即時和虛擬會議和活動的最終 QA &amp; 和輪詢平臺。 其提供互動式 QA &amp; 、即時投票，以及有關您物件的深入解析。 |
| 公司總部位置 | 斯洛伐克 |
| 應用程式資訊頁面 | [https://www.sli.do/product](https://www.sli.do/product) |
...
Slido 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

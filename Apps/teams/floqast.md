...
| App 的使用條款 | [https://floqast.com/terms-of-use/](https://floqast.com/terms-of-use/) |
| 應用程式的核心功能 | FloQast 提供關閉的管理解決方案，以及工作流程自動化，可協助會計執行月末結束。 |

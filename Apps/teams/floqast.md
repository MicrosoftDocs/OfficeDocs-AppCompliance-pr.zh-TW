---
title: FloQast by FloQast 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: FloQast 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/326749cd-77f8-4579-8944-6837ebeb175d" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003117" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

FloQast 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | FloQast |
| 公司的網站 | [https://floqast.com](https://floqast.com) |
| 應用程式的使用規定 | [https://floqast.com/terms-of-use/](https://floqast.com/terms-of-use/) |
| 應用程式的核心功能 | FloQast 提供關閉管理解決方案以及工作流程自動化，其設計目的是協助管理人員執行月底關閉。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://floqast.com](https://floqast.com) |
...
FloQast 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: Check.it 的應用程式資訊，由雲端向其覆蓋
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: check.it 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/b5107b74-70ca-443e-be2a-61b14ba5341d" target="_blank">在 Teams 儲存區中查看</a>

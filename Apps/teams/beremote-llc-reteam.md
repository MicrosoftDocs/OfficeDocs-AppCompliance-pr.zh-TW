---
title: BeRemote LLC 的 ReTeam 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: ReTeam 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/92c90c0c-9a22-42ae-be52-c078eae02dea" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003293" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

BeRemote LLC 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.beremote.com](https://www.beremote.com) |
| 應用程式的使用規定 | [https://www.beremote.com/terms-of-use](https://www.beremote.com/terms-of-use) |
| 應用程式的核心功能 | ReTeam 提供適用于專業團隊、顧問和指導人員的工具，以進行參與和社交活動 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
BeRemote LLC 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: Engagedly by Engagedly Inc. 的應用程式資訊
ms.author: elmalova
author: elenamalova
ms.date: 11/10/2021
ms.topic: article
...
description: Engagedly 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "60922943"
---
# <a name="engagedly"></a>Engagedly

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新日期：2021年8月21日</p>

* <a href="https://teams.microsoft.com/l/app/d794bf4c-ef30-4d92-9e2e-6944e9f1512e" target="_blank">在 Teams 儲存區中查看</a>
...
由 Engagedly Inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Engagedly Inc。 |
| 公司的網站 | [https://engagedly.com](https://engagedly.com) |
| App 的使用條款 | [https://engagedly.com/terms/](https://engagedly.com/terms/) |
| 應用程式的核心功能 | Engagedly 是一種人才管理解決方案，可提供連續效能管理，並提供相關的效能評論、促進員工與 gamification 系統的接洽，以及提供分析和工作力規劃工具的主機。 |
...
Engagedly Inc. 已提供此資訊，供 Inc. 使用此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://engagedly.com/privacy/ |

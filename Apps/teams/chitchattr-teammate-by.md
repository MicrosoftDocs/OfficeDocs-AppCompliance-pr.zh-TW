...
| 使用條款的 URL | [https://www.chitchattr.com/termsofuse?p=teammate](https://www.chitchattr.com/termsofuse?p=teammate) |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| 個人讀取 | 委託 | 此應用程式可讓系統管理員選擇要以特定經驗為目標的使用者，因此需要儲存使用者的名稱、電子郵件和 Azure AD 物件識別碼。 | 此應用程式可讓系統管理員選擇要以特定經驗為目標的使用者，因此需要儲存使用者的名稱、電子郵件和 Azure AD 物件識別碼。 | a8e903c7-3b7f-4ec5-a474-b5d32e595f50 |

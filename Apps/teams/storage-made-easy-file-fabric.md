---
title: 儲存體使 File Fabric 的應用程式資訊變得簡單
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: File Fabric 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/bd063a87-1e4d-42cf-baea-8cab71839e35" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003017" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

儲存體讓 Microsoft 變得容易提供的資訊：
...
| 公司的網站 | [https://storagemadeeasy.com](https://storagemadeeasy.com) |
| 應用程式的使用規定 | [https://www.storagemadeeasy.com/terms](https://www.storagemadeeasy.com/terms) |
| 應用程式的核心功能 | 搜尋、流覽、編輯及共用儲存在Azure 檔案儲存體、Azure Blob 儲存體和其他儲存體上的檔案。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
...
| 應用程式會使用哪些主控雲端提供者？ | SelfHosted、Azure、AWS、GCP、IBMCloud、使用者可以與 Wasabi、Backblaze、Cloudian、Dropbox、Box.com、Salesforce、S3 相容、FTP 和 WebDAV 服務連線 |
...
這項資訊是由儲存體讓您輕鬆瞭解此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | 應用程式 | 當使用者透過應用程式下載、上傳或編輯指定的檔案時，所讀取或寫入的檔案資料。 | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
>| Sites.ReadWrite.All | 應用程式 | 針對所有使用者&#8217;檔案和資料夾收集的中繼資料，提供所有檔案服務的同盟檢視。 | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |

...
description: Empuls 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64881312"
---
# <a name="empuls"></a>Empuls

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 4 月 6 日</p>

* <a href="https://teams.microsoft.com/l/app/7ea47aaa-7c43-4fba-82fb-a81223e7cc2c" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002483" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Empuls 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Empuls |
| 公司的網站 | [https://www.xoxoday.com](https://www.xoxoday.com) |
| 應用程式的使用規定 | [https://www.xoxoday.com/terms-of-use](https://www.xoxoday.com/terms-of-use) |
| 應用程式的核心功能 | 改善動機、生產力，並配合此整體員工參與解決方案。 |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | [https://www.xoxoday.com/empuls](https://www.xoxoday.com/empuls) |
...
Empuls 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

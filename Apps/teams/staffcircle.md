---
title: StaffCircle by StaffCircle 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: StaffCircle 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64880910"
---
# <a name="staffcircle"></a>StaffCircle

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 7 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/7b358bf7-16db-498d-9407-80d2db25eb68" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002123" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

StaffCircle 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.staffcircle.com](https://www.staffcircle.com) |
| 應用程式的使用規定 | [https://www.staffcircle.com/terms](https://www.staffcircle.com/terms) |
| 應用程式的核心功能 | 遠端工作者的內部通訊、文化特性、參與度和效能管理平臺。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.staffcircle.com/integrations/microsoft-teams-in...](https://www.staffcircle.com/integrations/microsoft-teams-integration/) |
...
此資訊由 StaffCircle 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

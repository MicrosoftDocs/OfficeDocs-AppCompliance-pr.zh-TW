---
title: xto10x Technologies 10xGoals 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: 10xGoals 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/950aa4fb-0583-4b13-9b5f-bbc92b9cc376" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003122" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

xto10x Technologies 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | xto10x 技術 |
| 公司的網站 | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
| 應用程式的使用規定 | [https://www.xto10x.com/security/terms-of-use/](https://www.xto10x.com/security/terms-of-use/) |
| 應用程式的核心功能 | 10xGoals 是一種工具，可透過全小組的焦點、一致性、共同作業和可見度來推動策略執行。 透過 10xGoals &lt; &gt; Microsoft Teams整合，您可以在這裡自行管理整個執行。 首先，使用者可以接受/拒絕/對指派給他們的目標留言，以更妥善地管理其時間。 若要使用此應用程式，使用者必須擁有使用中的 10xGoals 訂用帳戶。 |
| 公司總部位置 | 印度 |
...
xto10x Technologies 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 應用程式 | 系統會擷取使用者電子郵件和 Azure 識別碼，讓應用程式可以針對組織的所有使用者主動安裝應用程式。  | [950aa4fb-0583-4b13-9b5f-主要 92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 應用程式 | 這是必要專案，讓應用程式可以為系統管理員擷取已安裝的 teamsAppDefinition，然後針對組織的所有使用者主動安裝本身。  | [950aa4fb-0583-4b13-9b5f-主要 92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |

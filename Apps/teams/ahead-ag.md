...
description: 所有可用的安全性與合規性資訊，包括預先、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66549436"
---
# <a name="ahead"></a>ahead

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 20 日</p>

* <a href="https://teams.microsoft.com/l/app/53360535-c93f-497f-b2a1-95bd9aa34283" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004202" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由預先 AG 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | ahead AG |
| 公司的網站 | [https://www.aheadintranet.com](https://www.aheadintranet.com) |
| 應用程式的使用規定 | [https://www.aheadintranet.com/terms-and-conditions](https://www.aheadintranet.com/terms-and-conditions) |
| 應用程式的核心功能 | 員工參與應用程式，讓員工隨時掌握資訊並參與。 |
| 公司總部位置 | 瑞士 |
| 應用程式資訊頁面 | |
...
這項資訊是由預先 AG 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 與預先內部網路產品正確運作相關的資料。 這包括但不限於新聞、報導、將內容目標設為特定使用者群組、流覽和通知的相關資訊。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 與預先內部網路產品正確運作相關的資料。 這包括但不限於新聞、報導、將內容目標設為特定使用者群組、流覽和通知的相關資訊。 使用者相關資料是 Azure AD 的唯讀複本。 這僅限於使用者的識別碼和名稱，以及其在 Azure AD 群組中已預先標示為相關的成員資格。 |
...
| 隱私權原則 URL | https://www.aheadintranet.com/data-security |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委託 | 根據 AD 群組將新聞設為目標 | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| Directory.Read.All | 應用程式 | 根據 AD 群組將新聞設為目標，以進行推播 | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| ExternalItem.Read.All | 委託 | 從 ServiceNow (協力廠商來源搜尋內容)  | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| Sites.Read.All | 委託 | 搜尋 SharePoint 網站的內容 | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read | 委託 | 讀取使用者設定檔 | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read | 委託 | 使用者 (圖片等的讀取設定檔。)  | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read.All | 委託 | 使用者的讀取設定檔 | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read.All | 應用程式 | 在搜尋中讀取設定檔資訊 | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |

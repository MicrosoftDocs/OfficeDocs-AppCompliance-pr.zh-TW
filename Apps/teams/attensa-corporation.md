---
title: Attensa Corporation 的 Attensa 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Attensa 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/0c42cdbf-56a5-4cdb-ae89-9253cb8138f0" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003148" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Attensa Corporation 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Attensa Corporation |
| 公司的網站 | [https://attensa.com](https://attensa.com) |
| 應用程式的使用規定 | [https://attensa.com/terms/](https://attensa.com/terms/) |
| 應用程式的核心功能 | 透過 Attensa 簡報，讓小組隨時掌握以專案為焦點的新聞和資訊 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://attensa.com/product/](https://attensa.com/product/) |
...
Attensa Corporation 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

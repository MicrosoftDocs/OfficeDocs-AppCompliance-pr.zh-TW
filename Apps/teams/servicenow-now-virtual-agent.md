---
title: ServiceNow 的 Now Virtual Agent 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: 所有可用的安全性與合規性資訊，適用于 Now Virtual Agent、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66852699"
---
# <a name="now-virtual-agent"></a>現在虛擬代理程式

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 7 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/49471a10-fdbc-4ffb-b0b8-944f3df985d9" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381816" target="_blank">在 AppSource 中檢視</a>
...
| 合作夥伴公司名稱 | ServiceNow |
| 公司的網站 | [https://www.servicenow.com](https://www.servicenow.com) |
| 應用程式的使用規定 | [https://www.servicenow.com/terms-of-use.html](https://www.servicenow.com/terms-of-use.html) |
| 應用程式的核心功能 | Now Virtual Agent 可讓您直接在 Microsoft Teams 中執行例行 ServiceNow 工作，讓您可以更有效率地使用聊天。  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://store.servicenow.com](https://store.servicenow.com) |
...
ServiceNow 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | 系統管理員可以選擇封鎖/解除封鎖特定 MS Teams 租使用者的應用程式 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser | 委託 | 現在，虛擬代理程式會使用此許可權來讀取、安裝、升級及卸載已登入使用者安裝的 Teams 應用程式。  | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
>| User.ReadBasic.All | 委託 | 應用程式會使用此許可權來讀取使用者的設定檔 | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
>| offline_access | 委託 | 這是取得重新整理權杖的必要專案。 我們正在使用 /authorize 端點 | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
>| openid | 委託 | 現在虛擬代理程式應用程式會使用 OpenID Connect (OIDC) 驗證通訊協定 | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |

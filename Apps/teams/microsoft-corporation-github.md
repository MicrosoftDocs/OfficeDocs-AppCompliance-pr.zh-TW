---
title: Microsoft Corporation 所GitHub的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
description: 所有可用的安全性與合規性資訊，適用于GitHub、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/ca9e26b7-dce5-44a0-b2b7-a70a3d65ce25" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002077" target="_blank">在 AppSource 中檢視</a>
...
| 公司的網站 | [https://github.com](https://github.com) |
| 應用程式的使用規定 | [https://github.com/site/terms](https://github.com/site/terms) |
| 應用程式的核心功能 | GitHub是共同作業和版本控制的程式碼裝載平臺。 它可讓開發人員在其專案上共同合作，從規劃和撰寫程式碼到運送軟體。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://teams.github.com](https://teams.github.com) |
...
Microsoft Corporation 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

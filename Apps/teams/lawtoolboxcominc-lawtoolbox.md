---
title: LawToolBox 依 LawToolBox （Inc.）的應用程式資訊。
ms.author: elmalova
author: elenamalova
ms.date: 10/28/2021
ms.topic: article
...
由 LawToolBox （Inc.）提供給 Microsoft 的資訊：
...
此資訊是由 LawToolBox （Inc.）提供。關於此應用程式如何收集和儲存組織資料，以及您的組織將會對應用程式所收集的資料所做的控制。

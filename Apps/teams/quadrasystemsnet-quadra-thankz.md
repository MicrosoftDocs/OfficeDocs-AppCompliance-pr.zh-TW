---
title: Quadra Thankz by Quadrasystems.net 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Quadra Thankz 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64880600"
---
# <a name="quadra-thankz"></a>Quadra Thankz

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 1 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/a013c4a4-0683-4125-8c05-4004c2c3cc6f" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003671" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Quadrasystems.net 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Quadra Thankz |
| ID | WA200003671 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Quadrasystems.net |
| 公司的網站 | [https://www.quadrasystems.net](https://www.quadrasystems.net) |
| 應用程式的使用規定 | [https://www.quadrasystems.net/tou](https://www.quadrasystems.net/tou) |
| 應用程式的核心功能 | 感謝是建置公司的關鍵。 建置在熟悉的Microsoft Teams介面上，這是與您每天一起工作的人連線的全新方式。  感謝是協助人們以有趣的方式辨識彼此的工具。&#160;它提供豐富的使用者和企業功能，可啟用排行榜、預算和控制項等功能。 感謝協助您的員工感到連線、感謝和獎勵。 |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | [https://www.quadrasystems.net/what-we-do/intelligent-ip-sol...](https://www.quadrasystems.net/what-we-do/intelligent-ip-solution/thankz) |
...
這項資訊是由 Quadrasystems.net 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | 應用程式 | 若要取得使用者的管理員資訊  | [5d8eb1a9-2188-4292-86f6-f4964d49e8b3](../azure/5d8eb1a9-2188-4292-86f6-f4964d49e8b3.md) |

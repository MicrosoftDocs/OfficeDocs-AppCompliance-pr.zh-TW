...
description: Centrical 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/7a70b8e4-43ca-46a7-b7c3-eb31b33de397" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001531" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Biz-Effective提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://centrical.com](https://centrical.com) |
| 應用程式的使用規定 | [https://centrical.com/terms](https://centrical.com/terms) |
| 應用程式的核心功能 | 中心平臺會取得並讓員工專注于需要完成的工作，以及重要的是如何進行工作。 它會使用測量工作的資料來提示微學習，以建立熟練度。 它利用人工智慧來改善員工參與度、效能和微學習。 中心平臺可透過 Web 應用程式、行動應用程式、Microsoft Teams應用程式、Salesforce 和 SuccessFactors 應用程式取得。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://centrical.com/solutions/solutions-by-use-case-2/mic...](https://centrical.com/solutions/solutions-by-use-case-2/microsoft-teams-gamification/) |
...
這項資訊是由Biz-Effective提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

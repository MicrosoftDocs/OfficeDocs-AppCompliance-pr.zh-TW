---
title: ORCA SECURITY LTD 的 Orca 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Orca 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/50423b81-408b-4699-a850-9a0514ee42c3" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004132" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

ORCA SECURITY LTD 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | ORCA SECURITY LTD |
| 公司的網站 | [https://orca.security](https://orca.security) |
| 應用程式的使用規定 | [https://orca.security/terms-of-use](https://orca.security/terms-of-use) |
| 應用程式的核心功能 | 適用于 Microsoft Teams 的 Orca 安全性提供雲端環境安全性狀態的即時圖片。 使用者可以使用這兩種工具結合在一個檢視中，針對其雲端環境中的安全性問題建立具生產力的討論 Orca 警示會詳細說明特定雲端風險，包括安全性風險結果，以及造成風險的連線雲端資源。 |
| 公司總部位置 | 以色列 |
| 應用程式資訊頁面 | |
...
ORCA SECURITY LTD 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | Teams使用者識別碼、小組識別碼、小組名稱 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | Teams使用者識別碼、小組識別碼、小組名稱 |
...
| 隱私權原則 URL | https://orca.security/privacy-policy/ |

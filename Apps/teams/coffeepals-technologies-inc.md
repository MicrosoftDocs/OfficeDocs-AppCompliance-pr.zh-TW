...
CoffeePals 技術 Inc. 所提供的資訊給 Microsoft：
...
| 應用程式會使用哪一個主控雲端提供者？ | Aws、MongoDB、Heroku |
...
CoffeePals 技術 Inc. 已提供此資訊。關於此應用程式如何收集和儲存組織的資料，以及您的組織將會透過應用程式收集的資料所產生的控制項。
...
| 資料庫中儲存的資料為何？ | 使用者設定檔資料、使用者使用方式資料、使用者電子郵件地址、使用者相符的記錄、使用者設定、組織設定、組織名稱、小組名稱、組織頭像、比對報表資料、使用者設定檔相片、使用者小組成員資格、使用者意見反應 |
...
| 隱私權原則 URL | https://coffeepals.co/privacy |

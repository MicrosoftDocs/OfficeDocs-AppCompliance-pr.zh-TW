...
description: PlanIt 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66765135"
---
# <a name="planit"></a>PlanIt

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 7 月 7 日</p>

* <a href="https://teams.microsoft.com/l/app/49cd11e3-cd7c-422a-9e2c-98a0a40fa418" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004211" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

啟用 365 至 Microsoft 所提供的資訊：
...
| 合作夥伴公司名稱 | 啟用 365 |
| 公司的網站 | [https://www.enable.no](https://www.enable.no) |
| 應用程式的使用規定 | [https://www.enable.no/standard-contract-enable-planit-for-m...](https://www.enable.no/standard-contract-enable-planit-for-microsoft-store/) |
| 應用程式的核心功能 | 便於使用工具進行年度規劃。 圓行事曆中與 Planner 連接的美觀視覺效果。  |
| 公司總部位置 | 挪威 |
| 應用程式資訊頁面 | [https://appsource.microsoft.com/en-us/product/office/WA2000...](https://appsource.microsoft.com/en-us/product/office/WA200004211) |
...
這項資訊是由啟用 365 所提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、SharePoint 清單和 Teams 行事曆 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者和 Teams 授權資料 |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 愛爾蘭、挪威 |
| 您是否有已建立的資料租用和處置程式？ | 是 |
| 帳戶終止之後，資料會保留多久？ | 未保留 |
| 您是否有已建立的資料存取管理程式？ | 是 |
...
| 已針對下列專案啟用多重要素驗證 (MFA) ： | Credential、CodeRepositories |
...
| 隱私權原則 URL | https://www.enable.no/eighteen/enable-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | 委託 | 識別目前的使用者 | [49cd11e3-cd7c-422a-9e2c-98a0a40fa418](../azure/49cd11e3-cd7c-422a-9e2c-98a0a40fa418.md) |
>| offline_access | 委託 | Teams 資料 | [49cd11e3-cd7c-422a-9e2c-98a0a40fa418](../azure/49cd11e3-cd7c-422a-9e2c-98a0a40fa418.md) |
>| openid | 委託 | SSO | [49cd11e3-cd7c-422a-9e2c-98a0a40fa418](../azure/49cd11e3-cd7c-422a-9e2c-98a0a40fa418.md) |
>| 設定檔 | 委託 | 識別目前的使用者 | [49cd11e3-cd7c-422a-9e2c-98a0a40fa418](../azure/49cd11e3-cd7c-422a-9e2c-98a0a40fa418.md) |

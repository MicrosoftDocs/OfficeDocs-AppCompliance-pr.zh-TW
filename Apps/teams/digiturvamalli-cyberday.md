---
title: 依 Digiturvamalli 的 Cyberday 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Cyberday 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/a8e43ae4-a97b-4d1a-b364-b27794da19a4" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001774" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Digiturvamalli 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://cyberday.ai](https://cyberday.ai) |
| 應用程式的使用規定 | [https://cyberday.ai/terms-of-use](https://cyberday.ai/terms-of-use) |
| 應用程式的核心功能 | Cyberday 是一種資訊安全性管理系統，可引導客戶遵循他們所選取的安全性架構。 |
| 公司總部位置 | 芬蘭 |
| 應用程式資訊頁面 | [https://cyberday.ai](https://cyberday.ai) |
...
此資訊由 Digiturvamalli 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 使用電子郵件來識別此使用者身分的應用程式系統管理員的使用者 + 顯示 | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
>| openid | 委託 | 使用使用者識別碼來識別使用者 | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |

...
| App 的使用條款 | [https://cyberday.ai/terms-of-use](https://cyberday.ai/terms-of-use) |
| 應用程式的核心功能 | Cyberday 是一種資訊安全管理系統，它會指導客戶遵循所選取的安全性框架。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 使用電子郵件來識別使用者 + 顯示，以供此使用者所用的應用程式管理員使用 | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](https://docs.microsoft.com/microsoft-365-app-certification/azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941) |
>| openid | 委託 | 使用使用者識別碼識別使用者 | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](https://docs.microsoft.com/microsoft-365-app-certification/azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941) |

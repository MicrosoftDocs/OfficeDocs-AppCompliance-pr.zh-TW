---
title: Pogo Studio 量身訂做交談的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: 針對量身打造的交談、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊，所有可用的安全性與合規性資訊。
...
ms.locfileid: "66656005"
---
# <a name="tailored-talks"></a>量身打造的交談

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/a1f5ad93-accd-463f-a8d5-904c77015815" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004309" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Pogo Studio 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Pogo Studio |
| 公司的網站 | [https://pogodigitalhealth.com](https://pogodigitalhealth.com) |
| 應用程式的使用規定 | [https://teams.tailored-talks.com/pdf/TermsOfUse.pdf](https://teams.tailored-talks.com/pdf/TermsOfUse.pdf) |
| 應用程式的核心功能 | 量身打造的交談可讓臨床醫生與病患分享個人化簡報。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | |
...
Pogo Studio 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://teams.tailored-talks.com/pdf/PrivacyPolicy.pdf |
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | 原則可以以特定使用者和群組為目標，讓系統管理員更精細地控制存取權。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 應用程式 | 識別使用者 | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
>| openid | 應用程式 | 識別使用者 | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
>| 設定檔 | 應用程式 | 識別使用者 | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |

---
title: timeghost 的應用程式資訊 - 依 timeghost.io 的時間追蹤
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: timeghost 的所有可用安全性與合規性資訊 - 時間追蹤、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/e3956558-7399-4ec1-848a-c61a2aa95bc1" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001532" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

timeghost.io 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | timeghost - Time tracking |
| ID | WA200001532 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | timeghost.io |
| 公司的網站 | [https://timeghost.io](https://timeghost.io) |
| 應用程式的使用規定 | [https://timeghost.io/terms-and-conditions/](https://timeghost.io/terms-and-conditions/) |
| 應用程式的核心功能 | Timeghost 是專為Office 365設計的時間追蹤工具。 |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | [https://timeghost.io](https://timeghost.io) |
...
這項資訊是由 timeghost.io 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、使用者郵件資料、使用者行事歷數據 |
...
| 已針對下列專案啟用多重要素驗證 (MFA) ： | DNSManagement、CodeRepositories、Credential |
...
| 隱私權原則 URL | https://timeghost.io/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委託 | 若要將 Microsoft 365 應用程式整合到 timeghost，並在 timeghost 摘要中顯示特定Outlook 行事曆事件。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| People.Read | 委託 | 若要將 Microsoft 365 應用程式整合到 timeghost 並顯示，例如顯示連結至其 Microsoft 365 設定檔的使用者虛擬人偶。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| User.Read | 委託 | 為了將 Microsoft 365 應用程式整合到 timeghost，並顯示例如向使用者顯示其公司的其他使用者也使用 timeghost。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| User.ReadBasic.All | 委託 | 若要將 Microsoft 365 應用程式整合到 timeghost 並顯示，例如顯示連結至其 Microsoft 365 設定檔的使用者虛擬人偶。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| openid | 委託 | 內部使用者識別碼  | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| 設定檔 | 委託 | 若要將 Microsoft 365 應用程式整合到 timeghost 並顯示，例如顯示連結至其 Microsoft 365 設定檔的使用者虛擬人偶。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |

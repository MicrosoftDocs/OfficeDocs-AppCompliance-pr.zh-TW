...
description: 所有可用的安全性與合規性資訊，適用于廣播、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/cfdaef91-3bae-4545-a571-b86b1685857f" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002697" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Cerkl 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Cerkl |
| 公司的網站 | [https://cerkl.com](https://cerkl.com) |
| 應用程式的使用規定 | [https://cerkl.com/terms](https://cerkl.com/terms) |
| 應用程式的核心功能 | Cerkl Broadcast 可讓員工物件與其組織&#8217;重要的通訊。 使用行為型個人化，Broadcast 會在正確的頻道上，于正確的時間將正確的訊息傳遞給正確的員工。 那&#8217;我們真正與競爭對手分開的地方， 我們可讓精通的通訊人員在不重複工作的情況下跨頻道進行通訊。 廣播也提供領先業界的計量，可協助用戶端知道哪些&#8217;為其物件運作。 |
| 公司總部位置 | 美國美國 |
...
Cerkl 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 系統會收集使用者的電子郵件，並用來查看使用者目前是否在我們的系統中，並且是由組織新增。 | [74ef25ab-3685-446c-aa43-4e9cc251ed62](../azure/74ef25ab-3685-446c-aa43-4e9cc251ed62.md) |

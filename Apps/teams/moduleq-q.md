...
description: Q、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "64878610"
---
# <a name="q"></a>Q

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 1 月 29 日</p>

* <a href="https://teams.microsoft.com/l/app/72bb25c7-3644-4318-8249-a08e5493a520" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381433" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

ModuleQ 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | ModuleQ |
| 公司的網站 | [https://moduleq.com](https://moduleq.com) |
| 應用程式的使用規定 | [https://moduleq.com/terms-of-service](https://moduleq.com/terms-of-service) |
| 應用程式的核心功能 | Q 的運作方式如同受信任的同事、追蹤客戶焦點，並傳送您在您必須詢問之前需要查看的商業新聞。 由 ModuleQ AI 和 Knowledge Graph提供技術支援，來自于布埃奇的身分。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://moduleq.com/product](https://moduleq.com/product) |
...
ModuleQ 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、使用者電子郵件中繼資料、使用者行事曆中繼資料 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者設定檔資料、使用者電子郵件中繼資料、使用者行事曆中繼資料 |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | Microsoft.AspNetCore.Authentication.MicrosoftAccount |
| 您的應用程式是否支援條件式存取原則？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 應用程式 | 產品功能的必要項。 | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
>| Group.Read.All | 委託 | 產品功能的必要項。 | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
>| Mail.Read | 應用程式 | 產品功能的必要項。 | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
>| User.Read | 委託 | 產品功能的必要項。 | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
>| User.Read.All | 委託 | 產品功能的必要項。 | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |

---
title: PrivyNow by PT Privy Identitas Digital 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2022
...
description: PrivyNow 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66547031"
---
# <a name="privynow"></a>PrivyNow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 3 月 2 日</p>

* <a href="https://teams.microsoft.com/l/app/00e595af-26e4-46b9-97d1-46e0831b1f02" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004229" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

PT Privy Identitas Digital 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | PT Privy Identitas Digital |
| 公司的網站 | [https://privynow.com/about-us/](https://privynow.com/about-us/) |
| 應用程式的使用規定 | [https://privynow.com/terms-of-use/](https://privynow.com/terms-of-use/) |
| 應用程式的核心功能 | 簽署各種檔是您日常生活不可或缺的一部分，而延遲會變更所有專案。 使用 PrivyNow 快速關閉您的交易。 在 1 分鐘內上傳和共用檔。   若要使用此應用程式，使用者必須擁有使用中的 PrivyNow 帳戶，請透過 PrivyNow.com 註冊，或連絡我們的支援小組以取得詳細資料。 |
| 公司總部位置 | 印尼 |
| 應用程式資訊頁面 | [https://privynow.com/guide/](https://privynow.com/guide/) |
...
這項資訊是由 PT Privy Identitas Digital 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 全名、電子郵件 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 全名、電子郵件 |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 印尼 |
| 您是否有已建立的資料租用和處置程式？ | 是 |
| 帳戶終止之後，資料會保留多久？ | 未保留 |
| 您是否有已建立的資料存取管理程式？ | 是 |
...
| 隱私權原則 URL | https://privynow.com/terms-of-use/ |

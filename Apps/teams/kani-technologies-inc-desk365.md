---
title: Kani Technologies Inc for Desk365 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/27/2021
...
description: Desk365 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/7656ec6e-c63b-4571-8ab8-95d1c451d1e6" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003323" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Kani Technologies Inc 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Kani Technologies Inc |
| 公司的網站 | [https://www.desk365.io](https://www.desk365.io) |
| 應用程式的使用規定 | [https://www.desk365.io/terms-of-service/](https://www.desk365.io/terms-of-service/) |
| 應用程式的核心功能 | Desk365 是適用于Microsoft 365工作場所的新式技術服務人員。 透過 Desk365 Teams應用程式，您可以輕鬆地與支援小組上的其他代理程式共同作業。 您可以回復票證、新增附注、檢查狀態、變更票證屬性，而不需要離開Microsoft Teams。 Desk365 最多 4 個代理程式免費使用。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.desk365.io/agent-bot/](https://www.desk365.io/agent-bot/) |
...
Kani Technologies Inc 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

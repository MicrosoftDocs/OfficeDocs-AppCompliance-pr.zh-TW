---
title: Edgility 的 Edgility 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: Edgility、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "64910239"
---
# <a name="edgility"></a>敏捷性

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 3 月 29 日</p>

* <a href="https://teams.microsoft.com/l/app/fe2f94eb-7164-4fcd-a2c7-16db90307caa" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003970" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Edgility 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 敏捷性 |
| 公司的網站 | [https://edgility.com.au](https://edgility.com.au) |
| 應用程式的使用規定 | [https://www.edgility.com.au/legal/](https://www.edgility.com.au/legal/) |
| 應用程式的核心功能 | Edgility 是開發整合式企業通訊工具的領導者。 這些 SMS 解決方案可讓組織人員使用其已依賴的平臺，簡化提醒、宣傳、警示和通知業務相關人員的程式。 其中包括 Microsoft 產品，例如Excel、Outlook和Teams。 使用者可以藉由將簡訊接收到 Microsoft Outlook並Teams，以利用這個有效的交談式工具。 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | [https://www.edgility.com.au/microsoft/teams/](https://www.edgility.com.au/microsoft/teams/) |
...
Edgility 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: QuickMinutes 的 QuickMinutes 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: 所有可用的安全性與合規性資訊，適用于 QuickMinutes、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/5f60fe53-d441-4320-8c26-13fdaee9b58a" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004414" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

QuickMinutes 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | QuickMinutes |
| 公司的網站 | [https://quickminutes.com](https://quickminutes.com) |
| 應用程式的使用規定 | [https://quickminutes.com/privacy#/terms_of_service](https://quickminutes.com/privacy#/terms_of_service) |
| 應用程式的核心功能 | 使用我們的智慧數位助理簡化會議線上工作流程。 |
| 公司總部位置 | 愛爾蘭 |
| 應用程式資訊頁面 | [https://support.quickminutes.com/portal/en-gb/kb/articles/m...](https://support.quickminutes.com/portal/en-gb/kb/articles/microsoft-teams-integration-22-4-2020-1) |
...
這項資訊是由 QuickMinutes 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 當使用者使用 Microsoft SSO 向 QuickMinutes 註冊新帳戶時，我們會使用使用者設定檔資料來填入 QuickMinutes DB 中的使用者資訊。 QuickMinutes 會提取使用者行事歷數據，以在 QuickMinutes UI 中顯示事件。 我們不會將這項資訊儲存在 QuickMinutes DB 中，只要從圖形 API擷取資訊，並顯示給使用者即可。  |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者設定檔資訊，例如名字、姓氏、Email和設定檔圖片。 我們也會儲存使用者 MS 存取和重新整理權杖。 |
...
| 隱私權原則 URL | https://quickminutes.com/privacy#/privacy_policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委託 | QuickMinutes 會使用行事曆範圍，將 QuickMinutes 會議讀取/寫入使用者 Microsoft 行事曆 | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| People.Read | 委託 | 當使用者新增至其 QuickMinutes 組織或群組時，QuickMinutes 會使用人員範圍來列出 Microsoft 使用者的連絡人 | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| 電子郵件 | 委託 | 電子郵件範圍是用來讓 QuickMinutes 以電子郵件宣告的形式存取使用者的主要電子郵件地址。 | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| openid | 委託 | Microsoft 身分識別平臺權杖端點上的 QuickMinutes 會使用 openid 範圍來取得識別碼權杖。 這可讓 QuickMinutes 使用權杖代表使用者存取圖形 API | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| 設定檔 | 委託 | 當我們透過 Microsoft SSO 註冊使用者設定檔並建立其 QuickMinutes 帳戶時，QuickMinutes 會使用設定檔範圍來存取使用者設定檔。 | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |

---
title: ThoughtExchange 的應用程式資訊（按 ThoughtExchange）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/01/2021
...
description: ThoughtExchange 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/56e9692f-606b-45ef-8c1f-12e1ea5e27db" target="_blank">在 Teams 儲存區中查看</a>
...
由 ThoughtExchange 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | ThoughtExchange |
| ID | WA200003378 |
| 支援 Office 365 用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | ThoughtExchange |
| 公司的網站 | [https://thoughtexchange.com](https://thoughtexchange.com) |
| App 的使用條款 | [https://www.thoughtexchange.com/participant-leader-terms-of...](https://www.thoughtexchange.com/participant-leader-terms-of-use/) |
| 應用程式的核心功能 | &#8220;ThoughtExchange 可協助領導者從員工或社區中的任何人取得 candid 和非偏置的輸入，不論其位置為何。 不論是十或10000的群組&#8217;，ThoughtExchange 可讓您更輕鬆地以比例進行重要討論和作出決策。 &#8221; |
| 公司 headquarter 位置 | 加拿大 |
| 應用程式資訊頁面 | [https://get.thoughtexchange.help/hc/en-us/articles/15000107...](https://get.thoughtexchange.help/hc/en-us/articles/1500010779682) |
...
此資訊是由 ThoughtExchange 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.thoughtexchange.com/privacy-policy/ |

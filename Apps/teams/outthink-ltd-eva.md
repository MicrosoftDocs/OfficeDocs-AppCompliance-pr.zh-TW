---
title: OutThink Ltd 的 Eva 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Eva 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/eddbe35e-8260-4878-99d2-946c4aac73f4" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004345" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

OutThink Ltd 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | OutThink Ltd |
| 公司的網站 | [https://www.outthink.io](https://www.outthink.io) |
| 應用程式的使用規定 | [https://outthink.io/wp-content/uploads/OutThink-SaaS-Terms-...](https://outthink.io/wp-content/uploads/OutThink-SaaS-Terms-and-Conditions.pdf) |
| 應用程式的核心功能 | Eva 是 AI 助理，為想要管理組織內網路安全性人類風險的 OutThink 用戶端提供虛擬支援。  它會為員工提供訓練進度的定期更新，並提供有關其效能的有效意見反應，協助提升網路安全性知識。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://docs.outthink.io/integration-with-microsoft-teams/](https://docs.outthink.io/integration-with-microsoft-teams/) |
...
OutThink Ltd 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者郵件資料、使用者行事曆空閒/忙碌資訊 |
...
| 隱私權原則 URL | https://outthink.io/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委託 | 在使用者的行事曆中尋找下一個可用的可用位置，以允許他們透過 Teams 應用程式預約網路安全性訓練的位置。 | [07c3de2f-6e55-4fae-8c97-90964ff2b934](../azure/07c3de2f-6e55-4fae-8c97-90964ff2b934.md) |
>| User.Read | 委託 | 依電子郵件地址識別使用者，以便將郵件傳送給具有指定公司郵寄地址的使用者。 | [07c3de2f-6e55-4fae-8c97-90964ff2b934](../azure/07c3de2f-6e55-4fae-8c97-90964ff2b934.md) |

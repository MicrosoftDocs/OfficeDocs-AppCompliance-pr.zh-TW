---
title: KoareTech S.L 的 Koare 儀表板應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Koare 儀表板的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66817619"
---
# <a name="koare-dashboard"></a>Koare 儀表板

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/08a78d62-ec3b-4800-b51a-9ffd823273cd" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004403" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

KoareTech S.L 所提供的資訊。 至 Microsoft：
...
| 合作夥伴公司名稱 | KoareTech S.L. |
| 公司的網站 | [https://koaretech.com](https://koaretech.com) |
| 應用程式的使用規定 | [https://koaretech.com/termsofuse.php](https://koaretech.com/termsofuse.php) |
| 應用程式的核心功能 | 清查管理是用來記錄和追蹤組織中硬體和軟體資產以及 IT 清查的工具。 適合用於 IT 分離和管理。 KoareTech 清查管理工具所提供的報表會顯示指派給每位員工之專案的狀態和使用方式詳細資訊。 由 Microsoft Teams 和 SharePoint 支援。 需求：與 Microsoft Teams 群組或頻道建立關聯，並訂閱 Azure Marketplace。 |
| 公司總部位置 | 西班牙 |
| 應用程式資訊頁面 | |
...
此資訊已由 KoareTech S.L 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | 委託 | 存取 Sharepoint 清單 | [45aa6c59-3764-4c2f-hrf-178757957e62](../azure/45aa6c59-3764-4c2f-abef-178757957e62.md) |
>| Group.ReadWrite.All | 委託 | 存取 Sharepoint 清單 | [45aa6c59-3764-4c2f-hrf-178757957e62](../azure/45aa6c59-3764-4c2f-abef-178757957e62.md) |
>| Sites.Manage.All | 委託 | 建立 Sharepoint 清單 | [45aa6c59-3764-4c2f-hrf-178757957e62](../azure/45aa6c59-3764-4c2f-abef-178757957e62.md) |
>| User.Read.All | 委託 | 存取 Sharepoint 清單 | [45aa6c59-3764-4c2f-hrf-178757957e62](../azure/45aa6c59-3764-4c2f-abef-178757957e62.md) |

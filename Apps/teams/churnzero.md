---
title: ChurnZero by ChurnZero 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: ChurnZero 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c2e66b59-725d-4c56-8a0e-ee2587031d9f" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002581" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

ChurnZero 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | ChurnZero |
| 公司的網站 | [https://churnzero.net](https://churnzero.net) |
| 應用程式的使用規定 | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| 應用程式的核心功能 | ChurnZero 是即時客戶成功平臺，可協助訂用帳戶業務遭遇流失、擴充目前的帳戶、提高產品採用率，以及優化客戶體驗。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
此資訊由 ChurnZero 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 委派使用者的 Azure 物件識別碼，可與 ChurnZero 使用者相互關聯，以便在未來 Bot 會話期間識別並授權該使用者。 | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |

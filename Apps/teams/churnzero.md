...
| App 的使用條款 | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| 應用程式的核心功能 | ChurnZero 是一種即時客戶成功平臺，可協助訂閱公司抵抗改動、展開目前的帳戶、增加產品採用，並優化客戶體驗。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 要與 ChurnZero 使用者關聯之委派使用者的 Azure 物件識別碼，以便在未來的 bot 會話期間識別及授權該使用者。 | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](https://docs.microsoft.com/microsoft-365-app-certification/azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f) |

---
title: Tonkean by Tonkean 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Tonkean 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/b7391d00-e8e4-4dc9-970e-ba3386144114" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381749" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Tonkean 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Tonkean |
| 公司的網站 | [https://tonkean.com](https://tonkean.com) |
| 應用程式的使用規定 | [https://tonkean.com/terms/](https://tonkean.com/terms/) |
| 應用程式的核心功能 | Tonkean 可讓組織和營運小組快速地將複雜的商務程式自動化。 Tonkean 提供建置組塊，可完整執行、監視及管理我們 Solution Studio 中建置的任何商務程式，而不需要程式碼。  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://tonkean.com](https://tonkean.com) |
...
Tonkean 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 名稱、電子郵件、使用者識別碼。其他資料可能會在使用者要求/摘要時儲存。 |
...
| 隱私權原則 URL | https://tonkean.com/privacy |

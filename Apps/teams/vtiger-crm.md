---
title: Vtiger CRM by Vtiger 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Vtiger CRM 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/08cb9b41-2ceb-4fe1-b85b-6eb6128aa138" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003089" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Vtiger 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Vtiger |
| 公司的網站 | [https://www.vtiger.com](https://www.vtiger.com) |
| 應用程式的使用規定 | [https://www.vtiger.com/policy-legal-center/terms-of-service/](https://www.vtiger.com/policy-legal-center/terms-of-service/) |
| 應用程式的核心功能 | 連線 Vtiger CRM 來檢視及共用小組內的交易、案例、工作或連絡人。 |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | [https://help.vtiger.com/article/149601890-MS-Teams-and-Vtig...](https://help.vtiger.com/article/149601890-MS-Teams-and-Vtiger-CRM-Integration) |
...
Vtiger 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | 根據 IP 位址的限制。 使用角色和設定檔的資料存取控制。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 應用程式 | 取得電子郵件地址以驗證 AuthToken。 | [7a483472-4f1b-4c75-bff3-7a48dae227dc](../azure/7a483472-4f1b-4c75-bff3-7a48dae227dc.md) |

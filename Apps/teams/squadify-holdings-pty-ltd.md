---
title: Squadify By Squadify 的 Application Information By Squadify Pty Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: 所有可用的安全性與合規性資訊，適用于 Squadify、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/110107b9-4326-43d8-bf43-bf10fcdce8ad" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004349" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由通通通隊 Pty Ltd 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Squadify 擴增 Pty Ltd |
| 公司的網站 | [https://www.squadify.net](https://www.squadify.net) |
| 應用程式的使用規定 | [https://www.squadify.net/mst-terms-of-use](https://www.squadify.net/mst-terms-of-use) |
| 應用程式的核心功能 | Teamsify for Microsoft Teams 可讓您收集小組意見反應、對話，並產生可採取動作的深入解析。 使用 Teamsify for Microsoft Teams，您可以使用 1 鍵來設定建立佇列，並與 Microsoft Teams 的小組進行比對。 您也可以啟動 Teamifys、追蹤其進度，以及產生小組效能的深入解析，以便開始建立正確的交談。 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | [https://www.squadify.net/our-product](https://www.squadify.net/our-product) |
...
這個資訊是由 Squadify 將 Pty Ltd 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者完整名稱和Email位址 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者完整名稱和Email位址 |
...
| 隱私權原則 URL | https://www.squadify.net/privacy-policy |

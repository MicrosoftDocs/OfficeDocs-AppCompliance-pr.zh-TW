---
title: Skillsoft Percipio 的應用程式資訊 Skillsoft
ms.author: elmalova
author: elenamalova
ms.date: 10/26/2021
ms.topic: article
...
description: Skillsoft Percipio 的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/858597e0-33db-4cc0-bd1e-466b6ceb977a" target="_blank">在 Teams 儲存區中查看</a>
...
由 Skillsoft 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Skillsoft Percipio |
| ID | WA200003256 |
| 支援 Office 365 用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Skillsoft |
| 公司的網站 | [https://www.skillsoft.com](https://www.skillsoft.com) |
| App 的使用條款 | [https://www.skillsoft.com/terms-of-use](https://www.skillsoft.com/terms-of-use) |
| 應用程式的核心功能 | Skillsoft Percipio 可讓您存取完整的 Percipio 訓練內容和功能套件。 |
...
此資訊是由 Skillsoft 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

---
title: NewCOS by Newtech 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: NewCOS、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
<p>上次由開發人員更新日期：2021 年 6 月 17 日</p>

* <a href="https://teams.microsoft.com/l/app/205214d0-e04b-11e9-9332-5b5c97b60069" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001104" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Newtech 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Newtech |
| 公司的網站 | [https://newtech.com.ar](https://newtech.com.ar) |
| 應用程式的使用規定 | [https://newtech.com.ar/termsofservice](https://newtech.com.ar/termsofservice) |
| 應用程式的核心功能 | 快速、輕鬆且在服務模式中部署智慧型通訊解決方案。 NewCOS 平臺可讓您快速、輕鬆地執行、管理、監視及支援安裝，而不需要 IT 介入。  我們會與您一起進行，讓採用技術的程式成功。 我們可簡化現今共同作業工作區中變更的適應。 透過採用Microsoft 365我們可以加速組織內的數位轉型程式。  |
| 公司總部位置 | 阿根廷 |
...
Newtech 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 設定檔 | 兩者 | 此資料用於應用程式許可權的驗證 | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| openid | 兩者 | Microsoft Teams用量，以報告和治理 | [ea4de024-dd5f-4d3e-a092-3b8de6c64200](../azure/ea4de024-dd5f-4d3e-a092-3b8de6c64200.md) |

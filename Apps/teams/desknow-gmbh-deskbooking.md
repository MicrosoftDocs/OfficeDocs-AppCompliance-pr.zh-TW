---
title: DeskBooking 的應用程式資訊（按 DeskNow GmbH）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/25/2022
...
description: DeskBooking 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/d118c110-6d5d-4fa1-8151-1ebb10b0091c" target="_blank">在 Teams 儲存區中查看</a>

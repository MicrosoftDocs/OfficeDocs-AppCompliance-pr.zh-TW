---
title: Think AI 所Thinky365-Autotask的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Thinky365-Autotask 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/2291b3d5-ea1d-4605-9a94-ac4523b85c06" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004355" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Think AI 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Thinky365-Autotask |
| ID | WA200004355 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Think AI |
| 公司的網站 | [https://www.thinky365.com](https://www.thinky365.com) |
| 應用程式的使用規定 | [https://thinky365.com/terms-of-use/](https://thinky365.com/terms-of-use/) |
| 應用程式的核心功能 | 適用于 Autotask 的 Thinky365 Chatbot 是您的 24&#215;7 虛擬代理程式。 透過此聊天機器人，您將能夠以全新創新的方式提高服務小組的生產力，同時改善客戶的整體使用者體驗。  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
這項資訊是由 Think AI 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | Microsoft Graph、CRM 和 Azure 等服務的端點 |

---
title: Lucidspark Whiteboard by Lucid Software 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
description: 所有可用的安全性與合規性資訊，適用于 Lucidspark Whiteboard、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64875390"
---
# <a name="lucidspark-whiteboard"></a>Lucidspark Whiteboard

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 5 月 13 日</p>

* <a href="https://teams.microsoft.com/l/app/e9ab21fa-5fd5-48bb-a85d-4de7ced89cd1" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002583" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Lucid Software 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Lucidspark Whiteboard |
| ID | WA200002583 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Lucid Software |
| 公司的網站 | [https://lucid.co](https://lucid.co) |
| 應用程式的使用規定 | [https://lucid.co/tos](https://lucid.co/tos) |
| 應用程式的核心功能 | Lucidspark 是雲端式虛擬白板，小組可在其中呈現他們的最佳想法。 無論您&#8217;遠端或親自工作，以小組身分即時進行腦力激蕩和共同作業。 Lucidspark 可協助人員組織筆記和撰寫文字，並將其轉換成簡報就緒的概念。 當&#8217;後續步驟的時間時，小組可以開發工作流程和處理檔，將想法變成現實。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://lucidchart.zendesk.com](https://lucidchart.zendesk.com) |
...
Lucid Software 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 電子郵件 | 委託 | 名稱和電子郵件地址。 | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| openid | 委託 | 名稱和電子郵件地址。 | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| 設定檔 | 委託 | 名稱和電子郵件地址。 | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |

---
title: 新聞的應用程式資訊 - Jalios by Jalios SA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: 新聞的所有可用安全性與合規性資訊 - Jalios、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2021 年 12 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/a8662bd0-31c6-4254-b48f-0f54d0b92fcb" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003889" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Jalios SA 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Jalios SA |
| 公司的網站 | [https://www.jalios.com](https://www.jalios.com) |
| 應用程式的使用規定 | [https://jalios.com/msteams-app/termsofuse](https://jalios.com/msteams-app/termsofuse) |
| 應用程式的核心功能 | 動態且可自訂的數位公司市集  |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | |
...
Jalios SA 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、使用者電子郵件資料 |
...
| 隱私權原則 URL | https://jalios.com/msteams-app/privacy |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | Microsoft Teams JavaScript 用戶端 SDK |
| 您的應用程式是否支援條件式存取原則？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委託 | 讀取自訂架構延伸模組屬性  | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| User.Read | 委託 | 讀取使用者資料以登入 Jalios Workplace | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| offline_access | 委託 | SSO：維護對資料的存取 | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| openid | 委託 | 將使用者登入 | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |

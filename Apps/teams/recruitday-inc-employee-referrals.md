---
title: Recruitingday Inc. 員工推薦的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/18/2021
...
description: 員工推薦、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c179cdf6-f93d-4aa3-9e2d-e934e5a81846" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002708" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由 Recruitday Inc. 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.recruitday.com](https://www.recruitday.com) |
| 應用程式的使用規定 | [https://www.recruitday.com/terms-of-use](https://www.recruitday.com/terms-of-use) |
| 應用程式的核心功能 | 請連絡您的朋友以在公司中開啟工作，並使用Microsoft Teams追蹤您的獎勵。 |
| 公司總部位置 |  ()  |
| 應用程式資訊頁面 | [https://employer.recruitday.com/solutions/employee-referral...](https://employer.recruitday.com/solutions/employee-referrals/microsoft-teams) |
...
此資訊由 Recruitday Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 兩者 | 應用程式使用者的名字和姓氏 (，也就是員工) 主要由 HR 使用者用來輕鬆識別參考推薦應用程式追蹤和獎勵支付候選項目的員工。 當系統產生的電子郵件通知傳送時，它也會用來正確地為員工定址。 | [7414b436-87d1-4904-9d52-ff47885b89f1](../azure/7414b436-87d1-4904-9d52-ff47885b89f1.md) |

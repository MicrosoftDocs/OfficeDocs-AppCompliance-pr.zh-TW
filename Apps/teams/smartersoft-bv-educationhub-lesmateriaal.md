---
title: Application Information for EducationHUB Lesmateriaal by Smartersoft B.V.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: EducationHUB Lesmateriaal 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/f5558ae7-a166-41bd-997b-f8cc1eddebac" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004326" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Smartersoft B.V 所提供的資訊。 至 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | EducationHUB Lesmateriaal |
| ID | WA200004326 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Smartersoft B.V。 |
| 公司的網站 | [https://smartersoft.nl](https://smartersoft.nl) |
| 應用程式的使用規定 | [https://content.educationhub.nl/terms](https://content.educationhub.nl/terms) |
| 應用程式的核心功能 | 允許學校直接存取學校提供的數位內容，而不是強制學生前往另一個網站。 |
| 公司總部位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | [https://content.educationhub.nl](https://content.educationhub.nl) |
...
此資訊已由 Smartersoft B.V 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者識別碼、群組成員資格、新增至應用程式的個人內容 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者識別碼、群組識別碼、使用者提供的數位學校內容連結 |
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | 全部而言，Microsoft 平臺會負責為使用者提供權杖。 系統管理員決定如何驗證/強制使用者使用 MFA |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | 委託 | 存取儲存在群組擴充屬性中的資訊 | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| Team.ReadBasic.All | 委託 | 使用者小組的相關資訊 | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| User.Read | 委託 | 登入 | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |

---
title: DeskManager 的應用程式資訊（按 DeskNow GmbH）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: DeskManager 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63553428"
---
# <a name="deskmanager"></a>DeskManager

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新日期：2022年1月17日</p>

* <a href="https://teams.microsoft.com/l/app/a6076464-2435-4fa2-b087-895274867ac8" target="_blank">在 Teams 儲存區中查看</a>
...
由 DeskNow GmbH 所提供的資訊給 Microsoft：
...
| 合作夥伴公司名稱 | DeskNow GmbH |
| 公司的網站 | [https://desk-now.com](https://desk-now.com) |
| App 的使用條款 | [https://desk-now.com/en/useful/terms-conditions/](https://desk-now.com/en/useful/terms-conditions/) |
| 應用程式的核心功能 | 完全控制您的辦公室、會議室及其他！ HybridWork 全部，不論國家/地區、辦公室、會議室、辦公桌或人員人數為何。  |
| 公司 headquarter 位置 | 德國 |
| 應用程式資訊頁面 | |
| 用來執行應用程式的主控環境或服務模型為何？ | Iaas |
| 應用程式會使用哪一個主控雲端提供者？ | Aws、其他 |
...
此資訊是由 DeskNow GmbH 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 使用者的預約詳細資料。 使用者設定檔資料、使用者權限 |
...
| 隱私權原則 URL | https://desk-now.com/en/useful/general-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ReadWrite 共用的行事曆 | 包括 | 行事曆同步處理 | [e5d4c7df-50aa-4c15-aa06-c108d0225832](../azure/e5d4c7df-50aa-4c15-aa06-c108d0225832.md) |
>| GroupMember ReadWrite。 | 包括 | 使用者權限、預約權力 | [e5d4c7df-50aa-4c15-aa06-c108d0225832](../azure/e5d4c7df-50aa-4c15-aa06-c108d0225832.md) |
>| TeamMember ReadWrite。 | 包括 | 使用者權利、預約權力、  | [e5d4c7df-50aa-4c15-aa06-c108d0225832](../azure/e5d4c7df-50aa-4c15-aa06-c108d0225832.md) |

---
title: 連絡人中心的應用程式資訊 |ROGER365.io by ROGER365.io
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/08/2021
...
description: 連絡人中心所有可用的安全性和符合性資訊資訊 |ROGER365.io，其資料處理原則，它的 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/f24f4679-05a5-4073-b5f7-0e1916fbd858" target="_blank">在 Teams 儲存區中查看</a>
...
由 ROGER365.io 提供給 Microsoft 的資訊：
...
| App 的使用條款 | [https://www.roger365.io/tos](https://www.roger365.io/tos) |
| 應用程式的核心功能 | Omnichannel 與代理商的連絡人中心，主管報表功能。 |
| 公司 headquarter 位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | [https://ask.roger365.io](https://ask.roger365.io) |
...
此資訊是由 ROGER365.io 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

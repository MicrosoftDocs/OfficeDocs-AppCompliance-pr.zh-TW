---
title: X0PA AI 新加坡 X0PA ROOM 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/31/2021
...
description: X0PA ROOM 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/d84ed1b7-cd38-42e7-8a07-56f7ae72e93a" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003028" target="_blank">在 AppSource 中檢視</a>
...
| 公司的網站 | [https://x0paroom.com](https://x0paroom.com) |
| 應用程式的使用規定 | [https://x0pa.com/terms-of-use](https://x0pa.com/terms-of-use) |
| 應用程式的核心功能 | 使用 X0PA ROOM 的智慧隨選視訊面試功能和分析 |
| 公司總部位置 | 新加坡 |
| 應用程式資訊頁面 | [https://x0paroom.com](https://x0paroom.com) |
...
這項資訊是由 X0PA AI 新加坡提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: Avista 技術解決方案是否保管庫的應用程式資訊？
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: 您是否保管庫？、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/884e521a-dadc-41e9-a8af-fcaa907e783e" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003863" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Avista 技術解決方案提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://safetybot.in](https://safetybot.in) |
| 應用程式的使用規定 | [https://safetybot.in/terms.html](https://safetybot.in/terms.html) |
| 應用程式的核心功能 | &quot;AreYouSafe？ &quot; Bot 是您個人化的危機管理助理。 適合安全系統管理員和人力資源人員在緊急期間設定和使用。  您不需要任何其他軟體或服務即可使用此應用程式。 我們的 Bot 很容易使用，並避免在整個危機期間，在Teams與外部應用程式之間交換。  使用我們的 Bot 來瞭解受重大事件影響的員工狀態。 &quot;AreYouSafe？ &quot; Bot 藉由提供即時更新，協助您為需要的使用者提供協助。 |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | [https://safetybot.in](https://safetybot.in) |
...
Avista 技術解決方案提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: 您保管庫的應用程式資訊？依 Avista 技術解決方案
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
* <a href="https://teams.microsoft.com/l/app/884e521a-dadc-41e9-a8af-fcaa907e783e" target="_blank">在 Teams 儲存區中查看</a>
...
| App 的使用條款 | [https://safetybot.in/terms.html](https://safetybot.in/terms.html) |
| 應用程式的核心功能 | &quot;AreYouSafe？ &quot; bot 是您個人化的危機管理助理。 適用于安全管理員和 HR 人員在緊急情況期間設定和使用。  您不需要任何其他軟體或服務，即可使用此應用程式。 我們的 bot 便於使用，且避免在整個危機中 Teams 和外部應用程式之間互換。  使用我們的 bot 來瞭解主要事件所影響的員工狀態。 &quot;AreYouSafe？ &quot; bot 可協助您提供即時更新，以協助您提供必要的協助。 |

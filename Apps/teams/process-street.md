---
title: Process Street by Process Street 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: 進程街的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64838796"
---
# <a name="process-street"></a>進程街

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 3 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/6910821c-1244-4a0b-9d64-f0fc396b8e7c" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003933" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Process Street 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 進程街 |
| 公司的網站 | [https://www.process.st](https://www.process.st) |
| 應用程式的使用規定 | [https://www.process.st/terms/](https://www.process.st/terms/) |
| 應用程式的核心功能 | 現代化進程管理平臺，用於建置、共用和自動化核心程式。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
此資訊由 Process Street 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.process.st/help/docs/gdpr-statement/ |

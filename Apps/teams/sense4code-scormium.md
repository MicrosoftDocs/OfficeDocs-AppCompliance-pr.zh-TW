---
title: 依 Sense4code 的 Scormium 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Scormium 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/ad42b2ed-c5ad-4f2c-99e3-5da268a9c967" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004358" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Sense4code 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Sense4code |
| 公司的網站 | [https://en.scormium.com](https://en.scormium.com) |
| 應用程式的使用規定 | [https://en.scormium.com/podminky-a-pravidla-uziti](https://en.scormium.com/podminky-a-pravidla-uziti) |
| 應用程式的核心功能 | 使用 Scormium 享受 E-learning、Events 和 Study 路徑的功能。  |
| 公司總部位置 | 捷克文 |
| 應用程式資訊頁面 | |
...
Sense4code 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者的電子郵件   |
...
| 隱私權原則 URL | https://en.scormium.com/zasady-ochrany-soukromi |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 登入並讀取使用者設定檔 | [ffdbe361-6168-42f7-31b7922da](../azure/ffdbe361-6168-42f7-beef-d1931b7922da.md) |

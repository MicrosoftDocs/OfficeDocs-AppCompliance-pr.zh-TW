---
title: ParkHere Corporate by ParkHere GmbH 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: ParkHere 公司的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/bc9ce604-cd9b-4aee-9cee-29028e1b00ab" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003124" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由 ParkHere GmbH 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://park-here.eu](https://park-here.eu) |
| 應用程式的使用規定 | [https://park-here.eu/ms-teams-terms-of-use/](https://park-here.eu/ms-teams-terms-of-use/) |
| 應用程式的核心功能 | Finden und Reservieren Sie einen verf&#252;gbaren Parkplatz an Ihrer Ar marketplacetsstelle |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | [https://park-here.eu/komplettloesung/](https://park-here.eu/komplettloesung/) |
...
此資訊已由 ParkHere GmbH 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

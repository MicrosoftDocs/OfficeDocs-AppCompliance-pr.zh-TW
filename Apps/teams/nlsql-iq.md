...
description: IQ 的所有可用安全性與合規性資訊、其資料處理原則、Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65935444"
---
# <a name="iq"></a>智商

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 18 日</p>

* <a href="https://teams.microsoft.com/l/app/9d0bdc38-2705-4109-835f-3c14534f923f" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004126" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

NLSQL 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | NLSQL |
| 公司的網站 | [https://nlsql.com](https://nlsql.com) |
| 應用程式的使用規定 | [https://www.nlsql.com/terms_of_use](https://www.nlsql.com/terms_of_use) |
| 應用程式的核心功能 | IQ 支援經理產生要詢問的面試問題，並支援應徵者為面試做準備。 面試問題準備是人工智慧軟體，會根據職位輸入產生隨機問題，讓您清楚瞭解如何做好面試的準備。 應徵者可以隨意產生面試問題，以進行更好的準備。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.nlsql.com/blog/post/interview-questions-to-ask-...](https://www.nlsql.com/blog/post/interview-questions-to-ask-candidates-and-managers/) |
...
NLSQL 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 登入並讀取使用者設定檔 | [f9555238-64f3-4ec2-a8fc-3787baa157aa](../azure/f9555238-64f3-4ec2-a8fc-3787baa157aa.md) |

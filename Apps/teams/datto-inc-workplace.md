---
title: Datto Workplace by Datto， Inc. 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2021
...
description: Datto Workplace 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c1869b15-a530-4386-9d3e-6937a83b66f3" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001987" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Datto， Inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Datto, Inc. |
| 公司的網站 | [https://datto.com](https://datto.com) |
| 應用程式的使用規定 | [https://us.workplace.datto.com/partner/at/eula/eula_en.html](https://us.workplace.datto.com/partner/at/eula/eula_en.html) |
| 應用程式的核心功能 | 使用 Datto Workplace 檔案共用和共同作業工具提高生產力。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.datto.com/products/workplace](https://www.datto.com/products/workplace) |
...
此資訊由 Datto， Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC1 認證日期 | 2019-10-01 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 認證日期 | 2019-10-01 |

...
| App 的使用條款 | [https://www.koan.co/terms-of-service](https://www.koan.co/terms-of-service) |
| 應用程式的核心功能 | 將您的目標管理和狀態追蹤直接加入 Microsoft Teams，以查看進度並保持小組的對齊狀態。 Koan&#8217;的整合功能可讓員工將重點放在最重要的工作，而不需要 Microsoft Teams。 輕鬆建立積極的共用狀態、識別 wins 和識別問題的小組習慣，針對其周圍的任何人提升該欄。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ReadBasic | 委託 | 使用通道識別碼及通道名稱。 我們會使用資料，讓使用者可以選擇要將反射通知傳送至何處。 | [5b599e19-a609-432b-9074-c9d4457e8766](https://docs.microsoft.com/microsoft-365-app-certification/azure/5b599e19-a609-432b-9074-c9d4457e8766) |
>| Team.ReadBasic.All | 包括 | 同時收集和使用團隊識別碼及小組名稱。 我們會使用資料，讓使用者可以選擇要將反射通知傳送至何處。 | [5b599e19-a609-432b-9074-c9d4457e8766](https://docs.microsoft.com/microsoft-365-app-certification/azure/5b599e19-a609-432b-9074-c9d4457e8766) |
>| User.Read | 委託 | 使用使用者名稱、使用者識別碼、使用者電子郵件地址。 我們使用資料在 Microsoft Teams 和 Koan 之間連結使用者帳戶。 它只適用于 at-提及。 | [5b599e19-a609-432b-9074-c9d4457e8766](https://docs.microsoft.com/microsoft-365-app-certification/azure/5b599e19-a609-432b-9074-c9d4457e8766) |

...
description: Koan 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64877210"
---
# <a name="koan"></a>Koan

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 6 月 1 日</p>

* <a href="https://teams.microsoft.com/l/app/dae2b2c3-b014-4188-a887-c87c3ca4a227" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002936" target="_blank">在 AppSource 中檢視</a>
...
| 合作夥伴公司名稱 | Koan， Inc. |
| 公司的網站 | [https://www.koan.co](https://www.koan.co) |
| 應用程式的使用規定 | [https://www.koan.co/terms-of-service](https://www.koan.co/terms-of-service) |
| 應用程式的核心功能 | 直接將您的目標管理和狀態追蹤帶入Microsoft Teams，以查看進度並讓小組保持一致。 Koan&#8217;整合可讓員工專注于最重要的工作，而不需要離開Microsoft Teams。 輕鬆地建立分享狀態、辨識勝出，以及提早找出疑慮的正面小組習慣，為其他人帶來一大問題。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.koan.co/how-it-works](https://www.koan.co/how-it-works) |
...
此資訊由 Koan， Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委託 | 使用通道識別碼和通道名稱。 我們會使用資料，讓使用者可以選取要傳遞反映通知的位置。 | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| Team.ReadBasic.All | 兩者 | 收集和使用小組識別碼和小組名稱。 我們會使用資料，讓使用者可以選取要傳遞反映通知的位置。 | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| User.Read | 委託 | 使用使用者名稱、使用者識別碼、使用者電子郵件地址。 我們會使用資料來連結Microsoft Teams與 Koan 之間的使用者帳戶。 它只適用于提及時。 | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |

...
description: 結構化、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/7d83045e-58b6-471a-b574-a544420254b7" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002514" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

結構化公司提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.structural.com](https://www.structural.com) |
| 應用程式的使用規定 | [https://www.structural.com/terms-of-service](https://www.structural.com/terms-of-service) |
| 應用程式的核心功能 | 連線人員彼此和商機 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.structural.com](https://www.structural.com) |
| 用來執行應用程式的裝載環境或服務模型為何？ | Iaas |
| 應用程式會使用哪些主控雲端提供者？ | AWS、GCP |
...
結構化公司已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | 委託 | 是：在單一登入期間驗證使用者。 | [fb6ddd39-35f2-4110-a45d-d2e73b946cae](../azure/fb6ddd39-35f2-4110-a45d-d2e73b946cae.md) |
>| 電子郵件 | 委託 | 是：在單一登入期間驗證使用者。 | [fb6ddd39-35f2-4110-a45d-d2e73b946cae](../azure/fb6ddd39-35f2-4110-a45d-d2e73b946cae.md) |
>| offline_access | 委託 | 是：在單一登入期間驗證使用者。 | [fb6ddd39-35f2-4110-a45d-d2e73b946cae](../azure/fb6ddd39-35f2-4110-a45d-d2e73b946cae.md) |
>| openid | 委託 | 是：在單一登入期間驗證使用者。 | [fb6ddd39-35f2-4110-a45d-d2e73b946cae](../azure/fb6ddd39-35f2-4110-a45d-d2e73b946cae.md) |
>| 設定檔 | 委託 | 是：在單一登入期間驗證使用者。 | [fb6ddd39-35f2-4110-a45d-d2e73b946cae](../azure/fb6ddd39-35f2-4110-a45d-d2e73b946cae.md) |

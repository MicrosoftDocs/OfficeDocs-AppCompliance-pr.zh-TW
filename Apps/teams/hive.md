...
description: Hive 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/4a863b83-e52f-412d-ba6a-3b9608090c7d" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000093" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Hive 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Hive |
| 公司的網站 | [https://www.hive.com](https://www.hive.com) |
| 應用程式的使用規定 | [https://hive.com/terms](https://hive.com/terms) |
| 應用程式的核心功能 | Hive 可讓您的小組更有效率地共同作業 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.hive.com](https://www.hive.com) |
...
Hive 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

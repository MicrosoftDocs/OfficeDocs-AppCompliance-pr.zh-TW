...
* <a href="https://teams.microsoft.com/l/app/10fcc57c-8d49-4f94-a516-a75de60bc969" target="_blank">在 Teams 儲存區中查看</a>
...
Jexet 技術 LLC 給 Microsoft 所提供的資訊：
...
| 合作夥伴公司名稱 | Jexet 技術 LLC |
| 公司的網站 | [https://mspbots.ai](https://mspbots.ai) |
| App 的使用條款 | [https://mspbots.ai/termsofuse/](https://mspbots.ai/termsofuse/) |
| 應用程式的核心功能 | 商務智慧平臺、IT 管理服務提供者商務用可自訂的 bot 的重複工作。 |
...
此資訊是由 Jexet 技術 LLC 所提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://mspbots.ai/home/data-security/ |

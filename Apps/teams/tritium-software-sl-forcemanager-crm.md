...
| App 的使用條款 | [https://www.forcemanager.com/info/terms-and-conditions/](https://www.forcemanager.com/info/terms-and-conditions/) |
| 應用程式的核心功能 | ForceManager 是最主要的 CRM，具有針對工作樣式（包括首頁、office 或欄位）建立的完整服務 web 和行動應用程式。 此應用程式的目標是銷售代表，其必須使用方便使用介面來管理其每日議程和活動，並且便於使用應用程式。 |

---
title: ForceManager CRM by Tritium Software SL 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: 所有適用于 ForceManager CRM 的可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/f429eb71-607a-4e12-9467-209276404047" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002655" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Tritium Software SL 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.forcemanager.com](https://www.forcemanager.com) |
| 應用程式的使用規定 | [https://www.forcemanager.com/info/terms-and-conditions/](https://www.forcemanager.com/info/terms-and-conditions/) |
| 應用程式的核心功能 | ForceManager 是前置 CRM，具有針對一系列工作樣式所建立的完整服務 Web 和行動應用程式，包括住家、辦公室或欄位。 應用程式的目標在於銷售代表，其需要使用使用者易記介面來管理其日常議程和活動，且便於使用應用程式。 |
| 公司總部位置 | 西班牙 |
| 應用程式資訊頁面 | |
...
Tritium Software SL 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

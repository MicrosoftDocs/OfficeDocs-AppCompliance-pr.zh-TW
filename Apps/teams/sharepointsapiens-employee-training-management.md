---
title: 依SharePoint|進行員工訓練管理的應用程式資訊Sapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: 此頁面上的資訊是以應用程式開發人員針對安全性、合規性和資料處理做法所提供的自我評估報告為基礎，後面接著此應用程式。
...
* <a href="https://teams.microsoft.com/l/app/17b6b751-7463-4afd-a3ae-ad26a20c8904" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001512" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的核心功能 | 員工訓練管理增益集可讓每個人輕鬆地組織及管理員工持續的專業開發。 從設定和排程訓練事件、管理學習者及其指派和註冊，到追蹤成就和意見反應，一切都涵蓋在內。 增益集可協助您履行合規性法規和安全性原則。 它可讓您指派必要的訓練、追蹤成就、管理到期日等等。 |
| 公司總部位置 | 奧地利 |

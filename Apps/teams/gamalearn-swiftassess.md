---
title: SwiftAssess 的應用程式資訊（按 GamaLearn）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: SwiftAssess 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/0cd07157-f297-4c2c-a23b-64577bceea6c" target="_blank">在 Teams 儲存區中查看</a>
...
| App 的使用條款 | [https://swiftassess.com/terms-and-conditions](https://swiftassess.com/terms-and-conditions) |
| 應用程式的核心功能 | 用於所有評估需求的一站式車間; 從已嘗試的方法和真正的方法和功能開始，其指導您在組織中的所有層級，都能透過您的編寫，提供及追蹤評估轉換策略。 SwiftAssess 提供了多個重要的解決方案、功能和工作流程，可簡化並自動化不同機構中的實際評估流程。 這涵蓋安全性、協助工具、分析、專案銀行等方面的行業標準。 |
...
此資訊是由 GamaLearn 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

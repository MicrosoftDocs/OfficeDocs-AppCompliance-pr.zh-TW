---
title: GamaLearn 的 SwiftAssess 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: SwiftAssess 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/0cd07157-f297-4c2c-a23b-64577bceea6c" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001973" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

GamaLearn 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | GamaLearn |
| 公司的網站 | [https://gamalearn.com](https://gamalearn.com) |
| 應用程式的使用規定 | [https://swiftassess.com/terms-and-conditions](https://swiftassess.com/terms-and-conditions) |
| 應用程式的核心功能 | 一站式尋找所有評定需求，範圍包括嘗試和真實的方法和功能，可引導您在組織中的所有層級撰寫、傳遞及追蹤評定轉換策略。 SwiftAssess 提供多個重要的解決方案、功能和工作流程，可簡化和自動化不同機構中的實際評定程式。 這涵蓋安全性、協助工具、分析、專案銀行等產業標準 |
| 公司總部位置 | 阿拉伯聯合大公國 ()  |
| 應用程式資訊頁面 | [https://swiftassess.com/about/partners/microsoft#Teams](https://swiftassess.com/about/partners/microsoft#Teams) |
...
GamaLearn 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: SightCall 的應用程式資訊（按 SightCall）
ms.author: elmalova
author: elenamalova
ms.date: 02/17/2022
ms.topic: article
...
description: SightCall 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
<p>上次於開發人員的更新：2022年2月17日</p>

* <a href="https://teams.microsoft.com/l/app/c5312ffd-d146-4515-89e0-b43fa5282368" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | SightCall |
| 公司的網站 | [https://sightcall.com](https://sightcall.com) |
| App 的使用條款 | [https://sightcall.com/terms-conditions](https://sightcall.com/terms-conditions) |
| 應用程式的核心功能 | SightCall 是企業級的影片雲端平臺 |
...
此資訊是由 SightCall 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 最近的 SOC2 認證日期 |  2021-06-25 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最近的 SOC3 認證日期 |  2021-06-25 |
...
| 隱私權原則 URL | https://sightcall.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 電子郵件 | 委託 | 登入的必要條件 | [c5312ffd-d146-4515-89e0-b43fa5282368](https://docs.microsoft.com/microsoft-365-app-certification/azure/c5312ffd-d146-4515-89e0-b43fa5282368) |
>| 設定檔 | 委託 | 登入的必要條件 | [c5312ffd-d146-4515-89e0-b43fa5282368](https://docs.microsoft.com/microsoft-365-app-certification/azure/c5312ffd-d146-4515-89e0-b43fa5282368) |

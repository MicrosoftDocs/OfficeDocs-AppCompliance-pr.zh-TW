---
title: FireWatch by Infographics UK Ltd 的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: FireWatch 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64879320"
---
# <a name="firewatch"></a>FireWatch

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 7 月 29 日</p>

* <a href="https://teams.microsoft.com/l/app/822055b4-508e-49c8-b7cc-c891ccb5c4eb" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003303" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Infographics UK Ltd. 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.infographics.co.uk](https://www.infographics.co.uk) |
| 應用程式的使用規定 | [https://www.infographics.co.uk/terms-and-conditions/](https://www.infographics.co.uk/terms-and-conditions/) |
| 應用程式的核心功能 | FireWatch 連線可讓火災和救援服務將 FireWatch 應用程式與Microsoft Teams整合，讓使用者可以直接從Microsoft Teams內完成工作。 它目前透過Microsoft Teams Bot 提供使用者支援和協助，以直接在Microsoft Teams使用者環境中預約開啟/關閉工作。 未來的版本將包含透過 Bot 和卡片進一步動作的支援，包括 FireWatch 假日要求、工作提醒等。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.firewatch.co.uk](https://www.firewatch.co.uk) |
...
Infographics UK Ltd 提供這項資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對應用程式所收集資料的控制。

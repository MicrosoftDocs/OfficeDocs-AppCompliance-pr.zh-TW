...
* <a href="https://teams.microsoft.com/l/app/822055b4-508e-49c8-b7cc-c891ccb5c4eb" target="_blank">在 Teams 儲存區中查看</a>
...
Infographics UK 有限公司提供給 Microsoft 的資訊：
...
| App 的使用條款 | [https://www.infographics.co.uk/terms-and-conditions/](https://www.infographics.co.uk/terms-and-conditions/) |
| 應用程式的核心功能 | FireWatch 連線可讓消防和挽救服務將 FireWatch 應用程式與 Microsoft Teams 整合，讓使用者可以直接在 Microsoft Teams 中完成工作。 它目前是透過 Microsoft Teams Bot 提供使用者支援及協助，以直接在 Microsoft Teams 使用者環境中預訂或關閉崗位。 未來版本將包含透過 Bot 和卡片進行進一步動作的支援，包括 FireWatch 假日要求、工作提醒等等。 |
...
此資訊是由 Infographics UK 公司所提供。關於此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

---
title: Tilly Group Limited 之 tiLly 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: 所有可用的安全性與合規性資訊，包括 tiLly、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66113005"
---
# <a name="tilly"></a>蒂莉

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 12 月 6 日</p>

* <a href="https://teams.microsoft.com/l/app/9f9d64e3-e479-4b7b-9c5e-c4e049a732aa" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003825" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Tilly Group 受限於 Microsoft 所提供的資訊：
...
| 合作夥伴公司名稱 | Tilly Group Limited |
| 公司的網站 | [https://tillygroup.co.uk](https://tillygroup.co.uk) |
| 應用程式的使用規定 | [https://www.tillygroup.co.uk/wp-content/uploads/2021/11/Til...](https://www.tillygroup.co.uk/wp-content/uploads/2021/11/Tilly-Group-Limited-tiLly-Terms-of-Use.pdf) |
| 應用程式的核心功能 | 使用您自己的Microsoft Teams BOT 來吸引、強化及支援您的學習者提升技能！ |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.tillygroup.co.uk/wp-content/uploads/2021/11/BOT...](https://www.tillygroup.co.uk/wp-content/uploads/2021/11/BOT-Infographic-1.pdf) |
...
Tilly Group Limited 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 租使用者識別碼、商務名稱、連絡人詳細資料。 針對使用者、使用者名稱、匿名使用者識別碼、所提供的問題和答案，包括任何影像和附件 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 租使用者識別碼、商務名稱、連絡人詳細資料。 針對使用者、使用者名稱、匿名使用者識別碼、所提供的問題和答案，包括任何影像和附件 |
...
| 隱私權原則 URL | https://www.tillygroup.co.uk/wp-content/uploads/2021/11/Tilly-Group-Limited-tiLly-Privacy-Statement.pdf |
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | 應用程式會與 Azure AD 同盟，因此可以使用所有條件式存取原則 |

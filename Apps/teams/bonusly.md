---
title: Bonusly by Bonusly 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Bonusly 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65455018"
---
# <a name="bonusly"></a>額外獎勵

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/c06753b3-85de-4054-9a99-dcd869dc0836" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381622" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Bonusly 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 額外獎勵 |
| 公司的網站 | [https://bonus.ly](https://bonus.ly) |
| 應用程式的使用規定 | [https://bonus.ly/terms_of_service](https://bonus.ly/terms_of_service) |
| 應用程式的核心功能 | 藉由整合 Bonusly 與 Microsoft Teams，來頻繁且即時地進行 Spark 辨識 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://bonus.ly/integrations/teams](https://bonus.ly/integrations/teams) |
...
Bonusly 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 電子郵件地址、名字、姓氏、Birthdate (如果功能使用) ，則為雇用日期 (如果功能使用)  |
...
| 隱私權原則 URL | https://bonus.ly/privacy_policy |

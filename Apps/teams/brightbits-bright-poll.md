---
title: Bright Poll by BrightBits 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
description: Bright Poll 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64879810"
---
# <a name="bright-poll"></a>亮色投票

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 11 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/3a3156c1-b214-4d42-bc25-6d36f6aabb5e" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002562" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

BrightBits 提供給 Microsoft 的資訊：
...
| 應用程式的使用規定 | [https://brightbits.app/terms/](https://brightbits.app/terms/) |
| 應用程式的核心功能 | 透過聊天內投票收集小組成員的意見反應。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://brightbits.app/bright-poll/](https://brightbits.app/bright-poll/) |
...
這項資訊是由 BrightBits 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: Jira Integration Plus by Nextup， LLC 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: Jira Integration Plus 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2021 年 12 月 2 日</p>

* <a href="https://teams.microsoft.com/l/app/a3394b99-8ae6-48cb-bb45-898fd4c49f93" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003847" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Nextup、LLC 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Jira Integration Plus |
| ID | WA200003847 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Nextup, LLC |
| 公司的網站 | [https://www.nextup.ai](https://www.nextup.ai) |
| 應用程式的使用規定 | [https://www.nextup.ai/terms](https://www.nextup.ai/terms) |
| 應用程式的核心功能 | 尋找現有的 Jira 問題以編輯或討論Teams，或建立新問題。 在訊息中傳送問題。 對問題加上批註，或參閱詳細資料。 變更狀態、指派狀態等等。 透過命令列介面 (CLI) 使用 Jira。 批註、記錄工作等等。 取得通道上的問題通知， (連接器) 。 從具有傳訊擴充功能的訊息建立新問題。 在索引標籤)  (使用面板來管理問題。 按一下Teams中任何訊息下方的圖示來搜尋問題。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.nextup.ai/microsoft-teams/jira-integration-plus/](https://www.nextup.ai/microsoft-teams/jira-integration-plus/) |
...
Nextup、LLC 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 唯一識別碼和電子郵件地址 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 唯一識別碼和電子郵件地址 |
...
| 已針對下列專案啟用多重要素驗證 (MFA) ： | Credential、DNSManagement |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | 兩者 | 我們使用此 API 來確認使用者有權存取我們的應用程式 | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| AccessReview.ReadWrite.All | 兩者 | 我們使用此 API 來確認使用者有權存取我們的應用程式 | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Directory.Read.All | 兩者 | 我們使用此 API 來確保使用者有許可權在Teams應用程式和小組和頻道中使用 Bot | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Directory.Read.All | 兩者 | 我們使用此 API 來確保使用者有許可權在Teams應用程式和小組和頻道中使用 Bot | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Files.ReadWrite.All | 兩者 | 我們使用此 API 來接受使用者的檔案，他們可以將這些檔案附加至 Jira 問題 | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Files.ReadWrite.All | 兩者 | 我們使用此 API 來接受使用者的檔案，他們可以將這些檔案附加至 Jira 問題 | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Sites.Read.All | 兩者 | 我們使用此 API 來查看使用者可存取哪些網站，讓他們可以在適當的位置建立票證 | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Sites.Read.All | 兩者 | 我們使用此 API 來查看使用者可存取哪些網站，讓他們可以在適當的位置建立票證 | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| User.ReadWrite.All | 兩者 | 我們使用此 API 來允許系統管理員使用者為其組織提供許可權，以搭配 Jira 使用我們的應用程式。 | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| User.ReadWrite.All | 兩者 | 我們使用此 API 來允許系統管理員使用者為其組織提供許可權，以搭配 Jira 使用我們的應用程式。 | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |

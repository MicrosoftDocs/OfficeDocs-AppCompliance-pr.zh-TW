---
title: Flipick Pvt Ltd 的 LTI 用戶端應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: LTI 用戶端的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/bfed1af2-2c16-4536-9780-8e21d7fc7d79" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003313" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Flipick Pvt Ltd 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://flipick.com](https://flipick.com) |
| 應用程式的使用規定 | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| 應用程式的核心功能 | 應用程式提供具有 LTI (Learning Tools 互通性) 伺服器的單一登入 (SSO) ，以啟動課程 () 。 它是 LTI 工具取用者，支援基本 LTI (BLTI) 。 |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | |
...
Flipick Pvt Ltd 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

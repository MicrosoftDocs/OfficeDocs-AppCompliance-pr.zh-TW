---
title: LTI 用戶端的應用程式資訊，Flipick Pvt 有限公司
ms.author: elmalova
author: elenamalova
ms.date: 10/05/2021
ms.topic: article
...
* <a href="https://teams.microsoft.com/l/app/bfed1af2-2c16-4536-9780-8e21d7fc7d79" target="_blank">在 Teams 儲存區中查看</a>
...
由 Flipick Pvt 有限公司提供給 Microsoft 的資訊：
...
| App 的使用條款 | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| 應用程式的核心功能 | 應用程式會提供單一登入 (SSO) 與 LTI (Learning 工具互通性) 伺服器以啟動課程 () 。 它是 LTI 工具消費者，支援基本 LTI (BLTI) 。 |
...
此資訊是由 Flipick Pvt 組織提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

---
title: CyCX Contact Center by CyTrack 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: CyCX 連絡人中心的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66655998"
---
# <a name="cycx--contact-centre"></a>CyCX 連絡人中心

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 27 日</p>

* <a href="https://teams.microsoft.com/l/app/4d7b80a9-d64d-4b54-a1db-259cc204b15d" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004350" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

CyTrack 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | CyTrack |
| 公司的網站 | [https://web.cytrack.com](https://web.cytrack.com) |
| 應用程式的使用規定 | [https://web.cytrack.com/subscription-service-software-agree...](https://web.cytrack.com/subscription-service-software-agreement/) |
| 應用程式的核心功能 | CyCX 的目標是需要提升客戶語音通話體驗的商務使用者，以及會議、聊天和共同作業以外的連絡人中心功能。  CyCX 是 Microsoft Teams 的通訊和共同作業平臺。  CyTrack CyCX 可在 Microsoft Teams 中透過他們選擇的通道與您的客戶開會，為您的代理程式提供單一、統一的介面，並提供客戶的整體檢視，以啟用更深入的互動。 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | [https://web.cytrack.com/microsoft-teams/contact-centre-for-...](https://web.cytrack.com/microsoft-teams/contact-centre-for-microsoft-teams/) |
...
CyTrack 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | Teams 通話資料 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | Teams 通話資料 |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 澳洲、紐西蘭、英國、英國和北愛爾蘭 ()  |
| 您是否有已建立的資料租用和處置程式？ | 是 |
...
| 隱私權原則 URL | https://web.cytrack.com/privacy-policy-teams/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppRoleAssignment.ReadWrite.All | 委託 | 我們需要此專案來建立 servicePrincipal，以在客戶租使用者的 Azure AD 應用程式中授與 API 許可權 | [acafd8f7-a6d3-420e-89d7-7729751b7c04](../azure/acafd8f7-a6d3-420e-89d7-7729751b7c04.md) |
>| Application.ReadWrite.All | 委託 | 我們需要此許可權，才能在我們用來訂閱變更通知服務的客戶租使用者中建立 Azure AD 應用程式，以取得與 Teams 通話相關的中繼資料。 | [acafd8f7-a6d3-420e-89d7-7729751b7c04](../azure/acafd8f7-a6d3-420e-89d7-7729751b7c04.md) |

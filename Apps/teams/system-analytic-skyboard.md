---
title: System Analytic for SkyBoard 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: 所有可用的安全性與合規性資訊，適用于 SkyBoard、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/9322b063-9069-45fc-aaad-e3a0f9a2462a" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004162" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

系統分析提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 系統分析 |
| 公司的網站 | [https://www.systemanalytic.com](https://www.systemanalytic.com) |
| 應用程式的使用規定 | [https://www.systemanalytic.com/eula.html](https://www.systemanalytic.com/eula.html) |
| 應用程式的核心功能 | 完整的數位諮詢委員會。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | |
...
系統分析已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://vmlyr-digitalsolutions.com/privacy.html |

---
title: SysAid by SysAid 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: SysAid 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64880510"
---
# <a name="sysaid"></a>SysAid

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 1 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/932c8be4-fac6-4df3-9e15-bc542f4ef88e" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003221" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

SysAid 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | SysAid |
| 公司的網站 | [https://www.sysaid.com](https://www.sysaid.com) |
| 應用程式的使用規定 | [https://www.sysaid.com/wp-content/uploads/service-agreement...](https://www.sysaid.com/wp-content/uploads/service-agreement-cloud.pdf) |
| 應用程式的核心功能 | 使用 Bot 在 Microsoft Teams 中建立 SysAid 票證 |
| 公司總部位置 | 以色列 |
| 應用程式資訊頁面 | |
...
SysAid 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

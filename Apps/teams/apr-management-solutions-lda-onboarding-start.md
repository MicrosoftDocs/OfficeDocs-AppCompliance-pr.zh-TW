---
title: 從 APR 開始上線的應用程式資訊 - 管理解決方案 Lda。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: 所有可用的安全性與合規性資訊，適用于上線開始、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65454980"
---
# <a name="onboarding-start"></a>上線開始

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 4 月 8 日</p>

* <a href="https://teams.microsoft.com/l/app/35729029-db8c-4cf5-b71f-9dc9511e0563" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004025" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

APR 提供的資訊 - 管理解決方案 Lda。 至 Microsoft：
...
| 合作夥伴公司名稱 | APR - 管理解決方案 Lda。 |
| 公司的網站 | [https://www.apr.pt](https://www.apr.pt) |
| 應用程式的使用規定 | [https://www.apr.pt/terms-and-conditions/](https://www.apr.pt/terms-and-conditions/) |
| 應用程式的核心功能 | 將組織的上執行緒序自動化，並輕鬆地與新進員工溝通。 |
| 公司總部位置 | 葡萄牙 |
| 應用程式資訊頁面 | |
...
此資訊已由 APR - 管理解決方案 Lda 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.apr.pt/privacy-statement/ |

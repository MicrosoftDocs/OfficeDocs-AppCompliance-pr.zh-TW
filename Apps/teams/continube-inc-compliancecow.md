---
title: ContiNube Inc 的 ComplianceCow 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: ComplianceCow 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66249720"
---
# <a name="compliancecow"></a>ComplianceCow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 12 日</p>

* <a href="https://teams.microsoft.com/l/app/be1720d1-f7ae-4f6e-ab02-e6911a51bc92" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004247" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

ContiNube Inc 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | ComplianceCow |
| ID | WA200004247 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | ContiNube Inc |
| 公司的網站 | [https://compliancecow.com](https://compliancecow.com) |
| 應用程式的使用規定 | [https://compliancecow.com/trust/termsandconditions](https://compliancecow.com/trust/termsandconditions) |
| 應用程式的核心功能 | 安全性 GRC 和保證的最低限度工作流程 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://compliancecow.com/docs#compliancecow-chat-applicati...](https://compliancecow.com/docs#compliancecow-chat-applications) |
...
ContiNube Inc 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

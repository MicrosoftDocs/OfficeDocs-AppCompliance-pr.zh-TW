---
title: CoNtextere AVA by CoNtextere 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: CoNtextere AVA 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64877730"
---
# <a name="contextere-ava"></a>CoNtextere AVA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 8 月 13 日</p>

* <a href="https://teams.microsoft.com/l/app/be5caee0-f2bc-11ea-b597-ef970e2f5141" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003167" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

CoNtextere 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | CoNtextere |
| 公司的網站 | [https://contextere.com](https://contextere.com) |
| 應用程式的使用規定 | [https://contextere.com/wp-primary/wp-content/uploads/Contex...](https://contextere.com/wp-primary/wp-content/uploads/Contextere-End-User-License-Agreement-Microsoft-Challenge.pdf) |
| 應用程式的核心功能 | CoNtextere Advanced 虛擬助理 (AVA) 為產業工作者提供作業上的深入解析。 |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | |
...
CoNtextere 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: Subramanian Ramanathan 為 Sitecore 進行 Proconnect 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
Subramanian Ramanathan 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Proconnect for Sitecore |
| ID | WA200003274 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Subramanian Ramanathan |
| 公司的網站 | [https://subbu.ca](https://subbu.ca) |
| 應用程式的使用規定 | [https://github.com/SubbuRamanathan/sitecore-microsoft-teams...](https://github.com/SubbuRamanathan/sitecore-microsoft-teams-integration/blob/main/terms-of-use.md) |
| 應用程式的核心功能 | 透過工作流程 &amp; 發佈更新的即時警示，增強內容撰寫體驗。 此連接器也包含警示的適當動作，讓內容作者能夠更快速地完成工作。 此連接器會建立通訊的透明度，同時也包含網站/頁面效能的深入解析。 |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | |
...
此資訊已由 Subramanian Ramanathan 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對應用程式所收集資料的控制。

...
由 Subramanian Ramanathan 所提供的資訊給 Microsoft：
...
| App 的使用條款 | [https://github.com/SubbuRamanathan/sitecore-microsoft-teams...](https://github.com/SubbuRamanathan/sitecore-microsoft-teams-integration/blob/main/terms-of-use.md) |
| 應用程式的核心功能 | 使用有關工作流程 &amp; 發佈更新的立即提醒，增強內容製作體驗。 此連接器也包含針對提醒的適當動作，因此可讓內容作者更快速地完成工作。 此連接器會在通訊中建立透明性，也包含網站/頁面效能的洞察力。 |
...
此資訊是由 Subramanian Ramanathan 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

---
title: Trivia Engine 的應用程式資訊 EnableUC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Trivia 引擎的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/3bd813fa-a19a-4c06-b130-450b24b8ee08" target="_blank">在 Teams 儲存區中查看</a>
...
| App 的使用條款 | [https://www.triviaengine.com/termsofuse.html](https://www.triviaengine.com/termsofuse.html) |
| 應用程式的核心功能 | 使用 &#8220;gamification&#8221; 增強現有的訓練並改善知識保留。 |
...
此資訊是由 EnableUC 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

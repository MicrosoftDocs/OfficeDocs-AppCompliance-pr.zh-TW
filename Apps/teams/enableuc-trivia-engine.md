---
title: EnableUC 的 Trivia 引擎應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Trivia Engine 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/3bd813fa-a19a-4c06-b130-450b24b8ee08" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003412" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

EnableUC 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Trivia Engine |
| ID | WA200003412 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | EnableUC |
| 公司的網站 | [https://www.triviaengine.com](https://www.triviaengine.com) |
| 應用程式的使用規定 | [https://www.triviaengine.com/termsofuse.html](https://www.triviaengine.com/termsofuse.html) |
| 應用程式的核心功能 | 使用&#8220;gamification&#8221;來增強現有的訓練並改善知識保留。 |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | [https://www.triviaengine.com](https://www.triviaengine.com) |
...
這項資訊是由 EnableUC 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | N/A - 使用最新版的 MSAL。 |
| 您的應用程式是否支援條件式存取原則？ | 否 |

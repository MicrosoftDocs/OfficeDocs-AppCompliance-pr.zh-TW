---
title: Timewax by Timewax 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2022
...
description: Timewax 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/0d3bddff-8ca4-4f41-ae48-5aad1ef26e0d" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004428" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Timewax 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Timewax |
| 公司的網站 | [https://www.timewax.com](https://www.timewax.com) |
| 應用程式的使用規定 | [https://www.timewax.com/tc/](https://www.timewax.com/tc/) |
| 應用程式的核心功能 | 直接從 Timewax 平臺取得通知到 Teams。 |
| 公司總部位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | [https://www.docs.timewax.com/en/knowledgebase/microsoft-tea...](https://www.docs.timewax.com/en/knowledgebase/microsoft-teams/) |
...
Timewax 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.timewax.com/privacynotice/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委託 | 需要它來擷取使用者的行事曆事件，以判斷是否已由我們的 Outlook 整合同步處理，以便我們可以在索引標籤中顯示它們。 | [c6557591-6b74-430d-b25e-87ab28766f32](../azure/c6557591-6b74-430d-b25e-87ab28766f32.md) |
>| User.Read | 委託 | 需要它來個人化小組整合。 | [c6557591-6b74-430d-b25e-87ab28766f32](../azure/c6557591-6b74-430d-b25e-87ab28766f32.md) |

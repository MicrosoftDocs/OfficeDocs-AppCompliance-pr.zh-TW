...
| 公司的網站 | [https://evocom.de](https://evocom.de) |
...
| 資料庫中儲存的資料為何？ | 使用者識別碼、E-Mail、Name、Profilbild |
...
| 隱私權原則 URL | https://evocom.de/datenschutz |
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | Multi-Factor 驗證-Kundenspezifisch |

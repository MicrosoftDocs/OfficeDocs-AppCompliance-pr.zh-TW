...
| App 的使用條款 | [https://brainbot.ai/terms/](https://brainbot.ai/terms/) |
| 應用程式的核心功能 | BrainBot 會傳送簡短的定期互動，協助您維護訓練課程的知識。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 應用程式 | 我們在驗證程式中使用電子郵件地址 &amp; 完整名稱。 此外，電子郵件地址是用來將學習順序傳送給使用者，而使用者訂閱了一個 | [b256b34a-b377-4fc2-b25a-a8f5f0594e86](https://docs.microsoft.com/microsoft-365-app-certification/azure/b256b34a-b377-4fc2-b25a-a8f5f0594e86) |

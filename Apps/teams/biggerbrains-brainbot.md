---
title: BrainBot by Biggerbrains 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: BrainBot 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2021 年 4 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/3c95872f-ca12-456e-84b9-c717fe93330c" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381981" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的使用規定 | [https://brainbot.ai/terms/](https://brainbot.ai/terms/) |
| 應用程式的核心功能 | BrainBot 會傳送簡短的定期互動，以協助您保留訓練課程的知識。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://brainbot.ai](https://brainbot.ai) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 應用程式 | 我們會使用電子郵件地址 &amp; 完整名稱作為驗證程式的一部分。 此外，當使用者訂閱一個時，也會使用電子郵件地址將學習順序傳送給使用者 | [b256b34a-b377-4fc2-b25a-a8f5f0594e86](../azure/b256b34a-b377-4fc2-b25a-a8f5f0594e86.md) |

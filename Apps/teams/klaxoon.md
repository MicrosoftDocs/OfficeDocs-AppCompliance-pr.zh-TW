---
title: Klaxoon by Klaxoon 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2022
...
description: Klaxoon 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66548102"
---
# <a name="klaxoon"></a>Klaxoon𶠁

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/6adc8d55-eb37-4537-a66d-743b3cd4511b" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104382058" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Klaxoon 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Klaxoon𶠁 |
| 公司的網站 | [https://klaxoon.com](https://klaxoon.com) |
| 應用程式的使用規定 | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| 應用程式的核心功能 | Klaxoon 提供一套完整的共同作業工具， (白板、問卷、測驗、即時輪詢等) 設計來提升團隊合作效率。 Klaxoon 套件可透過 Web 應用程式、行動應用程式 (Apple/Android) 存取，或直接從 Microsoft Teams (透過 Tab 整合)  |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://klaxoon.com](https://klaxoon.com) |
| 用來執行應用程式的裝載環境或服務模型為何？ | 混合式 |
| 應用程式會使用哪些主控雲端提供者？ | Azure，Aws，其他 |
...
Klaxoon 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | email， firstname， lastname， avatar |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | email， firstname， lastname， avatar |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 美國美國、法國、德國 |
| 您是否有已建立的資料租用和處置程式？ | 是 |
...
| 隱私權原則 URL | https://static.klaxoon.com/website/pdf/privacy-policy.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 使用者識別和帳戶建立 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| 電子郵件 | 委託 | 使用者識別和帳戶建立 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| offline_access | 委託 | 使用者識別和帳戶建立 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| openid | 委託 | 使用者識別和帳戶建立 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| 設定檔 | 委託 | 使用者識別和帳戶建立 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |

...
* <a href="https://teams.microsoft.com/l/app/6adc8d55-eb37-4537-a66d-743b3cd4511b" target="_blank">在Teams存放區中檢視</a>
...
| 應用程式的核心功能 | Klaxoon 提供一套完整的共同作業工具， (白板、問卷、測驗、即時輪詢等) 設計來提升團隊合作效率。 Klaxoon 套件可透過 webapp、行動應用程式 (Apple/Android) 存取，或透過 Tab 整合直接從Microsoft Teams (存取)  |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://klaxoon.com](https://klaxoon.com) |
| 用來執行應用程式的裝載環境或服務模型為何？ |  |
| 應用程式會使用哪些主控雲端提供者？ | AWS、Azure、claranet |

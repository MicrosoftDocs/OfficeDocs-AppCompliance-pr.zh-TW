...
| App 的使用條款 | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| 應用程式的核心功能 | Klaxoon 可讓您存取全套的共同作業工具 (白板、調查、quizz、即時輪詢等 ) ，以提升團隊合作效率。 Klaxoon 套件可作為 nm-client-w15-webapp-long、行動應用程式 (Apple/Android) 或透過 Tab 鍵整合直接從 Microsoft Teams (存取)  |
| 公司 headquarter 位置 | 法國 |
| 應用程式資訊頁面 | [https://klaxoon.com](https://klaxoon.com) |
| 用來執行應用程式的主控環境或服務模型為何？ |  |
| 應用程式會使用哪一個主控雲端提供者？ | AWS，Azure，claranet |

---
title: 由 FinStat s.r.o 提供的 HitHorizons 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/15/2022
...
description: HitHorizons 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64878230"
---
# <a name="hithorizons"></a>HitHorizons

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 2 月 11 日</p>

* <a href="https://teams.microsoft.com/l/app/2b492ea3-0727-4789-90d7-8e2079d46717" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001411" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

FinStat s.r.o 所提供的資訊。 至 Microsoft：
...
| 合作夥伴公司名稱 | FinStat s.r.o. |
| 公司的網站 | [https://www.hithorizons.com](https://www.hithorizons.com) |
| 應用程式的使用規定 | [https://www.hithorizons.com/legal/terms-and-conditions](https://www.hithorizons.com/legal/terms-and-conditions) |
| 應用程式的核心功能 | 從歐洲及超過 7500 萬家以上的公司存取 HitHorizons 資料庫，Microsoft Teams |
| 公司總部位置 | 斯洛伐克 |
| 應用程式資訊頁面 | [https://www.hithorizons.com/services/microsoft/teams](https://www.hithorizons.com/services/microsoft/teams) |
...
此資訊已由 FinStat s.r.o 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

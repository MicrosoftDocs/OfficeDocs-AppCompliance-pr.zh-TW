---
title: SelfDrvn by SelfDrvn 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2021
...
description: SelfDrvn 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64875325"
---
# <a name="selfdrvn"></a>SelfDrvn

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 5 月 1 日</p>

* <a href="https://teams.microsoft.com/l/app/227f2790-98ab-42dc-8d3f-1d76c83c9d04" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001861" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

SelfDrvn 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | SelfDrvn |
| 公司的網站 | [https://selfdrvn.com](https://selfdrvn.com) |
| 應用程式的使用規定 | [https://selfdrvn.com/eula](https://selfdrvn.com/eula) |
| 應用程式的核心功能 | 遠端員工管理和 Talent Engagement |
| 公司總部位置 | 新加坡 |
| 應用程式資訊頁面 | |
...
此資訊由 SelfDrvn 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: OfficeSuite 的應用程式資訊（按 Windstream）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: OfficeSuite 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/bf9c1c49-a529-451e-a81d-ac94cfdbec3e" target="_blank">在 Teams 儲存區中查看</a>
...
由 Windstream 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Windstream |
| 公司的網站 | [https://www.windstreamenterprise.com](https://www.windstreamenterprise.com) |
| App 的使用條款 | [https://www.windstream.com/about/legal/Terms-and-Conditions](https://www.windstream.com/about/legal/Terms-and-Conditions) |
| 應用程式的核心功能 | 通話、會議及來電通知應用程式 |
...
此資訊是由 Windstream 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 最近的 SOC2 認證日期 |  2021-11-03 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最近的 SOC3 認證日期 |  2021-11-04 |
...
| 隱私權原則 URL | https://www.windstream.com/about/legal/privacy-policy |

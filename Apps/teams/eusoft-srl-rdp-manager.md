---
title: Eusoft S.r.l 的 Eusoft Rdp Manager 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Eusoft Rdp Manager 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/cbe80cd5-d89b-45e4-9d24-345b43378b9d" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004321" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Eusoft S.r.l 所提供的資訊。 至 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Eusoft Rdp Manager |
| ID | WA200004321 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Eusoft S.r.l. |
| 公司的網站 | [https://www.eusoft.it](https://www.eusoft.it) |
| 應用程式的使用規定 | [https://www.eusoft.co.uk/privacy-cookies/](https://www.eusoft.co.uk/privacy-cookies/) |
| 應用程式的核心功能 | Eusoft.Lab RDP Manager 是由 Eusoft 開發的應用程式，用於測試報表檢視 |
| 公司總部位置 | 義大利 |
| 應用程式資訊頁面 | |
...
這項資訊已由 Eusoft S.r.l 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.eusoft.co.uk/privacy-cookies |

---
title: Project 真知灼見 Project 洞察力的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/22/2022
...
description: Project 洞察力的所有可用安全性和符合性資訊資訊，其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63753830"
---
# <a name="project-insight"></a>Project 洞察力

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員的更新日期：2022年3月21日</p>

* <a href="https://teams.microsoft.com/l/app/57a8236b-4ed2-453e-b785-02a887e16a5b" target="_blank">在 Teams 儲存區中查看</a>
...
Project 對 Microsoft 的洞察力所提供的資訊：
...
| 合作夥伴公司名稱 | Project 洞察力 |
| 公司的網站 | [https://projectinsight.com](https://projectinsight.com) |
| App 的使用條款 | [https://projectinsight.com/legal/license-agreement](https://projectinsight.com/legal/license-agreement) |
| 應用程式的核心功能 | Project 的洞察力可讓您的小組直接從 Teams 管理其工作、專案、時間和費用。 |
...
此資訊的提供方式 Project 深入瞭解此應用程式如何收集及儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 最近的 SOC1 認證日期 |  2022-01-18 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 您已完成哪一種 SOC 2 憑證？ |  type2 |
| 最近的 SOC2 認證日期 |  2022-01-18 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation ReadWriteForUser 所有 | 委託 | 允許為 Microsoft Teams 承租人中的使用者安裝我們的應用程式 | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| User.Read.All | 委託 | 比對我們系統和 Microsoft Teams 租使用者之間的使用者 | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |

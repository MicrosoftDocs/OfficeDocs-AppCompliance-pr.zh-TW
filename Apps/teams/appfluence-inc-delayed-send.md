---
title: Appfluence Inc 延遲傳送的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: 延遲傳送的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
---
# <a name="delayed-send"></a>延遲傳送

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/ae64c32a-0eab-47d9-91e4-b693a99f7fc3" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004301" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的使用規定 | [https://delayedsend.com/eula](https://delayedsend.com/eula) |
| 應用程式的核心功能 | 排程要在未來傳送至任何私人或群組聊天的訊息。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://delayedsend.com](https://delayedsend.com) |
...
| 您的應用程式會處理哪些資料？ | Teams 中的群組和個人聊天清單，以協助使用者選擇傳送訊息的位置。 |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | next-auth/react |
| 您的應用程式是否支援條件式存取原則？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | 委託 | 顯示正在聊天的使用者，讓他們瞭解訊息的傳送位置 | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| ChatMessage.Send | 委託 | 代表我們的使用者傳送訊息 | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| User.Read | 委託 | 登入使用者並瞭解使用者的名稱 | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| User.ReadBasic.All | 委託 | 請參閱使用者的共同作業者清單，以允許選取其延遲訊息的目的地 | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| offline_access | 委託 | 允許我們的應用程式在訊息傳遞的排程時間作為使用者 | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |

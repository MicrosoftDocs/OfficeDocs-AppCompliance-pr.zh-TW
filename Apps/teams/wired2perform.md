---
title: Wired2Perform by Wired2Perform 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Wired2Perform 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/b08f369e-4927-4c66-b997-e1086df7970d" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002935" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Wired2Perform 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://wired2perform.com](https://wired2perform.com) |
| 應用程式的使用規定 | [https://wired2perform.com/terms-conditions](https://wired2perform.com/terms-conditions) |
| 應用程式的核心功能 | Wired2Perform&#174;是一家以目的為導向的公司，結合了行為科學和進階分析，將人員與最佳的可用機會同步，並協助配音領導者成長、優化和存取更適配的員工。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://wired2perform.com](https://wired2perform.com) |
...
Wired2Perform 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

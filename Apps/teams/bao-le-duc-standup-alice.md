---
title: Standup Alice by 體積 Le Duc 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Standup Alice 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/724b774e-aa53-4d2d-885b-6008c114cb37" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000758" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由 Le Duc 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Bao Le Duc |
| 公司的網站 | [https://www.standupalice.com](https://www.standupalice.com) |
| 應用程式的使用規定 | [https://www.standupalice.com/terms](https://www.standupalice.com/terms) |
| 應用程式的核心功能 | 協助您有效地執行適用于Rume 小組的每日待命會議 |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | [https://www.standupalice.com](https://www.standupalice.com) |

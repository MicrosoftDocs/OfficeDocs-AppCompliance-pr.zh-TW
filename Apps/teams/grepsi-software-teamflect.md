---
title: Grepsi Software 的 Teamflect 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: 所有可用的安全性與合規性資訊，適用于 Teamflect、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/e46015e9-f2ae-4dbc-be6b-f05043192e62" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001860" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Grepsi Software 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://teamflect.com](https://teamflect.com) |
| 應用程式的使用規定 | [https://teamflect.com/terms](https://teamflect.com/terms) |
| 應用程式的核心功能 | Teamflect 是專為Microsoft Teams而建置的一對一效能管理和員工參與解決方案。 它可讓人員更有效率且更深入地參與其 1 對 1 會議、目標/確定、意見反應、辨識和工作模組 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
Grepsi Software 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | BlockAccess、RequireMFA |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 應用程式 | 我們使用此許可權來存取使用者行事曆，以識別一對一會議 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
>| Directory.Read.All | 委託 | 公司目錄 - 我們使用此許可權，在使用者執行搜尋時向使用者顯示其同事清單 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |

...
>|:-----------------------------------------------------|:------------------------------|:----------------------------------------|
>| Mailjet | 組織網域 | 我們會使用協力廠商郵件提供者，將電子郵件通知傳送給我們的使用者。 |
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| 我們的 bot 應用程式會將通知傳送給使用者。 在這些通知中，我們的 bot 會處理並處理資料，但此 bot 也會裝載在 Microsoft Azure 資料中心，而且不會將任何 EUII 資料傳送至協力廠商服務之外。 | 否 |  |
...
>只要使用者資料繼續使用我們的應用程式，我們才會儲存。 在5年或後端使用者要求之後，我們會刪除所有與非作用中使用者相關的資料。

#### <a name="organizational-controls-for-data-stored-by-partner"></a>夥伴所儲存資料的組織控制項

說明組織管理員如何在合作夥伴系統中控制其資訊？例如刪除、保留、審核、封存、使用者原則等等。

>我們使用 Microsoft Azure 來主控我們的應用程式伺服器和資料庫。 我們只會使用協力廠商郵件服務，將電子郵件通知傳送給我們的使用者。 此協力廠商郵件系統會儲存使用者的電子郵件地址，但根據我們的資料保留和隱私權原則來控制。
...
Grepsi 軟體會提供此資訊，此應用程式會如何處理驗證、授權、應用程式註冊最佳作法及其他身分識別準則。

...
description: BGA Notify 的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/33f1ff9f-5910-4036-9927-e09b90c64518" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | 霍尼韋爾 |
| 公司的網站 | [https://bga.honeywellforge.com](https://bga.honeywellforge.com) |
| App 的使用條款 | [https://www.honeywell.com/us/en/terms-and-conditions](https://www.honeywell.com/us/en/terms-and-conditions) |
| 應用程式的核心功能 | 這個 bot 主要是用來根據其來自其飛機的喜好設定和事件 Honeywell 商務航空客戶，以進行主動訊息。 |
| 公司 headquarter 位置 | 美國地區 |
| 應用程式資訊頁面 | [https://bga.honeywellforge.com](https://bga.honeywellforge.com) |
...
此資訊是由 Honeywell 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.honeywell.com/us/en/privacy-statement |

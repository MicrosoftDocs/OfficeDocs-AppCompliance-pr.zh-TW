---
title: Cursum by Cursum A/S 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: 資料指標、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "66817639"
---
# <a name="cursum"></a>資料指標

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 13 日</p>

* <a href="https://teams.microsoft.com/l/app/11db7a4c-d454-41b5-a9be-35a5acdd5c9e" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004407" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

資料指標 A/S 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 資料指標 A/S |
| 公司的網站 | [https://cursum.com](https://cursum.com) |
| 應用程式的使用規定 | [https://go.microsoft.com/fwlink/?linkid=2041178](https://go.microsoft.com/fwlink/?linkid=2041178) |
| 應用程式的核心功能 | 資料指標核心 - 在工作流程中學習 |
| 公司總部位置 | 丹麥 |
| 應用程式資訊頁面 | |
...
資料指標 A/S 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | 兩者皆是 | 讀取使用者資訊 | [962ef41c-0088-4cf2-b8ac-df68a8111022](../azure/962ef41c-0088-4cf2-b8ac-df68a8111022.md) |

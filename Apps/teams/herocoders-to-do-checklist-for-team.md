...
description: 所有可用的安全性與合規性資訊，適用于小組的「執行檢查清單」、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66655969"
---
# <a name="to-do-checklist-for-team"></a>小組的 To-do 檢查清單

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/b08b0225-1f4b-4e82-879e-d4ef15b5bbda" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004362" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

HeroCoders 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 小組的 To-do 檢查清單 |
| ID | WA200004362 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | HeroCoders |
| 公司的網站 | [https://herocoders.com](https://herocoders.com) |
| 應用程式的使用規定 | [https://herocoders.com/legal/checklist-for-team#EULA](https://herocoders.com/legal/checklist-for-team#EULA) |
| 應用程式的核心功能 | 每個規模小組的進階檢查清單。 |
| 公司總部位置 | 波蘭 |
| 應用程式資訊頁面 | [https://herocoders.com](https://herocoders.com) |
...
此資訊由 HeroCoders 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | Azure AD 識別碼 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | Azure AD 識別碼 |
...
| 隱私權原則 URL | https://herocoders.com/legal/checklist-for-team#Privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 電子郵件 | 委託 | 若要使用單一Sign-On (SSO)  | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| offline_access | 委託 | 能夠在使用者未登入時，向其他使用者顯示檢查清單專案的相關資訊。 | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| openid | 委託 | 使用其 Azure Ad 帳戶登入使用者 | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| 設定檔 | 委託 | 在檢查清單的歷程記錄中顯示使用者的名稱。 | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |

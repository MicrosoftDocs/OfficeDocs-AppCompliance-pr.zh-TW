...
| App 的使用條款 | [https://www.beekast.com/terms/](https://www.beekast.com/terms/) |
| 應用程式的核心功能 | Beekast 是一種共同作業平臺，可加速您的會議。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 電子郵件、名字和姓氏：這些資料是用來在 beekast 應用程式內進行共同作業。 | [4d0997dc-df53-4b18-9df1-bb283f8a0377](https://docs.microsoft.com/microsoft-365-app-certification/azure/4d0997dc-df53-4b18-9df1-bb283f8a0377) |

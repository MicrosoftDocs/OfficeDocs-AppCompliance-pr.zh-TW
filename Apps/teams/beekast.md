---
title: Beekast by Beekast 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Beekast 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64881390"
---
# <a name="beekast"></a>Beekast

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 4 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/377da6a7-efc3-4599-887a-1d3eda45120a" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001447" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Beekast 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Beekast |
| 公司的網站 | [https://www.beekast.com](https://www.beekast.com) |
| 應用程式的使用規定 | [https://www.beekast.com/terms/](https://www.beekast.com/terms/) |
| 應用程式的核心功能 | Beekast 是加速會議的共同作業平臺。 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://www.beekast.com](https://www.beekast.com) |
...
Beekast 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 電子郵件、名字和姓氏：這些資料可用來在 beekast 應用程式內共同作業。 | [4d0997dc-df53-4b18-9df1-bb283f8a0377](../azure/4d0997dc-df53-4b18-9df1-bb283f8a0377.md) |

---
title: Spektra Systems LLC 的 CloudLabs 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/18/2021
...
description: CloudLabs 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64879170"
---
# <a name="cloudlabs"></a>CloudLabs

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 10 月 14 日</p>

* <a href="https://teams.microsoft.com/l/app/ec483835-4185-4229-a976-32a20138ff9d" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003273" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Spektra Systems LLC 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Spektra Systems LLC |
| 公司的網站 | [https://cloudlabs.ai](https://cloudlabs.ai) |
| 應用程式的使用規定 | [https://cloudlabs.ai/terms-of-use/](https://cloudlabs.ai/terms-of-use/) |
| 應用程式的核心功能 | 練習 CloudLabs 練習測試以準備 Microsoft 雲端基本概念認證 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://cloudlabs.ai/cloudlabs-teams-app](https://cloudlabs.ai/cloudlabs-teams-app) |
...
Spektra Systems LLC 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | Cloud Apps 的所有 CA 原則 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 名稱、電子郵件 - 能夠提供個人化體驗和支援 | [539ffd4e-15ba-4d18-b136-0d73b67d05f0](../azure/539ffd4e-15ba-4d18-b136-0d73b67d05f0.md) |

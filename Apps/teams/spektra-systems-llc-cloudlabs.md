---
title: CloudLabs by Spektra 系統的應用程式資訊 LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/18/2021
...
description: CloudLabs 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63546341"
---
# <a name="cloudlabs"></a>CloudLabs

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員的更新日期：2021年10月14日</p>

* <a href="https://teams.microsoft.com/l/app/ec483835-4185-4229-a976-32a20138ff9d" target="_blank">在 Teams 儲存區中查看</a>
...
由 Spektra 系統所提供的資訊 LLC 至 Microsoft：
...
| App 的使用條款 | [https://cloudlabs.ai/terms-of-use/](https://cloudlabs.ai/terms-of-use/) |
| 應用程式的核心功能 | 使用 CloudLabs 練習測試來準備 Microsoft cloud 基礎認證 |
...
Spektra 系統會提供此資訊，LLC 關於此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 名稱，電子郵件，能夠提供個人化的經驗和支援 | [539ffd4e-15ba-4d18-b136-0d73b67d05f0](../azure/539ffd4e-15ba-4d18-b136-0d73b67d05f0.md) |

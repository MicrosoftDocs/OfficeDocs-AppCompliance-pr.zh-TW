---
title: Ichicraft 的相片檔案伺服器的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: 所有可用的安全性和符合性資訊，如相片檔案管理員、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "64463742"
---
# <a name="photo-filer"></a>相片檔案伺服器

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員的更新：2022年2月25日</p>

* <a href="https://teams.microsoft.com/l/app/28fdbeb3-f306-4d78-a1d8-2c1bef32e6ea" target="_blank">在 Teams 儲存區中查看</a>
...
| App 的使用條款 | [https://photofiler.ichicraft.com/terms/](https://photofiler.ichicraft.com/terms/) |
| 應用程式的核心功能 | 在 Microsoft Teams 中共用及封存相片的最簡單方式。 |
...
此資訊是由 Ichicraft 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage 傳送 | 委託 | 建立聊天訊息，其具有使用者上傳的少量照片摘要。 | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| Files.ReadWrite.All | 委託 | 讀取資料夾結構並上傳 SharePoint 文件庫中的檔案。 | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| User.Read | 委託 | 從使用者設定檔讀取。 | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |

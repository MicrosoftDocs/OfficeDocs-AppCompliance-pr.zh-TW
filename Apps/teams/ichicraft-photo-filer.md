...
description: 相片檔案管理器的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64879720"
---
# <a name="photo-filer"></a>相片檔案處理工具

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 2 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/28fdbeb3-f306-4d78-a1d8-2c1bef32e6ea" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003881" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Craftcraft 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Ichicraft |
| 公司的網站 | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
| 應用程式的使用規定 | [https://photofiler.ichicraft.com/terms/](https://photofiler.ichicraft.com/terms/) |
| 應用程式的核心功能 | 在Microsoft Teams中共用及封存相片的最簡單方式。 |
| 公司總部位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
...
此資訊由 並排說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 委託 | 建立聊天訊息，其中包含使用者已上傳的小型相片摘要。 | [e54fe734-manual8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| Files.ReadWrite.All | 委託 | 讀取SharePoint文件庫中的資料夾結構和上傳檔案。 | [e54fe734-manual8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| User.Read | 委託 | 從使用者設定檔讀取。 | [e54fe734-manual8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |

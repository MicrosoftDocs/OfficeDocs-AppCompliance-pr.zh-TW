---
title: FireHydrant by FireHydrant 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: FireHydrant 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c18f3920-4098-4907-bc92-43c8559b5e18" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003794" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

FireHydrant 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | FireHydrant |
| 公司的網站 | [https://firehydrant.io](https://firehydrant.io) |
| 應用程式的使用規定 | [https://app.firehydrant.io/legal/ssa](https://app.firehydrant.io/legal/ssa) |
| 應用程式的核心功能 | 使用 FireHydrant.io 來管理您的事件。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
FireHydrant 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者身分識別 (名稱、電子郵件) 、來自小組頻道的事件資料 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 小組識別碼、租使用者識別碼、訊息、使用者名稱 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | 委託 | FireHydrant 會代表我們的使用者建立通道來管理事件 | [00485db5-81b3-4299-833a-8d6c366d0ac0](../azure/00485db5-81b3-4299-833a-8d6c366d0ac0.md) |

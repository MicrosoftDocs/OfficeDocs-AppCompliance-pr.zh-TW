---
title: FireHydrant 的應用程式資訊（按 FireHydrant）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: FireHydrant 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63553420"
---
# <a name="firehydrant"></a>FireHydrant

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員更新：2022年2月10日</p>

* <a href="https://teams.microsoft.com/l/app/c18f3920-4098-4907-bc92-43c8559b5e18" target="_blank">在 Teams 儲存區中查看</a>
...
由 FireHydrant 提供給 Microsoft 的資訊：
...
| App 的使用條款 | [https://app.firehydrant.io/legal/ssa](https://app.firehydrant.io/legal/ssa) |
| 應用程式的核心功能 | 使用 FireHydrant.io 管理您的事件。 |
...
此資訊是由 FireHydrant 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 小組識別碼、租使用者識別碼、郵件、username |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 通道。建立 | 委託 | FireHydrant 代表我們的使用者建立通道以管理事件 | [00485db5-81b3-4299-833a-8d6c366d0ac0](../azure/00485db5-81b3-4299-833a-8d6c366d0ac0.md) |

---
title: UKG Pro的應用程式資訊，由 UKG， Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/12/2021
...
description: 所有可用的安全性與合規性資訊，適用于 UKG Pro、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/f2120944-5201-4c71-8314-770f7806fff0" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003173" target="_blank">在 AppSource 中檢視</a>
...
| 合作夥伴公司名稱 | UKG, Inc. |
| 公司的網站 | [https://ukg.com](https://ukg.com) |
| 應用程式的使用規定 | [https://ukg.com](https://ukg.com) |
| 應用程式的核心功能 | 輕鬆存取員工資訊、檢視薪資詳細資料，以及視需要完成其他 HR 動作。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://ukg.com](https://ukg.com) |
...
這項資訊是由 UKG， Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

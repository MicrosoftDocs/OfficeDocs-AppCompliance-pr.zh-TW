---
title: Solutions2Share GmbH 的外部使用者管理員應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: 外部使用者管理員的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
---
# <a name="external-user-manager"></a>外部使用者管理員

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員更新：2022年3月24日</p>

* <a href="https://teams.microsoft.com/l/app/e41aa305-2f95-4a15-a2b7-026338541850" target="_blank">在 Teams 儲存區中查看</a>
...
| 公司的網站 | [https://www.solutions2share.com](https://www.solutions2share.com) |
| App 的使用條款 | [https://www.solutions2share.com/en/terms-and-conditions/](https://www.solutions2share.com/en/terms-and-conditions/) |
| 應用程式的核心功能 | 管理 Microsoft Teams 中的外部使用者 |
| 公司 headquarter 位置 | 德國 |
| 應用程式資訊頁面 | [https://www.solutions2share.com/external-user-manager](https://www.solutions2share.com/external-user-manager) |
...
| 資料庫中儲存的資料為何？ | TenantID，使用者主要名稱，外部使用者 E-Mail |
...
| 隱私權原則 URL | https://www.solutions2share.com/privacy-policy/ |

---
title: Lundano 所Org@Work的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: 所有可用的安全性與合規性資訊，適用于Org@Work、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/b9f5d3b0-424e-473d-bcbe-dd01f17f9a41" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002461" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Lundano 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Lundano |
| 公司的網站 | [https://www.lundano.com/en/](https://www.lundano.com/en/) |
| 應用程式的使用規定 | [https://cp.lundano.com/Terms_en.html](https://cp.lundano.com/Terms_en.html) |
| 應用程式的核心功能 | 使用共同作業規劃來管理您的工作組織和辦公室佔用率 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://www.lundano.com/orgatwork/index.html#](https://www.lundano.com/orgatwork/index.html#) |
...
Lundano 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 我們正在儲存資料。 我們只使用資料將使用者登入Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| 電子郵件 | 委託 | 我們正在儲存資料。 我們只使用資料將使用者登入Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| offline_access | 委託 | 我們正在儲存資料。 我們只使用資料將使用者登入Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| openid | 委託 | 我們正在儲存資料。 我們只使用資料將使用者登入Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| 設定檔 | 委託 | 我們正在儲存資料。 我們只使用資料將使用者登入Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |

---
title: GmbH 內由Cornelsen eCademy &amp; 提供的 eCademy Lernplattform 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: eCademy Lernplattform 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/8b1066b0-59c2-4a7b-8ac6-f43edcfe5eef" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002717" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由 GmbH 內的Cornelsen eCademy &amp; 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.ecademy-learning.com](https://www.ecademy-learning.com) |
| 應用程式的使用規定 | [https://www.ecademy-learning.com/agb/](https://www.ecademy-learning.com/agb/) |
| 應用程式的核心功能 | 對於想要啟用創新教學和學習的訓練人員和受訓者，eCademy Lernplattform 是數位學習解決方案，可隨時隨地開啟個別且實用的學習路徑。 我們協助公司和教育機構針對未來的人力市場成功訓練及開發技術熟練的工作者和員工，並讓他們能夠在需求增加和異質性日益增加的人才集區時表現更好。 |
| 公司總部位置 | 德國 |
...
這項資訊是由 GmbH 內的Cornelsen eCademy &amp; 所提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

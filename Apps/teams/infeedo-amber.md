...
description: 所有可用的安全性和符合性資訊資訊，如琥珀色光，其資料處理原則，它的 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/a4d418db-2e4a-4fe7-978c-5f28e85d6307" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | inFeedo |
| 公司的網站 | [https://infeedo.com](https://infeedo.com) |
| App 的使用條款 | [https://infeedo.com/terms-and-conditions](https://infeedo.com/terms-and-conditions) |
| 應用程式的核心功能 | 員工經驗平臺 |
| 公司 headquarter 位置 | 印度 |
| 應用程式資訊頁面 | [https://help.infeedo.com/docs](https://help.infeedo.com/docs) |
...
此資訊是由 inFeedo 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://infeedo.com/privacy-policy |

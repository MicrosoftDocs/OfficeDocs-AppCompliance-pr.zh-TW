---
title: Yeastar Workplace by 將 Yeastar Co.，Ltd 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Yeastar Workplace 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/8a2a6bf3-b7ad-403a-bdf4-68855ed22024" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004339" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由一般 Yeastar Co.，Ltd 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Yeastar Workplace |
| ID | WA200004339 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | 致使 Yeastar Co.，Ltd |
| 公司的網站 | [https://www.yeastar.com](https://www.yeastar.com) |
| 應用程式的使用規定 | [https://www.yeastar.com/yeastar-workplace-terms-of-service/](https://www.yeastar.com/yeastar-workplace-terms-of-service/) |
| 應用程式的核心功能 | 在 Microsoft Teams 中輕鬆地尋找和預約會議室。 |
| 公司總部位置 | 中國 |
| 應用程式資訊頁面 | [https://www.yeastar.com/yeastar-workplace/meeting-room-book...](https://www.yeastar.com/yeastar-workplace/meeting-room-booking) |
| 用來執行應用程式的裝載環境或服務模型為何？ | Iaas |
| 應用程式會使用哪些主控雲端提供者？ | AlibabaCloud、GCP、Aws |
...
這項資訊是由一般 Yeastar Co.，Ltd 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者登入和會議預約 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者登入和會議預約 |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 美國美國、德國 |
| 您是否有已建立的資料租用和處置程式？ | 是 |
| 帳戶終止之後，資料會保留多久？ |  |
| 您是否有已建立的資料存取管理程式？ | 是 |
...
| 隱私權原則 URL | https://www.yeastar.com/yeastar-workplace-privacy-policy/ |

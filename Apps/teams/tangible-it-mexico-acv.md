...
description: ACV 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/0a3b1cc0-1cda-4373-90b9-7740e604c5e3" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004237" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

有形 IT 墨西哥提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Tangible IT Mexico |
| 公司的網站 | [https://www.tangibleit.com](https://www.tangibleit.com) |
| 應用程式的使用規定 | [https://www.acv.app/terms](https://www.acv.app/terms) |
| 應用程式的核心功能 | 管理出席控制、透過儀表板提供主管可見度，並透過使用白板來促進教學體驗。 全部在鏡像您學校的解決方案中。 |
| 公司總部位置 | 墨西哥 |
| 應用程式資訊頁面 | [https://www.acv.app](https://www.acv.app) |
...
這項資訊是由有形 IT 墨西哥提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、用於驗證的使用者電子郵件資料。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者名稱、使用者電子郵件、使用者角色、學校電話、學校位址、學校名稱、主體、班級、課程。 |
...
| 隱私權原則 URL | https://www.acv.app/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 兩者皆是 | 若要張貼白板共同作業 (我們的功能) 連結到頻道。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| Group.ReadWrite.All | 兩者皆是 | 若要張貼白板共同作業 (我們的功能) 連結到頻道。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| User.Read | 兩者皆是 | 驗證程式會執行，而且會在屬於群組的學生設定檔上取得資料。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| 電子郵件 | 兩者皆是 | 驗證程式會執行，而且會在屬於群組的學生設定檔上取得資料。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| openid | 兩者皆是 | 驗證程式會執行，而且會在屬於群組的學生設定檔上取得資料。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| 設定檔 | 兩者皆是 | 驗證程式會執行，而且會在屬於群組的學生設定檔上取得資料。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |

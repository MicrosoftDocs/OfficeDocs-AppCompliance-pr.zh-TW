---
title: Zavvy by Zavvy GmbH 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Zavvy 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/15562290-1f82-4829-9638-452633a217d8" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003965" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Zavvy GmbH 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Zavvy GmbH |
| 公司的網站 | [https://www.zavvy.io](https://www.zavvy.io) |
| 應用程式的使用規定 | [https://www.zavvy.io/terms-conditions](https://www.zavvy.io/terms-conditions) |
| 應用程式的核心功能 | 直接在 Microsoft Teams 中讓您的人員上線、開發和連線。 |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | |
...
Zavvy GmbH 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資訊、小組資訊 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 安裝應用程式之小組的使用者識別碼、租使用者識別碼、名稱和識別碼。 |
...
| 隱私權原則 URL | https://www.zavvy.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | 委託 | 若要能夠檢查應用程式是否已安裝在小組中 | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| Channel.Create | 應用程式 | 若要能夠建立頻道，萬一我們必須將群組訊息傳送給組織中的使用者。 | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| ChannelMember.ReadWrite.All | 應用程式 | 將訊息傳送給使用者和頻道  | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| Group.Read.All | 應用程式 | 若要列出租使用者中的所有小組，讓系統管理員可以挑選要在其中安裝應用程式的小組。 | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| TeamMember.Read.All | 應用程式 | 在小組中安裝應用程式之後，從指定小組尋找使用者及其 Bot 架構識別碼。 | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| TeamsAppInstallation.ReadWriteForTeam.All | 應用程式 | 在 Team 中安裝 Zavvy Microsoft Teams 應用程式。 | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |

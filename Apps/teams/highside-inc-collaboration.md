---
title: HighSide 協同作業的應用程式資訊，由 HighSide，Inc。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: HighSide 共同作業的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
---
# <a name="highside-collaboration"></a>HighSide 共同作業

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新日期：2022年1月31日</p>

* <a href="https://teams.microsoft.com/l/app/d4460828-ddde-4619-b40b-39412667f7a3" target="_blank">在 Teams 儲存區中查看</a>
...
由 HighSide 提供的資訊，Inc. 為 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | HighSide 共同作業 |
| ID | WA200003916 |
| 支援 Office 365 用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | HighSide, Inc |
| 公司的網站 | [https://highside.io](https://highside.io) |
| App 的使用條款 | [https://highside.io/terms-of-service](https://highside.io/terms-of-service) |
| 應用程式的核心功能 | E2E Microsoft Teams 的加密郵件 &amp; 檔案。 |
...
HighSide，Inc. 已提供此資訊，Inc. 瞭解此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 使用者 Microsoft UUID、使用者名稱、使用者電子郵件地址 |

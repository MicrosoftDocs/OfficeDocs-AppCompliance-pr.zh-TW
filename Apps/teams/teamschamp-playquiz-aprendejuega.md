---
title: PlayQuiz 的應用程式資訊 - Aprende &amp; Juega by TeamsChamp
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: PlayQuiz - Aprende &amp; Juega 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2022 年 6 月 10 日</p>

* <a href="https://teams.microsoft.com/l/app/d36eac22-ff28-4392-9ba7-6e32151b9894" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002820" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

TeamsChamp 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | TeamsChamp |
| 公司的網站 | [https://www.encamina.com](https://www.encamina.com) |
| 應用程式的使用規定 | [https://www.teamsquiz.com/en/terms/](https://www.teamsquiz.com/en/terms/) |
| 應用程式的核心功能 | PlayQuiz 是 Gamification 應用程式，使用者可在其中每天回答 3 個問題，從Microsoft 365生態系統到&#8220;獲得&#8221;數位知識點。 使用者將能夠觀看公司排行榜，以探索誰是公司的最佳 M365 風雲人物。 藉由在公司中加入 gamification，使用者可以深入瞭解使用Microsoft 365工具的最佳做法。 此外，系統管理員將能夠將其自訂問題新增至系統，以建置著重于特定主題的活動。 |
| 公司總部位置 | 西班牙 |
| 應用程式資訊頁面 | [https://www.teamsquiz.com](https://www.teamsquiz.com) |
...
TeamsChamp 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | direcci&#243;n de correoelectr&#243;，nombre y apellido |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 西班牙 |
| 您是否有已建立的資料租用和處置程式？ | 否 |
| 帳戶終止之後，資料會保留多久？ | 未保留 |
| 您是否有已建立的資料存取管理程式？ | 是 |
...
| 隱私權原則 URL | https://www.theplayquiz.com/procesamiento-de-datos/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | Acceder a los datos del usuarios (email， nombre y apellido)  | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| User.ReadBasic.All | 委託 | Acceder a los datos de los compa&#241;eros del usuario principal (email， nombre y apellido)  | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| openid | 委託 | Recibir identificador del usuario | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| 設定檔 | 委託 | obtener la foto a la hora de compartirlo en teams (nombre de imagen y nombre de usuario)  | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |

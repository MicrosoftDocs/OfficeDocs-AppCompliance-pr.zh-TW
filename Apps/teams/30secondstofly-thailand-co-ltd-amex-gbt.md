---
title: AMEX GBT by 30SecondsToFly (泰國) Co Ltd 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: AMEX GBT 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/157b5ffb-b183-453c-b072-9c94bb6c694c" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003272" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

30SecondsToFly (泰國) Co Ltd 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 30SecondsToFly (Thailand) Co Ltd |
| 公司的網站 | [https://www.amexglobalbusinesstravel.com](https://www.amexglobalbusinesstravel.com) |
| 應用程式的使用規定 | [https://www.amexglobalbusinesstravel.com/terms-service/](https://www.amexglobalbusinesstravel.com/terms-service/) |
| 應用程式的核心功能 | 與旅行旅行家聊天。 無論您需要尋找停留地點或是剛錯過航班的協助，我們的旅行小眾皆可 24/7 聊天。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
此資訊已由 30SecondsToFly (泰國) Co Ltd 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

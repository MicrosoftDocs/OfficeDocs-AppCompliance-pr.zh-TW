---
title: Perdoo 的應用程式資訊（按 Perdoo GmbH）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Perdoo 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/20de31f7-5eb6-4763-bf6f-00d019feee5d" target="_blank">在 Teams 儲存區中查看</a>
...
由 Perdoo GmbH 所提供的資訊給 Microsoft：
...
| 合作夥伴公司名稱 | Perdoo GmbH |
| 公司的網站 | [https://www.perdoo.com](https://www.perdoo.com) |
| App 的使用條款 | [https://www.perdoo.com/terms-of-service/](https://www.perdoo.com/terms-of-service/) |
| 應用程式的核心功能 | 追蹤您的小組通訊所發生的目標。 |
| 公司 headquarter 位置 | 德國 |
| 應用程式資訊頁面 | [https://support.perdoo.com/en/articles/3286052-microsoft-te...](https://support.perdoo.com/en/articles/3286052-microsoft-teams-integration) |
...
此資訊是由 Perdoo GmbH 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.perdoo.com/privacy-policy/ |

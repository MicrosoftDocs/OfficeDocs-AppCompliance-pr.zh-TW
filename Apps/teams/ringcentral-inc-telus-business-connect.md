---
title: TelUS Business Connect by RingCentral， Inc. 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: TELUS Business Connect 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/d5001eed-f63e-4a7d-9b49-bf8272c934cd" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002300" target="_blank">在 AppSource 中檢視</a>
...
| 公司的網站 | [https://www.telus.com](https://www.telus.com) |
| 應用程式的使用規定 | [https://www.telus.com/en/bc/business/support/article/busine...](https://www.telus.com/en/bc/business/support/article/business-connect-terms) |
| 應用程式的核心功能 | 使用快速 Bot 命令和傳訊功能來啟動並加入 Telus 視訊或音訊通話。 |
| 公司總部位置 | 美國美國 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 若要取得使用者設定檔資料 | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read.All | 委託 | 若要取得使用者設定檔資料 | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |

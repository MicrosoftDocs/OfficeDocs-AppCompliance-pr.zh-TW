---
title: IntraActive by IntraActive by Fellowmind 丹麥播放的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/02/2022
...
description: 所有可用的安全性與合規性資訊，適用于 Play by IntraActive、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。

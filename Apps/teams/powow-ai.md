...
* <a href="https://teams.microsoft.com/l/app/5e6f557b-3d89-40e6-9d8e-0ccb5c956c22" target="_blank">在 Teams 儲存區中查看</a>
...
Powow AI 會提供此資訊，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 使用者設定檔資料、使用者電子郵件、行事曆事件 |

...
description: 適用于 Powow 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64875350"
---
# <a name="powow"></a>Powow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 12 月 15 日</p>

* <a href="https://teams.microsoft.com/l/app/5e6f557b-3d89-40e6-9d8e-0ccb5c956c22" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002952" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Powow AI 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Powow AI |
| 公司的網站 | [https://www.powow.ai](https://www.powow.ai) |
| 應用程式的使用規定 | [https://www.powow.ai/legal/tos.pdf](https://www.powow.ai/legal/tos.pdf) |
| 應用程式的核心功能 | Powow 是一個 SaaS 平臺，可釋放 AI 在商務會議中的威力。 它會使用專屬的 AI 演算法來轉譯和分析會議，並將其轉換成可採取動作的深入解析。 Powow 可讓組織員工參與較少的會議，同時透過會議探索、分析和共同作業來獲得生產力。 |
| 公司總部位置 | 美國美國 |
...
Powow AI 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、使用者電子郵件、行事曆事件 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者設定檔資料、使用者電子郵件、行事曆事件 |
...
| 隱私權原則 URL | https://www.sembly.ai/wp-content/uploads/2021/09/privacy.pdf |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | Microsoft Teams用戶端 SDK |
| 您的應用程式是否支援條件式存取原則？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ExternalItem.ReadWrite.All | 應用程式 | 用於搜尋連接器 (功能，可將 Powow 資料推送至 Microsoft 索引以搜尋Microsoft 服務)  | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| User.Read | 委託 | 登入和讀取註冊和登入的使用者設定檔 | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| User.Read.All | 應用程式 | 用於搜尋連接器 (功能，可將 Powow 資料推送至 Microsoft 索引以搜尋Microsoft 服務)  | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| 電子郵件 | 委託 | 檢視使用者的電子郵件地址以進行註冊和登入 | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| offline_access | 委託 | 若要存取應用程式內的使用者資料， (追蹤行事曆更新)  | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| openid | 委託 | 將使用者登入 | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |

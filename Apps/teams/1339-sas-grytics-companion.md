---
title: 1339 SAS 的 Grytics 隨附應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Grytics Companion 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/54ab7c02-a92f-4a87-9f59-764e42009fbc" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004217" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

1339 SAS 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Grytics Companion |
| ID | WA200004217 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | 1339 SAS |
| 公司的網站 | [https://grytics.com](https://grytics.com) |
| 應用程式的使用規定 | [https://grytics.com/terms](https://grytics.com/terms) |
| 應用程式的核心功能 | 使用者可以比較 &amp; 分析已新增至其 Grytics 帳戶之商務社交網路的趨勢 &amp; 活動 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | |
...
此資訊已由 1339 SAS 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 電子郵件，名稱 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 應用程式使用者的名稱、電子郵件。  |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 愛爾蘭、法國 |
| 您是否有已建立的資料租用和處置程式？ | 是 |
...
| 隱私權原則 URL | https://grytics.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 應用程式 | 若要允許 Grytics 系統管理員授權其 Grytics 使用者在 Teams 上使用應用程式，並符合其在 AAD 上的使用者識別碼，則需要此選項 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read | 委託 | SSO 驗證流程需要 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read.All | 應用程式 | 若要允許 Grytics 系統管理員授權其 Grytics 使用者在 Teams 上使用應用程式，並符合其在 AAD 上的使用者識別碼，則需要此選項 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| 電子郵件 | 委託 | SSO 驗證流程需要 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| offline_access | 委託 | SSO 驗證流程需要 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| 設定檔 | 委託 | SSO 驗證流程需要 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |

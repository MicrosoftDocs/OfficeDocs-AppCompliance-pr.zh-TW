...
* <a href="https://teams.microsoft.com/l/app/fa662fca-9224-49e3-9566-f66d2a6949af" target="_blank">在 Teams 儲存區中查看</a>
...
由 Weekdone 有限公司提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Weekdone 有限公司 |
| 公司的網站 | [https://weekdone.com](https://weekdone.com) |
...
Weekdone 有限公司會提供此資訊，告知有關此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 裝置的 IP 位址。 客戶的名稱和電子郵件地址。 |
...
| 隱私權原則 URL | https://weekdone.com/privacy |

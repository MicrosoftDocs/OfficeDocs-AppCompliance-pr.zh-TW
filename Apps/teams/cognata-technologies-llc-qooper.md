---
title: COGNATA TECHNOLOGIES、LLC 的 Qooper 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Qooper 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/fadca663-cc96-4756-8a3b-271000082238" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002964" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

COGNATA TECHNOLOGIES、LLC 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://qooper.io](https://qooper.io) |
| 應用程式的使用規定 | [https://qooper.io/terms-of-use](https://qooper.io/terms-of-use) |
| 應用程式的核心功能 | 使用有意義的連線 &amp; 內容達成目標。 透過指導、對等指導、社群學習和網路功能，讓您的人員擁有有意義的連線和內容。 Qooper 合作夥伴與各種規模的公司、大學和非營利組織合作，以自動化指導計畫管理工作、在互動式指導學習平臺上與人員連線，以及顯示計畫分析。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://qooper.io](https://qooper.io) |
...
此資訊已由 COGNATA TECHNOLOGIES、LLC 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

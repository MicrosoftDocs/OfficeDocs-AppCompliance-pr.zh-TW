---
title: Fabasoft 奧地利 GmbH 的 Fabasoft Cloud 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/15/2021
...
* <a href="https://teams.microsoft.com/l/app/12ba525f-5370-4cd9-b1c9-fde7edecae8a" target="_blank">在 Teams 儲存區中查看</a>
...
Fabasoft 奧地利 GmbH 所提供的資訊給 Microsoft：
...
| 公司的網站 | [https://www.fabasoft.com](https://www.fabasoft.com) |
| App 的使用條款 | [https://www.fabasoft.com/terms-of-use](https://www.fabasoft.com/terms-of-use) |
| 應用程式的核心功能 | 從 Fabasoft Business Process Cloud 共用您的商務資料 |
| 公司 headquarter 位置 | 奧地利 |
| 應用程式資訊頁面 | [https://www.fabasoft.com/fabasoft-business-process-cloud](https://www.fabasoft.com/fabasoft-business-process-cloud) |
...
此資訊是由 Fabasoft 奧地利 GmbH 提供，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

---
title: Educatieve Uitgeversgroep B.V 的 Digiplein 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
description: Digiplein 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/9a58f891-dad9-4c01-bf1a-3c418fb6b282" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003298" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Educatieve Uitgeversgroep B.V 所提供的資訊。 至 Microsoft：
...
| 公司的網站 | [https://www.uitgeversgroep.nl](https://www.uitgeversgroep.nl) |
| 應用程式的使用規定 | [https://www.uitgeversgroep.nl/voorwaarden](https://www.uitgeversgroep.nl/voorwaarden) |
| 應用程式的核心功能 | Online leeromgeving van de Uitgeversgroep |
| 公司總部位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | [https://www.uitgeversgroep.nl/digiplein](https://www.uitgeversgroep.nl/digiplein) |
...
這項資訊是由 Educatieve Uitgeversgroep B.V 所提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

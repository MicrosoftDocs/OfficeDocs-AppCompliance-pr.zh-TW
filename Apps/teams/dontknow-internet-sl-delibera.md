---
title: Dontknow Internet S.L 的 delibera 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: 分隔符號、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "66656042"
---
# <a name="delibera"></a>delibera

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 29 日</p>

* <a href="https://teams.microsoft.com/l/app/0c914e60-f699-11ea-b068-b9aff13273d5" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003380" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Dontknow Internet S.L 所提供的資訊。 至 Microsoft：
...
| 合作夥伴公司名稱 | 不知道網際網路 S.L。 |
| 公司的網站 | [https://www.delibera.com](https://www.delibera.com) |
| 應用程式的使用規定 | [https://www.delibera.com/terms](https://www.delibera.com/terms) |
| 應用程式的核心功能 | Delibera 可改善組織中重要交談的品質，協助領導者更瞭解、決定及執行 |
| 公司總部位置 | 西班牙 |
| 應用程式資訊頁面 | [https://www.delibera.com](https://www.delibera.com) |
...
此資訊已由 Dontknow 網際網路 S.L 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.delibera.com/privacy |

...
description: Miro 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/8216e453-3db5-48ee-a3d6-5122f505c8a3" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381906" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Miro 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Miro |
| 公司的網站 | [https://miro.com](https://miro.com) |
| 應用程式的使用規定 | [https://pinpointprod.blob.core.windows.net/marketing/Partne...](https://pinpointprod.blob.core.windows.net/marketing/Partner_21474848323/Product_42949682538/Asset_435d8bad-e143-4e39-afed-895c2d2ac8a1/RealtimeBoardMSAenterprisecust.docx) |
| 應用程式的核心功能 | 線上共同作業白板平臺 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://miro.com/about/](https://miro.com/about/) |
...
Miro 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://miro.com/legal/privacy-policy/ |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | SAML， 0Auth |
| 您的應用程式是否支援條件式存取原則？ | 否 |

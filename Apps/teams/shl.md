...
description: SHL 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/0c52adc0-18a0-45ca-b6ee-154cf1ef87e2" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002887" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

SHL 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | SHL |
| 公司的網站 | [https://shl.com](https://shl.com) |
| 應用程式的使用規定 | [https://www.shl.com/en/terms-of-service/](https://www.shl.com/en/terms-of-service/) |
| 應用程式的核心功能 | SHL 是人力資源技術和計量科學的全球領導者，可讓您深入瞭解人員，協助公司打造強大的員工解決方案來推動業務成果。 SHL 帶來強大且透明的 AI 技術、資料科學和物件，協助公司吸引、開發及成長在數位紀元成功所需的員工。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.shl.com/en/about/](https://www.shl.com/en/about/) |
...
SHL 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read.Shared | 委託 | 可用的共用 Calander 位置 | [afd2c390-8b78-40fa-913b-7fc5911e884a](../azure/afd2c390-8b78-40fa-913b-7fc5911e884a.md) |

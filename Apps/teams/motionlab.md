---
title: Motionlab by Motionlab 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Motionlab 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/8ad5fc1b-251b-4d14-aceb-2624bcab0e85" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004250" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Motionlab 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Motionlab |
| 公司的網站 | [https://www.motionlab.io](https://www.motionlab.io) |
| 應用程式的使用規定 | [https://www.motionlab.io/term-of-use](https://www.motionlab.io/term-of-use) |
| 應用程式的核心功能 | 直接在 Microsoft Teams 中輕鬆建立個人化影片。 |
| 公司總部位置 | 捷克文 |
| 應用程式資訊頁面 | |
...
Motionlab 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 建立個人化影片所需的資訊。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 建立個人化影片所需的資訊。 |

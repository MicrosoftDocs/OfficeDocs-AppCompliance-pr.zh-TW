...
* <a href="https://teams.microsoft.com/l/app/64d24486-30aa-4fae-8bdc-2680a85dcbb5" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002968" target="_blank">在 AppSource 中檢視</a>
...
| 合作夥伴公司名稱 | 所有藍色解決方案 |
| 公司的網站 | [https://ngdesk.com](https://ngdesk.com) |
| 應用程式的使用規定 | [https://ngdesk.com/terms-of-service/](https://ngdesk.com/terms-of-service/) |
| 應用程式的核心功能 | ngDesk 包含支援、銷售、資產管理、行銷和呼叫器，這些全合一應用程式已準備好可供使用。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://ngdesk.com](https://ngdesk.com) |
...
此資訊已由所有藍色解決方案提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

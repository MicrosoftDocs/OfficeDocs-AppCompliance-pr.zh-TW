---
title: OfficeRnD 混合式作品的應用程式資訊 OfficeRnD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/11/2021
...
description: 所有適用于 OfficeRnD 混合式作業的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/ff19eb3c-6afa-4f33-acfd-df1338289524" target="_blank">在 Teams 儲存區中查看</a>
...
由 OfficeRnD 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | OfficeRnD Hybrid Work |
| ID | WA200003460 |
| 支援 Office 365 用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | OfficeRnD |
| 公司的網站 | [https://officernd.com](https://officernd.com) |
| App 的使用條款 | [https://officernd.com/terms](https://officernd.com/terms) |
| 應用程式的核心功能 | 讓員工能夠快速尋找及書、會議室及其他共用空間。 |
| 公司 headquarter 位置 | 英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.officernd.com/hybrid-workplace-management-softw...](https://www.officernd.com/hybrid-workplace-management-software/) |
...
此資訊是由 OfficeRnD 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://officernd.com/privacy |

...
| App 的使用條款 | [https://www.mindmup.com/resources/terms_mindmup.html](https://www.mindmup.com/resources/terms_mindmup.html) |
| 應用程式的核心功能 | MindMup 可讓使用者使用構思圖、蜘蛛圖表、概念地圖、引數視覺化效果和階層式圖表輕鬆顯示創意。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Teams。ReadBasic。 All | 委託 | 使用者的小組識別碼及小組名稱 | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |
>| User.Read | 委託 | 驗證之後顯示的使用者識別碼、電子郵件地址 | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |

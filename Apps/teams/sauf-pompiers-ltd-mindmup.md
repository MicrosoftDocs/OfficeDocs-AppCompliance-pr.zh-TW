---
title: Sauf Fuiers Ltd 的 MindMup 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/09/2021
...
description: MindMup 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001759" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Sauf Fuiers Ltd 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.mindmup.com](https://www.mindmup.com) |
| 應用程式的使用規定 | [https://www.mindmup.com/resources/terms_mindmup.html](https://www.mindmup.com/resources/terms_mindmup.html) |
| 應用程式的核心功能 | MindMup 可讓使用者使用心形圖、圖表、概念圖、引數視覺效果和階層式圖表，輕鬆地將想法視覺化。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.mindmup.com/tutorials/microsoft-teams.html](https://www.mindmup.com/tutorials/microsoft-teams.html) |
...
Sauf Fuiers Ltd 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Teams。ReadBasic.All | 委託 | 使用者的小組識別碼和小組名稱 | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |
>| User.Read | 委託 | 驗證後要顯示的使用者識別碼、電子郵件地址 | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |

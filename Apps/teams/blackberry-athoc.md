---
title: BlackBerry AtHoc by BlackBerry 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/05/2021
...
description: BlackBerry AtHoc 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003065" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的使用規定 | [https://www.athoc.com/pss/terms.html#](https://www.athoc.com/pss/terms.html#) |
| 應用程式的核心功能 | BlackBerry AtHoc 與 Teams 整合可讓整個組織順暢地進行重要事件管理，&#8211;您&#8217;已重新驗證的一個熟悉 UI。 在不離開Teams的情況下，BlackBerry AtHoc 整合可讓緊急和事件管理員：&#8226;按一下即可將警示發佈到任何裝置&#8226;在Teams內以Teams &#8226;共同作業為目標的預先建立通訊群組，以即時管理事件 |
| 公司總部位置 | 美國美國 |
...
| 應用程式會使用哪些主控雲端提供者？ | Azure、AWS、SelfHosted |
...
此資訊由 BlackBerry 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 委託 | 我們會存取使用者&#8217;基本詳細資料，例如主體名稱，以及已登入使用者獲授權的小組一般頻道 (連結，) 將警示卡傳送至小組。 | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| Group.Read.All | 委託 | 我們會存取使用者&#8217;基本詳細資料，例如主體名稱，以及已登入使用者獲授權的小組一般頻道 (連結，) 將警示卡傳送至小組。 | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| User.Read | 委託 | 我們會存取使用者&#8217;基本詳細資料，例如主體名稱，以及已登入使用者獲授權的小組一般頻道 (連結，) 將警示卡傳送至小組。 | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| 電子郵件 | 委託 | 我們會存取使用者&#8217;基本詳細資料，例如主體名稱，以及已登入使用者獲授權的小組一般頻道 (連結，) 將警示卡傳送至小組。 | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| openid | 委託 | 我們會存取使用者&#8217;基本詳細資料，例如主體名稱，以及已登入使用者獲授權的小組一般頻道 (連結，) 將警示卡傳送至小組。 | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| 設定檔 | 委託 | 我們會存取使用者&#8217;基本詳細資料，例如主體名稱，以及已登入使用者獲授權的小組一般頻道 (連結，) 將警示卡傳送至小組。 | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |

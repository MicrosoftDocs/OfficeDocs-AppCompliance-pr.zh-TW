---
title: OperaLogica srl 的 Meety 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Meety 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/9a68d494-f5ae-4e0c-ad18-478bf6fcd101" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004258" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

operaLogica srl 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | operaLogica srl |
| 公司的網站 | [https://meety.business](https://meety.business) |
| 應用程式的使用規定 | [https://meety.business/termsofuse](https://meety.business/termsofuse) |
| 應用程式的核心功能 | 收集和組織會議，並讓您透過會議的目標、工作和歷程記錄來增強會議體驗 |
| 公司總部位置 | 義大利 |
| 應用程式資訊頁面 | |
...
此資訊已由 operaLogica srl 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 插入的電子郵件、名稱、姓氏、會議 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 插入的電子郵件、名稱、姓氏、會議 |
...
| 隱私權原則 URL | https://meety.business/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委託 | 將會議新增至執行緒的可能性 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| Chat.Read | 委託 | 閱讀會議的相關資訊 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| Chat.ReadBasic | 委託 | 閱讀會議的相關資訊 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| OnlineMeetingArtifact.Read.All | 委託 | 閱讀會議成品的相關資訊，以增加使用者的體驗 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| OnlineMeetings.Read | 委託 | 讀取會議識別碼以新增進一步的資料 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| User.Read | 委託 | 取得使用應用程式之使用者的相關資訊 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |

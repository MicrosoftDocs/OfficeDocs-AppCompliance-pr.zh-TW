---
title: Status Hero， Inc. 的狀態主圖應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: 狀態主圖、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/7917afd4-9825-4c1d-b683-ce1fcb77d5b4" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004205" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Status Hero， Inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Status Hero, Inc. |
| 公司的網站 | [https://statushero.com](https://statushero.com) |
| 應用程式的使用規定 | [https://statushero.com/terms](https://statushero.com/terms) |
| 應用程式的核心功能 | 狀態主圖會將小組工具中的非同步簽入和資料，轉換成簡潔且具深入的報表。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://statushero.com/integrations/microsoft-teams](https://statushero.com/integrations/microsoft-teams) |
...
此資訊已由 Status Hero， Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://statushero.com/privacy |

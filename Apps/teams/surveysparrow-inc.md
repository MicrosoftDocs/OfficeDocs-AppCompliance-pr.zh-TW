---
title: SurveySparrow by SurveySparrow inc. 的 Application Information for SurveySparrow.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: SurveySparrow 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/1b923c85-b04c-43d4-b2c2-0fdc0f598658" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002257" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

SurveySparrow inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | SurveySparrow inc. |
| 公司的網站 | [https://surveysparrow.com](https://surveysparrow.com) |
| 應用程式的使用規定 | [https://surveysparrow.com/legal/terms-of-service/](https://surveysparrow.com/legal/terms-of-service/) |
| 應用程式的核心功能 | 輕鬆地進行每日獨立、每月快樂，並測量員工脈衝。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://surveysparrow.com/apps/microsoft-teams-survey-integ...](https://surveysparrow.com/apps/microsoft-teams-survey-integration/) |
...
這項資訊是由 SurveySparrow Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: BitFractal by BitFractal 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/03/2022
...
description: BitFractal 的所有可用安全性與合規性資訊、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/2908a48e-21b7-48e4-89fc-7f4a433952fa" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004172" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

BitFractal 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | BitFractal |
| 公司的網站 | [https://www.bitfractal.com](https://www.bitfractal.com) |
| 應用程式的使用規定 | [https://www.bitfractal.com/termsofuse](https://www.bitfractal.com/termsofuse) |
| 應用程式的核心功能 | BitFractal 以簡單且有效率的方式將 AI 帶給商務使用者，藉由將 AI 認知服務從 Azure 連線到 Teams 的使用者易記介面，然後利用 Teams 功能，例如 Bot、索引標籤、訊息擴充功能等等，為企業使用者新增生產力和共同作業層。 |
| 公司總部位置 | 美國 |
| 應用程式資訊頁面 | [https://www.bitfractal.com](https://www.bitfractal.com) |
...
BitFractal 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料 (DisplayName、Email、ObjectId、TenantId)  |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者設定檔資料 (DisplayName、Email、ObjectId、TenantId)  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 取得應用程式與使用者互動的基本使用者設定檔資訊 | [6a1d567b-1106-46a0-83bc-ffe9ada78b9b](../azure/6a1d567b-1106-46a0-83bc-ffe9ada78b9b.md) |
>| User.Read | 委託 | 取得應用程式與使用者互動的基本使用者設定檔資訊 | [8f261936-59e1-44b3-8234-a746c5e4eab7](../azure/8f261936-59e1-44b3-8234-a746c5e4eab7.md) |
>| User.Read | 委託 | 取得應用程式與使用者互動的基本使用者設定檔資訊 | [fb5ad138-bf16-44c0-bdc2-2a9c0e6f246f](../azure/fb5ad138-bf16-44c0-bdc2-2a9c0e6f246f.md) |

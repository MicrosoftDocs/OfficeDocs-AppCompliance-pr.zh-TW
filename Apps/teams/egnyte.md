---
title: Egnyte by Egnyte 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/05/2021
...
description: Egnyte 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/28b871ff-85bf-48a5-9bee-364f2b74d104" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381174" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Egnyte 提供給 Microsoft 的資訊：
...
| 應用程式的核心功能 | 從Microsoft Teams內輕鬆檢視、存取及共用 Egnyte 受控內容。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://helpdesk.egnyte.com/hc/en-us/articles/115000999611-...](https://helpdesk.egnyte.com/hc/en-us/articles/115000999611-Egnyte-for-Microsoft-Teams) |
...
Egnyte 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

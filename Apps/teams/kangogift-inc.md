---
title: 使用者適用的應用程式資訊，此應用程式資訊由 Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/03/2022
...
description: 所有可用的安全性與合規性資訊，適用于在 CSA STAR 登錄中，適用于並存、其資料處理原則、Microsoft Cloud App Security 應用程式目錄資訊，以及安全性/合規性資訊。
...
ms.locfileid: "65938700"
---
# <a name="kangogift"></a>卡羅羅Gift

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 13 日</p>

* <a href="https://teams.microsoft.com/l/app/a19a36e4-c33d-4988-a706-5c740ccab0eb" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004174" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由 Inc. 的一般資訊提供給 Microsoft：
...
| 合作夥伴公司名稱 | UnloadoGift， Inc. |
| 公司的網站 | [https://www.kangogift.com](https://www.kangogift.com) |
| 應用程式的使用規定 | [https://www.kangogift.com/app_terms](https://www.kangogift.com/app_terms) |
| 應用程式的核心功能 | 傳送辨識和感謝。 |
| 公司總部位置 | 美國 |
| 應用程式資訊頁面 | |
...
這項資訊是由 Inc. 的一般提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者的基本資訊 - 名稱、電子郵件。 這會在我們與用戶端的個別合約中處理。  |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者的基本資訊 - 名稱、電子郵件。 這會在我們與用戶端的個別合約中處理。  |
...
| 隱私權原則 URL | https://www.kangogift.com/privacy |

---
title: Rafiky 由全球國會 SRL 提供的應用程式資訊
ms.author: elmalova
author: elenamalova
ms.date: 09/20/2021
ms.topic: article
...
* <a href="https://teams.microsoft.com/l/app/c4661f80-2c9c-42d4-aec5-5ed6d64adb4d" target="_blank">在 Teams 儲存區中查看</a>
...
| App 的使用條款 | [https://rafiky.net/en/terms-conditions/](https://rafiky.net/en/terms-conditions/) |
| 應用程式的核心功能 | Rafiky 是非常靈活且易於存取的雲端平臺解決方案，其設計目的是針對線上事件執行遠端轉譯。 它&#8217;的是遠端轉譯的獨特且創新的遠景設想;它可讓專業的譯員隨時從任何地方運作。 |
...
此資訊已由全球國會 SRL 提供，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

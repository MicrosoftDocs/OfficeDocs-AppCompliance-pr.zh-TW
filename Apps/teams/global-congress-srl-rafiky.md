---
title: 依全域之 GLOBAL 的函數 SRL 的 Application Information
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
* <a href="https://teams.microsoft.com/l/app/c4661f80-2c9c-42d4-aec5-5ed6d64adb4d" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003263" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

全域的權數 SRL 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 全球會議 SRL |
| 公司的網站 | [https://rafiky.net/en/](https://rafiky.net/en/) |
| 應用程式的使用規定 | [https://rafiky.net/en/terms-conditions/](https://rafiky.net/en/terms-conditions/) |
| 應用程式的核心功能 | Accessibleiky 是極具彈性且可存取的雲端平臺解決方案，其設計目的是要為您的線上事件執行遠端同時解譯。 它&#8217;遠端解譯的獨特創新願景;它可讓專業解譯器隨時隨地工作。 |
| 公司總部位置 | 義大利 |
| 應用程式資訊頁面 | |
...
此資訊已由全域的許可權 SRL 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

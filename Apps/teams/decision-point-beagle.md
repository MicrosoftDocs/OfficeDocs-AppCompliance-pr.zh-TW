---
title: Beagle by Decision Point 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Beagle 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/a0f836a9-178e-4407-9c26-4579dcd17bd1" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002687" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

決策點提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://decisionpoint.ai](https://decisionpoint.ai) |
| 應用程式的使用規定 | [https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms...](https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms-of-Use.pdf) |
| 應用程式的核心功能 | Beagle 是以聊天為基礎的 BI 工具，與 MS Teams 等平臺整合。 Beagle 可降低採用障礙，並透過共同作業應用程式將資料帶給人員，以消除 (個人) 訓練的需求。  Beagle 會以深入解析卡片的形式向使用者顯示相關資料，並讓他們使用篩選器深入探討該資料，並協助您更快速地進行決策。  |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | [https://beagleanalytics.ai](https://beagleanalytics.ai) |
...
決策點已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

...
| App 的使用條款 | [https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms...](https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms-of-Use.pdf) |
| 應用程式的核心功能 | Beagle 是以聊天為基礎的 BI 工具，與像是 MS Teams 的平臺整合。 Beagle 利用共同作業應用程式的資料，降低使用的障礙，並不再需要 (個別人員的訓練) 。  Beagle 會以深入瞭解的方式向使用者顯示相關的資料，並可讓他們使用篩選器深入瞭解，並協助您更快速地進行決策。  |

---
title: Do！book CB by Digital Office Inc. 的應用程式資訊！
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: 所有可用的安全性與合規性資訊，適用于 do！book CB、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/92abac76-5f78-472f-8dfa-e7c23564cd92" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002597" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Digital Office Inc. 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.do-tools.net](https://www.do-tools.net) |
| 應用程式的使用規定 | [https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf](https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf) |
| 應用程式的核心功能 | 使用材料共用面板 &quot; 讓會議更方便 &quot; ！ |
| 公司總部位置 | 日本 |
| 應用程式資訊頁面 | [https://www.do-tools.net](https://www.do-tools.net) |
...
Digital Office Inc. 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: ClipTraining 的 ClipTraining 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/08/2021
...
description: ClipTraining 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64876450"
---
# <a name="cliptraining"></a>ClipTraining

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 6 月 14 日</p>

* <a href="https://teams.microsoft.com/l/app/6cb4b701-2a4f-4080-8a8a-d99f93905e15" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001687" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

ClipTraining 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.cliptraining.com](https://www.cliptraining.com) |
| 應用程式的使用規定 | [https://www.cliptraining.com/eula/](https://www.cliptraining.com/eula/) |
| 應用程式的核心功能 | 適用于新式學習的內容串流服務，包括 5000 個以上的Microsoft 365課程。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.cliptraining.com](https://www.cliptraining.com) |
| 用來執行應用程式的裝載環境或服務模型為何？ |  |
| 應用程式會使用哪些主控雲端提供者？ | Azure、SelfHosted |
...
ClipTraining 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 電子郵件 | 委託 | 使用者登入和對應的電子郵件地址、名字、姓氏。  | [af089bb5-48be-413d-ad34-53c32799da7d](../azure/af089bb5-48be-413d-ad34-53c32799da7d.md) |
>| offline_access | 委託 | 使用者登入和對應的電子郵件地址、名字、姓氏。  | [af089bb5-48be-413d-ad34-53c32799da7d](../azure/af089bb5-48be-413d-ad34-53c32799da7d.md) |
>| openid | 委託 | 使用者登入和對應的電子郵件地址、名字、姓氏。  | [af089bb5-48be-413d-ad34-53c32799da7d](../azure/af089bb5-48be-413d-ad34-53c32799da7d.md) |
>| 設定檔 | 委託 | 使用者登入和對應的電子郵件地址、名字、姓氏。  | [af089bb5-48be-413d-ad34-53c32799da7d](../azure/af089bb5-48be-413d-ad34-53c32799da7d.md) |

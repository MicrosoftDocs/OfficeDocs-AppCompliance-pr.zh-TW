...
| App 的使用條款 | [https://skypointcloud.com/terms/](https://skypointcloud.com/terms/) |
| 應用程式的核心功能 | SkyPoint 可協助品牌瞭解客戶、進行策略決策，並持續採取適當的動作，以更好地服務其消費者，並繼續成長業務。 我們是一種客戶資料平臺，可提供跨資料管理和統一、隱私權遵從性、分析和洞察力等的智慧功能。  |

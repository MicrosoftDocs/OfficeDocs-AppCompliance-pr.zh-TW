---
title: SkyPoint Cloud 的 SkyPoint Cloud 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/21/2022
...
description: 所有適用于 SkyPoint Cloud 的可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64880553"
---
# <a name="skypoint-cloud"></a>SkyPoint Cloud

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 2 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/9637dd07-ec2d-48f7-83cd-bccad3be9fd4" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002580" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

SkyPoint Cloud Inc. 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://skypointcloud.com](https://skypointcloud.com) |
| 應用程式的使用規定 | [https://skypointcloud.com/terms/](https://skypointcloud.com/terms/) |
| 應用程式的核心功能 | SkyPoint 可協助品牌認識客戶、制定策略性決策，並持續採取正確的動作，以更妥善地為消費者提供服務，並持續拓展業務。 我們為客戶資料平臺，提供跨資料管理和統一、隱私權合規性、分析和深入解析，以及啟用的智慧型功能。  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://skypointcloud.com/platform/](https://skypointcloud.com/platform/) |
...
這項資訊已由 SkyPoint Cloud Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

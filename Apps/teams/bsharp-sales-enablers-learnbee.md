---
title: Learnbee 的應用程式資訊（按 Bsharp 銷售啟用程式）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/10/2022
...
description: Learnbee 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/222090f5-29ca-4375-aa96-248079d4cacc" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | Bsharp 銷售推動 |
| 公司的網站 | [https://learnbee.com](https://learnbee.com) |
| App 的使用條款 | [https://learnbee.com/terms/](https://learnbee.com/terms/) |
| 應用程式的核心功能 | LearnBee 可協助您接洽您的 frontline 團隊以進行教學。  |
| 公司 headquarter 位置 | 印度 |
| 應用程式資訊頁面 | [https://learnbee.com](https://learnbee.com) |
...
這種資訊已透過 Bsharp 銷售啟用器提供，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://learnbee.com/privacy |

---
title: Glueckkanja-gab AG 之統一連絡人的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: 所有可用的安全性和符合性資訊所有整合的連絡人、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/085251c0-aef3-11ea-bccf-6fc12269b243" target="_blank">在 Teams 儲存區中查看</a>
...
由 glueckkanja-gab AG 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | glueckkanja-gab AG |
| 公司的網站 | [https://www.glueckkanja-gab.com/en](https://www.glueckkanja-gab.com/en) |
| App 的使用條款 | [https://www.glueckkanja-gab.com/en/products/unified-contact...](https://www.glueckkanja-gab.com/en/products/unified-contacts/terms-and-conditions) |
| 應用程式的核心功能 | Azure AD、您的公司連絡人、Exchange Online 和您的個人連絡人的整合搜尋。 |
| 公司 headquarter 位置 | 德國 |
| 應用程式資訊頁面 | [https://www.glueckkanja-gab.com/en/products/unified-contacts](https://www.glueckkanja-gab.com/en/products/unified-contacts) |
...
Glueckkanja-gab AG 會提供此資訊，讓您瞭解此應用程式如何收集及儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.glueckkanja-gab.com/en/products/unified-contacts/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts。已讀取。共用 | 委託 | 整合連絡人需要存取客戶租使用者中的連絡人資料，以提供基本功能。 | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| Directory.Read.All | 委託 | 整合連絡人需要存取客戶租使用者中的連絡人資料，以提供基本功能。 | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| User.Read | 委託 | 整合連絡人需要存取客戶租使用者中的連絡人資料，以提供基本功能。 | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |

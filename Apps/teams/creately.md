---
title: Creately for Creately 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: 所有可用的安全性與合規性資訊，適用于 Creately、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/dddf988d-00af-480f-b419-76a357a72460" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004335" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Creately 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Creately |
| 公司的網站 | [https://creately.com](https://creately.com) |
| 應用程式的使用規定 | [https://creately.com/tos](https://creately.com/tos) |
| 應用程式的核心功能 | 透過 Creately，您可以體驗與以往一樣的視覺化共同作業。 現在，在不離開 Microsoft Teams 的情況下規劃、分析及執行您的所有工作。 Creately 提供自由格式的無限視覺畫布，可即時組織想法、腦力激蕩解決方案、設計程式，以及與小組成員共同作業。 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | |
...
此資訊由 Creately 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者電子郵件、使用者全名 |
...
| 隱私權原則 URL | https://creately.com/privacy/ |

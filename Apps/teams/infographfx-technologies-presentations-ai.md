---
title: Infographfx 技術的簡報 AI 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: 簡報 AI 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/1f510555-b518-4084-84e0-18c7bebc807c" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001352" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Infographfx 技術提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://presentations.ai](https://presentations.ai) |
| 應用程式的使用規定 | [https://presentations.ai/terms_teams.html](https://presentations.ai/terms_teams.html) |
| 應用程式的核心功能 | Presentations.AI 是具有最佳設計做法的智慧型工具，可建立令人讚歎的簡報。 |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | |
...
Infographfx 技術已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

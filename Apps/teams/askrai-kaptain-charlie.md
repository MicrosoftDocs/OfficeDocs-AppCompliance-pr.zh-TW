---
title: Kaptain Charlie 的應用程式資訊 askR.ai
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: Kaptain Charlie 的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
| App 的使用條款 | [https://en.askr.ai/terms-of-use-askr-ai](https://en.askr.ai/terms-of-use-askr-ai) |
| 應用程式的核心功能 | 與您的資料聊天！ askR.ai 是您的個人資料助理您有資料，但不想要使用技術程式來存取它？ 使用資料助理來回答您的問題，並協助您探索！ AskR.ai 中 Microsoft Teams 第一個資料小幫手的情況為何？ -AI-已加電的個人資料-assistant-提供立即 KPIs 和資料 viz-瞭解特定業務詞彙-傳送提醒-建議您進行其他分析 |

---
title: AskR.ai 的 Kaptain 擴 askR.ai 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: 所有可用的安全性與合規性資訊，適用于 Kaptain Mirror、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/1f36eaf6-30a3-4488-a73f-4754b91e865d" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001583" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

askR.ai 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Kaptain Charlie |
| ID | WA200001583 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | askR.ai |
| 公司的網站 | [https://en.askr.ai](https://en.askr.ai) |
| 應用程式的使用規定 | [https://en.askr.ai/terms-of-use-askr-ai](https://en.askr.ai/terms-of-use-askr-ai) |
| 應用程式的核心功能 | 與您的資料聊天！ askR.ai 是您的個人資料助理：您有資料，但您不喜歡存取資料的技術程式？ 使用資料助理來回答您的問題，並協助您探索！ Microsoft Teams上的第一個資料助理 askR.ai 什麼？ - AI 提供的個人資料助理 - 提供即時 KPI 和資料 viz - 瞭解特定商務詞彙 - 傳送警示 - 建議您進行其他分析 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://en.askr.ai](https://en.askr.ai) |
...
這項資訊是由 askR.ai 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://en.askr.ai/terms-of-use-askr-ai |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | OAuth 程式庫 |
| 您的應用程式是否支援條件式存取原則？ | 否 |

---
title: 依 Eylean 的 Teamutton 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: 所有可用的安全性與合規性資訊，適用于 Team 區、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64877680"
---
# <a name="teamhood"></a>Teamhood

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 4 月 27 日</p>

* <a href="https://teams.microsoft.com/l/app/22372c30-c5de-483e-85b4-8d51db246eda" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002568" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Eylean 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Eylean |
| 公司的網站 | [https://teamhood.com](https://teamhood.com) |
| 應用程式的使用規定 | [https://teamhood.com/terms-of-use/](https://teamhood.com/terms-of-use/) |
| 應用程式的核心功能 | Team要有效率的每日共同作業，是一項專案和工作管理的一體軟體。 Team 要為每個專案經理和小組成員提供必要的功能，以規劃、執行和報告工作資料。 |
| 公司總部位置 | 立陶宛 |
| 應用程式資訊頁面 | [https://teamhood.com/features/teamhood-and-microsoft-teams-...](https://teamhood.com/features/teamhood-and-microsoft-teams-integration/) |
...
Eylean 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: Teamhood 的應用程式資訊（按 Eylean）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
| App 的使用條款 | [https://teamhood.com/terms-of-use/](https://teamhood.com/terms-of-use/) |
| 應用程式的核心功能 | Teamhood 是一種專案和任務管理的所有一體軟體，可提供高效的日常合作。 Teamhood 為每個專案經理和小組成員提供必要的功能，以規劃、執行和報告工作資料。 |
...
此資訊是由 Eylean 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

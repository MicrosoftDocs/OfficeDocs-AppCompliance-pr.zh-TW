---
title: Advantive 365-QA 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: 365-QA 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64881020"
---
# <a name="365-qa"></a>365-QA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 12 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/03e51569-33a8-4000-abb6-9a825e33ece2" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001394" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Advantive 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Advantive |
| 公司的網站 | [https://www.advantive.be](https://www.advantive.be) |
| 應用程式的使用規定 | [https://www.advantive.be/terms-of-service-en/](https://www.advantive.be/terms-of-service-en/) |
| 應用程式的核心功能 | Advantive 是一個 ICT 專業人員的積極小組，他們使用 Microsoft 技術來開發和實作創新的 ICT 解決方案。 我們根據標準 Microsoft 功能，提供最高品質的建議、產品和服務。 這可讓&#8217;客戶提高效率，並利用快速變化的情況。 我們的核心業務是提供服務，包括建議、開發、實作、專案支援和維護。 |
| 公司總部位置 | 比利時 |
...
Advantive 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: SpadeWorx 軟體服務的 BravoNow 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: BravoNow 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/272032ad-0c2e-4928-910e-5d52b19f70d5" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000157" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

SpadeWorx 軟體服務提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.spadeworx.com](https://www.spadeworx.com) |
| 應用程式的使用規定 | [https://docs.pozitive.io/BRAVO_TermsOfService.pdf](https://docs.pozitive.io/BRAVO_TermsOfService.pdf) |
| 應用程式的核心功能 | Bravo 是點對點員工辨識平臺。 |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | [https://bravo.pozitive.io](https://bravo.pozitive.io) |
...
SpadeWorx 軟體服務已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 使用者電子郵件地址。 | [272032ad-0c2e-4928-910e-5d52b19f70d5](../azure/272032ad-0c2e-4928-910e-5d52b19f70d5.md) |

---
title: GuideSpark 的應用程式資訊：GuideSpark 與雲端通訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: GuideSpark Communicate Cloud 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64879740"
---
# <a name="guidespark-communicate-cloud"></a>GuideSpark 通訊雲端

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 10 月 13 日</p>

* <a href="https://teams.microsoft.com/l/app/34b870ca-2417-4660-b835-ebb18ee7ccf9" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003348" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

GuideSpark 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | GuideSpark 通訊雲端 |
| ID | WA200003348 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | GuideSpark |
| 公司的網站 | [https://guidespark.com](https://guidespark.com) |
| 應用程式的使用規定 | [https://www.guidespark.com/terms/](https://www.guidespark.com/terms/) |
| 應用程式的核心功能 | 以物件為目標，並透過 GuideSpark Communicate Cloud 追蹤參與資料，以推動組織變更。 擴充您的傳遞通道，並連絡您的人員，以促進有效的內部通訊。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.guidespark.com/change-communications-software/](https://www.guidespark.com/change-communications-software/) |
...
GuideSpark 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

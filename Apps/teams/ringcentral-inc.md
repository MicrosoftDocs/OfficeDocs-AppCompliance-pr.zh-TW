...
description: RingCentral 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64880930"
---
# <a name="ringcentral"></a>RingCentral

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 5 月 18 日</p>

* <a href="https://teams.microsoft.com/l/app/2f285d77-896a-4c5f-901e-0902316003b5" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000135" target="_blank">在 AppSource 中檢視</a>
...
| 公司的網站 | [https://www.ringcentral.com](https://www.ringcentral.com) |
| 應用程式的使用規定 | [https://www.ringcentral.com/legal/last-update-October-15-20...](https://www.ringcentral.com/legal/last-update-October-15-2019/eulatos.html) |
| 應用程式的核心功能 | 使用快速 Bot 命令和傳訊功能來啟動及加入 RingCentral 視訊或音訊通話。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.ringcentral.com/apps/ringcentral-for-microsoft-...](https://www.ringcentral.com/apps/ringcentral-for-microsoft-teams) |
...
此資訊由 RingCentral， Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC2 認證日期 | 2020-05-11 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 認證日期 | 2020-05-11 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委託 |  允許應用程式透過行事曆傳送會議邀請活動 | [ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| offline_access | 委託 |  允許應用程式取得和更新 oauth 權杖 | [ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read | 委託 |  允許應用程式讀取使用者&#8217;的基本設定檔， (電子郵件、名稱) ，以便在我們的結尾進行連絡人比對。 並允許使用者使用 RingCentral 帳戶登入並連結其 O365 帳戶 | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read.All | 委託 | 允許應用程式讀取具有電話號碼的使用者完整設定檔，以便使用我們的服務撥打電話。 | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |

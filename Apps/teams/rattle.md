...
description: Rattle 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65628277"
---
# <a name="rattle"></a>Rattle

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 2 日</p>

* <a href="https://teams.microsoft.com/l/app/bacd48e3-a2e1-48db-992f-609eb58ac326" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004030" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Rattle 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Rattle |
| 公司的網站 | [https://www.gorattle.com](https://www.gorattle.com) |
| 應用程式的使用規定 | [https://www.gorattle.com/terms-of-service](https://www.gorattle.com/terms-of-service) |
| 應用程式的核心功能 | Rattle 是一種無程式碼自動化工具，可從 MS Teams 管理Salesforce |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
Rattle 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.gorattle.com/privacy-policy |

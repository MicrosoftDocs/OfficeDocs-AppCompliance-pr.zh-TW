---
title: Skoach by Cultify 的應用程式資訊，Lda
ms.author: elmalova
author: elenamalova
ms.date: 11/09/2021
ms.topic: article
...
description: Skoach 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/401ece51-d146-4cfb-b426-d7c8b70b056b" target="_blank">在 Teams 儲存區中查看</a>
...
由 Cultify 提供的資訊，Lda 至 Microsoft：
...
| 合作夥伴公司名稱 | Cultify、Lda |
| 公司的網站 | [https://skoach.com](https://skoach.com) |
| App 的使用條款 | [https://www.skoach.com/terms-of-service](https://www.skoach.com/terms-of-service) |
| 應用程式的核心功能 | Skoach 是一項虛擬教練，可讓小組保持在一起，以一致和生產力的方式，根據重複的問卷調查結果，以行動人員來採用新的行為。 Skoach 不但可增加小組的通訊流程，也會使其保持不變，但也可協助使用者自行追蹤，以應對混合式運作帶來的新挑戰，增加保留 &amp; 生產力。 |
| 公司 headquarter 位置 | 葡萄牙 |
| 應用程式資訊頁面 | |
...
此資訊是由 Cultify 所提供，Lda 如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否可以處理與 Microsoft 客戶或其裝置相關的任何資料？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 資料庫中儲存的資料為何？ | 客戶名稱和電子郵件（若有的話）。 |
...
| 隱私權原則 URL | https://www.skoach.com/privacy-policy |

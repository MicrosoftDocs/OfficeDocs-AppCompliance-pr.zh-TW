---
title: Zoho Corporation Private Limited 的 Zoho 登入應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/17/2022
...
description: Zoho Sign 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* [在Teams存放區中檢視](https://teams.microsoft.com/l/app/7a22873b-81e6-48ed-aee3-6f0e7dd5a104)
* [在 AppSource 中檢視](https://appsource.microsoft.com/product/office/WA104382011)
...
| 應用程式的核心功能 | Zoho Sign 是一個安全的雲端式數位簽章應用程式，可讓您以合法和電子方式簽署、傳送及管理您的商務檔。 您可以輕鬆地建立電子簽名工作流程，以收集簽章、驗證簽署者、觸發提醒，以及即時追蹤簽章和核准狀態。 Zoho Sign 也可讓您直接從網頁瀏覽器和行動裝置應用程式的 Microsoft 應用程式管理所有檔工作。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.zoho.com/sign/help/teams-extension.html](https://www.zoho.com/sign/help/teams-extension.html) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 登入並讀取使用者設定檔 | [a67ee0a9-b008-4e90-986d-1eb8d55a81d6](../azure/a67ee0a9-b008-4e90-986d-1eb8d55a81d6.md) |

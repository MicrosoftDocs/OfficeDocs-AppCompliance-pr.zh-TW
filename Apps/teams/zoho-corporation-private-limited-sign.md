...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| 連絡人。 ReadWrite | 委託 |  | 擁有使用者連絡人的完整存取權。 | [](https://docs.microsoft.com/microsoft-365-app-certification/azure/) |
>| ReadWrite 共用 | 委託 |  | 讀取和寫入使用者和共用連絡人。 | [](https://docs.microsoft.com/microsoft-365-app-certification/azure/) |
>| Files.ReadWrite | 委託 |  | 擁有使用者檔案的完整存取權。 | [](https://docs.microsoft.com/microsoft-365-app-certification/azure/) |
>| Files.ReadWrite.All | 委託 |  | 擁有使用者可以存取之所有檔案的完整存取權。 | [](https://docs.microsoft.com/microsoft-365-app-certification/azure/) |
>| ReadWrite。選取 | 委託 |  | 讀取及寫入使用者選取的檔案。 | [](https://docs.microsoft.com/microsoft-365-app-certification/azure/) |

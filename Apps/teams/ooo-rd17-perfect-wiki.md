---
title: OOO RD17 的完美 Wiki 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: 適用于 Perfect Wiki、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/40906836-4323-4bbe-875e-3cbb134c40a2" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001679" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

OOO RD17 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | OOO RD17 |
| 公司的網站 | [https://perfectwikiforteams.com](https://perfectwikiforteams.com) |
| 應用程式的使用規定 | [https://docs.google.com/document/d/e/2PACX-1vTMQNAdgN7xy6n9...](https://docs.google.com/document/d/e/2PACX-1vTMQNAdgN7xy6n9tNvhDe8Sb2AF8A9v8jfG3gJ503cXzIq1nr_Zbq5aShN0mU49fvADgKZ8a58Oha-C/pub) |
| 應用程式的核心功能 | 適用于 Microsoft Teams 的 Rich Wiki 功能 |
| 公司總部位置 | 俄 ()  |
| 應用程式資訊頁面 | [https://perfectwikiforteams.com](https://perfectwikiforteams.com) |
...
OOO RD17 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委託 | ChannelId 和 channelName，我們會取得在應用程式中顯示使用者的資訊 | [b9604964-9c3a-483e-abf2-1b5cba495081](../azure/b9604964-9c3a-483e-abf2-1b5cba495081.md) |
>| Team.ReadBasic.All | 委託 | 我們會取得使用者的 teamId 並取得小組名稱 | [b9604964-9c3a-483e-abf2-1b5cba495081](../azure/b9604964-9c3a-483e-abf2-1b5cba495081.md) |
>| User.Read | 委託 | userId，用來瞭解登入的使用者 | [b9604964-9c3a-483e-abf2-1b5cba495081](../azure/b9604964-9c3a-483e-abf2-1b5cba495081.md) |

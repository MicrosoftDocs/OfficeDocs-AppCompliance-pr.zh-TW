...
description: 所有可用的安全性與合規性資訊，適用于 enmacc、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/260128ec-36bf-49df-956f-7102feba3e49" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003282" target="_blank">在 AppSource 中檢視</a>
...
| 合作夥伴公司名稱 | enmacc |
| 公司的網站 | [https://enmacc.com](https://enmacc.com) |
| 應用程式的使用規定 | [https://enmacc.com/terms_en.html](https://enmacc.com/terms_en.html) |
| 應用程式的核心功能 | 接收Microsoft Teams中的所有 enmacc 即時能源交易活動。 |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | |
...
此資訊是由 Enmacc 所提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

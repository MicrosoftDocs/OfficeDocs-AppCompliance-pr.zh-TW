---
title: 適用于 Genuity by Stratum Networks 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2022
...
description: Genuity 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/1d37e38f-7513-4239-8251-208a749bba7e" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004008" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Stratum Networks 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Stratum Networks |
| 公司的網站 | [https://secure.gogenuity.com](https://secure.gogenuity.com) |
| 應用程式的使用規定 | [https://gogenuity.com/terms](https://gogenuity.com/terms) |
| 應用程式的核心功能 | 在Microsoft Teams內管理您的 Genuity 技術服務人員 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
此資訊已由 Stratum Networks 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

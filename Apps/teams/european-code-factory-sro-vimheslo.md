---
title: Vimheslo by European Code Factory s.r.o 的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/08/2022
...
description: vimheslo 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/73ee6b52-6b68-41c1-a7c5-91919e05b845" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003843" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

歐洲 Code Factory s.r.o 所提供的資訊。 至 Microsoft：
...
| 應用程式的使用規定 | [https://ecodef.cz/terms_of_use.html](https://ecodef.cz/terms_of_use.html) |
| 應用程式的核心功能 | 密碼管理員 |
| 公司總部位置 | 捷克文 |
| 應用程式資訊頁面 | [https://vimheslo.cz](https://vimheslo.cz) |
...
此資訊已由歐洲 Code Factory s.r.o 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read.All | 委託 | 資料會儲存在OneDrive或SharePoint文件庫中，應用程式需要讀取資料。 | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
>| Sites.Read.All | 委託 | Team 內容中的應用程式會將資料儲存在相關SharePoint文件庫中，應用程式需要讀取網站名稱以設定路徑，其中包含資料的檔案位於該路徑。 | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
>| User.Read | 委託 | 應用程式必須知道個人OneDrive才能在該處儲存個人資料。 | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
>| 電子郵件 | 委託 | 允許共用資料。 | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |

---
title: Vimheslo 依歐代碼工廠 s.r.o. 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/08/2022
...
* <a href="https://teams.microsoft.com/l/app/73ee6b52-6b68-41c1-a7c5-91919e05b845" target="_blank">在 Teams 儲存區中查看</a>
...
歐洲程式碼工廠 s.r.o. 提供的資訊 至 Microsoft：
...
此資訊由歐洲程式碼工廠 s.r.o. 提供 關於此應用程式如何收集和儲存組織資料，以及您的組織將會對應用程式收集的資料所做的控制。

---
title: Akouo 技術 Inc. Akouo 轉譯的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Akouo 轉譯的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
<p>上次於開發人員的更新日期：2022年3月26日</p>

* <a href="https://teams.microsoft.com/l/app/d863a24b-7cdd-46c9-8309-a15878f4f7bf" target="_blank">在 Teams 儲存區中查看</a>
...
Akouo 技術 Inc. 所提供的資訊給 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Akouo Interpretation |
| ID | WA200003814 |
| 支援 Office 365 用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Akouo Technologies Inc. |
| 公司的網站 | [https://akouo.io](https://akouo.io) |
| App 的使用條款 | [https://akouo.io/terms](https://akouo.io/terms) |
| 應用程式的核心功能 | 讓您的會議使用同時轉譯的多語系。 |
| 公司 headquarter 位置 | 英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://akouo.io](https://akouo.io) |
...
Akouo 技術 Inc. 已提供此資訊。關於此應用程式如何收集和儲存組織的資料，以及您的組織將會透過應用程式收集的資料所產生的控制項。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否可以處理與 Microsoft 客戶或其裝置相關的任何資料？ | 是 |
| 您的應用程式所處理的資料為何？ | 用於 MS Teams 內的使用者設定檔資料、圖像及音訊。 |
| App 是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 資料庫中儲存的資料為何？ | 使用者的電子郵件地址。 |
...
| 隱私權原則 URL | https://akouo.io/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| OnlineMeetings.Read | 委託 | 用於取得會議詳細資料（如開始時間等）。只要求會議 Organiser。 | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
>| offline_access | 應用程式 | 由 Microsoft&#8217;s 單一登入架構自動要求。 https://docs.microsoft.com/graph/permissions-reference#remarks-15  | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
>| openid | 應用程式 | 使用 Microsoft/Azure 登入會話驗證使用者 | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |

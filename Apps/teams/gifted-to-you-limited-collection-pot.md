...
description: 集合伺花、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/dee26c7b-3bce-4fe3-af55-1999276e1a72" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002016" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

提供給您的資訊僅限於 Microsoft：
...
| 公司的網站 | [https://www.collectionpot.com](https://www.collectionpot.com) |
| 應用程式的使用規定 | [https://www.collectionpot.com/terms-of-service/](https://www.collectionpot.com/terms-of-service/) |
| 應用程式的核心功能 | 個人化 &amp; 的有趣方式，可收集任何時間、生活事件或活動中的金錢 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | |
...
這項資訊是由[提供給您有限] 所提供，說明此應用程式收集和儲存組織資料的方式，以及貴組織對於應用程式所收集資料的控制。

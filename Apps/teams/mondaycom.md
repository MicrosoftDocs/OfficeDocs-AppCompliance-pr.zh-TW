---
title: monday.com 所 monday.com 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: 所有可用的安全性與合規性資訊，適用于 monday.com、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/eab2d3ce-6d6a-4415-abc4-5f40a8317b1f" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001798" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

monday.com 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | monday.com |
| 公司的網站 | [https://monday.com](https://monday.com) |
| 應用程式的使用規定 | [https://monday.com/l/legal/tos/](https://monday.com/l/legal/tos/) |
| 應用程式的核心功能 | monday.com 是一種多功能的工作 OS，可支援遠端團隊合作，以組織、建構及簡化所有程式、專案和程式。  透過 monday.com，您可以使用建置組塊&#8211;例如面板、檢視、圖表、自動化和整合 - 建立自訂工作流程應用程式來執行程式、專案和日常工作。 建立新的 monday.com 板，或直接從Microsoft Teams內新增至現有的面板，並輕鬆地將小組&#8217;在一個共同作業工作區中的工作視覺化。 |
| 公司總部位置 | 以色列 |
| 應用程式資訊頁面 | |
...
此資訊是由 monday.com 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC1 認證日期 | 2021-05-01 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 認證日期 | 2021-05-01 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 認證日期 | 2021-05-01 |

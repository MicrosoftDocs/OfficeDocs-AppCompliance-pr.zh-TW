...
| App 的使用條款 | [https://monday.com/l/legal/tos/](https://monday.com/l/legal/tos/) |
| 應用程式的核心功能 | monday.com 是一種功能豐富的工作作業系統，可為遠端團隊合作-組織、構建和簡化所有的程式、專案和流程。  透過 monday.com，您可以使用組建區塊 &#8211; 例如板、views、圖表、自動化和整合-建立自訂工作流程應用程式，以執行程式、專案及日常工作。 在 Microsoft Teams 中直接建立新的 monday.com 板，或直接加入至現有的專案，並在一個共同作業工作區中輕鬆顯示您的小組&#8217;工作。 |
...
| 最近的 SOC1 認證日期 |  2021-05-01 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 您已完成哪一種 SOC 2 憑證？ |   |
| 最近的 SOC2 認證日期 |  2021-05-01 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最近的 SOC3 認證日期 |  2021-05-01 |

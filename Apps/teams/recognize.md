...
description: 辨識、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/bbcb7b0c-c687-4be0-91e3-362afebbbcd0" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001519" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Recognize 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 認識 |
| 公司的網站 | [https://recognizeapp.com](https://recognizeapp.com) |
| 應用程式的使用規定 | [https://recognizeapp.com/terms](https://recognizeapp.com/terms) |
| 應用程式的核心功能 | 具有對等辨識、提名、獎勵、 &amp; 獎勵憑證的員工參與平臺。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://recognizeapp.com](https://recognizeapp.com) |
...
這項資訊是由 Recognize 所提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://recognizeapp.com/privacy |

---
title: Hermis， Inc. 的應用程式資訊，適用于 Hermis 的有趣性
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: 所有可用的安全性與合規性資訊，適用于 Hermis 的有趣性、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
---
# <a name="funtivity-by-hermis"></a>Hermis 的有趣性

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/d75e14a9-9bfd-43b4-8430-7264da3b6995" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004244" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Hermis， Inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Hermis， Inc. |
| 公司的網站 | [https://www.herm.is](https://www.herm.is) |
| 應用程式的使用規定 | [https://www.herm.is/terms](https://www.herm.is/terms) |
| 應用程式的核心功能 | Hermis 的有趣性有各種不同的活動 &amp; 內容，包括小組建置、會議分組研討會、文化活動等等。 每週有十多個不同的活動和新的精心製作活動，&#8217;讓每個人都能享受。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.herm.is/integrations/funtivity-msteams](https://www.herm.is/integrations/funtivity-msteams) |
...
此資訊由 Hermis， Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 客戶的識別碼、名稱 &amp; 電子郵件是用來在 Hermis 上註冊使用者。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者名稱 &amp; 電子郵件會儲存在我們的資料庫中。 使用者電子郵件會使用 AES-256-CBC 加密 |
...
| 隱私權原則 URL | https://www.herm.is/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 我們會使用使用者的設定檔詳細資料，在我們的平臺上註冊使用者。 | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| 電子郵件 | 委託 | 我們會使用使用者的設定檔詳細資料，在我們的平臺上註冊使用者。 | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| openid | 委託 | 我們會使用使用者的設定檔詳細資料，在我們的平臺上註冊使用者。 | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| 設定檔 | 委託 | 我們會使用使用者的設定檔詳細資料，在我們的平臺上註冊使用者。 | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |

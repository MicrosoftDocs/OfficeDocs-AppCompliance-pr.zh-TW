---
title: Gameinar 的應用程式資訊（按 Heuristix）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Gameinar 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/10a3a812-c72d-47d4-b9b5-6425c6fed158" target="_blank">在 Teams 儲存區中查看</a>
...
| App 的使用條款 | [https://www.disprz.com/terms-of-service-gameinar/](https://www.disprz.com/terms-of-service-gameinar/) |
| 應用程式的核心功能 | 建立參與虛擬 facilitations！ |
...
此資訊是由 Heuristix 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

---
title: 依藍色區域 GmbH 的 polumana 導覽路線規劃工具的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Polumana 導覽路線規劃工具、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "66655970"
---
# <a name="polumana-tour-route-planner"></a>polumana 導覽路線規劃工具

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 4 月 5 日</p>

* <a href="https://teams.microsoft.com/l/app/4b4b3e3d-a1eb-4b52-b0b9-ba1a79b6be79" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004331" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

藍區 GmbH 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | polumana 導覽路線規劃工具 |
| ID | WA200004331 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | blue-zone GmbH |
| 公司的網站 | [https://blue-zone.de](https://blue-zone.de) |
| 應用程式的使用規定 | [https://azaap-disp-route-planning.azurewebsites.net/#/terms...](https://azaap-disp-route-planning.azurewebsites.net/#/termsofuse) |
| 應用程式的核心功能 | Polumana 導覽 &amp; 路線規劃工具，可提升客戶造訪的效率 |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | |
...
藍區 GmbH 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 連絡人、電子郵件地址 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 電子郵件、連絡人的位址 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 應用程式 | 路由優化之後，我們需要建立新的約會並刪除現有的約會 | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
>| Contacts.Read | 應用程式 | 我們需要讀取連絡人，才能建立約會 | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
>| User.Read | 應用程式 | 我們需要取得使用者的電子郵件以保存設定 | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |

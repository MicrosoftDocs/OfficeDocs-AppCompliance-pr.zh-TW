...
description: CT 簡報者的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66817624"
---
# <a name="ct-presenter"></a>CT 簡報者

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 30 日</p>

* <a href="https://teams.microsoft.com/l/app/f33e9d75-e765-49f9-b7b2-d4bfa89066a0" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004401" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Customertimes 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Customertimes |
| 公司的網站 | [https://customertimes.com](https://customertimes.com) |
| 應用程式的使用規定 | [https://rd.ctclm.com/eula](https://rd.ctclm.com/eula) |
| 應用程式的核心功能 | 遠端簡報 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://help.customertimes.com/articles/](https://help.customertimes.com/articles/) |
...
Customertimes 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

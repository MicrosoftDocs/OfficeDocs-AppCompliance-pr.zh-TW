---
title: Solutions2Share GmbH 的檔案管理員應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: 在 CSA 星型登錄中，檔案管理員的所有可用安全性和符合性資訊資訊，其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及安全性/符合性資訊。
...
ms.locfileid: "64463729"
---
# <a name="file-manager"></a>檔案管理員

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新日期：2021年12月30日</p>

* <a href="https://teams.microsoft.com/l/app/4946e155-584a-412d-aac1-48975e073587" target="_blank">在 Teams 儲存區中查看</a>
...
| 應用程式的核心功能 | 透過 Microsoft Teams 中的所有小組管理檔案 |
| 公司 headquarter 位置 | 德國 |
| 應用程式資訊頁面 | [https://www.solutions2share.com/file-manager/](https://www.solutions2share.com/file-manager/) |

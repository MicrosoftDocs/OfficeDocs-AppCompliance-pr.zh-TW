---
title: Highspot by Highspot 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
description: Highspot、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/55b7c78e-4768-47e0-97be-e6b953e6a0d0" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002894" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Highspot 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Highspot |
| 公司的網站 | [https://www.highspot.com](https://www.highspot.com) |
| 應用程式的使用規定 | [https://www.highspot.com/terms/](https://www.highspot.com/terms/) |
| 應用程式的核心功能 | Highspot 是代表愛的銷售啟用平臺。 我們讓公司能夠提升推動策略性成長的客戶交談。 我們的直覺式平臺結合了智慧型內容管理、訓練、內容指引、客戶參與和可採取動作的分析。 進入市場小組會使用 Highspot 來提供統一的購買體驗，以增加營收、客戶滿意度和保留期。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.highspot.com/overview/](https://www.highspot.com/overview/) |
...
Highspot 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

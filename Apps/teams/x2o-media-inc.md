---
title: X2O Media， Inc. 的 X2O 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: X2O 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/647624e1-056f-43cb-a112-b9bc64c81ef4" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003735" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

X2O Media， Inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | X2O Media， Inc. |
| 公司的網站 | [https://www.x2omedia.com](https://www.x2omedia.com) |
| 應用程式的使用規定 | [https://www.x2omedia.com/en/terms-of-use/](https://www.x2omedia.com/en/terms-of-use/) |
| 應用程式的核心功能 | 使用 X2O 管道將商務資訊傳達給全球員工。 |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | |
...
X2O Media， Inc. 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC1 認證日期 | 2020-05-14 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 您達成哪一個 SOC 2 認證？ | type2 |
| 最新的 SOC2 認證日期 | 2020-05-14 |
...
| 隱私權原則 URL | https://www.x2omedia.com/privacy |

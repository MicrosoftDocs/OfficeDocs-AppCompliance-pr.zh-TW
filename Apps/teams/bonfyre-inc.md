---
title: Bonfyre、 Inc 的 Bonfyre 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: Bonfyre 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66547022"
---
# <a name="bonfyre"></a>Bonfyre

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 3 月 30 日</p>

* <a href="https://teams.microsoft.com/l/app/829fa155-8058-4b1e-b43a-86efb74da5d4" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004185" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由 Bonfyre， Inc 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Bonfyre, Inc |
| 公司的網站 | [https://bonfyreapp.com](https://bonfyreapp.com) |
| 應用程式的使用規定 | [https://bonfyreapp.com/terms-of-use-teams](https://bonfyreapp.com/terms-of-use-teams) |
| 應用程式的核心功能 | 將 Bonfyre 參與功能的威力帶入員工每天使用的工作頻道。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://bonfyreapp.com/blog/bonfyre-now-integrates-with-mic...](https://bonfyreapp.com/blog/bonfyre-now-integrates-with-microsoft-teams) |
...
此資訊由 Bonfyre， Inc 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者提交的內容和使用者設定檔資料。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者名稱、電子郵件地址和設定檔圖片。  這項資訊可能會在客戶上線期間預先共用，但我們會與使用者設定檔同步處理，以將資訊保持在最新狀態。 |
...
| 隱私權原則 URL | https://bonfyreapp.com/privacy-policy-teams |

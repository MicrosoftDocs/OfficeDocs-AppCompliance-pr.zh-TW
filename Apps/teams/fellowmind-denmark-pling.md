---
title: Pling by Fellowmind 丹麥的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Pling 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66655945"
---
# <a name="pling"></a>Pling

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 27 日</p>

* <a href="https://teams.microsoft.com/l/app/9ca359c6-8466-4519-b3b9-29573ebe39ca" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004294" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由丹麥同仁提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Fellowmind Denmark |
| 公司的網站 | [https://intraactive.net](https://intraactive.net) |
| 應用程式的使用規定 | [https://intraactive.net/terms-of-use-pling](https://intraactive.net/terms-of-use-pling) |
| 應用程式的核心功能 | 來自整合式應用程式或 Logic Apps 或 Power Automate 的通知 |
| 公司總部位置 | 丹麥 |
| 應用程式資訊頁面 | |
...
這份資訊是由丹麥同仁提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://intraactive.net/privacy-policy-play |
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | 支援所有原則，因為我們的驗證配置原生於 Microsoft Teams |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | 委託 | 檢查應用程式是否已安裝 | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| Group.Read.All | 委託 | 尋找所有群組以允許使用者選擇應該接收 Pling 訊息的人員 | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| People.Read | 委託 | 取得使用者的相關資訊，以確保在傳送 Pling 訊息時有適當的目標 | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| User.Read | 委託 | 取得目前使用者的相關資訊，以檢查他們是誰，以及他們是否已向 Pling 註冊 | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| User.ReadBasic.All | 委託 | 根據選取的群組尋找使用者，以取得要傳送訊息的使用者清單 | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| Group.Read.All | 應用程式 | 將訊息傳送至群組時，需要進行查閱並尋找每個群組 | [83797eec-6657-4fda-a566-d1ac05bfe874](../azure/83797eec-6657-4fda-a566-d1ac05bfe874.md) |
>| Organization.Read.All | 應用程式 | 取得目前下載 Pling 以自動化上線的組織相關資訊 | [83797eec-6657-4fda-a566-d1ac05bfe874](../azure/83797eec-6657-4fda-a566-d1ac05bfe874.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | 應用程式 | 當使用者收到訊息時，自動安裝 Pling 的主動式傳訊需要 | [83797eec-6657-4fda-a566-d1ac05bfe874](../azure/83797eec-6657-4fda-a566-d1ac05bfe874.md) |

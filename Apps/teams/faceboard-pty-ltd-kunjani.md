---
title: 由 FACEBOARD (PTY) LTD 提供的適用于 Kunjani 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/10/2021
...
description: 所有可用的安全性與合規性資訊，適用于在 CSA STAR 登錄中，適用于因為應項、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及安全性/合規性資訊。
...
ms.locfileid: "64875430"
---
# <a name="kunjani"></a>Kunjani

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 10 月 10 日</p>

* <a href="https://teams.microsoft.com/l/app/6b4ac65a-764d-4021-bf3f-40cb2d137a33" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003049" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由 FACEBOARD (PTY) LTD 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.kunjani.co](https://www.kunjani.co) |
| 應用程式的使用規定 | [https://www.kunjani.co/termsandconditions](https://www.kunjani.co/termsandconditions) |
| 應用程式的核心功能 | 使用您所設計的互動式Gamejani 遊戲，讓您的會議上線。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://Kunjani.co](https://Kunjani.co) |
...
此資訊由 FACEBOARD (PTY) LTD 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

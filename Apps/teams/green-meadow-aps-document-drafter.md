...
description: 檔草稿程式的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65357048"
---
# <a name="document-drafter"></a>檔草稿者

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 2 月 2 日</p>

* <a href="https://teams.microsoft.com/l/app/6b96e77c-08d1-432e-819f-7dc7b6585a1a" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004059" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Green 即會提供資訊給 Microsoft：
...
| 合作夥伴公司名稱 | 綠色的 Green Green Aps |
| 公司的網站 | [https://gmeadow.com](https://gmeadow.com) |
| 應用程式的使用規定 | [https://tinyurl.com/2p9dw3tm](https://tinyurl.com/2p9dw3tm) |
| 應用程式的核心功能 | 在Microsoft Teams內的自動化檔上使用並共同作業。 |
| 公司總部位置 | 丹麥 |
| 應用程式資訊頁面 | [https://gmeadow.com/document-drafter-inside-microsoft-teams/](https://gmeadow.com/document-drafter-inside-microsoft-teams/) |
...
此資訊已由 Green 因此 ApS 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 電子郵件識別碼、名稱和安全性群組。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 電子郵件識別碼、名稱和安全性群組。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 兩者 | 若要讀取通道中的傳送程式庫，使用者在儲存應用程式中產生的檔時，需要這些程式庫才能流覽資料夾。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| Files.ReadWrite.All | 委託 | 讓使用者流覽或建立資料夾，以儲存在我們的應用程式中產生的檔。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| Group.ReadWrite.All | 委託 | 若要識別Teams成員以進行存取管理。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| TeamsActivity.Send | 委託 | 用於傳送問卷/問卷更新等相關訊息。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| User.Read.All | 委託 | 若要讀取完整設定檔，以瞭解使用者擁有的群組成員資格 - 用來將訊息傳送至Teams活動摘要。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| 電子郵件 | 委託 | 我們使用電子郵件識別碼來識別後端系統中的使用者。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| openid | 委託 | 使用者驗證。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| 設定檔 | 委託 | 若要藉由取得使用者的虛擬人偶/相片來增強使用者體驗，如果有的話。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |

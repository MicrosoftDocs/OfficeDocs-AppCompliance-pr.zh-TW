---
title: 由 FabricHR Inc. 元件的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: 元件、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "64879410"
---
# <a name="assembly"></a>組件

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 5 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/3e674b5f-ba5d-41cc-8b06-e065b4394aeb" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002271" target="_blank">在 AppSource 中檢視</a>
...
| 公司的網站 | [https://www.joinassembly.com](https://www.joinassembly.com) |
| 應用程式的使用規定 | [https://joinassembly.com/terms-of-service](https://joinassembly.com/terms-of-service) |
| 應用程式的核心功能 | 元件是員工參與和辨識平臺。 |
| 公司總部位置 | 美國美國 |
...
這項資訊是由致使者HR Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC1 認證日期 | 2020-09-01 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 最新的 SOC2 認證日期 | 2021-02-28 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | 委託 | 允許使用者從我們的應用程式將應用程式指派給剛建立的通道 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Directory.Read.All | 應用程式 | 讓設定檔保持同步，讓成員可在元件中正確搜尋 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Group.Read.All | 委託 | 我們會觀察資料，以確定他們可以將我們的應用程式指派給正確的群組 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Teams。ReadBasic.All | 應用程式 | 將應用程式指派給正確小組索引標籤的能力 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| TeamsTab.Create | 應用程式 | 我們使用此選項來讓應用程式正確地附加至頻道/小組 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| 電子郵件 | 委託 | 使用者的電子郵件，讓我們可以授與他們其特定帳戶的存取權 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| 設定檔 | 委託 | 自動填入元件並與Microsoft Teams中的變更保持同步的使用者名稱 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |

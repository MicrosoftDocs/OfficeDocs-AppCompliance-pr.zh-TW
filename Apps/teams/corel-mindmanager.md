---
title: MindManager by Corel 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2021
...
description: MindManager 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64879400"
---
# <a name="mindmanager"></a>MindManager

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 5 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/cebe4a59-b076-47f3-a7bf-79148daf82f7" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002261" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Corel 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Corel |
| 公司的網站 | [https://www.mindmanager.com](https://www.mindmanager.com) |
| 應用程式的使用規定 | [https://www.mindjet.com/go/mmcloudterms](https://www.mindjet.com/go/mmcloudterms) |
| 應用程式的核心功能 | 共同編輯地圖、管理小組儀表板、建立流程圖，以及讓專案保持在檢視中。 |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | |
...
Corel 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 委託 | 在 MindManager 檔案中所做的變更相關資訊，這些變更接著可以張貼為訊息 | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Chat.Send | 委託 | 在 MindManager 檔案中所做的變更相關資訊，這些變更接著可以張貼為訊息 | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Files.ReadWrite | 委託 | 網站清單、資料夾清單、檔案中繼資料、檔案內容 - 針對檔案瀏覽器，使用者可以流覽其檔案以開啟 MindManager (.mmap) 檔案。 | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Sites.ReadWrite.All | 委託 | 網站清單、資料夾清單、檔案中繼資料、檔案內容 - 針對檔案瀏覽器，使用者可以流覽其檔案以開啟 MindManager (.mmap) 檔案。 | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| User.Read | 委託 | 設定檔資料：識別使用者並顯示其設定檔 | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| offline_access | 委託 | 這可讓我們在稍後如有需要，代表使用者將檔案儲存回原始位置。 | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |

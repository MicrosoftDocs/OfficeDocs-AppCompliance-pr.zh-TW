---
title: Derdack SIGNL4 的 SIGNL4 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: SIGNL4 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66845015"
---
# <a name="signl4"></a>SIGNL4

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 7 月 15 日</p>

* <a href="https://teams.microsoft.com/l/app/bd19c878-00b7-47cd-9b65-74a2def84427" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001239" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Derdack SIGNL4 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.derdack.com](https://www.derdack.com) |
| 應用程式的使用規定 | [https://www.signl4.com/terms_of_use/](https://www.signl4.com/terms_of_use/) |
| 應用程式的核心功能 | Derdack SIGNL4 可針對操作關鍵基礎結構啟用行動裝置警示和任何事件回應。 它支援作業和隨選小組。 |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | [https://www.signl4.com](https://www.signl4.com) |
...
Derdack SIGNL4 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | email address |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 電子郵件地址 |
...
| 隱私權原則 URL | https://www.signl4.com/privacy-policy/ |

...
| App 的使用條款 | [https://www.signl4.com/terms_of_use/](https://www.signl4.com/terms_of_use/) |
| 應用程式的核心功能 | Derdack SIGNL4 是行動通知應用程式，可針對工作小組進行可靠的通知，並提升其生產力。 |

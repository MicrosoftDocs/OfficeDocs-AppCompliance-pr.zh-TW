...
由 Svava 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Svava for Meetings |
| ID | WA200001723 |
...
| 應用程式資訊頁面 | [https://svava.io](https://svava.io) |
...
此資訊是由 Svava 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

---
title: Clixie by Clixie Media LLC 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Clixie 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "64463700"
---
# <a name="clixie"></a>Clixie

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員更新：2022年3月23日</p>

* <a href="https://teams.microsoft.com/l/app/3ff43e1b-180b-4aab-916e-e49aaaefbccb" target="_blank">在 Teams 儲存區中查看</a>
...
Clixie Media LLC 所提供的資訊給 Microsoft：
...
| 合作夥伴公司名稱 | Clixie 媒體 LLC |
| 公司的網站 | [https://clixiemedia.com](https://clixiemedia.com) |
| App 的使用條款 | [https://clixiemedia.com/terms-and-conditions/](https://clixiemedia.com/terms-and-conditions/) |
| 應用程式的核心功能 | Clixie 會進行即時或混合會議會話的錄製，並將其變成有用、吸引和記憶的隨選即用訓練模組，Clixie 會即時自動更新;透過憑證和資料一覽，您可以用來實際作出決策。 具有鎖定功能的 chaptering、以影片進行中的評估/polls、適應性教育和 gamification 只是一些強大的功能，專門用於促進合約。 |
| 公司 headquarter 位置 | 美國地區 |
| 應用程式資訊頁面 | [https://clixiemedia.com](https://clixiemedia.com) |
...
此資訊已由 Clixie Media LLC 提供，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://clixiemedia.com/privacy-policy/ |

---
title: UserVoice by UserVoice 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: UserVoice 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/1a2efc96-5f06-4b76-ad90-00ce6c1ac74d" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001944" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

UserVoice 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | UserVoice |
| 公司的網站 | [https://www.uservoice.com](https://www.uservoice.com) |
| 應用程式的使用規定 | [https://www.uservoice.com/tos](https://www.uservoice.com/tos) |
| 應用程式的核心功能 | 在Microsoft Teams內取得產品意見反應計畫的即時更新。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://help.uservoice.com/hc/en-us/articles/360052330913-M...](https://help.uservoice.com/hc/en-us/articles/360052330913-Microsoft-Teams-Integration) |
...
UserVoice 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

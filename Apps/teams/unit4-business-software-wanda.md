---
title: Wanda by Unit4 Business Software 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Wanda 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/73642721-0f64-4d3a-ab6c-2c1fe053aa80" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004038" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Unit4 Business Software 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Unit4 Business Software |
| 公司的網站 | [https://www.unit4.com](https://www.unit4.com) |
| 應用程式的使用規定 | [https://www.unit4.com/terms-and-conditions](https://www.unit4.com/terms-and-conditions) |
| 應用程式的核心功能 | Wanda 可協助您處理最例行的 ERP 工作。 |
| 公司總部位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | [https://get-wanda-help.u4pp.com](https://get-wanda-help.u4pp.com) |
...
Unit4 Business Software 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | Bot 特定Microsoft Teams使用者識別碼 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | Bot 特定Microsoft Teams使用者識別碼 |
...
| 最新的 SOC1 認證日期 | 2021-11-05 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 您達成哪一個 SOC 2 認證？ | type2 |
| 最新的 SOC2 認證日期 | 2021-11-23 |
...
| 隱私權原則 URL | https://info.unit4.com/rs/400-HYB-295/images/Unit4-People-Platform-Service-Description-v.1.1-September-2021-%28EN%29-%281%29.pdf |

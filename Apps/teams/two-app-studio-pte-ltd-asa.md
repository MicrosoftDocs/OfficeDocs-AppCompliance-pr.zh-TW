...
* <a href="https://teams.microsoft.com/l/app/2973405f-6e3b-45a3-a3a4-7c85d8d3be88" target="_blank">在 Teams 儲存區中查看</a>
...
由兩個應用程式工作室 Pte 有限公司提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 兩個應用程式工作室 Pte 有限公司。 |
| 公司的網站 | [https://asa.team](https://asa.team) |
...
這項資訊是由兩個應用程式工作室 Pte 有限公司所提供。關於此應用程式如何收集和儲存組織資料，以及您的組織將會對應用程式所收集的資料所做的控制。
...
| 資料庫中儲存的資料為何？ | microsoft tenantId，供使用者和其傳送 bot 郵件的群組 |
...
| 隱私權原則 URL | https://asa.team/privacypolicy |

---
title: Vonage Business Communications by Vonage 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/05/2021
...
description: Vonage Business Communications 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/47c6b242-a067-426c-9a02-0f680a42c488" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002988" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Vonage 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Vonage |
| 公司的網站 | [https://www.vonage.com](https://www.vonage.com) |
| 應用程式的使用規定 | [https://www.vonage.com/legal/unified-communications/tos/glo...](https://www.vonage.com/legal/unified-communications/tos/global-vbc-tos/) |
| 應用程式的核心功能 | 適用于 Teams 的 Vonage Business Communications 可透過 Vonage 直接路由來啟用通話、簡訊和多媒體簡訊。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.vonage.com/unified-communications/](https://www.vonage.com/unified-communications/) |
...
Vonage 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | 應用程式 | 沒有使用此許可權儲存任何資料 | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
>| User.Read | 委託 | 取得 Azure 使用者識別碼和租使用者識別碼，以便稍後傳送通知給此使用者。 | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |

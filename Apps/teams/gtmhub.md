---
title: Gtmhub by Gtmhub 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Gtmhub 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66564537"
---
# <a name="gtmhub"></a>Gtmhub

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/5fdd80e2-4d58-4c5c-ac85-356c1b2a0bba" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001164" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Gtmhub 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Gtmhub |
| 公司的網站 | [https://www.gtmhub.com](https://www.gtmhub.com) |
| 應用程式的使用規定 | [https://gtmhub.com/terms-of-service](https://gtmhub.com/terms-of-service) |
| 應用程式的核心功能 | 可讓您檢視、共用及更新您的 OKR，而不需要離開 MS Teams。 檢視 OKR、在通道中共用，以及更新關鍵結果從未如此快速。 更新的體驗與 Gtmhub 一樣順暢。 您可以從 [Gtmhub] 索引標籤存取 [中樞]，這會顯示您所有的 OKR 和工作。  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://help.gtmhub.com/en/articles/3558083-how-to-view-and...](https://help.gtmhub.com/en/articles/3558083-how-to-view-and-update-okrs-from-ms-teams) |
...
Gtmhub 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://help.gtmhub.com/en/articles/633973-privacy-policy |

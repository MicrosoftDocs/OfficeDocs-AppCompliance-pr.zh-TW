...
| App 的使用條款 | [https://gtmhub.com/terms-of-service](https://gtmhub.com/terms-of-service) |
| 應用程式的核心功能 | 可讓您查看、共用和更新您的 OKRs，而不需要保留 MS Teams。 查看 OKRs，在通道中共用，並更新重要結果，都不會快。 更新的體驗完全像是 Gtmhub 中的順利。 在 [Gtmhub] 索引標籤中，您可以存取中樞，以顯示所有的 OKRs 和工作。  |
...
| 您已完成哪一種 SOC 2 憑證？ |   |
| 最近的 SOC2 認證日期 |  2020-09-30 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最近的 SOC3 認證日期 |  2020-09-30 |

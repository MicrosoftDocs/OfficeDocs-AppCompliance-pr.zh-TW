...
* <a href="https://teams.microsoft.com/l/app/ed754df9-2e28-48ef-9f0f-e0909ce4f320" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001496" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Cisco 提供給 Microsoft 的資訊：
...
| 應用程式的使用規定 | [https://www.cisco.com/c/en/us/products/universal-cloud-agre...](https://www.cisco.com/c/en/us/products/universal-cloud-agreement.html) |
| 應用程式的核心功能 | 使用 Teams App 直接從 MS 進行 Cisco Voice 和視訊通話。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
Cisco 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

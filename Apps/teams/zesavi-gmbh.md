---
title: Zesavi 的應用程式資訊（按 Zesavi GmbH）
ms.author: elmalova
author: elenamalova
ms.date: 01/03/2022
ms.topic: article
...
description: Zesavi 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
| 公司的網站 | [https://zesavi.com](https://zesavi.com) |
| App 的使用條款 | [https://zesavi.com/en/impressum/](https://zesavi.com/en/impressum/) |
| 應用程式的核心功能 | Zesavi 可讓公司內的每個人都 &amp; 直接在網際網路瀏覽器中建立、編輯共用簡短的影片 documentations。 |
...
| 隱私權原則 URL | https://zesavi.com/en/datenschutz/ |

---
title: HelloTeam by HelloTeam Inc. 的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/10/2021
...
description: HelloTeam 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/58426e2f-12cd-4b86-bae3-37feb09bf146" target="_blank">在 Teams 儲存區中查看</a>
...
HelloTeam Inc. 所提供的資訊給 Microsoft：
...
| App 的使用條款 | [https://www.helloteam.com/index.php/terms-and-conditions/](https://www.helloteam.com/index.php/terms-and-conditions/) |
| 應用程式的核心功能 | 現代工作力的所有共同人員成功平臺 |
...
此資訊是由 HelloTeam Inc. 提供。關於此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

---
title: Pajat Solutions Oy 的 Poimapper 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Poimapper 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66655950"
---
# <a name="poimapper"></a>Poimapper

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 30 日</p>

* <a href="https://teams.microsoft.com/l/app/f2dac71d-b558-496b-be58-b28980e2cfd9" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004353" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Pajat Solutions Oy 所提供的資訊。 至 Microsoft：
...
| 合作夥伴公司名稱 | Pajat Solutions Oy. |
| 公司的網站 | [https://poimapper.com](https://poimapper.com) |
| 應用程式的使用規定 | [https://portal.poimapper.com/termofservice.jsp](https://portal.poimapper.com/termofservice.jsp) |
| 應用程式的核心功能 | Poimapper 會變更組織收集和分析欄位資料的方式。 |
| 公司總部位置 | 芬蘭 |
| 應用程式資訊頁面 | |
...
此資訊已由 Pajat Solutions Oy 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://portal.poimapper.com/privacy.jsp |

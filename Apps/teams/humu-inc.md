...
description: Humu 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64879330"
---
# <a name="humu"></a>Humu

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 8 月 20 日</p>

* <a href="https://teams.microsoft.com/l/app/7fbbb34f-a0fa-471b-9c2a-abc15daad3cb" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003302" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Humu Inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Humu Inc. |
| 公司的網站 | [https://www.humu.com](https://www.humu.com) |
| 應用程式的使用規定 | [https://www.humu.com/humu-for-microsoft-teams-license](https://www.humu.com/humu-for-microsoft-teams-license) |
| 應用程式的核心功能 | Humu 是一個動作管理平臺，可讓組織輕鬆地每週進行改善。 Humu 會將商務策略轉譯為組織內每個人的個人相關動作。 我們的主要重點是大規模推動組織改善，以建立更具生產力、共同作業、創新和包容性的員工。 Humu 可讓變更更輕鬆，以改善工作。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
Humu Inc. 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

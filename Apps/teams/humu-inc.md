...
| App 的使用條款 | [https://www.humu.com/humu-for-microsoft-teams-license](https://www.humu.com/humu-for-microsoft-teams-license) |
| 應用程式的核心功能 | Humu 是一種動作管理平臺，便於組織每隔一周進行改進。 Humu 會將商務策略翻譯為組織內每個人的個人相關動作。 我們的主要重點是以規模為單位，促進組織的改進，以創造更高的效率、共同作業、創新性及包容的 workforces。 Humu 讓您更輕鬆地進行變更，使工作更順利。 |

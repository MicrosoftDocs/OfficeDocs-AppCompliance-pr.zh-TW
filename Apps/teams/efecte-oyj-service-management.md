---
title: Efecte 服務管理的應用程式資訊，由 Efecte Oyj
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: Efecte 服務管理的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63553436"
---
# <a name="efecte-service-management"></a>Efecte 服務管理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新：2022年1月24日</p>

* <a href="https://teams.microsoft.com/l/app/1c20b1ea-7f9f-496a-a577-8b1bb1a28228" target="_blank">在 Teams 儲存區中查看</a>
...
由 Efecte Oyj 所提供的資訊給 Microsoft：
...
| 合作夥伴公司名稱 | Efecte Oyj |
| 公司的網站 | [https://www.efecte.com](https://www.efecte.com) |
| App 的使用條款 | [https://www.efecte.com/terms-of-service](https://www.efecte.com/terms-of-service) |
| 應用程式的核心功能 | 接收 Efecte Service Management (ESM) 中新票證的通知 |
| 公司 headquarter 位置 | 芬蘭 |
| 應用程式資訊頁面 | [https://www.efecte.com/ms-teams-integration](https://www.efecte.com/ms-teams-integration) |
| 用來執行應用程式的主控環境或服務模型為何？ | Paas |
| 應用程式會使用哪一個主控雲端提供者？ | Azure，其他 |
...
此資訊是由 Efecte Oyj 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.efecte.com/privacy-policy |

...
description: CLIPr 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66952606"
---
# <a name="clipr"></a>CLIPr

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 12 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/2d6b2a6d-a20d-4206-a11c-e01d34d0d3a0" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003612" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

CLIPr Co 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | CLIPr Co |
| 公司的網站 | [https://www.clipr.ai](https://www.clipr.ai) |
| 應用程式的使用規定 | [https://www.clipr.ai/terms-of-use](https://www.clipr.ai/terms-of-use) |
| 應用程式的核心功能 | CLIPr 使用 AI/機器學習，讓影片內容可搜尋且可採取動作。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
CLIPr Co 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 我們會收集使用者的名稱和電子郵件地址。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者名稱、電子郵件地址，以及附加至其租使用者識別碼的公司名稱。  |
...
| 隱私權原則 URL | https://www.clipr.ai/privacy-policy |

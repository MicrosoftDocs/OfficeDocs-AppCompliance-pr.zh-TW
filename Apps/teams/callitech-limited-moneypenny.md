---
title: CALLITECH LIMITED 的 Moneypenny 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/08/2021
...
description: Moneypenny 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/ff5b7b81-ef94-441d-bc7c-eb04e53a188f" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003396" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

CALLITECH LIMITED 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | LIMITED |
| 公司的網站 | [https://www.moneypenny.com](https://www.moneypenny.com) |
| 應用程式的使用規定 | [https://www.moneypenny.com/uk/microsoft-teams-terms-and-con...](https://www.moneypenny.com/uk/microsoft-teams-terms-and-conditions/) |
| 應用程式的核心功能 | 應用程式的核心功能是讓Teams使用者將其組織上線，以透過 Bot 接收來自 Moneypenny 的電話 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | |
...
CALLITECH LIMITED 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | Microsoft 租使用者識別碼、Microsoft 物件識別碼 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | Microsoft 租使用者識別碼、Microsoft 物件識別碼 |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | Microsoft Identity Web |
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | MFA |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | 應用程式 | 將媒體從 Bot 串流至Teams使用者 | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |
>| Calls.Initiate.All | 應用程式 | 透過 Bot 呼叫Teams使用者 | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |

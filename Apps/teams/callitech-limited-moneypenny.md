...
ms.locfileid: "60874900"
---
# <a name="moneypenny"></a>錢班霓

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新日期：2021年9月21日</p>

* <a href="https://teams.microsoft.com/l/app/ff5b7b81-ef94-441d-bc7c-eb04e53a188f" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | CALLITECH 有限 |
| 公司的網站 | [https://www.moneypenny.com](https://www.moneypenny.com) |
| App 的使用條款 | [https://www.moneypenny.com/uk/microsoft-teams-terms-and-con...](https://www.moneypenny.com/uk/microsoft-teams-terms-and-conditions/) |
| 應用程式的核心功能 | app 的核心功能是供 Teams 使用者透過 Bot 從 Moneypenny 接到其組織，以接收來自從的呼叫 |
...
CALLITECH 提供此資訊的方式是限制此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | Microsoft 租使用者識別碼，Microsoft 物件識別碼 |
...
>|   **Graph許可**  | **權限類型** |          **對齊**          |
>|:------------------------|:--------------------|:------------------------------------|
>| 呼叫。 Initiate 所有 | 應用程式 | 透過 Bot 撥打 Teams 使用者 |
>| AccessMedia 所有 | 應用程式 | 若要將媒體從 Bot 傳輸至 Teams 使用者 |

---
title: SuperOffice by SuperOffice InfoBridge 軟體的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: SuperOffice 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63539809"
---
# <a name="superoffice"></a>SuperOffice

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員更新：2021年12月10日</p>

* <a href="https://teams.microsoft.com/l/app/4f9a1c49-28e3-443c-9007-67c7819407bc" target="_blank">在 Teams 儲存區中查看</a>
...
SuperOffice InfoBridge 軟體所提供的資訊給 Microsoft：
...
| 合作夥伴公司名稱 | SuperOffice InfoBridge 軟體 |
| 公司的網站 | [https://infobridge.com](https://infobridge.com) |
| App 的使用條款 | [https://msteams.superofficeapps.com/Home/TermsAndConditions](https://msteams.superofficeapps.com/Home/TermsAndConditions) |
| 應用程式的核心功能 | 在 SuperOffice CRM 中，通知您的客戶、專案及銷售發生的情況。 |
| 公司 headquarter 位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | [https://msteams.superofficeapps.com](https://msteams.superofficeapps.com) |
...
SuperOffice InfoBridge 軟體會提供此資訊，此應用程式是關於此應用程式如何收集和儲存組織資料，以及您的組織將會透過應用程式收集的資料所產生的控制項。
...
| 隱私權原則 URL | https://msteams.superofficeapps.com/Home/PrivacyPolicy |

---
title: CEMEQ inc. 的 Mediatheque+ 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Mediatheque+ 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64876480"
---
# <a name="mediatheque"></a>Mediatheque +

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 7 月 26 日</p>

* <a href="https://teams.microsoft.com/l/app/d546d064-6146-4341-b997-3a83855cafb3" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003099" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

CEMEQ inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | CEMEQ inc. |
| 公司的網站 | [https://www.cemeq.qc.ca](https://www.cemeq.qc.ca) |
| 應用程式的使用規定 | [https://www.cemeq.qc.ca/data/themes/cemeq/viewerJS/Conditio...](https://www.cemeq.qc.ca/data/themes/cemeq/viewerJS/ConditionsUtilisationMEDPLUS.pdf) |
| 應用程式的核心功能 | Acc&#233;dez au mat&#233;riel p&#233;dagogique du CEMEQ |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | |
...
CEMEQ inc.提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

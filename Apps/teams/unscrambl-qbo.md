...
description: qbo 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65688558"
---
# <a name="qbo"></a>qbo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 11 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/834c6939-152c-450b-a305-c65b4dd5d1c7" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001708" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Unscrambl 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Unscrambl |
| 公司的網站 | [https://unscrambl.com](https://unscrambl.com) |
| 應用程式的使用規定 | [https://unscrambl.com/service-agreement](https://unscrambl.com/service-agreement) |
| 應用程式的核心功能 | qbo 由 Unscrambl qbo insights 提供技術支援，可讓分析使用一流的 NLP 進行交談。 使用者輸入問題，qbo 會在貼齊中呈現最相關的深入解析和視覺效果。 使用者可以主動與同事共同作業、做出決策，並在簡報就緒的面板中擷取結果。 qbo 可讓組織中的每個人做出資料驅動決策。 qbo 會直接連線到一系列的雲端或內部部署來源，並可透過Microsoft Teams或瀏覽器來存取。 |
| 公司總部位置 | 美國美國 |
...
此資訊是由 Unscrambl 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 名稱和電子郵件地址用於建立帳戶 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 名稱和電子郵件地址 |
| 如果基礎結構化會處理或儲存 Microsoft 客戶資料，則此資料會在何處儲存？ | 新加坡 |
| 您是否有已建立的資料租用和處置程式？ | 是 |
| 帳戶終止之後，資料會保留多久？ | 未保留 |
| 您是否有已建立的資料存取管理程式？ | 是 |

---
title: HubEngage by HubEngage， Inc. 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: HubEngage 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66549407"
---
# <a name="hubengage"></a>HubEngage

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 1 月 12 日</p>

* <a href="https://teams.microsoft.com/l/app/d96b4f99-e4b8-4af8-ba3d-36675f9a5353" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003668" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

HubEngage， Inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | HubEngage, Inc. |
| 公司的網站 | [https://www.hubengage.com](https://www.hubengage.com) |
| 應用程式的使用規定 | [https://www.hubengage.com/privacy-policy/](https://www.hubengage.com/privacy-policy/) |
| 應用程式的核心功能 | HubEngage Teams 應用程式可讓您從 Teams 記憶體取組織的通訊和其他相關資訊。 您也可以提交自己的貼文，以及在其他貼文上加上贊和批註。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
此資訊由 HubEngage， Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.hubengage.com/platform-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 兩者皆是 | 認識使用者 | [63e17eec-6b5f-476b-a26b-54fde8bd2c83](../azure/63e17eec-6b5f-476b-a26b-54fde8bd2c83.md) |

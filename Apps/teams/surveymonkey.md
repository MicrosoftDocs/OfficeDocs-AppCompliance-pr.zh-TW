---
title: SurveyMonkey by SurveyMonkey 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: SurveyMonkey 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2021 年 10 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/0fd925a0-357f-4d25-8456-b3022aaa41a9" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381088" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

SurveyMonkey 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.surveymonkey.com](https://www.surveymonkey.com) |
| 應用程式的使用規定 | [https://www.surveymonkey.com/mp/legal/terms-of-use/](https://www.surveymonkey.com/mp/legal/terms-of-use/) |
| 應用程式的核心功能 | 透過問卷調查和快速投票，共同作業並擷取員工的意見反應和情感。 在一個地方擷取結果，讓小組保持最新狀態並有新的回應。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://help.surveymonkey.com/articles/en_US/kb/Microsoft-T...](https://help.surveymonkey.com/articles/en_US/kb/Microsoft-Teams-Integration) |
...
SurveyMonkey 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

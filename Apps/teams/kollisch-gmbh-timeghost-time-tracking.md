---
title: timeghost 的應用程式資訊 - K&#246;llisch GmbH 的時間追蹤
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/22/2021
...
K&#246;llisch GmbH 提供給 Microsoft 的資訊：
...
K&#246;llisch GmbH 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

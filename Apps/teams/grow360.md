---
title: Grow360 的應用程式資訊（按 Grow360）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Grow360 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/042d26ab-41cc-4a88-920a-3125ebfd7944" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | Grow360 |
| 公司的網站 | [https://grow360.com](https://grow360.com) |
| App 的使用條款 | [https://grow360.com/terms](https://grow360.com/terms) |
| 應用程式的核心功能 | 成長可協助專業人員和團隊透過一流的領導開發解決方案，獲得更高的效能。 我們相信強小組會為小組成員和其所提供的組織建立 virtuous 週期。 當團隊狀況良好時，小組成員會變壯大。 當小組成員在發展時，小組的執行效果更好。 |
| 公司 headquarter 位置 | 新加坡 |
| 應用程式資訊頁面 | [https://grow360.com/about](https://grow360.com/about) |
...
此資訊是由 Grow360 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否可以處理與 Microsoft 客戶或其裝置相關的任何資料？ | 是 |
| 您的應用程式所處理的資料為何？ | DocsPublishingCommon。 AppInfos 的 DataProcess |
| App 是否支援 TLS 1.1 或更新版本？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 資料庫中儲存的資料為何？ | 名字和姓氏，電子郵件地址 |
...
| 隱私權原則 URL | https://grow360.com/privacy |

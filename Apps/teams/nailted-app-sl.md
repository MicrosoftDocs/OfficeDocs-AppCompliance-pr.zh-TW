...
* <a href="https://teams.microsoft.com/l/app/1a199d17-c299-4634-a124-075e0c119d71" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003375" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由TED APP S.L 所提供的資訊。 至 Microsoft：
...
| 合作夥伴公司名稱 | NAILTED APP S.L. |
| 公司的網站 | [https://nailted.com](https://nailted.com) |
| 應用程式的使用規定 | [https://nailted.com/legal/terms](https://nailted.com/legal/terms) |
| 應用程式的核心功能 | 新式 People &amp; HR 小組的員工參與平臺。 |
| 公司總部位置 | 西班牙 |
| 應用程式資訊頁面 | |
| 用來執行應用程式的裝載環境或服務模型為何？ | Paas |
| 應用程式會使用哪些主控雲端提供者？ | Heroku |
...
這項資訊已由一些已由一個已完成的應用程式 S.L 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | tenantId 和電子郵件 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | tenantId 和電子郵件 |
...
| 隱私權原則 URL | https://nailted.com/legal/privacy |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | 我們使用最新版的 Microsoft 驗證程式庫 |
| 您的應用程式是否支援條件式存取原則？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 應用程式 | 用來存取群組。 | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| TeamsAppInstallation.ReadWriteForUser | 應用程式 | 使用者可以選取要安裝應用程式的使用者。 因此，我們會使用此許可權來安裝應用程式 | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| User.Read.All | 應用程式 | 用來讀取使用者資訊 | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| 電子郵件 | 應用程式 | 存取員工的電子郵件以同步處理 | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| offline_access | 應用程式 | 當使用者無法在線上時，我們使用此許可權來存取 API，以便能夠同步處理員工並安裝應用程式 | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |

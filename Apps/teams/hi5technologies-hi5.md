---
title: Hi5Technologies 的 Hi5 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2021
...
description: Hi5 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/ca334a56-72b5-4613-81d4-77b1148df03c" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001610" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Hi5Technologies 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.get5.io](https://www.get5.io) |
| 應用程式的使用規定 | [https://www.get5.io/terms](https://www.get5.io/terms) |
| 應用程式的核心功能 | 使用持續的辨識和意見反應來解除鎖定文化。 Hi5 是超簡單且有趣的應用程式，可供經理和同儕提供 &amp; 接收辨識。 有人&#8217;完成一項很棒的工作嗎？ 這&#8217;很簡單 - 給他們 Hi5，並分享成功的快樂！ 小組成員可以提供點對點或小組辨識、檢視 Hi5 排行榜等等 |
| 公司總部位置 | 南非 |
...
此資訊由 Hi5Technologies 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 我們只會儲存來自Teams的使用者會話資訊，而且使用者必須透過新增通知來核准此資訊 (他們可以隨時移除) 。 不會儲存其他資訊。 | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| 電子郵件 | 委託 | 我們只會儲存來自Teams的使用者會話資訊，而且使用者必須透過新增通知來核准此資訊 (他們可以隨時移除) 。 不會儲存其他資訊。 | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| offline_access | 委託 | 我們只會儲存來自Teams的使用者會話資訊，而且使用者必須透過新增通知來核准此資訊 (他們可以隨時移除) 。 不會儲存其他資訊。 | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| openid | 委託 | 我們只會儲存來自Teams的使用者會話資訊，而且使用者必須透過新增通知來核准此資訊 (他們可以隨時移除) 。 不會儲存其他資訊。 | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| 設定檔 | 委託 | 我們只會儲存來自Teams的使用者會話資訊，而且使用者必須透過新增通知來核准此資訊 (他們可以隨時移除) 。 不會儲存其他資訊。 | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |

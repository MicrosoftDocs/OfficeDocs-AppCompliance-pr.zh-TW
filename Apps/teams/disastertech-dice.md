---
title: DisasterTech DICE by DisasterTech 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: DisasterTech DICE 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65811231"
---
# <a name="disastertech-dice"></a>DisasterTech DICE

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 31 日</p>

* <a href="https://teams.microsoft.com/l/app/7df3e67b-ed62-48e9-a950-c95bd7ebce80" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001909" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

DisasterTech 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.disastertech.com](https://www.disastertech.com) |
| 應用程式的使用規定 | [https://dice.disastertech.com/tos.html](https://dice.disastertech.com/tos.html) |
| 應用程式的核心功能 | 災害技術資料科學整合式共同作業環境 (DICE) 提供具有使用者定義和自助式分析和資料科學工具的 Web 型資料視覺效果和資料探索軟體。 DICE 可讓您存取最完整的災害風險資料清查，以便在災害發生之前、期間和之後即時進行探索。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
此資訊由 DisasterTech 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | User Profile |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | User Profile |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | Microsoft Teams單一登入 | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| 電子郵件 | 委託 | Microsoft Teams單一登入 | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| offline_access | 委託 | Microsoft Teams單一登入 | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| openid | 委託 | Microsoft Teams單一登入 | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| 設定檔 | 委託 | Microsoft Teams單一登入 | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |

---
title: ARGUS DATA INSIGHTS Schweiz AG 的 ARGUSnylar 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: ARGUSnylar 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/f14455f8-5bbe-4da9-8df3-9c5533057569" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003186" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

ARGUS DATA INSIGHTS Schweiz AG 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.argusdatainsights.ch/en/](https://www.argusdatainsights.ch/en/) |
| 應用程式的使用規定 | [https://portal.nylar.org/terms-of-use](https://portal.nylar.org/terms-of-use) |
| 應用程式的核心功能 | ARGUSnylar 是您帳戶的實用擴充功能。 |
| 公司總部位置 | 瑞士 |
| 應用程式資訊頁面 | [https://portal.nylar.org/help](https://portal.nylar.org/help) |
...
ARGUS DATA INSIGHTS Schweiz AG 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | 應用程式 | / | [5c1f85d2-d744-4159-8c01-16e9a7b1207b](../azure/5c1f85d2-d744-4159-8c01-16e9a7b1207b.md) |

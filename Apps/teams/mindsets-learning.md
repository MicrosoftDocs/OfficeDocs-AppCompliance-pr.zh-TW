...
description: 所有可用的安全性與合規性資訊，適用于思維、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/fdc91943-4341-41e6-b4e7-b4625ab8c8f7" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003000" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

思維Learning提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.mindsets.com](https://www.mindsets.com) |
| 應用程式的使用規定 | [https://www.mindsets.com/terms](https://www.mindsets.com/terms) |
| 應用程式的核心功能 | 思維Learning是查詢 &amp; 專案型學習平臺。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.mindsets.com](https://www.mindsets.com) |
...
這些資訊是由思維Learning提供，其中包含此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

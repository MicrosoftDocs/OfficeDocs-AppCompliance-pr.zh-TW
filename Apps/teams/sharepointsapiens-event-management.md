---
title: 依SharePoint|的事件管理應用程式資訊Sapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: 事件管理的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64784252"
---
# <a name="event-management"></a>事件管理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 3 月 22 日</p>

* <a href="https://teams.microsoft.com/l/app/2b8b9b59-d595-46b3-ba0a-602024bab0cc" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000714" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

SharePoint|提供的資訊Sapiens 至 Microsoft：
...
| 公司的網站 | [https://www.sharepointsapiens.com](https://www.sharepointsapiens.com) |
| 應用程式的使用規定 | [https://addins.sharepointsapiens.com/licensing/services-agr...](https://addins.sharepointsapiens.com/licensing/services-agreement.html) |
| 應用程式的核心功能 | 事件管理增益集可協助您組織各種類型的事件。 在幾個簡單的步驟中，可以隨時無時間排程事件。 參與者只要按一下滑鼠即可在線上註冊。 身為召集人，您也可以代表註冊內部或外部使用者，或透過電子郵件傳送邀請。 參與者會透過電子郵件接收會議要求和更新，以確保他們的Outlook行事曆中一律有最新的資訊。 增益集會在單一位置追蹤所有出席者。 |
| 公司總部位置 | 奧地利 |
...
這項資訊已由SharePoint|提供關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://addins.sharepointsapiens.com/licensing/data-processing-agreement.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | 委託 | 閱讀基本使用者資訊以啟用Exchange室預約 | [9e8e113c-8a08-4606-b08a-de4decc7252f](../azure/9e8e113c-8a08-4606-b08a-de4decc7252f.md) |

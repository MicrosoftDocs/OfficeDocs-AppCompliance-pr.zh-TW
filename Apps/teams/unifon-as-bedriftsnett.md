---
title: Bedriftsnett 的應用程式資訊，Unifon 為
ms.author: elmalova
author: elenamalova
ms.date: 11/29/2021
ms.topic: article
...
description: Bedriftsnett 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "61212981"
---
# <a name="bedriftsnett"></a>Bedriftsnett

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員的更新日期：2021年10月8日</p>

* <a href="https://teams.microsoft.com/l/app/af9a1113-600a-4084-9e68-5f20fe25f4d8" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | Unifon 為 |
| 公司的網站 | [https://www.unifon.no](https://www.unifon.no) |
| App 的使用條款 | [https://www.unifon.no/avtalevilkar/](https://www.unifon.no/avtalevilkar/) |
| 應用程式的核心功能 | Unifon Bedriftsnett 現在可以直接在 Microsoft Teams 中使用 |
...
Unifon 提供此資訊的方式，就是此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.unifon.no/personvern/ |

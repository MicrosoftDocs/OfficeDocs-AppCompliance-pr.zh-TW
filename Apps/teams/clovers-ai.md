---
title: Clovers 的應用程式資訊（按 Clovers AI）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/22/2022
...
description: Clovers 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/1356036b-5fa7-42ce-8079-5741f2acfc5f" target="_blank">在 Teams 儲存區中查看</a>
...
透過 Clovers AI 提供給 Microsoft 的資訊：
...
| App 的使用條款 | [https://clovers.ai/terms-of-use/](https://clovers.ai/terms-of-use/) |
| 應用程式的核心功能 | Clovers-協助小組員工更有效率的面試指南 |
...
Clovers AI 會提供此資訊，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

...
description: Clovers 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/1356036b-5fa7-42ce-8079-5741f2acfc5f" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003795" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Clovers AI 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Clovers AI |
| 公司的網站 | [https://clovers.ai](https://clovers.ai) |
| 應用程式的使用規定 | [https://clovers.ai/terms-of-use/](https://clovers.ai/terms-of-use/) |
| 應用程式的核心功能 | 複製者 - 可協助團隊更有效率地雇用的面試指南 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
Clovers AI 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

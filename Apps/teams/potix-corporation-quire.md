---
title: Potix Corporation 的 Quire 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Quire 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64879660"
---
# <a name="quire"></a>Quire

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 6 月 9 日</p>

* <a href="https://teams.microsoft.com/l/app/dfad3be2-e62c-49c5-9453-ccd30999f003" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002946" target="_blank">在 AppSource 中檢視</a>
...
| 公司的網站 | [https://www.quire.io](https://www.quire.io) |
| 應用程式的使用規定 | [https://quire.io/terms](https://quire.io/terms) |
| 應用程式的核心功能 | 在階層式清單中細分目標的最佳共同作業專案管理軟體。 |
| 公司總部位置 | 臺灣 (中國省)  |
| 應用程式資訊頁面 | [https://www.quire.io](https://www.quire.io) |
...
Potix Corporation 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

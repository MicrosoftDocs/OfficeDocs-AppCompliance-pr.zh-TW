---
title: INFOR (US) ， INC. Infor 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/06/2021
...
description: Infor 此處的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/b9a120c7-9103-4e04-90b8-91c9db422a6e" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003314" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

INFOR (US) ， INC 所提供的資訊。 至 Microsoft：
...
| 公司的網站 | [https://www.infor.com](https://www.infor.com) |
| 應用程式的使用規定 | [https://www.infor.com/about/legal](https://www.infor.com/about/legal) |
| 應用程式的核心功能 | Infor Fabric Digital Assistant 提供交談式介面，藉由啟用 Infor Cloudsuites 的自然語言擴充性和協助工具，將人類工作潛力最大化。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
此資訊已由 INFOR (US) ， INC 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

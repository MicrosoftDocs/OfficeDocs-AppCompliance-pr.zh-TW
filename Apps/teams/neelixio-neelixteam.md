---
title: Neelix.IO 的 Neelix.Team 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Neelix.Team 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64876290"
---
# <a name="neelixteam"></a>Neelix.Team

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 7 月 10 日</p>

* <a href="https://teams.microsoft.com/l/app/bed170ee-dbd7-4efa-b48e-b0937ded1689" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003047" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Neelix.IO 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Neelix.IO |
| 公司的網站 | [https://www.neelix.team](https://www.neelix.team) |
| 應用程式的使用規定 | [https://www.neelix.io/terms-of-use-en](https://www.neelix.io/terms-of-use-en) |
| 應用程式的核心功能 | Neelix 平臺會以完整迴圈的方式管理意見反應迴圈。 使用者可以將進行中的體驗、回顧性的意見反應和情感傳送至小組的日誌。 |
| 公司總部位置 | 澳洲 |
...
此資訊是由 Neelix.IO 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委託 | 應用程式會使用通道識別碼和名稱，以便方便使用者在傳送來自 MS Treams 的意見反應時管理其預設喜好設定 | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| Team.ReadBasic.All | 委託 | 應用程式會使用小組識別碼和名稱，以便方便使用者在傳送來自 MS Treams 的意見反應時管理其預設喜好設定 | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| 電子郵件 | 委託 | 電子郵件會作為 Neelix 內使用者註冊的一部分。 初始註冊之後，電子郵件會用於通知。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| offline_access | 委託 | 這用於取得重新整理權杖 | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| 設定檔 | 委託 | 向 Neelix 註冊時，會使用使用者名稱來建立使用者帳戶。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| User.Read | 委託 | Bot 應用程式使用 user.read，以便能夠傳送資訊使用者，讓 Neelix 核心平臺可以識別使用者 | [bed170ee-dbd7-4efa-b48e-b0937ded1689](../azure/bed170ee-dbd7-4efa-b48e-b0937ded1689.md) |

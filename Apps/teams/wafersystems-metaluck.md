---
title: Wafersystems 的 MetaLuck 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/09/2022
...
description: MetaLuck 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/173a0e6d-74dd-4df3-97f8-118a27c20f5d" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004198" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

wafersystems 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | wafersystems |
| 公司的網站 | [https://www.wafersystems.com](https://www.wafersystems.com) |
| 應用程式的使用規定 | [https://cloud.virsical.cn/service/service](https://cloud.virsical.cn/service/service) |
...
這項資訊是由 wafersystems 提供，這些資訊是關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 應用程式 | &#23637;&#31034;&#29992;&#25143;&#20449;&#24687; | [4c708a72-75bd-4da5-9764-bf0b14e15098](../azure/4c708a72-75bd-4da5-9764-bf0b14e15098.md) |

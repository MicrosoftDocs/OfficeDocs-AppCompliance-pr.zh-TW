...
* <a href="https://teams.microsoft.com/l/app/f6179d94-de34-4c1b-9303-519fdf048c7e" target="_blank">在 Teams 儲存區中查看</a>
...
Vibe Inc. 已提供此資訊，供 Inc. 使用此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 客戶的顯示名稱、電子郵件地址和設定檔影像 |
...
| 隱私權原則 URL | https://vibe.us/privacy/ |

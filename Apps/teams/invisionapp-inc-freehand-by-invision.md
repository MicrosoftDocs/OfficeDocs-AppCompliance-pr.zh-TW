---
title: InVisionApp， Inc. Freehand by InVision 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2021
...
description: InVision 的 Freehand、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "64879700"
---
# <a name="freehand-by-invision"></a>Freehand by InVision

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 5 月 6 日</p>

* <a href="https://teams.microsoft.com/l/app/67cf2c5a-db0e-4256-a423-14010cbeafdd" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381362" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

InVisionApp， Inc. 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Freehand by InVision |
| ID | WA104381362 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | InVisionApp, Inc. |
| 公司的網站 | [https://www.invisionapp.com](https://www.invisionapp.com) |
| 應用程式的使用規定 | [https://www.invisionapp.com/legal/terms-of-service](https://www.invisionapp.com/legal/terms-of-service) |
| 應用程式的核心功能 | 使用線上白板即時共同作業。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.invisionapp.com/freehand](https://www.invisionapp.com/freehand) |
...
這項資訊是由 InVisionApp， Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC2 認證日期 | 2020-05-13 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 認證日期 | 2020-06-12 |

---
title: InVision by InVisionApp，Inc. 以手繪多邊形的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2021
...
| App 的使用條款 | [https://www.invisionapp.com/legal/terms-of-service](https://www.invisionapp.com/legal/terms-of-service) |
| 應用程式的核心功能 | 使用線上白板即時合作。 |
...
InVisionApp，Inc. 已提供此資訊。關於此應用程式如何收集和儲存組織的資料，以及您的組織將會透過應用程式收集的資料所產生的控制項。
...
| 您已完成哪一種 SOC 2 憑證？ |   |
| 最近的 SOC2 認證日期 |  2020-05-13 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最近的 SOC3 認證日期 |  2020-06-12 |

...
* <a href="https://teams.microsoft.com/l/app/8ddc9e63-e032-4639-afa6-b7c806303212" target="_blank">在 Teams 儲存區中查看</a>
...
Schule am Bildschirm GmbH 所提供的資訊給 Microsoft：
...
| 合作夥伴公司名稱 | Schule am Bildschirm GmbH |
| 公司的網站 | [https://web.schabi.ch](https://web.schabi.ch) |
...
此資訊是由 Schule am Bildschirm GmbH 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.schabi.ch/Info/Datenschutz |

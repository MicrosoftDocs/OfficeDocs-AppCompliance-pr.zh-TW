...
description: Cloud Effective、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c976a771-1aa9-4e98-b87d-32f271bd6e7f" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002408" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Cloud Effective 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://CloudEffective.com](https://CloudEffective.com) |
| 應用程式的使用規定 | [https://cloudeffective.com/term-of-use.php](https://cloudeffective.com/term-of-use.php) |
| 應用程式的核心功能 | 優化共同作業。 管理團隊、目標、專案和工作，將想法轉換成結果！ |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://cloudeffective.com/products-pricing](https://cloudeffective.com/products-pricing) |
...
這項資訊已由 Cloud Effective 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | 委託 | 同步處理小組名稱和成員，以確保來自MS-Teams的小組成員具有 Cloud Effective 中對應小組的相同存取權。  | [50356ee3-b48b-424b-a7a7-35e53c2ce736](../azure/50356ee3-b48b-424b-a7a7-35e53c2ce736.md) |

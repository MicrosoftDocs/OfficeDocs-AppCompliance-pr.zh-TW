...
description: Abi 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66564575"
---
# <a name="abi"></a>Abi

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 3 月 17 日</p>

* <a href="https://teams.microsoft.com/l/app/55560ea0-ae82-48b2-b71e-a45356f56bb1" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003862" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Beroe 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Beroe |
| 公司的網站 | [https://www.beroeinc.com](https://www.beroeinc.com) |
| 應用程式的使用規定 | [https://www.beroeinc.com/terms/](https://www.beroeinc.com/terms/) |
| 應用程式的核心功能 | Abi &#8211;您的 AI 技術數位採購小幫手 |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | [https://www.beroeinc.com/beroe-live-ai](https://www.beroeinc.com/beroe-live-ai) |
...
Beroe 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 名字，姓氏 &amp; 公司電子郵件識別碼 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 名字、姓氏、工作電子郵件識別碼 &amp; 交談識別碼 |
...
| 隱私權原則 URL | https://www.beroeinc.com/privacy-policy/ |

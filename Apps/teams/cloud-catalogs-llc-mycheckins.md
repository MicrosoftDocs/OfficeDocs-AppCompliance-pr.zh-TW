---
title: MyCheckins by Cloud Catalogs LLC 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: 所有適用于 MyCheckins、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/6f74dbb7-cd5c-48ac-b3f4-082eabef3808" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004375" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

雲端目錄 LLC 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 雲端目錄 LLC |
| 公司的網站 | [https://mycheckins.io](https://mycheckins.io) |
| 應用程式的使用規定 | [https://mycheckins.io/terms-and-conditions](https://mycheckins.io/terms-and-conditions) |
| 應用程式的核心功能 | 在 Microsoft Teams 上執行非同步獨立、回顧等等。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://mycheckins.io](https://mycheckins.io) |
...
雲端類別目錄 LLC 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、使用者Email、傳送至 Bot 的使用者訊息 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者設定檔資料、使用者Email、傳送至 Bot 的使用者訊息 |
...
| 隱私權原則 URL | https://mycheckins.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 應用程式 | 取得使用者詳細資料，例如名字、姓氏和電子郵件地址 | [8f43fc50-571c-4eab-b6ea-675d55e1755e](../azure/8f43fc50-571c-4eab-b6ea-675d55e1755e.md) |

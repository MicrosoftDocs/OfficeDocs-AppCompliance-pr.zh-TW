---
title: Konica Minolta IT 解決方案之公司導覽器的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/12/2021
...
description: 公司導覽器的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64880640"
---
# <a name="company-navigator"></a>Company Navigator

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 11 月 11 日</p>

* <a href="https://teams.microsoft.com/l/app/a75a9d33-76cc-4410-b879-a6ca7d4333cd" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003365" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Konica Minolta IT 解決方案提供給 Microsoft 的資訊：
...
| 應用程式的使用規定 | [https://company-navigator.kmglobalrd.com/info/termsofuse](https://company-navigator.kmglobalrd.com/info/termsofuse) |
| 應用程式的核心功能 | 尋找與專案或興趣相關之檔、人員或動作的整體搜尋工具。 |
| 公司總部位置 | 捷克文 |
...
Konica Minolta IT 解決方案提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者郵件、使用者磁片磁碟機專案、使用者資訊 |
...
>| Calendars.Read.Shared | 委託 | 讀取與應用程式使用案例相關的使用者資料 | [5123b34d-663d-4ae9-a3c9-d2298be203f2](../azure/5123b34d-663d-4ae9-a3c9-d2298be203f2.md) |
...
>| Mail.Read.Shared | 委託 | 讀取與應用程式使用案例相關的使用者資料 | [5123b34d-663d-4ae9-a3c9-d2298be203f2](../azure/5123b34d-663d-4ae9-a3c9-d2298be203f2.md) |
>| Mail.ReadBasic.All | 委託 | 讀取與應用程式使用案例相關的使用者資料 | [5123b34d-663d-4ae9-a3c9-d2298be203f2](../azure/5123b34d-663d-4ae9-a3c9-d2298be203f2.md) |
>| People.Read | 委託 | 讀取與應用程式使用案例相關的使用者資料 | [5123b34d-663d-4ae9-a3c9-d2298be203f2](../azure/5123b34d-663d-4ae9-a3c9-d2298be203f2.md) |

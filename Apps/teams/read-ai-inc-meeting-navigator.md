---
title: Read AI， Inc. 讀取會議導覽器的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/15/2022
...
description: 讀取會議導覽器的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65357064"
---
# <a name="read-meeting-navigator"></a>讀取會議導覽器

---
title: 由 Anaek 提供的 AttendanceBot 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: AttendanceBot 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2022 年 7 月 6 日</p>

* <a href="https://teams.microsoft.com/l/app/77231724-5a80-4edf-ad93-dfd2e61207fa" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381652" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Anaek 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | AttendanceBot |
| ID | WA104381652 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Anaek |
| 公司的網站 | [https://www.harmonizehq.com](https://www.harmonizehq.com) |
| 應用程式的使用規定 | [https://www.attendancebot.com/attendance/tos/](https://www.attendancebot.com/attendance/tos/) |
| 應用程式的核心功能 | 用來追蹤時間、出席率、PTO、逾時、混合式工作、 &amp; 輪班規劃的新式 HR |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.attendancebot.com](https://www.attendancebot.com) |
...
Anaek 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.attendancebot.com/attendance/privacy/ |

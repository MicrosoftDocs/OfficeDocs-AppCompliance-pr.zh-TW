...
description: 提醒的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/88546d4f-9973-4716-98e4-cd181c04bc2d" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001444" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

88 系結者所提供的資訊僅限於 Microsoft：
...
| 應用程式的使用規定 | [https://teamsreminder.app/#terms](https://teamsreminder.app/#terms) |
| 應用程式的核心功能 | 提醒您自己或您的小組成員重要會議、待辦專案或甚至生日。 設定個人提醒、群組聊天提醒或頻道提醒。 您甚至可以設定週期性提醒 (例如每週一上午 9 點的小組會議) ！ |
| 公司總部位置 | 香港 |
...
這項資訊是由 88 項限制提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 提醒其他使用者時的使用者 GUID 和使用者名稱 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委託 | 當系統管理員搜尋使用者以將其指派給授權時使用。 此功能的使用完全是選擇性的，而且在一般應用程式使用期間並非必要。 | [88546d4f-9973-4716-98e4-cd181c04bc2d](../azure/88546d4f-9973-4716-98e4-cd181c04bc2d.md) |
>| People.Read.All | 委託 | 當使用者想要將使用者指派給授權時使用 | [88546d4f-9973-4716-98e4-cd181c04bc2d](../azure/88546d4f-9973-4716-98e4-cd181c04bc2d.md) |

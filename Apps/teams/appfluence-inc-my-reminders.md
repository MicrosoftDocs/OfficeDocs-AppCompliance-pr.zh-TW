---
title: Appfluence Inc 的 My Reminders 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: 所有可用的安全性與合規性資訊，適用于 My Reminders、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/ae64c32a-0eab-47d9-91e4-b693569f7fc3" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004342" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的使用規定 | [https://teamsreminder.com/eula](https://teamsreminder.com/eula) |
| 應用程式的核心功能 | 排程提醒訊息，以透過我們的聊天機器人傳回給您。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://teamsreminder.com](https://teamsreminder.com) |
...
| 您的應用程式會處理哪些資料？ | 在 Teams 中列出使用者的聊天，以協助使用者指出提醒是否與特定交談相關。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | 委託 | 顯示正在聊天的使用者，讓他們瞭解提醒是否與聊天相關聯 | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| User.Read | 委託 | 登入使用者並瞭解使用者的名稱 | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| User.ReadBasic.All | 委託 | 當我們排程與個人聊天相關的提醒時，顯示相關共同作業者的虛擬人偶 | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| offline_access | 委託 | 允許我們的應用程式在排程時間作為使用者，以進行提醒傳遞 | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| 設定檔 | 委託 | 登入使用者並瞭解使用者的名稱 | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |

---
title: Skedda Pty Ltd 的 Skedda 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/11/2022
...
description: Skedda 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/6a3ea4b3-7e59-44b7-b668-ec5264c03fc8" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004065" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Skedda Pty Ltd 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Skedda Pty Ltd |
| 公司的網站 | [https://www.skedda.com](https://www.skedda.com) |
| 應用程式的使用規定 | [https://support.skedda.com/en/articles/663213-terms-and-con...](https://support.skedda.com/en/articles/663213-terms-and-conditions-for-venues) |
| 應用程式的核心功能 | Skedda 是辦公室桌面和會議室的簡潔排程平臺。 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | [https://support.skedda.com/en/articles/6165941-microsoft-te...](https://support.skedda.com/en/articles/6165941-microsoft-teams-app) |
...
Skedda Pty Ltd 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、預約資料 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者設定檔資料、預約資料 |
...
| 隱私權原則 URL | https://support.skedda.com/en/articles/663173-privacy-policy-for-venue-users |
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | 裝置平臺、位置、用戶端應用程式、裝置篩選 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 應用程式 | Skedda 是預約平臺，可與Microsoft 365行事曆整合以同步處理事件，請參閱https://support.skedda.com/en/articles/6125677-direct-integration-with-microsoft-365-and-google-workspace | [0f198a3c-ad80-44d5-af34-61cfd28e022e](../azure/0f198a3c-ad80-44d5-af34-61cfd28e022e.md) |
>| Contacts.Read | 應用程式 | 將出席者新增至 Skedda 的預約時，使用者可以搜尋要新增的連絡人清單。 | [0f198a3c-ad80-44d5-af34-61cfd28e022e](../azure/0f198a3c-ad80-44d5-af34-61cfd28e022e.md) |
>| Mail.Read | 應用程式 | 用於轉送事件 RSVP 通知，如中所述 https://support.skedda.com/en/articles/6125677-direct-integration-with-microsoft-365-and-google-workspace | [0f198a3c-ad80-44d5-af34-61cfd28e022e](../azure/0f198a3c-ad80-44d5-af34-61cfd28e022e.md) |
>| Mail.Send | 應用程式 | 用於轉送事件 RSVP 通知，如中所述 https://support.skedda.com/en/articles/6125677-direct-integration-with-microsoft-365-and-google-workspace | [0f198a3c-ad80-44d5-af34-61cfd28e022e](../azure/0f198a3c-ad80-44d5-af34-61cfd28e022e.md) |
>| People.Read.All | 應用程式 | 將出席者新增至 Skedda 的預約時，使用者可以搜尋要新增的連絡人和目錄人員清單。 | [0f198a3c-ad80-44d5-af34-61cfd28e022e](../azure/0f198a3c-ad80-44d5-af34-61cfd28e022e.md) |
>| User.Read.All | 應用程式 | 將出席者新增至 Skedda 的預約時，使用者可以搜尋要新增的連絡人和目錄人員清單。 | [0f198a3c-ad80-44d5-af34-61cfd28e022e](../azure/0f198a3c-ad80-44d5-af34-61cfd28e022e.md) |

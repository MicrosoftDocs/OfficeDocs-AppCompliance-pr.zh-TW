---
title: IdeaScale 的應用程式資訊（按 IdeaScale）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: IdeaScale 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/a4de8de4-33b1-4e55-97ac-9f87b5978c0f" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | IdeaScale |
| 公司的網站 | [https://ideascale.com](https://ideascale.com) |
| App 的使用條款 | [https://ideascale.com/terms-and-conditions-of-use](https://ideascale.com/terms-and-conditions-of-use) |
| 應用程式的核心功能 | IdeaScale 是創新小組的主要思想管理平臺。 組織中的任何人都可以共用社區中其他人所看到的觀點，並收集意見反應和資源，以將這些觀點轉變為新產品或專案。 現在，您可以將 IdeaScale 社區連線到您的 Microsoft Teams 工作區，以管理構思，而不需離開 Teams。 |
| 公司 headquarter 位置 | 美國地區 |
| 應用程式資訊頁面 | [https://ideascale.com/teams/](https://ideascale.com/teams/) |
...
此資訊是由 IdeaScale 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://ideascale.com/privacy-policy |

---
title: SmileBack by SmileBack 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: 所有可用的安全性與合規性資訊，適用于 SmileBack、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64880552"
---
# <a name="smileback"></a>SmileBack

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 4 月 12 日</p>

* <a href="https://teams.microsoft.com/l/app/273e3385-93c3-4054-8c03-328b8c3fd9af" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002623" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由 SmileBack 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | SmileBack |
| 公司的網站 | [https://smileback.com](https://smileback.com) |
| 應用程式的使用規定 | [https://smileback.com/terms](https://smileback.com/terms) |
| 應用程式的核心功能 | SmileBack 是專為受控服務提供者、技術支援中心和 IT 支援小組設計的客戶滿意度平臺。 我們的 CSAT + NPS&#174;工具可協助 IT 專業人員收集、報告及處理客戶意見反應。 CSAT (客戶滿意度問卷) 可協助您瞭解目前的客戶滿意度，讓您立即且直接地測量每個客戶互動 (支援票證) 。 NPS&#174; (Net Promoter Score) 可讓您深入瞭解整體客戶關係。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
| 用來執行應用程式的裝載環境或服務模型為何？ |  |
| 應用程式會使用哪些主控雲端提供者？ | AWS、Heroku |
...
此資訊由 SmileBack 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

...
| App 的使用條款 | [https://smileback.com/terms](https://smileback.com/terms) |
| 應用程式的核心功能 | SmileBack 是專為受管理的服務提供者、協助桌面和 IT 支援小組而設計的客戶滿意度平臺。 我們的 CSAT + NPS&#174; 工具可協助 IT 專業人員收集、報告及行動客戶意見反應。 CSAT (客戶滿意度調查) 協助您瞭解目前的客戶滿意度，可讓您立即和直接衡量每個客戶互動 (支援票證) 。 NPS&#174; (Net Promoter 分數) 可深入瞭解整體的客戶關係。 |

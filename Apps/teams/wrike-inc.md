---
title: Wrike Inc. 的 Wrike 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: Wrike 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2021 年 10 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/05274a45-7312-4c23-8f64-d57fe4a28d6d" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381390" target="_blank">在 AppSource 中檢視</a>
...
| 合作夥伴公司名稱 | Wrike Inc. |
| 公司的網站 | [https://wrike.com](https://wrike.com) |
| 應用程式的使用規定 | [https://www.wrike.com/security/terms/](https://www.wrike.com/security/terms/) |
| 應用程式的核心功能 | 直接在Teams中管理所有 Wrike 專案、共同作業工作，以及接收通知。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://wrike.com](https://wrike.com) |

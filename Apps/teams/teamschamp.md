---
title: TeamsChamp by TeamsChamp 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/22/2021
...
description: TeamsChamp、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/4fea4594-3f83-4e33-9929-9af6b78a7340" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001487" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的使用規定 | [https://www.teamschamp.com/terms/](https://www.teamschamp.com/terms/) |
| 應用程式的核心功能 | TeamsChamp 可提升組織資訊系統的使用和採用， (其已透過數位員工的遊戲化來投資) 。  以全新的空氣和文化來重新啟用Microsoft 365採用，以促進其數位轉型。 |
| 公司總部位置 | 西班牙 |
| 應用程式資訊頁面 | [https://www.teamschamp.com](https://www.teamschamp.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 登入和讀取使用者設定檔 | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](../azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df.md) |
>| User.ReadBasic.All | 委託 | 讀取所有使用者的基本設定檔 | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](../azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df.md) |
>| 設定檔 | 委託 | 檢視使用者的基本設定檔 | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](../azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df.md) |

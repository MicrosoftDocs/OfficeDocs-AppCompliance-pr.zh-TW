---
title: 依 Berryworks.ai 的 Berry 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Berry 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/3694c470-c14b-11ec-97bc-6b8526f20a81" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004138" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Berryworks.ai 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Berryworks.ai |
| 公司的網站 | [https://berryworks.ai](https://berryworks.ai) |
| 應用程式的使用規定 | [https://www.berryworks.ai/tnc/](https://www.berryworks.ai/tnc/) |
| 應用程式的核心功能 | 與員工互動、即時解譯情感並推動責任 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://berryworks.ai/teams-integration/](https://berryworks.ai/teams-integration/) |
...
這項資訊是由 Berryworks.ai 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 哪些資料會儲存在您的資料庫中？ | 租使用者資訊，例如租使用者識別碼、使用者通訊識別碼 |

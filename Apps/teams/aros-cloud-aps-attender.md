---
title: Attender by Aros 雲端 Ap 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: Attender 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/30b8d518-2535-4919-ab8b-d0fab193380f" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | Aros 雲端 ApS |
| 公司的網站 | [https://www.attender.uk](https://www.attender.uk) |
| App 的使用條款 | [https://www.attender.uk/wp-content/uploads/2022/02/Terms-of...](https://www.attender.uk/wp-content/uploads/2022/02/Terms-of-use.pdf) |
| 應用程式的核心功能 | 適用于學校的快速出席註冊，可降低學生 dropouts，並節省教學時間。 |
| 公司 headquarter 位置 | 丹麥 |
| 應用程式資訊頁面 | [https://www.attender.uk](https://www.attender.uk) |
...
此資訊已透過 Aros 雲端 Ap 提供，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否可以處理與 Microsoft 客戶或其裝置相關的任何資料？ | 是 |
| 您的應用程式所處理的資料為何？ | 使用者的 UPN 名稱、使用者顯示名稱、學生出勤資料、學生設定檔圖片、教師和學生時程表資料 |
| App 是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 資料庫中儲存的資料為何？ | 使用者的 UPN 名稱、使用者顯示名稱、學生出勤資料、學生設定檔圖片、教師和學生時程表資料 |
| 如果基礎 infastructure 處理或儲存 Microsoft 客戶資料，該資料地理位置存放在何處？ | 丹麥 |
...
| 隱私權原則 URL | https://www.attender.uk/wp-content/uploads/2022/02/Privacy-Statement.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | 委託 | 決定使用者角色 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| GroupMember Read。 All | 委託 | 決定使用者角色 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| User.Read | 委託 | 登入 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| 電子郵件 | 委託 | 取得使用者登入名稱。 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| openid | 委託 | 單一登入 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| 設定檔 | 委託 | 使用者資訊 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |

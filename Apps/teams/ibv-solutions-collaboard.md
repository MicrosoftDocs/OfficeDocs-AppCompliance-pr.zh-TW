---
title: Collaboard by IBV 解決方案的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: Collaboard 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/28ed14b8-5625-40e6-a17a-b56fa04fc76f" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | IBV 解決方案 |
| 公司的網站 | [https://www.collaboard.app](https://www.collaboard.app) |
| App 的使用條款 | [https://www.collaboard.app/terms](https://www.collaboard.app/terms) |
| 應用程式的核心功能 | Collaboard 是一種精美的共同作業線上白板，可供遠端運作。 |
| 公司 headquarter 位置 | 瑞士 |
| 應用程式資訊頁面 | [https://www.collaboard.app/product](https://www.collaboard.app/product) |
| 用來執行應用程式的主控環境或服務模型為何？ | 混合式 |
| 應用程式會使用哪一個主控雲端提供者？ | Azure、IBMCloud、Aws、Other |
...
此資訊已透過 IBV 解決方案提供，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.collaboard.app/dpa |

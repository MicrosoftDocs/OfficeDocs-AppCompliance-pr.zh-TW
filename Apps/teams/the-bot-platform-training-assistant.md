...
description: 所有適用于訓練小幫手的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "61350309"
---
# <a name="training-assistant"></a>訓練助理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新日期：2021年8月2日</p>

* <a href="https://teams.microsoft.com/l/app/40049dbc-3781-491d-ad2e-d59009538e45" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | Bot 平臺 |
| 公司的網站 | [https://thebotplatform.com](https://thebotplatform.com) |
| App 的使用條款 | [https://thebotplatform.com/wp-content/uploads/2021/11/TBP-T...](https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Customer-Terms-of-Use.pdf) |
| 應用程式的核心功能 | 這個數位助理會帶您一系列的訓練模組，涵蓋您在 Teams 中設定及使用所需瞭解的一切。 每個模組包含特定的教學課程影片和訓練內容，以確保您的員工完全瞭解 Microsoft Teams 上可用的功能，以及如何使用這些功能。 |
...
Bot 平臺會提供此資訊，此應用程式是關於此應用程式如何收集及儲存組織資料，以及您的組織將對應用程式所收集的資料所做的控制。
...
| 隱私權原則 URL | https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Privacy-Statement.pdf |

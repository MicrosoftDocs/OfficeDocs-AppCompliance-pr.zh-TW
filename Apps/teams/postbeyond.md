...
| App 的使用條款 | [https://www.postbeyond.com/terms-of-use/](https://www.postbeyond.com/terms-of-use/) |
| 應用程式的核心功能 | 啟動社交媒體倡議，以利用 PostBeyond 提供的員工倡議，以提升品牌知名度、服務和可測量的結果。 在員工的社交網路上 Amplify 您的最佳內容，讓您的品牌成為值得注意的。 我們為行銷人員放大員工的倡議和 delightfully，便於員工。  |

---
title: Stylebot by Stylebot Inc 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/07/2021
...
description: Stylebot 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64880530"
---
# <a name="stylebot"></a>Stylebot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 12 月 7 日</p>

* <a href="https://teams.microsoft.com/l/app/db9c0532-d5d9-4e1b-839f-3952c88c8ee2" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003177" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Stylebot Inc 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.stylebot.app](https://www.stylebot.app) |
| 應用程式的使用規定 | [https://www.stylebot.app/apptermsofservice](https://www.stylebot.app/apptermsofservice) |
| 應用程式的核心功能 | Stylebot 會將新式語言和樣式手動放在您的指尖上，以改善您的書寫 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.stylebot.app/msteamshelp](https://www.stylebot.app/msteamshelp) |
...
Stylebot Inc 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

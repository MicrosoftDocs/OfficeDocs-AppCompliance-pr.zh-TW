...
ms.locfileid: "63540451"
---
# <a name="stylebot"></a>Stylebot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新：2021年12月7日</p>

* <a href="https://teams.microsoft.com/l/app/db9c0532-d5d9-4e1b-839f-3952c88c8ee2" target="_blank">在 Teams 儲存區中查看</a>
...
由 Stylebot Inc. 提供給 Microsoft 的資訊：
...
| App 的使用條款 | [https://www.stylebot.app/apptermsofservice](https://www.stylebot.app/apptermsofservice) |
| 應用程式的核心功能 | Stylebot 可讓您輕鬆掌握現代化的語言和樣式手冊，以改善您的撰寫 |
...
Stylebot Inc. 已提供此資訊，供 Inc. 使用此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

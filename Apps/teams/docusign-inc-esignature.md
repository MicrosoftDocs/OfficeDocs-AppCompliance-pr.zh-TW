---
title: DocuSign eSignature by DocuSign， Inc. 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: DocuSign eSignature 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2022 年 6 月 14 日</p>

* <a href="https://teams.microsoft.com/l/app/e3e1c0f3-e2b3-492f-8944-d551b6dd71b9" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002755" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

DocuSign， Inc. 提供給 Microsoft 的資訊：
...
| 應用程式的核心功能 | 輕鬆地傳送和簽署檔。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://docs.docusign.com/supportdocs/ds-for-MS-teams/Conte...](https://docs.docusign.com/supportdocs/ds-for-MS-teams/Content/overview-docusign-for-ms-teams.htm) |
...
DocuSign， Inc. 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.docusign.com/company/privacy-policy |

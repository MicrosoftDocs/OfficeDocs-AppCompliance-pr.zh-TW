---
title: MyWorkDrive by MyWorkDrive 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/09/2022
...
description: MyWorkDrive 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64878600"
---
# <a name="myworkdrive"></a>MyWorkDrive

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 2 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/f4170c12-ec5c-47b9-834a-a4186cf27ec1" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002325" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

MyWorkDrive 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.myworkdrive.com](https://www.myworkdrive.com) |
| 應用程式的使用規定 | [https://www.myworkdrive.com/terms-of-service/](https://www.myworkdrive.com/terms-of-service/) |
| 應用程式的核心功能 | MyWorkDrive 應用程式可讓您存取Microsoft Teams中的檔案共用資料夾，並能夠從遠端編輯、共用和存取儲存在檔案共用上的公司檔案。   |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.myworkdrive.com/support/myworkdrive-teams-integ...](https://www.myworkdrive.com/support/myworkdrive-teams-integration/) |
...
此資訊由 MyWorkDrive 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

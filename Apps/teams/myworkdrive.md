...
| App 的使用條款 | [https://www.myworkdrive.com/terms-of-service/](https://www.myworkdrive.com/terms-of-service/) |
| 應用程式的核心功能 | MyWorkDrive 應用程式可讓您存取 Microsoft Teams 中的檔案共用資料夾，以及從遠端編輯、共用和存取公司檔案的功能。   |
...
| 應用程式會使用哪一個主控雲端提供者？ | Azure、Aws、其他 |

---
title: Gfacility 的應用程式資訊（按 Gfacility）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
description: Gfacility 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/0f553268-ba1c-4bb0-953c-def3e00aac7d" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | Gfacility |
| 公司的網站 | [https://gfacility.com](https://gfacility.com) |
| App 的使用條款 | [https://gfacility.com/terms-of-use](https://gfacility.com/terms-of-use) |
| 應用程式的核心功能 | 在 Microsoft Teams 中追蹤 Gfacility 的會議 |
...
此資訊是由 Gfacility 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://gfacility.com/privacy-policy |

---
title: 依 NLSQL 的 DoctorOnline 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/12/2022
...
description: DoctorOnline 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/f9555238-64f3-4ec2-a8fc-3787baa157aa" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004082" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的使用規定 | [https://doctoronline.bsmu.edu.ua/terms](https://doctoronline.bsmu.edu.ua/terms) |
| 應用程式的核心功能 | 預約免費的醫療保健線上支援。 超過 500 位授權且具有不同類別的烏克蘭醫生。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://doctoronline.bsmu.edu.ua](https://doctoronline.bsmu.edu.ua) |

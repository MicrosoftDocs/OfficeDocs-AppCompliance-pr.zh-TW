---
title: 由 AIVISION PRODUCTS SRL 提供 Meetgeek 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/28/2022
...
description: Meetgeek 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003720" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

AIVISION PRODUCTS SRL 提供給 Microsoft 的資訊：
...
| 應用程式的使用規定 | [https://meetgeek.ai/terms](https://meetgeek.ai/terms) |
| 應用程式的核心功能 | 將線上會議的生產力最大化！ 自動記錄、轉譯、共用摘要和存取會議深入解析。 |
| 公司總部位置 | 羅馬尼亞 |
...
AIVISION PRODUCTS SRL 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 來自行事曆的使用者設定檔資料、線上會議 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 來自行事曆的使用者設定檔資料、線上會議 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委託 | 同步處理使用者的行事歷數據 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
...
>| User.Read | 委託 | 識別已登入的使用者 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| 電子郵件 | 委託 | 識別已登入的使用者 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| offline_access | 委託 | 同步處理使用者的行事歷數據 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| openid | 委託 | 識別已登入的使用者 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| 設定檔 | 委託 | 識別已登入的使用者 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| Calls.AccessMedia.All | 委託 | 觸發 Meetgeek Bot 以加入使用者的 MS Teams呼叫 | [6f5cab29-c1ad-4048-bf96-fdbe54dba6ba](../azure/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba.md) |
>| Calls.Initiate.All | 委託 | 觸發 Meetgeek Bot 以加入使用者的 MS Teams呼叫 | [6f5cab29-c1ad-4048-bf96-fdbe54dba6ba](../azure/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba.md) |
>| Calls.InitiateGroupCall.All | 委託 | 觸發 Meetgeek Bot 以加入使用者的 MS Teams呼叫 | [6f5cab29-c1ad-4048-bf96-fdbe54dba6ba](../azure/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba.md) |
>| Calls.JoinGroupCall.All | 委託 | 觸發 Meetgeek Bot 以加入使用者的 MS Teams呼叫 | [6f5cab29-c1ad-4048-bf96-fdbe54dba6ba](../azure/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba.md) |

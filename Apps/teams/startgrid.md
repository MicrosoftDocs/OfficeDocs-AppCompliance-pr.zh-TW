---
title: Startgrid 的應用程式資訊（按 Startgrid）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/09/2022
...
description: Startgrid 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/6624420b-7199-41d2-98ff-90d745e039a7" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | Startgrid |
| 公司的網站 | [https://app.startgrid.com](https://app.startgrid.com) |
| App 的使用條款 | [https://corp.startgrid.com/terms-of-use](https://corp.startgrid.com/terms-of-use) |
| 應用程式的核心功能 | 尋找、分享及評估技術解決方案，以更快速地解決難題。 |
| 公司 headquarter 位置 | 美國地區 |
| 應用程式資訊頁面 | [https://corp.startgrid.com/platform](https://corp.startgrid.com/platform) |
...
此資訊是由 Startgrid 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://corp.startgrid.com/privacy-policy |

---
title: Cireson 的 Tikit 虛擬代理程式應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Tikit 虛擬代理程式的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66564574"
---
# <a name="tikit-virtual-agent"></a>Tikit 虛擬代理程式

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/55f323bf-3622-4624-b3b5-0582d8be4ad5" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004288" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Cireson 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Cireson |
| 公司的網站 | [https://tikit.ai](https://tikit.ai) |
| 應用程式的使用規定 | [https://tikit.ai/terms-service/](https://tikit.ai/terms-service/) |
| 應用程式的核心功能 | Tikit&#8217;虛擬代理程式：您的終端使用者&#8217;所有支援票證需求的解決方案 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://tikit.ai](https://tikit.ai) |
...
Cireson 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔和使用者郵件資料 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者設定檔 (Azure Active Directory 資訊 - 名稱、標題等)  |
...
| 隱私權原則 URL | https://www.tikit.ai/privacy-statement/ |
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | 多重要素驗證、只允許Intune註冊的裝置存取特定服務、限制使用者位置和 IP 範圍 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | 委託 | 用來讀取應用程式內 RBAC 的角色指派 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| Directory.Read.All | 委託 | 用來讀取應用程式內 RBAC 的角色指派 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| Group.Read.All | 兩者皆是 | 用來讀取應用程式內 RBAC 的角色指派 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| User.Read | 委託 | 登入 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| User.Read.All | 應用程式 | 登入 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| User.ReadBasic.All | 委託 | 登入 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| 電子郵件 | 委託 | 登入許可權 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| openid | 委託 | 登入 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| 設定檔 | 委託 | 登錄 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |

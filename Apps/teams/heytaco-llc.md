...
由 HeyTaco 提供的資訊，LLC 至 Microsoft：
...
此資訊是由 HeyTaco 所提供，LLC 如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否可以處理與 Microsoft 客戶或其裝置相關的任何資料？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 資料庫中儲存的資料為何？ | 名稱、電子郵件、頭像 |
...
| 隱私權原則 URL | https://www.heytaco.chat/privacy |

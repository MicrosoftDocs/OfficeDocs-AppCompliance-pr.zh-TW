...
description: 推送安全性、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/db06ca6c-96a2-48ef-804e-54295b5c035a" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002833" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

將安全性推送至 Microsoft 所提供的資訊：
...
| 合作夥伴公司名稱 | 推送安全性 |
| 公司的網站 | [https://pushsecurity.com](https://pushsecurity.com) |
| 應用程式的使用規定 | [https://pushsecurity.com/legal/terms/](https://pushsecurity.com/legal/terms/) |
| 應用程式的核心功能 | 我們藉由讓員工安全地使用應用程式，協助公司提高 SaaS 的生產力。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://pushsecurity.com/kb/10004/](https://pushsecurity.com/kb/10004/) |
...
推送安全性已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 推送會處理客戶的工作時間，以在客戶工作時提供警示。  |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 推送會儲存客戶的工作時間，以在客戶工作時提供警示。  |
...
| 隱私權原則 URL | https://pushsecurity.com/legal/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 應用程式 | 列出通道，讓安裝 Bot 變得更容易  | [4ed8651a-5a01-44f0-abf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| MailboxSettings.Read | 應用程式 | 查詢客戶的工作時間，讓我們不要在下班後傳送訊息 | [4ed8651a-5a01-44f0-abf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| Team.ReadBasic.All | 應用程式 | 列出小組，讓安裝 Bot 變得更容易  | [4ed8651a-5a01-44f0-abf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForTeam.All | 應用程式 | 允許 Bot 為小組自行安裝 | [4ed8651a-5a01-44f0-abf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 應用程式 | 允許 Bot 為使用者自行安裝 | [4ed8651a-5a01-44f0-abf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| User.Read.All | 應用程式 | 列出使用者，讓我們可以傳送訊息給他們 | [4ed8651a-5a01-44f0-abf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |

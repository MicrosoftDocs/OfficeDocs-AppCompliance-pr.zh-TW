...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ReadWrite 的行事曆 | 委託 | 唯一使用的資料是使用者可讓應用程式使用存取權杖來呼叫 Graph API 的明確確認。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](https://docs.microsoft.com/microsoft-365-app-certification/azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71) |
>| OnlineMeetings ReadWrite | 委託 | 唯一使用的資料是使用者可讓應用程式使用存取權杖來呼叫 Graph API 的明確確認。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](https://docs.microsoft.com/microsoft-365-app-certification/azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71) |
>| User.Read | 委託 | 唯一使用的資料是使用者可讓應用程式使用存取權杖來呼叫 Graph API 的明確確認。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](https://docs.microsoft.com/microsoft-365-app-certification/azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71) |

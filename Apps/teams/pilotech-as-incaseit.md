...
| App 的使用條款 | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/1-4-terms-of-use) |
| 應用程式的核心功能 | 危機管理系統。 系統，以取得危機和事件的準備與處理。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ReadWrite 的行事曆 | 委託 | 唯一使用的資料是使用者可讓應用程式使用存取權杖來呼叫 Graph API 的明確確認。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| OnlineMeetings ReadWrite | 委託 | 唯一使用的資料是使用者可讓應用程式使用存取權杖來呼叫 Graph API 的明確確認。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| User.Read | 委託 | 唯一使用的資料是使用者可讓應用程式使用存取權杖來呼叫 Graph API 的明確確認。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |

---
title: Application Information for InCaseIT by Pilotech AS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: InCaseIT 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/4420b597-c1d5-4d40-ba81-2b2a78575c81" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003265" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Pilotech AS 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://incaseit.com](https://incaseit.com) |
| 應用程式的使用規定 | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/1-4-terms-of-use) |
| 應用程式的核心功能 | 危機管理系統。 準備和處理危機和事件的系統。 |
| 公司總部位置 | 挪威 |
| 應用程式資訊頁面 | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/introduction-to-incaseit-version-2-0) |
...
Pilotech AS 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委託 | 唯一使用的資料是使用者明確確認，以允許應用程式使用存取權杖來呼叫圖形 API。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| OnlineMeetings.ReadWrite | 委託 | 唯一使用的資料是使用者明確確認，以允許應用程式使用存取權杖來呼叫圖形 API。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| User.Read | 委託 | 唯一使用的資料是使用者明確確認，以允許應用程式使用存取權杖來呼叫圖形 API。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |

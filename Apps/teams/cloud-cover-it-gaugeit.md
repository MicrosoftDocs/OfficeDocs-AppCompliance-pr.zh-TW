---
title: Gauge.it 的應用程式資訊，由雲端向其覆蓋
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: gauge.it 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/9e9e5036-942e-42b4-8b7a-855a59d1c1a1" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | Cloud Cover IT |
| 公司的網站 | [https://www.cloudcoverit.co.uk](https://www.cloudcoverit.co.uk) |
| App 的使用條款 | [https://www.cloudcoverit.co.uk/terms](https://www.cloudcoverit.co.uk/terms) |
| 應用程式的核心功能 | 建立及共用範本檢查清單至群組、小組或甚至您自己。 |
...
雲端提供此資訊的方式是讓雲端涵蓋此應用程式如何收集及儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.cloudcoverit.co.uk/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 存取 Active Directory 識別碼 | [898cccfe-ed44-4140-ad2f-c5dd98a12820](../azure/898cccfe-ed44-4140-ad2f-c5dd98a12820.md) |

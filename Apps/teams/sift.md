...
description: Sift 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65125322"
---
# <a name="sift"></a>篩選

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 4 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002545" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Sift 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 篩選 |
| 公司的網站 | [https://www.justsift.com](https://www.justsift.com) |
| 應用程式的使用規定 | [https://www.justsift.com/sift-msteams-eula](https://www.justsift.com/sift-msteams-eula) |
| 應用程式的核心功能 | 尋找、探索及與組織人員連線 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.justsift.com/integrating-sift/with-microsoft-te...](https://www.justsift.com/integrating-sift/with-microsoft-teams) |
...
Sift 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 我們的Teams應用程式會要求基本設定檔資訊，並同意檢視來自Azure AD使用者的會議資料。 它也會主動向使用者收集其他設定檔資訊，以增強其在平臺內的設定檔。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 如果系統管理使用者授與同意，則會收集來自 Microsoft Graph 的使用者設定檔資訊。 |
...
| 隱私權原則 URL | https://www.justsift.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | 委託 | 我們會從Graph擷取群組資訊，以便依群組篩選擷取的使用者 | [270b510a-7cfb-4a9a-8071-5ceab03cf357](../azure/270b510a-7cfb-4a9a-8071-5ceab03cf357.md) |
>| User.Read.All | 委託 | 我們會從Graph擷取使用者物件，以便在產品中布建和一致地更新員工設定檔 | [270b510a-7cfb-4a9a-8071-5ceab03cf357](../azure/270b510a-7cfb-4a9a-8071-5ceab03cf357.md) |
>| OnlineMeetingArtifact.Read.All | 委託 | 針對我們Teams應用程式中的會議擴充功能，我們需要擷取會議參與者相關資訊的許可權 | [d2a1ed44-6cca-44d2-9b9c-1c9c1d597093](../azure/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093.md) |
>| OnlineMeetings.Read | 委託 | 針對我們Teams應用程式中的會議擴充功能，我們需要擷取會議參與者相關資訊的許可權 | [d2a1ed44-6cca-44d2-9b9c-1c9c1d597093](../azure/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093.md) |

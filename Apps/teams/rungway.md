---
title: Rungway by Rungway 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/27/2022
...
description: Rungway 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/4bea8f81-966b-45fe-8c33-4c8843fda977" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004123" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Rungway 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Rungway |
| 公司的網站 | [https://app.rungway.com](https://app.rungway.com) |
| 應用程式的使用規定 | [https://support.rungway.com/terms-conditions.html](https://support.rungway.com/terms-conditions.html) |
| 應用程式的核心功能 | 以匿名方式提出問題並提出問題。 跟上共用建議。   |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.rungway.com/product-overview](https://www.rungway.com/product-overview) |
...
Rungway 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者電子郵件地址、使用者設定檔資訊 (每個用戶端可自訂，並由使用者輸入)  |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者電子郵件地址、使用者設定檔資訊 (每個用戶端可自訂，並由使用者輸入)  |
...
| 隱私權原則 URL | https://support.rungway.com/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 登入 &amp; 讀取使用者設定檔 | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| 電子郵件 | 委託 | &amp;識別驗證使用者 | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| offline_access | 委託 | 維護對資料的存取 | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| openid | 委託 | 登入使用者 | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| 設定檔 | 委託 | 檢視使用者的基本設定檔 | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |

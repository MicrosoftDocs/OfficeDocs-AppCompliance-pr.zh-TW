---
title: Dubber 的 Dubber 整合通話記錄應用程式資訊
ms.author: elmalova
author: elenamalova
ms.date: 12/09/2021
ms.topic: article
...
description: Dubber 整合通話記錄的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "62147919"
---
# <a name="dubber-unified-call-recording"></a>Dubber 整合通話錄音

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員更新：2021年11月3日</p>

* <a href="https://teams.microsoft.com/l/app/f31b8e05-b927-4874-851e-997264d13151" target="_blank">在 Teams 儲存區中查看</a>
...
由 Dubber 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Dubber 整合通話錄音 |
| ID | WA200003570 |
| 支援 Office 365 用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | 配音器 |
| 公司的網站 | [https://www.dubber.net](https://www.dubber.net) |
| App 的使用條款 | [https://www.dubber.net/terms](https://www.dubber.net/terms) |
| 應用程式的核心功能 | 整合雲端通話錄製 &amp; 語音 AI 以取得法規遵從性、銷售 &amp; 服務效能 |
...
此資訊是由 Dubber 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 客戶名稱和 Microsoft ID、通話錄製/會議資料 |

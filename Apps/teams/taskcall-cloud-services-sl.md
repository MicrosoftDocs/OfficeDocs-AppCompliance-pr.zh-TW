---
title: TaskCall 的應用程式資訊，由 TaskCall 雲端服務，S.L。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: TaskCall 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">在 Teams 儲存區中查看</a>
...
TaskCall 所提供的資訊雲端服務，S.L。 至 Microsoft：
...
| 合作夥伴公司名稱 | TaskCall 雲端服務，S.L。 |
| 公司的網站 | [https://taskcallapp.com](https://taskcallapp.com) |
| App 的使用條款 | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| 應用程式的核心功能 | TaskCall 的 Microsoft Teams bi 整合會透過允許從 Microsoft Teams 中處理事件，來簡化通訊和 IT-Ops 共同作業。 |
...
TaskCall 雲端服務、S.L. 提供此資訊。 關於此應用程式如何收集和儲存組織資料，以及您的組織將會對應用程式收集的資料所做的控制。

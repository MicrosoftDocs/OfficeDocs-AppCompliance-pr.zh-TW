---
title: TaskCall by TaskCall 的應用程式資訊 雲端服務， S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: TaskCall 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003914" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

TaskCall 雲端服務、 S.L 所提供的資訊。 至 Microsoft：
...
| 合作夥伴公司名稱 | TaskCall Cloud Services, S.L. |
| 公司的網站 | [https://taskcallapp.com](https://taskcallapp.com) |
| 應用程式的使用規定 | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| 應用程式的核心功能 | TaskCall 的Microsoft Teams雙向整合可藉由允許從Microsoft Teams內處理事件，來簡化通訊和IT-Ops共同作業。 |
| 公司總部位置 | 西班牙 |
| 應用程式資訊頁面 | [https://docs.taskcallapp.com/integrations/v1/microsoft-team...](https://docs.taskcallapp.com/integrations/v1/microsoft-teams-integration-guide) |
...
此資訊已由 S.L 雲端服務 TaskCall 提供。 關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: Avishkaram Technologies Pvt Ltd 的 TagMyFav 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: TagMyFav 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
<p>上次由開發人員更新日期：2022 年 3 月 12 日</p>

* <a href="https://teams.microsoft.com/l/app/4adaed2f-7c6a-4128-ba20-4fb097581b1b" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002713" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Avishkaram Technologies Pvt Ltd 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Avishkaram Technologies Pvt Ltd |
| 公司的網站 | [https://www.avishkaram.com](https://www.avishkaram.com) |
| 應用程式的使用規定 | [https://www.tagmyfav.com/terms-conditions](https://www.tagmyfav.com/terms-conditions) |
| 應用程式的核心功能 | TagMyFav for Microsoft 365提供簡單的書簽解決方案，讓共同作業 &amp; 通訊更容易。 &amp;在Microsoft Teams中進行交談時儲存共用連結，同時在Outlook中讀取電子郵件，同時在 Word 中建立檔，或在瀏覽器中進行研究時儲存。 TagMyFav 適用于所有產業，例如客戶支援、技術支援、法務服務人員、學生 &amp; 教師、行銷、HR 等，以組織和分享適用于共同作業或研究的連結。 |
| 公司總部位置 | 印度 |
| 應用程式資訊頁面 | [https://www.tagmyfav.com](https://www.tagmyfav.com) |
...
Avishkaram Technologies Pvt Ltd 提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、電子郵件 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 電子郵件、名稱、TimeZone、Microsoft Teams識別碼 |
...
| 隱私權原則 URL | https://www.tagmyfav.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read | 委託 | 讀取使用者的連絡人 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| User.Read | 委託 | 讀取使用者基本設定檔資訊 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| 電子郵件 | 委託 | 檢視使用者電子郵件 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| offline_access | 委託 | 維護您有權存取資料的存取權限 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| openid | 委託 | 登入使用者 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| 設定檔 | 委託 | 檢視使用者設定檔 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |

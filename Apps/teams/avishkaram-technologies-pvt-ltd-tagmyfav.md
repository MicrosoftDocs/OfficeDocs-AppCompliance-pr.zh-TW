---
title: TagMyFav by Avishkaram 技術 Pvt 有限公司的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: TagMyFav 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
<p>上次於開發人員更新：2022年3月12日</p>

* <a href="https://teams.microsoft.com/l/app/4adaed2f-7c6a-4128-ba20-4fb097581b1b" target="_blank">在 Teams 儲存區中查看</a>
...
Avishkaram 技術 Pvt 有限公司提供給 Microsoft 的資訊：
...
| App 的使用條款 | [https://www.tagmyfav.com/terms-conditions](https://www.tagmyfav.com/terms-conditions) |
| 應用程式的核心功能 | TagMyFav for Microsoft 365 可讓 &amp; 您輕鬆使用的書簽方案，以簡化共同作業通訊。 當您在 Word 中建立檔時，或在瀏覽器中進行調查時，在 Microsoft Teams 中讀取電子郵件時，會儲存 &amp; 共用連結，並在 Outlook 中讀取電子郵件。 TagMyFav 適用于所有行業，例如客戶支援、技術支援、法律 practitioner、學生 &amp; 教師、行銷、HR 等。若要組織和共用可共同作業或調查的連結。 |
...
Avishkaram 技術 Pvt 公司會提供此資訊，這些資訊是關於此應用程式如何收集及儲存組織資料的方式，以及您的組織將透過應用程式收集的資料所產生的控制項。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否可以處理與 Microsoft 客戶或其裝置相關的任何資料？ | 是 |
| 您的應用程式所處理的資料為何？ | 使用者設定檔資料，電子郵件 |
| App 是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 資料庫中儲存的資料為何？ | 電子郵件、名稱、TimeZone Microsoft Teams 識別碼 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 連絡人。已讀取 | 委託 | 讀取使用者的連絡人 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| User.Read | 委託 | 讀取使用者基本設定檔資訊 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| 電子郵件 | 委託 | 查看使用者電子郵件 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| offline_access | 委託 | 維護您有權存取資料的存取權限 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| openid | 委託 | 登入使用者 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| 設定檔 | 委託 | View users profile | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |

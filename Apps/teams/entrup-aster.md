...
description: Aster 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66249722"
---
# <a name="aster"></a>Aster

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 9 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/2d8e8042-66df-4605-8c3a-9ca8962f3e99" target="_blank">在 Teams 市集中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002379" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Entrup 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Entrup |
| 公司的網站 | [https://asterapp.co](https://asterapp.co) |
| 應用程式的使用規定 | [https://asterapp.co/conditions-generales/](https://asterapp.co/conditions-generales/) |
| 應用程式的核心功能 | 可讓您節省時間的會議分鐘數！ |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | [https://asterapp.co/solution/](https://asterapp.co/solution/) |
| 用來執行應用程式的裝載環境或服務模型為何？ |  |
| 應用程式會使用哪些主控雲端提供者？ | Azure、OVH Cloud (法國)  |
...
Entrup 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委託 | 傳送 Sharepoint 檔之 Planner 工作的目錄清單 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Group.ReadWrite.All | 委託 | 在現有或已建立的群組中傳送 Sharepoint 檔之 Planner 工作的群組清單 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Notes.ReadWrite.All | 委託 | 在 OneNote 中撰寫的筆記內容 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Tasks.ReadWrite.Shared | 委託 | 工作、指派、期限 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| User.Read | 委託 | 用於識別使用者的使用者電子郵件 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| offline_access | 委託 | 未收集任何資料，只針對看似無意義地重新整理權杖 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |

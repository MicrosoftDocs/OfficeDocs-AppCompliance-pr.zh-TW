---
title: Joye by Joye Pte 有限公司的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Joye 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/6c75be83-05a8-4515-9c7b-b5f759b99b7f" target="_blank">在 Teams 儲存區中查看</a>
...
由 Joye Pte 有限公司提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Joye Pte 有限公司 |
| 公司的網站 | [https://www.joye.ai](https://www.joye.ai) |
| App 的使用條款 | [https://www.joye.ai/terms](https://www.joye.ai/terms) |
| 應用程式的核心功能 | 在 Joye 高來電之後 Imagine 會提示您重新充電，並再次提升生產力。 歡迎使用 Joye。 其&#8217;s 為1-2-3 的簡易！  1：在安全且匿名的空格中口述您的主意。 您可以說出、寫入或遵循我們的導向反映。  2： Joye 將會深入瞭解您，並提供一些很好的建議，如您的導師或尊敬的朋友對您的指導。 現在，您可以管理您的每日遊戲層級！ 3：祝賀！ 您已準備好進行您一天的其他工作。  |
| 公司 headquarter 位置 | 新加坡 |
| 應用程式資訊頁面 | [https://www.joye.ai](https://www.joye.ai) |
| 用來執行應用程式的主控環境或服務模型為何？ | Paas |
| 應用程式會使用哪一個主控雲端提供者？ | GCP，Azure |
...
此資訊是由 Joye Pte 公司提供，這些 Pte 有關此應用程式如何收集及儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 使用者設定檔、空閒/忙碌行事曆排程。 使用者在應用程式中提供的其他輸入 |
| 如果基礎 infastructure 處理或儲存 Microsoft 客戶資料，該資料地理位置存放在何處？ | 北美美國，新加坡 |
...
| 最近的 SOC1 認證日期 |  2021-09-23 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 您已完成哪一種 SOC 2 憑證？ |  type2 |
| 最近的 SOC2 認證日期 |  2021-09-23 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最近的 SOC3 認證日期 |  2021-09-23 |
...
| 隱私權原則 URL | https://joye.ai/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 應用程式 | 若要在行事曆中讀取空閒-忙碌時間的模式，並要求使用者在正確的時間進行精神 wellbeing 中斷 | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| MailboxSettings 讀取 | 委託 | 取得時區的使用者資訊 | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| User.Read | 委託 | 使用者登入和資訊 | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| User.Read.All | 應用程式 | 讀取所有使用者的資訊，並同時讓 Teams 管理員為所有使用者自動安裝應用程式 | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| 電子郵件 | 委託 | 能夠讀取行事曆取得的使用者資訊。行事曆 | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| offline_access | 委託 | 使用資訊 | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| openid | 委託 | 使用者資訊 | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| 設定檔 | 委託 | 使用者資訊 | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |

---
title: OliveGroup 之橄欖 VLE 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/12/2021
...
description: 所有適用于橄欖 VLE 的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">在 Teams 儲存區中查看</a>
...
| App 的使用條款 | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| 應用程式的核心功能 | 橄欖 VLE 協助輔導提供者建立及管理課程、apprenticeship 程式和學員。 教育提供者管理員可以建立自己的線上課程、測試、工作分派、程式，並將其指派給教學課程。 Microsoft Teams 會使用 Graph API 進行整合，讓系統管理員也可以在 Teams 中建立影片教室，並邀請學員加入到影片課程。 學員可以查看並取得課程、程式及管理產品群組辨識項。 系統管理員也可以張貼新聞摘要。 |
| 公司 headquarter 位置 | 愛爾蘭 |
| 應用程式資訊頁面 | |
...
此資訊是由 OliveGroup 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

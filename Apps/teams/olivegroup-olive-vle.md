---
title: 依 OliveGroup 的對將 VLE 套用到的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/12/2021
...
description: 在 CSA STAR 登錄中，對這些 VLE、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003331" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由 OliveGroup 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | OliveGroup |
| 公司的網站 | [https://www.olivegroup.io](https://www.olivegroup.io) |
| 應用程式的使用規定 | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| 應用程式的核心功能 | Apple VLE 可協助教學和教育提供者建立及管理課程、教學課程計畫和學習者。 教育提供者系統管理員可以建置自己的線上課程、測試、指派、計畫，並將其指派給學習者。 Microsoft Teams使用圖形 API整合，讓系統管理員也可以在Teams內建立視訊教室，並邀請學習者進入影片教室。 學習者可以查看並進行其課程、計畫和管理產品群組辨識項。 系統管理員也可以張貼新聞摘要。 |
| 公司總部位置 | 愛爾蘭 |
| 應用程式資訊頁面 | |
...
此資訊由 OliveGroup 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

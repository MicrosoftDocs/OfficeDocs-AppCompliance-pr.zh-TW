---
title: FinTech Studio by FinTech Studio 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: FinTech Studio 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64974366"
---
# <a name="fintech-studios"></a>FinTech Studios

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 3 月 1 日</p>

* <a href="https://teams.microsoft.com/l/app/65e85032-940c-4d03-ad03-029fe9fff997" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003969" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

FinTech Studio 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | FinTech Studios |
| ID | WA200003969 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | FinTech Studios |
| 公司的網站 | [https://www.fintechstudios.com](https://www.fintechstudios.com) |
| 應用程式的使用規定 | [https://www.fintechstudios.com/eula](https://www.fintechstudios.com/eula) |
| 應用程式的核心功能 | AI 驅動商業智慧 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.fintechstudios.com/products](https://www.fintechstudios.com/products) |
...
此資訊由 FinTech Studio 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、小組名稱/識別碼、頻道名稱/識別碼 (沒有訊息資料) 、聊天名稱/識別碼 (沒有訊息資料)  |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者設定檔資料 (名稱、電子郵件、Microsoft Graph存取權 + 重新整理權杖)  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委託 | 提示使用者在應用程式中從工作模組共用內容的頻道 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChannelMessage.Send | 委託 | 從應用程式中的工作模組將共用內容傳送至通道 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Chat.ReadBasic | 委託 | 提示使用者在應用程式中從工作模組共用內容的聊天 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChatMessage.Send | 委託 | 從應用程式中的工作模組將共用內容傳送至聊天 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Team.ReadBasic.All | 委託 | 必須讓使用者可以存取的小組能夠存取使用者可用的頻道 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| User.Read | 委託 | 取得使用者的識別和通訊資訊 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |

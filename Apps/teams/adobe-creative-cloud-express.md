---
title: Adobe Creative Cloud Express by Adobe 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Adobe Creative Cloud Express 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/85d6a7d0-94aa-11ea-a1d7-2f19374441f9" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003946" target="_blank">在 AppSource 中檢視</a>
...
| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Adobe Creative Cloud Express |
| ID | WA200003946 |
| 支援Office 365用戶端 | Microsoft Teams |
| 合作夥伴公司名稱 | Adobe |
| 公司的網站 | [https://www.adobe.com/express/](https://www.adobe.com/express/) |
| 應用程式的使用規定 | [https://www.adobe.com/legal/terms.html](https://www.adobe.com/legal/terms.html) |
| 應用程式的核心功能 | Adobe Spark 可讓您在幾分鐘內建立令人驚豔的視覺故事、具影響力的社交圖形、網頁和短片。 現在，在Microsoft Teams中輕鬆地共用它們 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.adobe.com/express](https://www.adobe.com/express) |
...
| 隱私權原則 URL | https://www.adobe.com/privacy/policy.html |

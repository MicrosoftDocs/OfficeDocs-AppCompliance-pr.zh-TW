---
title: FYZ SERVICES 的 Weet 螢幕錄製應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: Weet Screen Recording 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64878650"
---
# <a name="weet-screen-recording"></a>Weet 螢幕錄製

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 9 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/f0c0f156-329e-4083-a1a7-89649407a31b" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003284" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

FYZ SERVICES 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://weet.co](https://weet.co) |
| 應用程式的使用規定 | [https://weet.co/terms-of-service/](https://weet.co/terms-of-service/) |
| 應用程式的核心功能 | Weet，第 1 個共同作業螢幕視訊 &amp; 錄製器簡單、免費且無限制的螢幕錄製 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://weet.co/weet-teams-integration/](https://weet.co/weet-teams-integration/) |
| 用來執行應用程式的裝載環境或服務模型為何？ |  |
| 應用程式會使用哪些主控雲端提供者？ | GCP、AWS |
...
FYZ SERVICES 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 委託 | 允許偵測是否已安裝 Weet 應用程式 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.Read | 委託 | 我們不會收集任何資料，但我們只使用電子郵件來協助使用者使用自動完成功能 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.ReadBasic.All | 委託 | 我們不會收集任何資料，但我們只使用電子郵件來協助使用者使用自動完成功能 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| offline_access | 委託 | 我們不會收集任何資料，但我們只使用電子郵件來協助使用者使用自動完成功能 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| openid | 委託 | 我們不會收集任何資料，但我們只使用電子郵件來協助使用者使用自動完成功能 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| 設定檔 | 委託 | 我們不會收集任何資料，但我們只使用電子郵件來協助使用者使用自動完成功能 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |

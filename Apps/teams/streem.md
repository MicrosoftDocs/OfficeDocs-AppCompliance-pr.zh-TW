---
title: Streem by Streem 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/09/2022
...
description: Streem 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://teams.microsoft.com/l/app/608c5480-b3aa-4a0f-8f26-b97715313f4a" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000197" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Streem 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Streem |
| 公司的網站 | [https://www.streem.com.au](https://www.streem.com.au) |
| 應用程式的使用規定 | [https://www.streem.com.au/terms](https://www.streem.com.au/terms) |
| 應用程式的核心功能 | Streem 透過收集和分析來自澳洲和紐西蘭的 Print、Online、TV、Radio 和 Social Media 來源的內容，提供即時媒體監視服務。 每個新內容片段都會與客戶關心的關鍵字進行比對，相關警示和報告會透過電子郵件、行動 &amp; 桌面應用程式或與 Slack 和 Microsoft Teams 整合來傳送。 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | |
...
Streem 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

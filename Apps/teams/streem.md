...
| App 的使用條款 | [https://www.streem.com.au/terms](https://www.streem.com.au/terms) |
| 應用程式的核心功能 | Streem 提供即時媒體監控服務，方法是收集及分析澳大利亞和紐西蘭的印刷、線上、電視、收音機和社交媒體來源中的內容。 每個新的內容片段都會比對客戶關心的關鍵字和相關的警示和報告，透過電子郵件、 &amp; 行動桌面應用程式或與 Microsoft Teams 時差的整合來傳送。 |

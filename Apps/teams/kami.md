...
ms.locfileid: "65874238"
---
# <a name="kami"></a>卡米

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 3 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/95b82c84-8994-45f6-946a-dda105f9d5df" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004148" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由布吉提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 卡米 |
| 公司的網站 | [https://kamiapp.com](https://kamiapp.com) |
| 應用程式的使用規定 | [https://kamiapp.com/terms-of-service/](https://kamiapp.com/terms-of-service/) |
| 應用程式的核心功能 | 現在讓每個人都喜歡使用Microsoft Teams&#8211;學習。 |
| 公司總部位置 | 紐西蘭 |
| 應用程式資訊頁面 | |
...
這項資訊是由卡吉所提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔 (名稱、電子郵件) 。 OneDrive檔案和中繼資料。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 使用者設定檔資料 (名稱、電子郵件、識別碼) 。 OneDrive檔案名、專案識別碼、磁片磁碟機識別碼)  (檔案中繼資料。 檔批註。 |
...
| 隱私權原則 URL | https://www.kamiapp.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委託 | 讓使用者能夠開啟、更新和匯出OneDrive和SharePoint檔案。 | [5fb90a92-665c-4ec3-863e-e37572074eb2](../azure/5fb90a92-665c-4ec3-863e-e37572074eb2.md) |
>| User.Read | 委託 | 若要存取使用者設定檔資料以填入卡吉文設定檔，例如電子郵件和名稱。 | [5fb90a92-665c-4ec3-863e-e37572074eb2](../azure/5fb90a92-665c-4ec3-863e-e37572074eb2.md) |

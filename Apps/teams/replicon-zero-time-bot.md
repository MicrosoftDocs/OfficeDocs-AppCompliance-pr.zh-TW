---
title: 依 Replicon 的零時差 Bot 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2022
...
description: 零時 Bot 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65269923"
---
# <a name="zero-time-bot"></a>零時差 Bot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 12 月 8 日</p>

* <a href="https://teams.microsoft.com/l/app/4db812e1-4d29-44e4-b72e-9654c0c91ce4" target="_blank">在Teams存放區中檢視</a>
...
Replicon 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、時間資料 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | 應用程式 | 取得使用者的電子郵件，並將它對應至 Replicon 系統中的使用者，以將聊天訊息推送至 Replicon 的應用程式 | [4db812e1-4d29-44e4-b72e-9654c0c91ce4](../azure/4db812e1-4d29-44e4-b72e-9654c0c91ce4.md) |

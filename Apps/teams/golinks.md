---
title: GoLinks 的應用程式資訊（按 GoLinks）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/18/2022
...
description: GoLinks 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c1abaf93-e823-4e9a-a810-34a47e77ef71" target="_blank">在 Teams 儲存區中查看</a>
...
| 合作夥伴公司名稱 | GoLinks |
| 公司的網站 | [https://www.golinks.io](https://www.golinks.io) |
| App 的使用條款 | [https://www.golinks.io/terms.php](https://www.golinks.io/terms.php) |
| 應用程式的核心功能 | GoLinks，稱為「前往連結」、「GoLinks」、「流覽」或「連結」，都是由小組所分享的直觀且容易記住的簡短連結。 它會將長而冗長的 URLs 轉換成可直接用於瀏覽器、電子郵件、聊天和交談的可供使用的可讀取連結。 GoLinks 可讓公司以規模的方式有效且有效地存取及共用工作資訊和資源。 |
| 公司 headquarter 位置 | 美國地區 |
| 應用程式資訊頁面 | [https://www.golinks.io/golinks.php](https://www.golinks.io/golinks.php) |
...
此資訊是由 GoLinks 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 我們只會儲存 Microsoft 的租使用者識別碼。 |
...
| 隱私權原則 URL | https://www.golinks.io/privacy.php |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage Read。群組 | 應用程式 | 我們需要存取公用通道中的郵件，才能檢查郵件是否包含 [前往/連結]。 | [c1abaf93-e823-4e9a-a810-34a47e77ef71](../azure/c1abaf93-e823-4e9a-a810-34a47e77ef71.md) |

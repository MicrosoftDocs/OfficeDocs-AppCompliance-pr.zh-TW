---
title: AuditBoard 的應用程式資訊（按 AuditBoard）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/10/2022
...
description: AuditBoard 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
* <a href="https://teams.microsoft.com/l/app/c37d6bf9-d665-4119-b4e4-c641ee74fe09" target="_blank">在 Teams 儲存區中查看</a>
...
由 AuditBoard 提供給 Microsoft 的資訊：
...
| App 的使用條款 | [https://www.auditboard.com/terms-of-use/](https://www.auditboard.com/terms-of-use/) |
| 應用程式的核心功能 | 可讓 AuditBoard 訂戶接收 Microsoft Teams 中的通知。 |
...
此資訊是由 AuditBoard 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.auditboard.com/privacy-policy/ |

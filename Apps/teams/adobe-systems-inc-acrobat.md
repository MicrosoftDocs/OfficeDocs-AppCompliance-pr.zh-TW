---
title: Adobe Systems Inc. 的 Adobe Acrobat 應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/09/2022
...
<p>上次由開發人員更新日期：2022 年 3 月 6 日</p>

* <a href="https://teams.microsoft.com/l/app/10aea93d-20cf-44c2-b4a5-284c5ef2e6a5" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002564" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Adobe Systems Inc. 提供給 Microsoft 的資訊：
...
| 應用程式的核心功能 | 使用適用于 Microsoft Teams 的 Adobe Acrobat，PDF 檔案格式的製作者可讓您與頻道中的每個人共同作業，並在單一 PDF &#8211;中收集意見反應，而不需要離開Teams環境。 當其他人對您的檔採取動作時，接收活動通知。 檢閱者可以查看並評論彼此&#8217;的意見反應，因此您&#8217;花費較少的時間來管理衝突 |
| 公司總部位置 | 美國美國 |
...
Adobe Systems Inc. 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | UserInfo、OAuth 資源、使用者資源、  |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | tenant_id、upn_hash、profile_and_token_info、oauth_state、ims_login_changed_at、preference_data、updated_at、created_at、expires_at |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | 不使用任何驗證程式庫，我們會直接使用 OAuth 2.0 通訊協定 |
| 您的應用程式是否支援條件式存取原則？ | 否 |

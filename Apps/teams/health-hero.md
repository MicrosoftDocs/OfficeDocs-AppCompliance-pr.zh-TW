...
description: 健康情況主圖、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "64875410"
---
# <a name="health-hero"></a>Health Hero

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 8 月 1 日</p>

* <a href="https://teams.microsoft.com/l/app/1394c825-0026-4f33-bcc9-abaa9ae5d83b" target="_blank">在Teams存放區中檢視</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001405" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Health Hero 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://gohealthhero.com](https://gohealthhero.com) |
| 應用程式的使用規定 | [https://www.gohealthhero.com/terms](https://www.gohealthhero.com/terms) |
| 應用程式的核心功能 | 健康情況主圖可讓使用者擷取狀況良好的活動並接收活動點。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
健康情況主圖已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 應用程式 | 僅限建立帳戶的使用者資訊。 | [5f1f4eb7-479e-42f3-b86f-4c1f53e1c222](../azure/5f1f4eb7-479e-42f3-b86f-4c1f53e1c222.md) |

---
title: Dynamo Software 的 Dynamo 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/09/2022
...
description: Dynamo 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65312269"
---
# <a name="dynamo"></a>發電機

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 9 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004007" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Dynamo Software 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 動態軟體 |
| 公司的網站 | [https://www.dynamosoftware.com](https://www.dynamosoftware.com) |
| 應用程式的使用規定 | [https://www.dynamosoftware.com/End-User-Terms](https://www.dynamosoftware.com/End-User-Terms) |
| 應用程式的核心功能 | Dynamo&#8217;適用于 Outlook 的Office增益集是支援程式，可讓現有的 Dynamo 使用者透過適用于 Windows 的傳統型Outlook應用程式來使用 Dynamo，並在 Web (Office 365 和 Outlook.com) 上Outlook。 您可以傳送合併列印草稿、將約會和活動及其附件新增至 Dynamo，以及建立連絡人、公司、交易和資金類型的新專案，而不需要開啟 Dynamo。  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://help.dynamosoftware.com/about-dynamo-web-add-in-for...](https://help.dynamosoftware.com/about-dynamo-web-add-in-for-outlook/) |
...
Dynamo Software 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.dynamosoftware.com/privacy-policy/ |

...
由 Mailbutler 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Mailbutler |
| 公司的網站 | [https://www.mailbutler.io](https://www.mailbutler.io) |
...
此資訊是由 Mailbutler 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | Email IDs，電子郵件中繼資料 (主旨，寄件者/收件者，如果客戶授權) ，則為連絡人資料 (（如果使用者匯入）)  |
...
| 隱私權原則 URL | https://www.mailbutler.io/privacy-policy-mailbutler/ |

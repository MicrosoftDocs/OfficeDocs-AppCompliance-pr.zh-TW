---
title: CodeTwo for Outlook by CodeTwo 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: CodeTwo 針對 Outlook、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003022" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的核心功能 | 自動電子郵件簽章、法律免責聲明會 &amp; 在您的郵件中顯示行銷橫幅。 |
| 公司總部位置 | 波蘭 |

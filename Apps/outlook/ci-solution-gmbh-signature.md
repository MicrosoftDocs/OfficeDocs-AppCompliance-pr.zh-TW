---
title: ci 解決方案 GmbH 所CI-Signature的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: CI-Signature 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA200002458" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的核心功能 | 在伺服器端產生的Outlook和 OWA 中新增可見的簽章CI-Sign，如果簽章是透過CI-Disclaimer在伺服器端新增，以符合公司身分識別需求和法律要求，則為預覽。  |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | [https://www.ci-solution.com/support/de/](https://www.ci-solution.com/support/de/) |

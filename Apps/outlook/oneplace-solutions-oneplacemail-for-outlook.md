...
| App 的使用條款 | [https://www.oneplacesolutions.com/eula.html](https://www.oneplacesolutions.com/eula.html) |
| 應用程式的核心功能 | OnePlaceMail 可將電子郵件和附件儲存至 SharePoint、OneDrive 及 Teams。 它也允許在撰寫電子郵件時使用 SharePoint、OneDrive 和 Teams 中的內容。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | 委託 | 需要判斷目前的使用者是否為成員 Teams。 | [44a72516-136f-4a55-ae26-ef09977230be](https://docs.microsoft.com/microsoft-365-app-certification/azure/44a72516-136f-4a55-ae26-ef09977230be) |
>| ReadWrite 共用 | 委託 | 需要存取郵件屬性以設定 SharePoint 欄，並將轉接至訊息項目上 SharePoint 類別 | [44a72516-136f-4a55-ae26-ef09977230be](https://docs.microsoft.com/microsoft-365-app-certification/azure/44a72516-136f-4a55-ae26-ef09977230be) |
>| MailboxSettings ReadWrite | 委託 | 未收集或使用此資料，這是用來將類別新增至使用者信箱中的主要類別清單 | [44a72516-136f-4a55-ae26-ef09977230be](https://docs.microsoft.com/microsoft-365-app-certification/azure/44a72516-136f-4a55-ae26-ef09977230be) |
>| Sites.ReadWrite.All | 委託 | 需要在應用程式上傳至 SharePoint 的專案上設定屬性。 | [44a72516-136f-4a55-ae26-ef09977230be](https://docs.microsoft.com/microsoft-365-app-certification/azure/44a72516-136f-4a55-ae26-ef09977230be) |
>| User.Read | 委託 | Microsoft Graph 驗證所需的。 | [44a72516-136f-4a55-ae26-ef09977230be](https://docs.microsoft.com/microsoft-365-app-certification/azure/44a72516-136f-4a55-ae26-ef09977230be) |
>| User.ReadBasic.All | 委託 | 需要在 [人員選擇] 欄位中顯示使用者設定檔影像。 | [44a72516-136f-4a55-ae26-ef09977230be](https://docs.microsoft.com/microsoft-365-app-certification/azure/44a72516-136f-4a55-ae26-ef09977230be) |
>| User.ReadBasic.All | 委託 | 需要在 [人員選擇] 欄位中顯示使用者設定檔影像。 | [44a72516-136f-4a55-ae26-ef09977230be](https://docs.microsoft.com/microsoft-365-app-certification/azure/44a72516-136f-4a55-ae26-ef09977230be) |
>| User.ReadWrite.All | 委託 | 需要判斷使用者 Office 365 租用中是否啟用 Teams 服務。 | [44a72516-136f-4a55-ae26-ef09977230be](https://docs.microsoft.com/microsoft-365-app-certification/azure/44a72516-136f-4a55-ae26-ef09977230be) |

---
title: Achiever for Outlook 的 Achiever 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: 適用于 Outlook 的 Achiever、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "66912918"
---
# <a name="achievers-for-outlook"></a>Outlook 的達成者

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 10 月 28 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381896" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式名稱 | Outlook 的達成者 |
| ID | WA104381896 |
| 支援Office 365用戶端 | Outlook 2016或更新版本的 Windows、mac 上的 Outlook 2016 或更新版本，Outlook 網頁版 |
| 合作夥伴公司名稱 | 成就 |
...
| 哪些資料會儲存在您的資料庫中？ | 租使用者識別碼、使用者識別碼、使用者電子郵件 |

...
description: 適用于 Outlook、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊，都適用于銷售業務開發的所有可用安全性與合規性資訊。
...
ms.locfileid: "64879470"
---
# <a name="outreach-sales-engagement-for-outlook"></a>適用于Outlook的拓展銷售業務

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 6 月 14 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381052" target="_blank">在 AppSource 中檢視</a>
...
| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 適用于Outlook的拓展銷售業務 |
| ID | WA104381052 |
| 支援Office 365用戶端 | Outlook 2013 年或更新版本，請參閱 mac 上的 Windows、Outlook 2016 或更新版本，Outlook 網頁版 |
| 合作夥伴公司名稱 | 外 展 |
| 公司的網站 | [https://www.outreach.io](https://www.outreach.io) |
| 應用程式的使用規定 | [https://www.outreach.io/terms](https://www.outreach.io/terms) |
| 應用程式的核心功能 | 拓展是最大且最快速成長的銷售業務平臺，可協助公司大幅提高生產力，並推動更聰明、更深入地與客戶互動。 從銷售自動化，到交談智慧、購買者情感分析、小組績效報告&#8212;等等&#8212;拓展是整合式銷售業務平臺，可協助銷售代表和領導者提高生產力、產生更多銷售商機，並達成銷售目標 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.outreach.io/product](https://www.outreach.io/product) |
| 用來執行應用程式的裝載環境或服務模型為何？ |  |
| 應用程式會使用哪些主控雲端提供者？ | Azure、GCP、AWS |
...
這項資訊是由「擴充」所提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

...
| App 的使用條款 | [https://www.outreach.io/terms](https://www.outreach.io/terms) |
| 應用程式的核心功能 | 「推廣」是最大且成長速度最快的銷售專案平臺，可協助公司大幅提高生產力，並以更聰明的方式與客戶合作。 從銷售自動化，到交談情報、買家 sentiment 分析、小組效能報告&#8212;，還有更多&#8212; 推廣是整合的銷售人員平臺，可協助銷售代表和領導者提高生產力、產生更多銷售機會，並擊敗您的銷售目標 |
| 公司 headquarter 位置 | 美國地區 |
| 應用程式資訊頁面 | [https://www.outreach.io/product](https://www.outreach.io/product) |
| 用來執行應用程式的主控環境或服務模型為何？ |  |
| 應用程式會使用哪一個主控雲端提供者？ | Azure、GCP、AWS |

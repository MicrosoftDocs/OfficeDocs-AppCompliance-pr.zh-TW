...
description: Evernote 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64784002"
---
# <a name="evernote-application-information"></a>Evernote 應用程式資訊

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 9 月 15 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104379617" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Evernote 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Evernote |
| 公司的網站 | [https://evernote.com](https://evernote.com) |
| 應用程式的使用規定 | [https://evernote.com/legal/terms-of-service](https://evernote.com/legal/terms-of-service) |
| 應用程式的核心功能 | 竄改您的收件匣。 將重要電子郵件儲存至 Evernote  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://evernote.com/about-us](https://evernote.com/about-us) |
...
Evernote 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

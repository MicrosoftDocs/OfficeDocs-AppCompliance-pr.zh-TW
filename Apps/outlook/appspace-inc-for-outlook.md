---
title: Appspace for appspace for Outlook 的應用程式資訊，由 Appspace， Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/25/2022
...
description: 適用于 Outlook 之 Appspace 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65692357"
---
# <a name="appspace-for-outlook"></a>適用于 Outlook 的 Appspace

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 2 月 2 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004102" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的使用規定 | [https://www.appspace.com/legal/user-agreement/](https://www.appspace.com/legal/user-agreement/) |
| 應用程式的核心功能 | Appspace 是一個通訊和空間管理平臺，可協助您的企業搭配組織和效率，從任何地方工作。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.appspace.com](https://www.appspace.com) |
...
Appspace， Inc 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 最新的 SOC2 認證日期 | 2020-11-09 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 認證日期 | 2020-11-09 |
...
| 隱私權原則 URL | https://www.appspace.com/legal/privacy-policy/ |

---
title: Flow Simulation Ltd 的電子郵件反應器應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Email Reactor 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65229390"
---
# <a name="email-reactor"></a>電子郵件反應器

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 4 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104379506" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的使用規定 | [https://www.flosim.com/reactor/EULA.html](https://www.flosim.com/reactor/EULA.html) |
| 應用程式的核心功能 | 省時電子郵件回應草稿工具 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.flosim.com/reactor/Email_Reactor.html](https://www.flosim.com/reactor/Email_Reactor.html) |

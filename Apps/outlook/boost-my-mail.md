...
description: 所有可用的安全性與合規性資訊，適用于 Boost My Mail、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
---
# <a name="boost-my-mail"></a>提升我的郵件

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 5 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004085" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Boost My Mail 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 提升我的郵件 |
| 公司的網站 | [https://www.boostmymail.com/fr](https://www.boostmymail.com/fr) |
| 應用程式的使用規定 | [https://www.boostmymail.com/fr/conditions-dutilisations/](https://www.boostmymail.com/fr/conditions-dutilisations/) |
| 應用程式的核心功能 | 集中管理Outlook上美觀的公司電子郵件簽章 |
| 公司總部位置 | 法國 |
| 應用程式資訊頁面 | |
...
此資訊由 Boost My Mail 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

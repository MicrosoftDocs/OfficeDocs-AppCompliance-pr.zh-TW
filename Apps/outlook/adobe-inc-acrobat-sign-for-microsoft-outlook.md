---
title: Adobe Acrobat Sign for Microsoft Outlook由 Adobe Inc. 的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: 適用于 Microsoft Outlook 的 Adobe Acrobat Sign、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "65070554"
---
# <a name="adobe-acrobat-sign-for-microsoft-outlook"></a>適用于 Microsoft Outlook 的 Adobe Acrobat Sign
...
* <a href="https://appsource.microsoft.com/product/office/WA104381158" target="_blank">在 AppSource 中檢視</a>
...
| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 適用于 Microsoft Outlook 的 Adobe Acrobat Sign |
| ID | WA104381158 |
...
| 應用程式的核心功能 | 當您將 Adobe Sign 新增至Outlook時，讓檔簽署工作流程保持快速移動。 現在，在Outlook中，您可以簽署檔、傳送檔以進行合法系結的電子簽章和核准，&#8212;全都使用 Microsoft 慣用的電子簽署解決方案。 |
| 公司總部位置 | 美國美國 |

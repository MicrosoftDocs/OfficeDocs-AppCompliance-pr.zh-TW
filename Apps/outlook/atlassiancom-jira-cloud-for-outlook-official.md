---
title: Outlook (官方) 的 Jira Cloud 應用程式資訊 Atlassian.com
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/26/2021
...
description: 適用于Outlook (官方) 、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的 Jira Cloud 所有可用的安全性與合規性資訊。
...
ms.locfileid: "64881500"
---
# <a name="jira-cloud-for-outlook-official"></a>適用于Outlook (官方) 的 Jira Cloud

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 8 月 11 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200000056" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Atlassian.com 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 適用于Outlook (官方) 的 Jira Cloud |
| ID | WA200000056 |
...
| 應用程式的核心功能 | 規劃、追蹤、發行軟體。 管理支援、客戶服務和專案。 |
| 公司總部位置 | 澳洲 |
| 應用程式資訊頁面 | |
...
這項資訊是由 Atlassian.com 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者電子郵件資料會當做顯示 Jira 連結之應用程式功能的一部分來處理。 |

...
| App 的使用條款 | [https://www.pexip.com/terms](https://www.pexip.com/terms) |
| 應用程式的核心功能 | Pexip 一種可讓使用者使用現有的會議安排工作流程輕鬆建立安全的會議。 Pexip 一種提供螢幕共用、語音和影片聊天功能。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委託 | 使用者的事件資料是用來在平臺上排程會議，以及追蹤會議中繼資料的變更 | [69609b5a-e416-4d72-b10b-8903e84780c3](https://docs.microsoft.com/microsoft-365-app-certification/azure/69609b5a-e416-4d72-b10b-8903e84780c3) |

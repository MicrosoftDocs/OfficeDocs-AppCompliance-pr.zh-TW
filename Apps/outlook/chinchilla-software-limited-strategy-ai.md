---
title: 策略的應用程式資訊-AI （依 Chinchilla 軟體限制）
ms.author: elmalova
author: elenamalova
ms.date: 12/14/2021
ms.topic: article
...
description: 在 CSA 星型登錄中，策略-AI 的所有可用安全性和符合性資訊資訊，其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及安全性/符合性資訊。
...
ms.locfileid: "61537893"
---
# <a name="strategy-ai"></a>策略-AI

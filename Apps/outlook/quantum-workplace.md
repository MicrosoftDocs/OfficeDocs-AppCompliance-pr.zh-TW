---
title: Quantum Workplace by Quantum Workplace 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Quantum Workplace 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA104381747" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Quantum Workplace 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Quantum Workplace |
| ID | WA104381747 |
| 支援Office 365用戶端 | Windows 上的 Outlook 2013 或更新版本、Mac 上的 Outlook 2016 或更新版本、Outlook 網頁版 |
| 合作夥伴公司名稱 | Quantum Workplace |
| 公司的網站 | [https://www.quantumworkplace.com](https://www.quantumworkplace.com) |
| 應用程式的使用規定 | [https://www.quantumworkplace.com/terms-of-use](https://www.quantumworkplace.com/terms-of-use) |
| 應用程式的核心功能 | 協助員工成功使用 Quantum Workplace 警示和通知。 |
| 公司總部位置 | 美國美國 |
...
Quantum Workplace 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 應用程式 | 使用 ChatId。 | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |
>| User.Read.All | 應用程式 | User.Id (預存) - 用來將傳送至 Bot 端點的使用者相互關聯;User.UserPrincipalName (未儲存) - 目前未使用;User.Mail (未儲存) - 用來比對系統中的使用者與我們儲存的 AzureAD 識別碼。 | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |

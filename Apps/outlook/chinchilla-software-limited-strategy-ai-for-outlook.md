---
title: Chinchilla 軟體所限制之策略的應用程式資訊-AI Outlook
ms.author: elmalova
author: elenamalova
ms.date: 12/14/2021
ms.topic: article
...
description: 所有可用的安全性和符合性資訊，如 Outlook 的戰略-AI，其資料處理原則，它的 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "62155230"
---
# <a name="strategy-ai-for-outlook"></a>策略-AI 用於 Outlook

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新：2021年12月1日</p>
...
由 Chinchilla 軟體所提供的資訊，僅限 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 策略-AI 用於 Outlook |
| ID | WA200003576 |
| 支援 Office 365 用戶端 | Outlook 2013 或更新版本的 Mac Windows Outlook 2016 或更新版本 Outlook 網頁版 |
| 合作夥伴公司名稱 | Chinchilla 軟體限制 |
| 公司的網站 | [https://www.strategy-ai.com](https://www.strategy-ai.com) |
| App 的使用條款 | [https://www.strategy-ai.com/terms](https://www.strategy-ai.com/terms) |
| 應用程式的核心功能 | 提供一致、跨業務、跨平臺的資料歸屬 |
...
此資訊是由 Chinchilla 軟體所提供，此應用程式會限制此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.strategy-ai.com/privacy |

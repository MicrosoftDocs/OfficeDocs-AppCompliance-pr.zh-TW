---
title: 依 salesforce.com 的 Salesforce 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/02/2021
...
description: Salesforce 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA104379334" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

salesforce.com 提供給 Microsoft 的資訊：
...
| 公司的網站 | [https://www.salesforce.com](https://www.salesforce.com) |
| 應用程式的使用規定 | [https://www.salesforce.com/content/dam/web/en_us/www/docume...](https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/Agreements/software-order-form-supplements/Salesforce_Outlook_TOU_Order_Form_Addendum.pdf) |
| 應用程式的核心功能 | 可讓您在Outlook體驗 Salesforce。 整合是以 100% 雲端為基礎，沒有軟體可推送、安裝或維護。 檢視與電子郵件和約會相關聯的所有連絡人、潛在客戶、帳戶、商機和案例，而不需在 Salesforce 與Outlook之間切換;您的 Salesforce 資料會直接出現在Outlook中。 直接在 Outlook 中建立新的 Salesforce 記錄，包括自訂物件記錄。 按一下即可將電子郵件和約會新增至 Salesforce 記錄，即使撰寫 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
這項資訊是由 salesforce.com 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

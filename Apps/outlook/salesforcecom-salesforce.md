...
| App 的使用條款 | [https://www.salesforce.com/content/dam/web/en_us/www/docume...](https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/Agreements/software-order-form-supplements/Salesforce_Outlook_TOU_Order_Form_Addendum.pdf) |
| 應用程式的核心功能 | 可讓您在 Outlook 中體驗銷售隊伍。 整合是 100% cloud，但沒有任何可強制進行、安裝或維護的軟體。 查看所有與電子郵件及約會關聯的連絡人、潛在客戶、帳戶、機會及案例，而不需要在 Salesforce 和 Outlook 之間切換; 您的 Salesforce 資料會直接出現在 Outlook 中。 直接在 Outlook 中建立新的 Salesforce 記錄，包括自訂物件記錄。 只需要按一下即可將電子郵件及約會新增至 Salesforce 記錄，即使在撰寫時也是如此。 |

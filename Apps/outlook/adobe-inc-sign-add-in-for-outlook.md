---
title: Adobe Inc Outlook Adobe Sign Add-In的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: 適用于 Outlook 的所有 Adobe Sign Add-In、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "64881087"
---
# <a name="adobe-sign-add-in-for-outlook"></a>適用于 Outlook 的 Adobe Sign Add-In
...
| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 適用于 Outlook 的 Adobe Sign Add-In |
| ID | WA104381158 |

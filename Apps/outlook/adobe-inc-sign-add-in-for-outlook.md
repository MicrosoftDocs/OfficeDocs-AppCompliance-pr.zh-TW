...
| 應用程式的核心功能 | 將 Adobe 簽署新增至 Outlook，使檔簽署工作流程的移動速度更快。 現在，在 Outlook 中，您可以簽署檔、傳送檔，以合法系結電子簽章和核准 &#8212; 所有檔都使用 Microsoft 偏好的電子簽名解決方案。 |
...
>| offline_access | 委託 | 若要在目前的憑證到期時重新整理存取權杖。 例如，當使用者在 [ &quot; 傳送簽名 &quot; ] 視窗中並保持停用狀態的時間過長時，當使用者使用中時，我們需要重新整理新的權杖。 | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](https://docs.microsoft.com/microsoft-365-app-certification/azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b) |

---
title: Egnyte for Outlook by Egnyte， Inc. 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Egnyte for Outlook 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66656046"
---
# <a name="egnyte-for-outlook"></a>Egnyte for Outlook

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 3 月 8 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004177" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Egnyte， Inc. 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Egnyte for Outlook |
| ID | WA200004177 |
| 支援Office 365用戶端 | Windows 上的 Outlook 2013 或更新版本、Mac 上的 Outlook 2016 或更新版本、Outlook 網頁版 |
| 合作夥伴公司名稱 | Egnyte， Inc. |
| 公司的網站 | [https://www.egnyte.com](https://www.egnyte.com) |
| 應用程式的使用規定 | [https://www.egnyte.com/terms-and-conditions/01-2020](https://www.egnyte.com/terms-and-conditions/01-2020) |
| 應用程式的核心功能 | 輕鬆地將 Egnyte 中的檔案共用到 Outlook 中的電子郵件，或直接將 Outlook 中的電子郵件和附件儲存到 Egnyte 資料夾，而不需離開收件匣 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://helpdesk.egnyte.com/hc/en-us/articles/4427124922125](https://helpdesk.egnyte.com/hc/en-us/articles/4427124922125) |
...
此資訊由 Egnyte， Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者設定檔資料、使用者郵件資料 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 電子郵件地址、租使用者識別碼、權杖、郵件和附件識別碼及其內容 |
...
| 隱私權原則 URL | https://www.egnyte.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.Read.Shared | 委託 | 需要讀取使用者有權存取的電子郵件詳細資料 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| User.Read | 委託 | 驗證使用者的授權用途的必要專案 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| 電子郵件 | 委託 | 驗證存取權杖的必要專案 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| offline_access | 委託 | 使用 OAuth 2.0 時明確要求重新整理權杖的必要項 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| openid | 委託 | 讀取使用者基本資訊的必要專案 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| 設定檔 | 委託 | 讀取基本使用者資訊的必要專案 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |

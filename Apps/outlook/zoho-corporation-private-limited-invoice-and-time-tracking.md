...
>只有在使用者同意後，才會回遷資料。 透過隔離的專屬網路提供對伺服器的邏輯存取 &amp; ，且具有高安全性和監控。 這個網路受到防火牆、2要素驗證及 Kerberos Authent 的保護。
...
<iframe height='1020' title='Microsoft Cloud App Security資訊' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/28305' frameborder='no' style='width: 100%;'></iframe>

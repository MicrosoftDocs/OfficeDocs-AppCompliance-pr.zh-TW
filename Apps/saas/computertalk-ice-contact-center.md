...
| 您的應用程式會處理哪些資料？ | AzureADGuid (帳戶連結) 。  Email位址和電話號碼可以從 AAD 匯入。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | AzureADGuid (帳戶連結) 。  Email位址和電話號碼可以從 AAD 匯入。 |

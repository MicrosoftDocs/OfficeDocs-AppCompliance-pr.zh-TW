...
由 ComputerTalk 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | ice 連絡人中心 |
| ID | computertalk-連絡人中心 |
...
此資訊是由 ComputerTalk 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | AzureADGuid (帳戶連結) 。  您可以從 AAD 匯入電子郵件地址和電話號碼。 |

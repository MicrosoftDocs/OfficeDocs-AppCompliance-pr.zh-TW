...
由 Genesys Cloud Services （Inc.）提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Genesys 雲端 CX Teams 整合 |
...
Genesys 雲端服務（Inc.）會提供此資訊，其是關於此應用程式如何收集和儲存組織資料，以及您的組織將會透過應用程式所收集資料的控制項。

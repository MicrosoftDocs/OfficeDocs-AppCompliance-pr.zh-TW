---
title: Outlook 由 Standss (太平洋) PTE 限制的 EmailNotes 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
Standss 所提供的資訊 (南部太平洋) PTE 限制為 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Outlook 的 EmailNotes |
| ID | standsssouthpacificltd1581455821226.emailnotes |
| 合作夥伴公司名稱 | Standss (南部太平洋) PTE 有限 |
| 公司的網站 | [https://www.standss.com](https://www.standss.com) |
| App 的使用條款 | [https://www.standss.com/sendguard_m365/terms_conditions.htm](https://www.standss.com/sendguard_m365/terms_conditions.htm) |
| 應用程式的核心功能 | SendGuard for Outlook M365 是一種風險和規範工具，可偵測、提示、警告和保護使用者從電子郵件敏感、機密或不適當的資訊到非預期的收件者 |
| 公司 headquarter 位置 | 斐濟 |
| 應用程式資訊頁面 | [https://www.standss.com/sendguard_m365/default.htm](https://www.standss.com/sendguard_m365/default.htm) |
...
此資訊是由 Standss (南部太平洋) PTE 所提供，這些 PTE 會限制此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | http://www.standss.com/sr/sg_m365/privacy_policy.asp |
...
| 您的應用程式是否支援條件式存取原則？ | 是 |
| 列出支援的原則類型 | 具有系統管理角色的使用者需要多重要素驗證 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ReadWrite 的行事曆 | 委託 | 若要從主旨、內文、附加至會議邀請的附件內容中讀取內容  | [471294e9-96d6-475b-b503-e02acd9ed2cd](../azure/471294e9-96d6-475b-b503-e02acd9ed2cd.md) |
>| 郵件。 ReadWrite | 委託 | 若要從主旨、內文、訊息項目附加的附件內容中讀取內容  | [471294e9-96d6-475b-b503-e02acd9ed2cd](../azure/471294e9-96d6-475b-b503-e02acd9ed2cd.md) |
>| User.Read | 委託 | 這是讀取使用者資料以驗證其網域/使用者帳戶的授權資訊 | [471294e9-96d6-475b-b503-e02acd9ed2cd](../azure/471294e9-96d6-475b-b503-e02acd9ed2cd.md) |
>| openid | 委託 | 單一登入 (SSO) 許可權的需求 | [471294e9-96d6-475b-b503-e02acd9ed2cd](../azure/471294e9-96d6-475b-b503-e02acd9ed2cd.md) |
>| 設定檔 | 委託 | 單一登入 (SSO) 許可權的需求 | [471294e9-96d6-475b-b503-e02acd9ed2cd](../azure/471294e9-96d6-475b-b503-e02acd9ed2cd.md) |

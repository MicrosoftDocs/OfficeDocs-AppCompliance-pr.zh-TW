...
由廣泛的創意/Idea2Innovation 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 廣泛的創意-創新軟體 |
| ID | wideideaspoweredbyidea2innovaitonswedenab.innovation_cloud_application |
| 合作夥伴公司名稱 | 廣泛的創意/Idea2Innovation |
| 公司的網站 | [https://getwideideas.com](https://getwideideas.com) |
| App 的使用條款 | [https://getwideideas.com/eula](https://getwideideas.com/eula) |
| 應用程式的核心功能 | 使用創新管理軟體從內嵌在 Microsoft 365 和 Teams 中的廣泛創意，分享挑戰，客戶體驗與新解決方案的想法，成為員工工作文化的一部分。 |
...
此資訊已透過廣泛的創意/Idea2Innovation 提供，與此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 使用者名稱和電子郵件地址 |
| 如果基礎 infastructure 處理或儲存 Microsoft 客戶資料，該資料地理位置存放在何處？ | 瑞典 |
...
| 隱私權原則 URL | https://getwideideas.com/privacy-policy/ |
...
>|   **Graph 許可權**  | **權限類型** |          **對齊**          |
>|:------------------------|:--------------------|:------------------------------------|
>| TeamsAppInstallation.ReadWriteForTeam | 委託 | 可讓整個觀點的系統管理中心讀取、安裝、升級和卸載已登入的使用者可以存取之小組中的 Teams 應用程式。  |
>| 通道。建立 | 委託 | 可讓整個觀點的系統管理中心，代表登入的使用者在任何小組中建立通道。  |
>| TeamsTab。建立 | 委託 |  可讓寬創意的系統管理中心，代表登入的使用者在 Microsoft Teams 中的任何小組中建立索引標籤。 |
>| Directory.Read.All | 委託 | 可讓整個觀點的系統管理中心讀取組織中的資料&#8217;s 目錄，例如使用者、群組和應用程式 |
>| Group.Read.All | 委託 | 允許廣泛的創意系統管理中心列出群組，並代表登入的使用者讀取其屬性和所有群組成員資格 |
>| User.Read | 委託 | 允許使用者登入廣泛的創意系統管理中心，並允許此應用程式讀取登入使用者的設定檔。  |

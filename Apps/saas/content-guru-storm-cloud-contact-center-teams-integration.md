---
title: 風暴雲端連絡人中心的應用程式資訊 Teams 依內容專家的整合
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: 風暴雲端連絡人中心所有可用的安全性和符合性資訊資訊 Teams 整合、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63551692"
---
# <a name="storm-cloud-contact-center-teams-integration"></a>風暴 Cloud Contact Center Teams 整合

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員的更新日期：2022年3月10日</p>
...
內容專家提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 風暴 Cloud Contact Center Teams 整合 |
...
| App 的使用條款 | [https://www.contentguru.com/about-us/terms-of-use/](https://www.contentguru.com/about-us/terms-of-use/) |
| 應用程式的核心功能 | 整合風暴 Cloud Contact Center 與 Microsoft Teams，以進行統一的 CCaaS 解決方案。 |
...
內容專家會提供此資訊，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

---
title: Anywhere365 連絡人中心的應用程式資訊，由 WORKSTREAMPEOPLE BV Teams
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Anywhere365 連絡人中心所有可用的安全性和符合性資訊資訊 Teams，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
---
# <a name="anywhere365-contact-center-for-teams"></a>Anywhere365 Teams 的連絡人中心

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次於開發人員的更新日期：2022年3月14日</p>
...
由 WORKSTREAMPEOPLE BV 所提供的資訊給 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Anywhere365 Teams 的連絡人中心 |
...
| App 的使用條款 | [https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialo...](https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialogue-Cloud-Agreement_202112_V3.6.pdf) |
| 應用程式的核心功能 | Anywhere365&#174; 對話方塊雲端平臺用於 Omnichannel 通訊，世界上第一個 microsoft 認可的連絡人 Teams 中心，與 microsoft eocystem 完全整合：從 Azure、Sharepoint 和 Teams 到 Dynamics 365，PowerApps 及 PowerBI。 透過 adition 的低代碼通訊自動化平臺對話方塊，我們可以與任何 API 架構的 bot 框架、通訊層和智慧系統整合。 |
...
此資訊是由 WORKSTREAMPEOPLE BV 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 通訊 &amp; 目前狀態資料 |
| 如果基礎 infastructure 處理或儲存 Microsoft 客戶資料，該資料地理位置存放在何處？ | 荷蘭 () ，美國美國，新加坡 |
...
>| 目前狀態為 [已讀取]。 | 委託 | 收集客戶目前狀態的詳細資料。 | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |

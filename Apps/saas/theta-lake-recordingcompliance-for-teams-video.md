---
title: 使用 theta lake Teams 影片的 Theta lake 錄製 &amp; 相容性應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: 所有可用的安全性和符合性資訊，以取得 Teams 影片的 Theta Lake 錄製 &amp; 相容性、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
---
# <a name="theta-lake-recording-amp-compliance-for-teams-video"></a>對 Teams 影片的 Theta Lake 錄製 &amp; 符合性
...
將 Theta 的資訊提供給 Microsoft：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 對 Teams 影片的 Theta Lake 錄製 &amp; 符合性 |
| ID | thetalake.thetalake_recording_and_compliance_for_teams |
| 合作夥伴公司名稱 | Theta Lake |
| 公司的網站 | [https://thetalake.com](https://thetalake.com) |
| App 的使用條款 | [https://thetalake.com/privacy-policy](https://thetalake.com/privacy-policy) |
| 應用程式的核心功能 | Microsoft Teams 音訊和視訊會議的記錄、封存、法規遵從性及風險降低 |
...
此資訊已由 Theta Lake 提供，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | Microsoft 影片 Microsoft Teams 聊天 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| JoinGroupCall 所有 | 委託 | Graph API 必須存取才能接收通話記錄 | [1cc8eecf-56f3-4137-a0fe-4b0466ca0677](../azure/1cc8eecf-56f3-4137-a0fe-4b0466ca0677.md) |

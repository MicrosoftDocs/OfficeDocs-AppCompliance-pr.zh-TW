...
由 Onna 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | MS365 的 Onna 探索 |
| ID | onna-探索-1 onna1600902517721 |
| 合作夥伴公司名稱 | Onna |
| 公司的網站 | [https://onna.com](https://onna.com) |
...
此資訊是由 Onna 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 電子郵件、電子郵件地址、使用者識別碼、聊天、檔案。 保留和移除原則可供使用者設定。  |
...
| 隱私權原則 URL | https://onna.com/privacy-policy/ |

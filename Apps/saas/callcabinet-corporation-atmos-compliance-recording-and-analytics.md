---
title: CallCabinet Corporation 的 CallCabinet Atmos 合規性錄製和分析的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/16/2022
...
description: CallCabinet Atmos 合規性錄製和分析的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
---
# <a name="callcabinet-atmos-compliance-recording-and-analytics"></a>CallCabinet Atmos 合規性錄製和分析

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 1 月 26 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/callcabinetcorporation1584393576335.atmos" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

CallCabinet Corporation 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | CallCabinet Atmos 合規性錄製和分析 |
| ID | callcabinetcorporation1584393576335.atmos |
| 合作夥伴公司名稱 | CallCabinet Corporation |
| 公司的網站 | [https://www.callcabinet.com](https://www.callcabinet.com) |
| 應用程式的使用規定 | [https://www.callcabinet.com/terms-and-conditions/](https://www.callcabinet.com/terms-and-conditions/) |
| 應用程式的核心功能 | CallCabinet 的 Atmos 是 Azure 原生合規性通話錄製、AI 分析和 QA SaaS 解決方案，適用于 Microsoft Teams 和其他共同作業或連絡人中心系統。 |
| 公司總部位置 | 美國美國 |
...
CallCabinet Corporation 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 錄製的 Teams 交談、影片和畫面分享 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 錄製的 Teams 交談、影片和畫面分享 |

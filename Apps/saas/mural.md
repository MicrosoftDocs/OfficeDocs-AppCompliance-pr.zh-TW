---
title: 依 MURAL 的 MURAL 適用的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
| 合作夥伴公司名稱 | MURAL |
| 公司的網站 | [https://www.mural.co](https://www.mural.co) |
| 應用程式的使用規定 | [https://www.mural.co/terms/terms-of-use](https://www.mural.co/terms/terms-of-use) |
| 應用程式的核心功能 | 以視覺化方式思考並共同作業 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://support.mural.co](https://support.mural.co) |
...
這個資訊是由 MURAL 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 根據登入目的，MURAL 只需要 [名稱]、[姓氏] 和 [電子郵件地址]。 要處理/儲存的資料種類取決於客戶。 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 根據登入目的，MURAL 只會儲存來自使用者的名字、姓氏和電子郵件。 儲存的任何其他資訊都取決於客戶儲存在其雜音中的資訊。 |
...
| 最新的 SOC2 認證日期 | 2021-04-01 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最新的 SOC3 認證日期 | 2021-04-01 |
...
| 隱私權原則 URL | https://www.mural.co/terms/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | 委託 | 將檔上傳至 MURAL 所需的 Files.read。 | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
>| User.Read | 委託 | User.read，因為下列專案需要名字、姓氏和電子郵件才能建立帳戶。 | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |

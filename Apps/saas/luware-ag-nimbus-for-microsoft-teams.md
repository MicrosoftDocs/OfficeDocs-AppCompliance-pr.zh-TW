...
| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Luware Nimbus for Microsoft Teams |
...
>| Calls.InitiateGroupCall.All | 應用程式 | 其中許多應用程式/Bot (每個連絡人中心佇列) 一個：呼叫代理程式  | [7e1fc6b3-90a7-4a98-a766-5627193e95bc](../azure/7e1fc6b3-90a7-4a98-a766-5627193e95bc.md) |
>| Calls.JoinGroupCall.All | 應用程式 | 其中許多應用程式/Bot (每個連絡人中心佇列) 一個：加入呈報的通話以播放公告 | [7e1fc6b3-90a7-4a98-a766-5627193e95bc](../azure/7e1fc6b3-90a7-4a98-a766-5627193e95bc.md) |
...
|:------------|:---------------------------------------|
| [**應用程式安全性**](../docs/certification-submission-guide.md#application-security) | **N/A** |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;滲透測試 | 不適用 |

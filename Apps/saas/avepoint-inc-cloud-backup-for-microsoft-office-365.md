---
title: AvePoint Inc. Microsoft Office 365雲端備份的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/27/2021
...
description: 適用于雲端備份的所有可用安全性與合規性資訊，適用于Microsoft Office 365、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64876580"
---
# <a name="cloud-backup-for-microsoft-office-365"></a>適用于 Microsoft Office 365 的雲端備份

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>上次由開發人員更新日期：2021 年 9 月 29 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/avepoint.cloudbackup_o365_transact" target="_blank">在 AppSource 中檢視</a>
...
| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 適用于 Microsoft Office 365 的雲端備份 |
...
| 應用程式的核心功能 | AvePoint 雲端備份是業界&#8217;最完整的雲端到雲端備份解決方案，適用于Microsoft 365。 透過無限制的自動備份，以及 AvePoint&#8217;Azure 儲存體或您自己的雲端中的安全儲存體，您只需決定要復原多少，以及何時復原即可。 隨選且細微的專案層級還原可隨時存取業務關鍵電子郵件、檔案、交談、錄製、專案、工作、群組、Teams、Planner 和網站。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.avepoint.com/products/cloud/backup/microsoft-of...](https://www.avepoint.com/products/cloud/backup/microsoft-office-365-backup) |
...
| 您的應用程式會處理哪些資料？ | SharePoint網站/ODFB 網站/Microsoft 365群組/小組識別碼、名稱、URL; |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | SharePoint網站/ODFB 網站/Microsoft 365群組/小組識別碼、名稱、URL; |
...
| 隱私權原則 URL | https://www.avepoint.com/company/privacy-and-security/ |
| 應用程式是否會執行自動化決策，包括可能會有法律效果或類似影響的分析？ | 是 |
| 個人是否提供物件處理的選項？ | 是 |
| 應用程式是否針對隱私權通知中未說明的次要用途處理客戶資料， (也就是行銷、分析) ？ | 是 |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | MSAL |
| 您的應用程式是否支援條件式存取原則？ | 是 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.ReadWrite.All | 應用程式 | 從所有通道新增和移除成員 | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
>| ChannelMessage.Read.All | 應用程式 | 讀取所有通道訊息 | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
>| ChannelSettings.ReadWrite.All | 應用程式 | 讀取和寫入所有通道的名稱、描述和設定 | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
>| Directory.Read.All | 應用程式 | 讀取目錄資料 | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
>| Files.Read.All | 應用程式 | 讀取所有網站集合中的檔案 | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
>| Group.ReadWrite.All | 應用程式 | 讀取和寫入所有群組 | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
>| Reports.Read.All | 應用程式 | 讀取所有使用量報告 | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
>| Sites.ReadWrite.All | 應用程式 | 讀取和寫入所有網站集合中的專案 | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
>| User.Read | 委託 | 登入並讀取使用者設定檔 | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |

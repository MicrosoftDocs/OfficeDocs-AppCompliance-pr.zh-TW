---
title: Emailgistics by Emailgistics Corp 的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/21/2022
...
description: Emailgistics 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
Emailgistics Corp 所提供的資訊給 Microsoft：
...
| App 的使用條款 | [https://emailgistics.com/tos](https://emailgistics.com/tos) |
| 應用程式的核心功能 | Microsoft 365 的小組收件匣電子郵件管理軟體 |
...
Emailgistics Corp 已提供此資訊。關於此應用程式如何收集和儲存組織的資料，以及您的組織將會對應用程式所收集的資料所做的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 郵件。 ReadWrite | 委託 | 讀取存取權要求取得共用信箱中郵件的相關資訊。 若郵件包含 &#8220;發票&#8221; （例如) ）以正確地追蹤交談 (的交談記錄和自動工作分派) ，而且報告 (（例如，「開啟訊息詳細資料」報告) ），則需要郵件資訊才能執行客戶定義的規則 (散佈至使用者 A。
寫入存取需要從規則傳送郵件 (例如自動回復) ，以及使用 Emailgistics 交談識別碼更新郵件主體。 | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| 傳送郵件 | 委託 | 允許 Emailgistics 從共用信箱傳送電子郵件。 若要從規則 (（例如自動回復) ）傳送郵件，則需要此許可權。 | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| MailboxSettings ReadWrite | 委託 | 可讓 Emailgistics 取得共用信箱名稱，並建立信箱規則，將內送郵件路由至其隱藏的內送資料夾，以進行初始處理、規則執行和自動指派。 | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| User.Read | 委託 | 允許 Emailgistics 登入共用信箱，並閱讀相關的基本資訊，例如服務主體識別碼、電子郵件地址和使用者名稱。 | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| User.ReadBasic.All | 委託 | 允許 Emailgistics 讀取您租使用者中使用者的基本資訊。 需要在 Emailgistics 中偵測信箱成員的電子郵件地址和名稱中的變更，並自動更新此資訊，以用於追蹤和報告目的。 這是其範圍延伸至共用信箱以外的唯一許可權。 | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| offline_access | 委託 | 允許 Emailgistics 做為後端應用程式，而不是互動式瀏覽器型應用程式，需要使用者在每次運作時登入。 此許可權可讓 Emailgistics 取得重新整理權杖，視需要重新整理，以維護持續存取。 | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |

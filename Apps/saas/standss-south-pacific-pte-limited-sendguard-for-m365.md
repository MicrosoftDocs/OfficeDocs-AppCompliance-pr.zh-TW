---
title: M365 的 SendGuard 應用程式資訊，由 Standss (南部太平洋) PTE 有限
ms.author: elmalova
author: elenamalova
ms.date: 12/10/2021
ms.topic: article
...
description: SendGuard for M365 的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "61420828"
---
# <a name="sendguard-for-m365"></a>M365 的 SendGuard

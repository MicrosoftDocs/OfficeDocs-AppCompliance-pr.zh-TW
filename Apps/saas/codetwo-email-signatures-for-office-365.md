...
| 應用程式的核心功能 | CodeTwo Office 365 的電子郵件簽章是以 Azure 為基礎的雲端服務，可對從任何電子郵件用戶端裝置傳送的郵件新增自動電子郵件簽名、法律免責聲明和署名 &amp; 。 它可讓人員 (管理員或委派的使用者) 或小組，以集中管理 Microsoft 365 (Office 365) 組織中的電子郵件簽名。 在將電子郵件傳送) 或直接在使用者輸入 Outlook 中傳送電子郵件之後，就可以將簽章新增至雲端 (。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委託 | 允許使用者登入 app，並允許此應用程式讀取登入使用者的設定檔。 它也可讓應用程式讀取已登入使用者的基本組織資訊。 | [2a93620e-4345-4e3b-9bae-0195f08aab69](https://docs.microsoft.com/microsoft-365-app-certification/azure/2a93620e-4345-4e3b-9bae-0195f08aab69) |

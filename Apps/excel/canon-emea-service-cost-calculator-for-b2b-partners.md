---
title: Canon EMEA 合作夥伴的 Canon EMEA 服務成本計算機的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: 適用于 B2B 合作夥伴的 Canon EMEA 服務成本計算機、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "64879880"
---
# <a name="canon-emea-service-cost-calculator-for-b2b-partners"></a>B2B 合作夥伴的 Canon EMEA 服務成本計算機

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 8 月 3 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003098" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Canon EMEA 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | B2B 合作夥伴的 Canon EMEA 服務成本計算機 |
| ID | WA200003098 |
| 支援Office 365用戶端 | Excel 2016 2013 年或更新版本的 mac、Excel 2013 或更新版本，Windows，Excel 網頁版 |
| 合作夥伴公司名稱 | Canon EMEA |
| 公司的網站 | [https://www.canon-europe.com](https://www.canon-europe.com) |
| 應用程式的使用規定 | [https://partners.canon-europe.com/partners/s/Terms%20and%20...](https://partners.canon-europe.com/partners/s/Terms%20and%20Conditions%20-%20English%20(Partner%20Portal)) |
| 應用程式的核心功能 | 精准、透明且具生產力的 Canon 印表機服務成本計算 (B2B)  |
| 公司總部位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | |
...
Canon EMEA 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

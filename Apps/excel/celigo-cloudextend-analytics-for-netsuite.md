...
description: 適用于 NetSuite 的 CloudExtend Analytics、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
<p>上次由開發人員更新日期：2022 年 6 月 7 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002784" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Celigo CloudExtend 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | CloudExtend Analytics for NetSuite |
| ID | WA200002784 |
| 支援Office 365用戶端 | Excel 2016或更新版本的 Mac、windows 上的 Excel 2016 或更新版本，Excel 網頁版 |
| 合作夥伴公司名稱 | Celigo CloudExtend |
| 公司的網站 | [https://www.cloudextend.io](https://www.cloudextend.io) |
| 應用程式的使用規定 | [https://www.cloudextend.io/agreements/ssa/2019-12/](https://www.cloudextend.io/agreements/ssa/2019-12/) |
| 應用程式的核心功能 | 對於 NetSuite 使用者，CloudExtend Analytics for NetSuite (CEAN) 會以視覺化方式呈現您的資料，以提供您在正確時間做出正確商務決策所需的所有見解。 CEAN 是提供所有必要工具的工具，可讓您彈性地自訂和控制資料，以取得 NetSuite 資料的深入解析。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.cloudextend.io/netsuite/excel-integration/p/ana...](https://www.cloudextend.io/netsuite/excel-integration/p/analytics-for-netsuite/) |
...
Celigo CloudExtend 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 使用者選擇透過我們的應用程式處理的商務資料。 |
...
| 隱私權原則 URL | https://www.cloudextend.io/privacy/ |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | OAuth 2.0 授權碼流程 |
| 您的應用程式是否支援條件式存取原則？ | 否 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 應用程式 | 以最新資料定期更新 Excel 活頁簿 | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| Sites.ReadWrite.All | 應用程式 | 若使用者位於 SharePoint 位置，則取得使用者正在處理之 Excel 的相關資訊 | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| offline_access | 委託 | 能夠在客戶未登入時寫入 Excel。 這是必要的，因為我們已排程將資料寫入 Excel 資料表的工作 | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |

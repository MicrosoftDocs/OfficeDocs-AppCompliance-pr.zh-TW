---
title: Adobe Inc. Report Builder的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/02/2021
...
description: 所有可用的安全性與合規性資訊，適用于Report Builder、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003101" target="_blank">在 AppSource 中檢視</a>
...
| 合作夥伴公司名稱 | Adobe Inc. |
| 公司的網站 | [https://experiencecloud.adobe.com](https://experiencecloud.adobe.com) |
| 應用程式的使用規定 | [https://wwwimages.adobe.com/content/dam/acom/en/legal/licen...](https://wwwimages.adobe.com/content/dam/acom/en/legal/licenses-terms/pdf/EULA-en_US-20190910_1413.pdf) |
| 應用程式的核心功能 | 使用 Adobe Customer Journey Analytics 資料建立Excel報告。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |

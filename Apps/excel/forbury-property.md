---
title: Forbury by Forbury 屬性的應用程式資訊
ms.author: elmalova
author: elenamalova
ms.date: 11/19/2021
ms.topic: article
...
description: Forbury 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
| 合作夥伴公司名稱 | Forbury 屬性 |
| 公司的網站 | [https://www.forbury.com](https://www.forbury.com) |
| App 的使用條款 | [https://www.forbury.com/terms-of-use](https://www.forbury.com/terms-of-use) |
| 應用程式的核心功能 | 在您的 Forbury 軟體中，valuations 商用房地產 (analytics) 最快的方式。 |
...
此資訊已透過 Forbury 屬性提供，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.forbury.com/privacy-policy |

---
title: XBRL US 的 XBRL 歸檔資料的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: XBRL 歸檔資料的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
---
# <a name="xbrl-filed-data"></a>XBRL 歸檔資料

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 8 月 2 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002591" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

XBRL US 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | XBRL US |
| 公司的網站 | [https://xbrl.us](https://xbrl.us) |
| 應用程式的使用規定 | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| 應用程式的核心功能 | XBRL US 是非營利聯盟，在美國 XBRL US 中建置並支援免費、開放、非專屬的商務報告標準，已引導開發及實作政府機構的資料標準 - 美國聯邦和Exchange委員會 (SEC) 、美國聯邦能源法規委員會 (FERC) ，以及能源部。 XBRL US 會監視資料，並協助建立 SEC 所使用的資料品質標準，以協助公用公司建立高品質的 XBRL 財務報表。  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| 用來執行應用程式的裝載環境或服務模型為何？ |  |
| 應用程式會使用哪些主控雲端提供者？ | GitHub |
...
XBRL US 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

...
ms.locfileid: "64784542"
---
# <a name="sheetgo-application-information"></a>SHEETGO 應用程式資訊

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 11 月 1 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002128" target="_blank">在 AppSource 中檢視</a>
...
| 公司的網站 | [https://www.sheetgo.com](https://www.sheetgo.com) |
| 應用程式的使用規定 | [https://www.sheetgo.com/legal/terms/](https://www.sheetgo.com/legal/terms/) |
| 應用程式的核心功能 | Sheetgo 是一個工作流程自動化平臺，可讓使用者連線線上試算表並建置自動化資料管理系統。 Sheetgo Web 應用程式提供建立和管理工作流程的平臺，以及各種範本。 適用于 Google Sheets Excel和附加元件的 Sheetgo 增益集可讓使用者直接從試算表內連線並自動化，而Teams應用程式可讓工作流程建立者與頻道和群組聊天中的同事共用其已連線的檔案。 |
| 公司總部位置 | 西班牙 |
...
| 哪些資料會儲存在您的資料庫中？ | 試算表中繼資料，例如檔案大小、試算表擁有者、試算表使用者、上次修改日期、檔案名等。我們不會儲存試算表資料 |
...
| 隱私權原則 URL | https://www.sheetgo.com/legal/privacy |

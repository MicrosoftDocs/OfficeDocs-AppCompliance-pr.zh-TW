---
title: Auditboard， Inc. 的 AuditBoard 增益集的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/18/2021
...
description: AuditBoard 增益集、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "65645646"
---
# <a name="auditboard-add-in"></a>AuditBoard 增益集

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 9 月 17 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003350" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Auditboard， Inc. 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | AuditBoard 增益集 |
| ID | WA200003350 |
...
| 合作夥伴公司名稱 | Auditboard， Inc. |
| 公司的網站 | [https://www.auditboard.com](https://www.auditboard.com) |
| 應用程式的使用規定 | [https://appsource.microsoft.com](https://appsource.microsoft.com) |
| 應用程式的核心功能 | 可讓 AuditBoard 訂閱者在編輯 AB 敘述時，將連結 &amp; 資料內嵌至 AB 網站。  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
...
此資訊由 Auditboard， Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: RocketDocs 快速啟動的應用程式資訊 RocketDocs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: RocketDocs 啟動板的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "64463704"
---
# <a name="rocketdocs-launchpad"></a>RocketDocs 啟動板
...
由 RocketDocs 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | RocketDocs 啟動板 |
| ID | WA200003648 |
| 支援 Office 365 用戶端 | mac 上的 Excel 2016 或更新版本、Excel 2016 或更新版本上的 Windows、Excel 網頁版、Word 2016 或更新版本、Word 網頁版、Word 2016 或更新版本 Windows |
| 合作夥伴公司名稱 | RocketDocs |
| 公司的網站 | [https://rocketdocs.com](https://rocketdocs.com) |
| App 的使用條款 | [https://rocketdocs.com/end-user-license-agreement/](https://rocketdocs.com/end-user-license-agreement/) |
| 應用程式的核心功能 | 可讓使用者在 RocketDocs 平臺中尋找內容，並將它插入檔中。 |
...
此資訊是由 RocketDocs 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

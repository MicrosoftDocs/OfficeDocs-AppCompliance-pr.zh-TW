...
由 Supermetrics 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Supermetrics |
| ID | WA104381807 |
| 支援 Office 365 用戶端 | Windows、Excel 2016 或更新版本的 Mac Excel 2016 或更新版本 Excel 網頁版 |
| 合作夥伴公司名稱 | Supermetrics |
| 公司的網站 | [https://supermetrics.com](https://supermetrics.com) |
| App 的使用條款 | [https://supermetrics.com/terms-of-service](https://supermetrics.com/terms-of-service) |
| 應用程式的核心功能 | 透過 Supermetrics，企業可將各自為政的資料從 70 + 行銷及銷售平臺（如 Facebook Ads、Google Analytics、Instagram 等等）集合，並直接將資料傳輸至 Excel 以供報告之用。 這可讓您：-自動化手動資料匯入工作;-使用 Excel 中已有的公式及工具來分析和形象化您的行銷資料;-您可以直接在 Excel 中查看多個資料來源，以取得重要的圖片。 |
...
此資訊是由 Supermetrics 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 最近的 SOC1 認證日期 |  2020-12-15 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 您已完成哪一種 SOC 2 憑證？ |  type2 |
| 最近的 SOC2 認證日期 |  2021-07-07 |
...
| 隱私權原則 URL | https://supermetrics.com/privacy-policy |

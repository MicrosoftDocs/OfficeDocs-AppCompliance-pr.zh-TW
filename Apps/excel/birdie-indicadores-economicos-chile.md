---
title: Indicadores Economicos For Indicadores Economicos by Insight 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Indicadores Economicos 訂用帳戶的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
---
# <a name="indicadores-economicos-chile"></a>Indicadores Economicos Microsoft

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 30 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381100" target="_blank">在 AppSource 中檢視</a>
...
| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Indicadores Economicos Microsoft |
| ID | WA104381100 |
| 支援Office 365用戶端 | Excel Mac 上的 Windows、Excel 網頁版、Excel 2016 或更新版本上的 2013 Service Pack 1 或更新版本 |
| 合作夥伴公司名稱 | 小鳥 |
| 公司的網站 | [https://www.birdie.cl](https://www.birdie.cl) |
| 應用程式的使用規定 | [https://www.birdie.cl/software/privacidad](https://www.birdie.cl/software/privacidad) |
| 應用程式的核心功能 | Obt&#233;n el valor de la Unidad de Fomento (UF) ， Euro， D&#243;lar y UTM de Lib de manera sencilla |
| 公司總部位置 | 智利 |
| 應用程式資訊頁面 | |
...
這項資訊是由關於此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制所提供的資訊。

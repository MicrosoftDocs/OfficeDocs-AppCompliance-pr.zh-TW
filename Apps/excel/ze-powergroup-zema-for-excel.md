---
title: ZEMA 的應用程式資訊，依 ZE PowerGroup Excel
ms.author: elmalova
author: elenamalova
ms.date: 02/17/2022
ms.topic: article
...
description: ZEMA Excel 的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "62884728"
---
# <a name="zema-for-excel"></a>Excel 的 ZEMA
...
從 ZE PowerGroup 至 Microsoft 所提供的資訊：
...
| 合作夥伴公司名稱 | ZE PowerGroup |
| 公司的網站 | [https://www.ze.com](https://www.ze.com) |
| App 的使用條款 | [https://www.ze.com/terms-of-use/](https://www.ze.com/terms-of-use/) |
| 應用程式的核心功能 | 快速而輕鬆地將 ZEMA 資料和分析匯入 Excel 活頁簿。 |
...
在 ZE PowerGroup 中會提供此資訊，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

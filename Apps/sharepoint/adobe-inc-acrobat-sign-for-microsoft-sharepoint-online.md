---
title: adobe inc. 用於 Microsoft Office SharePoint Online adobe Acrobat 符號的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: 所有可用於 Microsoft Office SharePoint Online Adobe Acrobat 符號的安全性和符合性資訊資訊、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
---
# <a name="adobe-acrobat-sign-for-microsoft-sharepoint-online"></a>Microsoft Office SharePoint Online 的 Adobe Acrobat 符號
...
| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Microsoft Office SharePoint Online 的 Adobe Acrobat 符號 |
| ID | WA104381012 |
...
| 應用程式的核心功能 | 將 Adobe 簽署新增至 Teams，使檔簽署工作流程的移動速度更快。 現在，在 Teams 中，您可以簽署檔、傳送檔，以合法系結電子簽章和核准 &#8212; 所有檔都使用 Microsoft 偏好的電子簽名解決方案。 |
| 公司 headquarter 位置 | 北美美國 |
| 應用程式資訊頁面 | [https://helpx.adobe.com/sign/using/microsoft-sharepoint-use...](https://helpx.adobe.com/sign/using/microsoft-sharepoint-user-guide.html) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委託 | 取得使用者角色，並驗證使用者是否授與應用程式功能的特定許可權。 | [99a3ad8d-8682-4f2a-9c2c-b4b27e99585c](../azure/99a3ad8d-8682-4f2a-9c2c-b4b27e99585c.md) |

---
title: Dropbox Inc. SharePoint HelloSign 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: 適用于 SharePoint 的 HelloSign、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003245" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Dropbox Inc. 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | HelloSign for SharePoint |
| ID | WA200003245 |
| 支援Office 365用戶端 | SharePoint 2013 或更新版本 |
| 合作夥伴公司名稱 | Dropbox Inc. |
| 公司的網站 | [https://hellosign.com](https://hellosign.com) |
| 應用程式的使用規定 | [https://hellosign.com/terms](https://hellosign.com/terms) |
| 應用程式的核心功能 | HelloSign&#8217;的數位工作流程平臺&#8211;，其中包含 eSignature、數位工作流程和電子傳真解決方案&#8212;可協助超過 80，000 位客戶和數百萬人更快速地執行業務。 我們協助客戶更快速地完成交易、輕鬆地將新進員工上線、完成檔而不發生錯誤等等。 |
| 公司總部位置 | 美國美國 |
...
此資訊由 Dropbox Inc. 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 是 |
| 您的應用程式會處理哪些資料？ | 租使用者識別碼、月臺識別碼、電子郵件、磁片磁碟機識別碼、磁片磁碟機專案識別碼 |
| 應用程式是否支援 TLS 1.1 或更新版本？ | 是 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 租使用者識別碼、月臺識別碼、電子郵件、磁片磁碟機識別碼、磁片磁碟機專案識別碼 |
...
| 隱私權原則 URL | https://www.hellosign.com/privacy |
...
| 如果您的應用程式未使用上述其中一個程式庫，則會使用哪些驗證程式庫或程式庫？ | 使用 Microsoft 身分識別平臺 和 OAuth 2.0 授權碼流程，https://docs.microsoft.com/en-us/azure/active-directory/develop/v2-oauth2-auth-code-flow |
| 您的應用程式是否支援條件式存取原則？ | 否 |

---
title: Agile-IS 的 Agile Task Board for SharePoint Online 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/08/2022
...
description: 適用于 SharePoint Online 的敏捷式工作面板、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
---
# <a name="agile-task-board-for-sharepoint-online"></a>適用于 SharePoint Online 的敏捷式工作面板

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 4 月 8 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002087" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Agile-IS 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 適用于 SharePoint Online 的敏捷式工作面板 |
| ID | WA200002087 |
| 支援Office 365用戶端 | SharePoint 2016 或更新版本 |
| 合作夥伴公司名稱 | Agile-IS |
| 公司的網站 | [https://www.agile-is.de](https://www.agile-is.de) |
| 應用程式的使用規定 | [https://www.agile-is.de/en/termsofuse](https://www.agile-is.de/en/termsofuse) |
| 應用程式的核心功能 | 敏捷式工作面板可協助您和您的小組取得敏捷式專案的更佳概觀。 將實體面板轉換成數位版本。 您可以使用如狀態顯示的資料行、任意數目的泳道、地圖的中繼資料驅動著色、責任指派、拖放編輯，以及許多其他設定等功能來對應您的程式。 所有資料都會保留在 M365 租使用者內。 |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | [https://www.agile-is.de/en/agiletaskboard](https://www.agile-is.de/en/agiletaskboard) |
...
Agile-IS 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | UPN 的 zur Lizenzverwaltung;Unternehmensdaten zur Rechnungslegung |
...
| 隱私權原則 URL | https://www.agile-is.de/en/telemetry |
...
| 適用于 Microsoft 365 的應用程式和增益集可能會使用 Microsoft Graph 外部的其他 Microsoft API。 您的應用程式或增益集是否使用其他 Microsoft API？ | 是 |

#### <a name="data-access-using-microsoft-graph"></a>使用 Microsoft Graph 存取資料

>|   **圖形許可權**  | **權限類型** |          **對齊**          | **Azure AD 應用程式識別碼** |
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | 委託 | 允許應用程式查詢目前安裝的應用程式頂點。 用來提供正確的應用程式資源。 | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| GroupMember.Read.All | 委託 | 讀取群組成員以指派規劃工具工作的  | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| Tasks.ReadWrite | 委託 | 使用 Planner 方案和工作的   | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsActivity.Send | 委託 | 將訊息傳送至小組活動 | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsAppInstallation.ReadForTeam | 委託 | 允許應用程式查詢目前安裝的應用程式頂點。 用來提供正確的應用程式資源。 | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.Read | 委託 | 允許使用者登入和讀取基本設定檔資訊 | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.ReadBasic.All | 委託 | 允許使用者讀取其他使用者的基本設定檔資訊 | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |

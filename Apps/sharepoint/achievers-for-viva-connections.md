---
title: Achiever for Viva Connections 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/06/2022
...
description: 適用于Viva Connections的 Achiever、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "66655990"
---
# <a name="achievers-for-viva-connections"></a>Viva Connections的達成者

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 6 月 10 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004313" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式的核心功能 | 成員的快速動作卡片，可使用 Achievers 平臺簽署慶祝卡片、檢視自我辨識和趨勢辨識 |
| 公司總部位置 | 加拿大 |
| 應用程式資訊頁面 | |

---
title: Smarter Business Solutions GmbH 的 Smarter 事件預約應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: Smarter 事件預約的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64876530"
---
# <a name="smarter-event-booking"></a>智慧型事件預約

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 7 月 20 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003125" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Smarter Business Solutions GmbH 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | 智慧型商務解決方案 GmbH |
| 公司的網站 | [https://smarterbusiness.at](https://smarterbusiness.at) |
| 應用程式的使用規定 | [https://www.smarterbusiness.at/en/terms-of-use-for-smarter-...](https://www.smarterbusiness.at/en/terms-of-use-for-smarter-event-booking) |
| 應用程式的核心功能 | Smarter Event Booking 可讓 Microsoft365 使用者註冊先前建立的事件。 |
| 公司總部位置 | 奧地利 |
| 應用程式資訊頁面 | [https://www.smarterbusiness.at/en/smarter-event-booking](https://www.smarterbusiness.at/en/smarter-event-booking) |
...
此資訊已由 Smarter Business Solutions GmbH 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

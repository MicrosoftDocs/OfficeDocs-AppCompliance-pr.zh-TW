---
title: 更智慧的商務解決方案 GmbH 的應用程式資訊以獲得更聰明的事件預約
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: 所有可用的安全性和符合性資訊資訊，以獲得更聰明的事件預約、其資料處理原則、其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63552212"
---
# <a name="smarter-event-booking"></a>更聰明的事件預約

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開發人員上次更新：2021年7月20日</p>
...
以更智慧的商務解決方案 GmbH 至 Microsoft 所提供的資訊：
...
| 合作夥伴公司名稱 | 更智慧的商務解決方案 GmbH |
| 公司的網站 | [https://smarterbusiness.at](https://smarterbusiness.at) |
| App 的使用條款 | [https://www.smarterbusiness.at/en/terms-of-use-for-smarter-...](https://www.smarterbusiness.at/en/terms-of-use-for-smarter-event-booking) |
| 應用程式的核心功能 | 更聰明的事件預約可讓 Microsoft365 使用者註冊先前建立的事件。 |
...
此資訊已透過更智慧的商務解決方案 GmbH，以瞭解此應用程式如何收集和儲存組織的資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

---
title: LifeWorks Viva Connections 的應用程式資訊，Lifeworks Inc。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: 所有適用于 LifeWorks Viva 連線的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63540631"
---
# <a name="lifeworks-viva-connections"></a>LifeWorks Viva 連線
...
由 Lifeworks Inc. 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | LifeWorks Viva 連線 |
| ID | WA200003517 |
| 支援 Office 365 用戶端 | SharePoint 2016 或更新版本 |
| 合作夥伴公司名稱 | Lifeworks Inc。 |
| 公司的網站 | [https://www.lifeworks.com](https://www.lifeworks.com) |
| App 的使用條款 | [https://help.lifeworks.com/hc/en-gb/articles/209973913-End-...](https://help.lifeworks.com/hc/en-gb/articles/209973913-End-User-Licence-Agreement) |
| 應用程式的核心功能 | 存取 wellbeing 內容並直接從 Viva 連線識別同事！ |
...
Lifeworks Inc. 已提供此資訊，供 Inc. 使用此應用程式如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://help.lifeworks.com/hc/en-gb/articles/209973913-End-User-Licence-Agreement |

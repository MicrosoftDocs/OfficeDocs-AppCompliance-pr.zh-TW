...
由 Zynyo 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 線上 SharePoint 的 Zynyo 符號 |
| ID | WA200003673 |
| 支援 Office 365 用戶端 | SharePoint 2016 或更新版本 |
| 合作夥伴公司名稱 | Zynyo |
| 公司的網站 | [https://zynyo.com](https://zynyo.com) |
...
此資訊是由 Zynyo 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 當使用者送出簽署要求時，會儲存選取的檔及輸入的資料，這包括客戶資料，例如名稱、電子郵件和電話號碼。 當簽章要求到期時，會刪除此資料（預設為30天）。 |
...
| 隱私權原則 URL | https://zynyo.com/Zynyo-Privacyverklaring.pdf |

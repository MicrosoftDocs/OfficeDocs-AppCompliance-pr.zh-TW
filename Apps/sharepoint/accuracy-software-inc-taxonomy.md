---
title: Accuracy Software Inc. 分類法的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/18/2022
...
description: 分類法的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64870951"
---
# <a name="taxonomy"></a>分類

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 2 月 18 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003006" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Accuracy Software Inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Accuracy Software Inc. |
| 公司的網站 | [https://accuracysoftware.ca](https://accuracysoftware.ca) |
| 應用程式的使用規定 | [https://accuracysoftware.ca/taxonomy-terms-of-service](https://accuracysoftware.ca/taxonomy-terms-of-service) |
| 應用程式的核心功能 | 分類法可讓您有效管理檔案分類計畫，方法是讓 IM 專業人員與不同專案關係人共同作業，以建立、檢閱檔案計畫，並將其發佈至整個組織。 此外，分類法可讓您產生可匯入 Microsoft 合規性中心的 M365 保留標籤匯出，並以可匯入至SharePoint字詞庫的字片語格式匯出您的檔案計畫。 |
| 公司總部位置 | 加拿大 |
...
| 應用程式會使用哪些主控雲端提供者？ | 用戶端SharePoint租使用者 |
...
準確度軟體公司已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式或基礎結構是否會處理任何與 Microsoft 客戶或其裝置相關的資料？ | 否 |
| 應用程式或基礎結構是否會儲存任何 Microsoft 客戶資料？ | 是 |
| 哪些資料會儲存在您的資料庫中？ | 檔案計畫分類資料 |

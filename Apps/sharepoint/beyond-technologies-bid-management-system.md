...
| 合作夥伴公司名稱 | 超越技術 |
| 公司的網站 | [https://www.beyondintranet.com](https://www.beyondintranet.com) |
...
此資訊的提供方式超出此應用程式如何收集和儲存組織資料的相關技術，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 資料庫中儲存的資料為何？ | 使用者電子郵件和 SharePoint 網站 url |
...
| 隱私權原則 URL | https://www.beyondintranet.com/privacypolicy |

---
title: 4Mata 的應用程式資訊 - CLOUDIGNITE LLC 的清單格式設計工具
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: 4Mata 的所有可用安全性與合規性資訊 - 列出格式化設計工具、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "66113001"
---
# <a name="4mata---list-formatting-designer"></a>4Mata - 清單格式設計工具

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 5 月 31 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002892" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

CLOUDIGNITE LLC 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | 4Mata - 清單格式設計工具 |
| ID | WA200002892 |
| 支援Office 365用戶端 | SharePoint 2016 或更新版本 |
| 合作夥伴公司名稱 | CLOUDIGNITE LLC |
| 公司的網站 | [https://4mata.com](https://4mata.com) |
| 應用程式的使用規定 | [https://docs.4mata.com/legal/terms-of-service](https://docs.4mata.com/legal/terms-of-service) |
| 應用程式的核心功能 | 4 由 CloudIgnite 提供的 4Mata 是一組工具，可讓企業透過設計和格式化清單和表單來視覺化資料SharePoint。  使用此應用程式，使用者可以直覺方式設定高度自訂的複雜SharePoint表單和清單，以供報表、發票、產品詳細資料發佈，以及連絡人資訊收集，以方便地與您的商務程式需求整合。  |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://4mata.com](https://4mata.com) |
...
CLOUDIGNITE LLC 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: Bizagi 團隊 Bizagi Webpart 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Bizagi webpart 的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63548551"
---
# <a name="bizagi-webparts"></a>Bizagi Webpart
...
由 Bizagi 小組提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Bizagi Webpart |
| ID | WA200003652 |
| 支援 Office 365 用戶端 | SharePoint 2016 或更新版本 |
| 合作夥伴公司名稱 | Bizagi 小組 |
| 公司的網站 | [https://www.bizagi.com](https://www.bizagi.com) |
| App 的使用條款 | [https://www.bizagi.com/en/buy/eula](https://www.bizagi.com/en/buy/eula) |
| 應用程式的核心功能 | 從 Sharepoint Online 建立並管理 Bizagi 上的案例 |
| 公司 headquarter 位置 | 美國地區 |
| 應用程式資訊頁面 | [https://www.bizagi.com/en/resources/help](https://www.bizagi.com/en/resources/help) |
...
Bizagi 小組已提供此資訊，告知此應用程式如何收集及儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://www.bizagi.com/en/privacy-policy |

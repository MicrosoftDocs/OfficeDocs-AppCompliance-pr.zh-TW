---
title: iGlobe CRM Office 365 for Microsoft 365 的應用程式資訊
ms.author: elmalova
author: elenamalova
ms.date: 06/22/2021
ms.topic: article
...
ms.locfileid: "65225007"
---
# <a name="application-information-for-iglobe-crm-office-365-for-microsoft-365"></a>適用于 Microsoft 365 的 iGlobe CRM Office 365應用程式資訊
...
| 使用規定 URL | [https://iglobecrm.com/content/iglobe-crm-office-365-end-use...](https://iglobecrm.com/content/iglobe-crm-office-365-end-user-license-agreement) |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Calendars.ReadWrite | 委託 | 應用程式資料庫中不會儲存任何資料。 | 從 canlendar 到 iGlobe 的會議報表時，可以存取使用者行事曆 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Contacts.ReadWrite | 委託 | Directory.AccessAsUser.All | 允許應用程式具有與登入使用者相同的目錄資訊存取權。 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Directory.Read.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 檢查許可權，並取得網站和清單。 建立資料夾、取得檔案並儲存檔案。 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Directory.ReadWrite.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 允許應用程式具有與登入使用者相同的目錄資訊存取權。 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Files.ReadWrite.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取、更新、建立 Panner 工作、讀取使用者最近和共用的檔案、取得SharePoint清單、程式庫和檔案。 若要將檔案和資料儲存至SharePoint清單。 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Group.Read.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取、更新、建立 Panner 工作、讀取使用者最近和共用的檔案、取得SharePoint清單、程式庫和檔案。 若要將檔案儲存至清單SharePoint。 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Group.ReadWrite.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取、更新、建立 Panner 工作、讀取使用者最近和共用的檔案、取得SharePoint清單、程式庫和檔案。 若要將檔案儲存至清單SharePoint。 整合到 iGlobe CRM Office 365 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Mail.ReadWrite | 委託 | 應用程式資料庫中不會儲存任何資料。 | 將 eamil 儲存至 iGlobe CRM，並將 informatiopn 從 iGlobe 移至新的 e-amil | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Sites.Manage.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 在 iGlobe CRM 中建立、編輯和刪除專案和清單 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Sites.Read.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取 iGlobe CRM 中的專案 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Sites.ReadWrite.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 在 iGlobe CRM 中編輯和刪除專案和清單 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Tasks.ReadWrite | 委託 | 應用程式資料庫中不會儲存任何資料。 | 從 iGlobe CRM 建立規劃工具工作 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| User.Read | 委託 | 應用程式資料庫中不會儲存任何資料。 | 若要取得 spefi 要使用者的 iGlobe CRM 資訊 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |

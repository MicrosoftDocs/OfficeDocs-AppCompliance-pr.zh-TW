...
description: 檢閱 SalesTim 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
| 合作夥伴公司名稱 | SalesTim |
| 合作夥伴網站的 URL | [https://nbold.co/](https://nbold.co/) |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| AppCatalog.ReadWrite.All | 委託 | 否 | 允許應用程式在公司應用程式目錄中安裝及更新自己的套件。 | 2a651f59-97ce-42bb-97d7-cf7a2af4b635 |

...
description: 設計工具、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。
...
ms.locfileid: "65225297"
---
# <a name="application-information-for-designer-by-officeatwork"></a>Officeatwork 設計工具的應用程式資訊

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 6 月 23 日</p>

* [在 AppSource 中檢視](https://appsource.microsoft.com/product/web-apps/officeatwork-ag.designer)
...
<iframe height='1020' title='Microsoft Cloud App Security資訊' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35749' frameborder='0'></iframe>

[在索引標籤{](https://appmcasinfoprod.azurewebsites.net/#/dashboard/35749)：target=「_blank」} 中檢視

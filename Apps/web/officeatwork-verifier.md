...
description: 所有可用的安全性與合規性資訊，適用于驗證器、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65225287"
---
# <a name="application-information-for-verifier-by-officeatwork"></a>Officeatwork 的驗證程式應用程式資訊

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 6 月 23 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.verifier" target="_blank">在 AppSource 中檢視</a>
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.Read | 委託 | 未儲存任何資料。 | OneDrive：能夠讀取已登入使用者的檔案 | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| Files.Read.All | 委託 | 未儲存任何資料。 | Teams：讀取登入使用者可存取的所有檔案。 | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| Sites.Read.All | 委託 | 未儲存任何資料。 | SharePoint Online：若要啟用從 SharePoint Online 讀取資料，登入的使用者可以存取。 | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| User.Read | 委託 | 未儲存任何資料。 | 登入：讓 officeatwork 應用程式讀取使用者的基本屬性。 | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| offline_access | 委託 | 未儲存任何資料。 | 登入：若要透過重新整理權杖啟用自動登入，使用者必須在每次啟動 officeatwork 應用程式時手動登入。 此範圍僅適用于未啟用 SSO 的主應用程式。 | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| openid | 委託 | 未儲存任何資料。 | 登入：讓使用者使用其組織和/或 Microsoft 帳戶登入 officeatwork 應用程式。 | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
>| 設定檔 | 委託 | 未儲存任何資料。 | 登入：在 officeatwork 應用程式中顯示已登入的使用者。 這有助於確保/確認使用者用來登入 officeatwork 應用程式的帳戶。 | 8cf0fbc9-28f7-4bfb-94db-237b049fcbf7 |
...
<iframe height='1020' title='Microsoft Cloud App Security資訊' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35755' frameborder='no'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35755" target="_blank">在新索引標籤中檢視</a>

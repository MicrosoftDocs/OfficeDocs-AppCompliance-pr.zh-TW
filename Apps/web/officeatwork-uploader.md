...
description: 上傳者的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
---
# <a name="application-information-for-uploader-by-officeatwork"></a>Officeatwork 上傳程式的應用程式資訊

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 6 月 23 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.uploader" target="_blank">在 AppSource 中檢視</a>
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.ReadWrite.All | 委託 | 未儲存任何資料。 | OneDrive：能夠將資料讀取和寫入使用者的OneDrive。 | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| Group.ReadWrite.All | 委託 | 未儲存任何資料。 | Teams：讀取和寫入資料至群組。 | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| GroupMember.Read.All | 委託 | 未儲存任何資料。 | SharePoint Online - 安全性群組支援：允許應用程式列出群組、讀取基本群組屬性，以及讀取登入使用者可存取之所有群組的成員資格。 | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| Sites.Read.All | 委託 | 未儲存任何資料。 | SharePoint Online：若要在 SharePoint Online 中啟用讀取資料，登入的使用者可以存取。 啟用將資料上傳至 SharePoint Online | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| User.Read | 委託 | 未儲存任何資料。 | 按一下：讓 officeatwork 應用程式讀取使用者的基本屬性。 | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| User.Read.All | 委託 | 未儲存任何資料。 | Teams：找出使用者所屬的群組。 | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| offline_access | 委託 | 未儲存任何資料。 | 單一登入：若要透過重新整理權杖啟用自動登入，使用者必須在每次啟動 officeatwork 應用程式時手動登入。 此範圍僅適用于未啟用 SSO 的主應用程式。 | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| openid | 委託 | 未儲存任何資料。 | 登入：讓使用者使用其組織和/或 Microsoft 帳戶登入 officeatwork 應用程式。 | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| 設定檔 | 委託 | 未儲存任何資料。 | 登入：在 officeatwork 應用程式中顯示已登入的使用者。 這有助於確保/確認使用者用來登入 officeatwork 應用程式的帳戶。 | f5c9f179-b9a5-4364-8f99-18d203b902ad |
...
<iframe height='1020' title='Microsoft Cloud App Security資訊' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35750' frameborder='no'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35750" target="_blank">在新索引標籤中檢視</a>

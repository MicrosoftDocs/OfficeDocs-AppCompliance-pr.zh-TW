...
description: MIPA 的所有可用安全性與合規性資訊 - 我的智慧型個人助理、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65225008"
---
# <a name="mipa---my-intelligent-personal-assistant-by-iglobe"></a>MIPA - iGlobe 的智慧型個人助理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 6 月 22 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/17859280.mipa" target="_blank">在 AppSource 中檢視</a>
...
| 使用規定 URL | [https://mipa.iglobe.dk/EULA](https://mipa.iglobe.dk/EULA) |
...
>| Directory.ReadWrite.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取、更新、建立 Panner 工作、讀取使用者最近和共用的檔案、取得SharePoint清單、程式庫和檔案。 若要將檔案儲存至清單SharePoint。 | e854ea05-68ab-4204-控制項-db4a784fb4d8 |
>| Files.ReadWrite.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取、更新、建立 Panner 工作、讀取使用者最近和共用的檔案、取得SharePoint清單、程式庫和檔案。 若要將檔案儲存至清單SharePoint。 | e854ea05-68ab-4204-控制項-db4a784fb4d8 |
>| Group.Read.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取、更新、建立 Panner 工作、讀取使用者最近和共用的檔案、取得SharePoint清單、程式庫和檔案。 若要將檔案儲存至清單SharePoint。 | e854ea05-68ab-4204-控制項-db4a784fb4d8 |
>| Group.ReadWrite.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取、更新、建立 Panner 工作、讀取使用者最近和共用的檔案、取得SharePoint清單、程式庫和檔案。 若要將檔案儲存至清單SharePoint。 整合到 iGlobe CRM Office 365 | e854ea05-68ab-4204-控制項-db4a784fb4d8 |
>| Mail.ReadWrite | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取和更新標幟的郵件 | e854ea05-68ab-4204-控制項-db4a784fb4d8 |
>| MailboxSettings.ReadWrite | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取和更新整數、讀取和更新標幟的郵件、讀取和更新Outlook 待辦事項整個 | e854ea05-68ab-4204-控制項-db4a784fb4d8 |
>| Tasks.ReadWrite | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取和更新整數、讀取和更新Outlook至 Do Entreies | e854ea05-68ab-4204-控制項-db4a784fb4d8 |
>| User.Read | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取和更新整數、讀取和更新Outlook至 Do Entreies | e854ea05-68ab-4204-控制項-db4a784fb4d8 |
>| User.Read.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取和更新整數、讀取和更新Outlook至 Do Entreies、讀取、更新、建立 Panner 工作 | e854ea05-68ab-4204-控制項-db4a784fb4d8 |
>| User.ReadBasic.All | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取和更新整數、讀取和更新Outlook至 Do Entreies、讀取、更新、建立 Panner 工作 | e854ea05-68ab-4204-控制項-db4a784fb4d8 |
>| User.ReadWrite | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取和更新整數、讀取和更新Outlook至 Do Entreies | e854ea05-68ab-4204-控制項-db4a784fb4d8 |
...
>| 設定檔 | 委託 | 應用程式資料庫中不會儲存任何資料。 | 讀取和更新整數、讀取和更新Outlook至 Do Entreies、讀取、更新、建立 Panner 工作 | e854ea05-68ab-4204-控制項-db4a784fb4d8 |
...
<iframe height='1020' title='Microsoft Cloud App Security資訊' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35699' frameborder='no'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35699" target="_blank">在新索引標籤中檢視</a>

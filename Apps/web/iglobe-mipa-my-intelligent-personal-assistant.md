...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| ReadWrite 的行事曆 | 委託 | 不會儲存應用程式資料庫中的資料。 | 閱讀和更新日曆 entires | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| 連絡人。 ReadWrite | 委託 | 不會儲存應用程式資料庫中的資料。 | 閱讀和更新日曆 entires | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| Directory.AccessAsUser.All | 委託 | 不會儲存應用程式資料庫中的資料。 | 讀取、更新、建立 Panner 任務、讀取使用者最近及共用的檔案。 以檢查使用者是否有同意，以及具有使用 API 的存取權。 | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| Directory.ReadWrite.All | 委託 | 不會儲存應用程式資料庫中的資料。 | 讀取、更新、建立 Panner 工作、讀取使用者最近及共用檔案，以取得 SharePoint 清單、文件庫及檔案。 將檔案儲存至 SharePoint 清單。 | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| Files.ReadWrite.All | 委託 | 不會儲存應用程式資料庫中的資料。 | 讀取、更新、建立 Panner 工作、讀取使用者最近及共用檔案，以取得 SharePoint 清單、文件庫及檔案。 將檔案儲存至 SharePoint 清單。 | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| Group.Read.All | 委託 | 不會儲存應用程式資料庫中的資料。 | 讀取、更新、建立 Panner 工作、讀取使用者最近及共用檔案，以取得 SharePoint 清單、文件庫及檔案。 將檔案儲存至 SharePoint 清單。 | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| Group.ReadWrite.All | 委託 | 不會儲存應用程式資料庫中的資料。 | 讀取、更新、建立 Panner 工作、讀取使用者最近及共用檔案，以取得 SharePoint 清單、文件庫及檔案。 將檔案儲存至 SharePoint 清單。 整合至 iGlobe CRM Office 365 | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| 郵件。 ReadWrite | 委託 | 不會儲存應用程式資料庫中的資料。 | 讀取和更新已標記的郵件 | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| MailboxSettings ReadWrite | 委託 | 不會儲存應用程式資料庫中的資料。 | 閱讀和更新 entires、讀取和更新已標記的郵件、讀取和 Outlook 更新已標記的郵件，以執行 Entires | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| 工作。 ReadWrite | 委託 | 不會儲存應用程式資料庫中的資料。 | 讀取和更新日曆 entires、讀取和更新 Outlook 以執行 Entreies | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| User.Read | 委託 | 不會儲存應用程式資料庫中的資料。 | 讀取和更新日曆 entires、讀取和更新 Outlook 以執行 Entreies | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| User.Read.All | 委託 | 不會儲存應用程式資料庫中的資料。 | 讀取和更新日曆 entires、讀取和更新 Outlook 以執行 Entreies、讀取、更新、建立 Panner 任務 | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| User.ReadBasic.All | 委託 | 不會儲存應用程式資料庫中的資料。 | 讀取和更新日曆 entires、讀取和更新 Outlook 以執行 Entreies、讀取、更新、建立 Panner 任務 | e854ea05-68ab-4204-babe-db4a784fb4d8 |
>| User.ReadWrite | 委託 | 不會儲存應用程式資料庫中的資料。 | 讀取和更新日曆 entires、讀取和更新 Outlook 以執行 Entreies | e854ea05-68ab-4204-babe-db4a784fb4d8 |
...
<iframe height='1020' title='Microsoft Cloud App Security 資訊' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35699' frameborder='no'></iframe>

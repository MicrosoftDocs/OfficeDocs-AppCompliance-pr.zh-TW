...
description: 精靈的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "65225277"
---
# <a name="application-information-for-wizard-by-officeatwork"></a>Officeatwork 精靈的應用程式資訊

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 6 月 23 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.wizard" target="_blank">在 AppSource 中檢視</a>
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Contacts.Read | 委託 | 未儲存任何資料。 | 連絡人：啟用讀取已登入使用者的所有連絡人。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Files.Read | 委託 | 未儲存任何資料。 | OneDrive - 檔案 (內容) ：啟用已登入使用者檔案的讀取。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Files.Read.All | 委託 | 未儲存任何資料。 | Teams - 檔案 (內容) ：啟用讀取已登入使用者的所有檔案。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Group.Read.All | 委託 | 未儲存任何資料。 | Office 365使用者 - 群組限制：啟用已登入使用者所有群組的讀取。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Sites.Read.All | 委託 | 未儲存任何資料。 | SharePoint Online：啟用從 SharePoint Online 讀取資料的功能。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| User.Read | 委託 | 未儲存任何資料。 | 按一下：讓 officeatwork 應用程式讀取使用者的基本屬性。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| User.Read.All | 委託 | 未儲存任何資料。 | Office 365使用者 - 所有屬性：啟用讀取所有使用者的所有屬性。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| User.ReadBasic.All | 委託 | 未儲存任何資料。 | Office 365使用者 - 基本屬性：啟用讀取所有使用者的基本屬性 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| offline_access | 委託 | 未儲存任何資料。 | 單一登入：若要透過重新整理權杖啟用自動登入，使用者必須在每次啟動 officeatwork 應用程式時手動登入。 此範圍僅適用于未啟用 SSO 的主應用程式。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| openid | 委託 | 未儲存任何資料。 | 登入：讓使用者使用其組織和/或 Microsoft 帳戶登入 officeatwork 應用程式 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| 設定檔 | 委託 | 未儲存任何資料。 | 登入：在 officeatwork 應用程式中顯示已登入的使用者。 這有助於確保/確認使用者用來登入 officeatwork 應用程式的帳戶。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
...
<iframe height='1020' title='Microsoft Cloud App Security資訊' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35749' frameborder='no'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35749" target="_blank">在新索引標籤中檢視</a>

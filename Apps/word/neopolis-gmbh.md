---
title: Neopolis 的應用程式資訊（按 neopolis GmbH）
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: neopolis 中所有可用的安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
由 neopolis GmbH 所提供的資訊給 Microsoft：
...
| 合作夥伴公司名稱 | neopolis GmbH |
| 公司的網站 | [https://neopol.is](https://neopol.is) |
| App 的使用條款 | [https://app.termly.io/document/terms-of-use-for-saas/655330...](https://app.termly.io/document/terms-of-use-for-saas/655330e8-5787-47b4-8957-90006db46c80) |
| 應用程式的核心功能 | Professionelle Textdokumente parallel schreiben，&#252;berarbeiten und versionieren。 Wir wenden 的 der in der Softwareentwicklung etablierte Git-Prinzip auf 片 kollaborative Bearbeitung professioneller Textdokumente。 Unser Word 外掛程式 erm&#246;glicht parallele und kontrollierte Zusammenarbeit，ohne dass bestehende Prozesse oder 軟體 umgestellt werden m&#252;ssen。 |
| 公司 headquarter 位置 | 德國 |
| 應用程式資訊頁面 | [https://neopol.is](https://neopol.is) |
...
此資訊是由 neopolis GmbH 提供的，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。
...
| 隱私權原則 URL | https://neopol.is/gdpr/ |

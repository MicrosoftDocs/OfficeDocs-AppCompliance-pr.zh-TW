---
title: Stilus for Word 的應用程式資訊，MeaningCloud
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/01/2021
...
description: Stilus for Word 的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63549901"
---
# <a name="stilus-for-word"></a>Word 的 Stilus
...
| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Word 的 Stilus |
| ID | WA200003400 |
| 支援 Office 365 用戶端 | Word 2016 或更新版本的 Mac、Word 網頁版、Word 2013 或更新版本 Windows |
| 合作夥伴公司名稱 | MeaningCloud |
| 公司的網站 | [https://www.mystilus.com/en](https://www.mystilus.com/en) |
| App 的使用條款 | [https://www.mystilus.com/en/about-stilus/license-agreements](https://www.mystilus.com/en/about-stilus/license-agreements) |
| 應用程式的核心功能 | 西班牙文的拼寫、語法和樣式檢查 |
| 公司 headquarter 位置 | 西班牙 |
| 應用程式資訊頁面 | [https://www.mystilus.com/en/plugins/stilus-for-word-365](https://www.mystilus.com/en/plugins/stilus-for-word-365) |
...
| 隱私權原則 URL | https://www.mystilus.com/en/data-protection |

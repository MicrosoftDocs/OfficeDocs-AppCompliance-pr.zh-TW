...
| App 的使用條款 | [https://crosscheck.krevealaddins.com/docs/license.htm](https://crosscheck.krevealaddins.com/docs/license.htm) |
| 應用程式的核心功能 | CrossCheck 簡化檔檢查，並查明常見的起草錯誤。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | 應用程式 | 不收集或使用任何資料。 | [5edad654-f2d5-41d8-bfc0-92c2735252e1](../azure/5edad654-f2d5-41d8-bfc0-92c2735252e1.md) |

---
title: kRevealLLC 的 CrossCheck 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/01/2021
...
description: CrossCheck 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003198" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

kRevealLLC 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | kRevealLLC |
| 公司的網站 | [https://kreveal.com](https://kreveal.com) |
| 應用程式的使用規定 | [https://crosscheck.krevealaddins.com/docs/license.htm](https://crosscheck.krevealaddins.com/docs/license.htm) |
| 應用程式的核心功能 | CrossCheck 可簡化檔檢閱，並找出常見的草稿錯誤。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://admin.krevealaddins.com/help](https://admin.krevealaddins.com/help) |
...
kRevealLLC 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | 應用程式 | 不會收集或使用任何資料。 | [5edad654-f2d5-41d8-bfc0-92c2735252e1](../azure/5edad654-f2d5-41d8-bfc0-92c2735252e1.md) |

---
title: Loio Inc. Loio 合約檢查軟體的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Loio 合約檢查軟體的所有可用安全性和符合性資訊資訊，其資料處理原則，其 Microsoft Cloud App Security 應用程式目錄資訊，以及 CSA 星型登錄中的安全性/符合性資訊。
...
ms.locfileid: "63550462"
---
# <a name="loio-contract-review-software"></a>Loio 合約檢查軟體
...
| App 的使用條款 | [https://loio.com/terms-of-use/](https://loio.com/terms-of-use/) |
| 應用程式的核心功能 | 使用 Loio 合約助理，查看 &amp; 更快速且更準確的分析合同。 |

---
title: Loio Contract Review Software by Loio Inc. 的應用程式資訊。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Loio 合約檢閱軟體的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64875240"
---
# <a name="loio-contract-review-software"></a>Loio 合約檢閱軟體

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 6 月 24 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002273" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Loio Inc. 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Loio Inc. |
| 公司的網站 | [https://loio.com](https://loio.com) |
| 應用程式的使用規定 | [https://loio.com/terms-of-use/](https://loio.com/terms-of-use/) |
| 應用程式的核心功能 | 檢閱 &amp; 使用 Loio 合約小幫手更快速且更精確地分析合約。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://loio.com](https://loio.com) |
...
Loio Inc. 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: LeasePilot 之 Clausebook 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Clausebook 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA200004044" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

LeasePilot 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Clausebook |
| ID | WA200004044 |
| 支援Office 365用戶端 | Word 2016或更新版本，在 Mac、Word 網頁版、windows 上Word 2016或更新版本 |
| 合作夥伴公司名稱 | LeasePilot |
| 公司的網站 | [https://clausebook.com](https://clausebook.com) |
| 應用程式的使用規定 | [https://clausebook.com/terms](https://clausebook.com/terms) |
| 應用程式的核心功能 | Clausebook 是您的檔草稿隨附！ 它可協助小組擷取、組織、草稿和共用表單和子句程式庫，以快速草擬組織做法並將其機構化。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | |
| 用來執行應用程式的裝載環境或服務模型為何？ | Paas |
| 應用程式會使用哪些主控雲端提供者？ | 其他，Vercel |
...
LeasePilot 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

---
title: SmartCite for Papers by Digital Science 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: SmartCite for Papers 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64877580"
---
# <a name="smartcite-for-papers"></a>SmartCite for Papers

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 5 月 29 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380917" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

數位科學提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | SmartCite for Papers |
| ID | WA104380917 |
| 支援Office 365用戶端 | Windows上的 mac、Word 2016 或更新版本上Word 2016或更新版本，Word 網頁版 |
| 合作夥伴公司名稱 | 數位科學 |
| 公司的網站 | [https://papersapp.com](https://papersapp.com) |
| 應用程式的使用規定 | [https://www.papersapp.com/terms](https://www.papersapp.com/terms) |
| 應用程式的核心功能 | 從 ReadCube 論文庫自動撰寫參考並產生書目！ |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://www.papersapp.com/smartcite-for-word/](https://www.papersapp.com/smartcite-for-word/) |
...
數位科學已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

...
| App 的使用條款 | [https://cocofax.com/terms.html](https://cocofax.com/terms.html) |
| 應用程式的核心功能 | 使用 CocoFax 從 Microsoft Word 或 Word Online 傳送傳真時，不需要 landlines 傳真數據機，。 |
...
| 最近的 SOC1 認證日期 |  2021-06-04 |
| 應用程式是否符合服務組織控制 (SOC 2) ？ | 是 |
| 您已完成哪一種 SOC 2 憑證？ |   |
| 最近的 SOC2 認證日期 |  2021-06-04 |
| 應用程式是否符合服務組織控制 (SOC 3) ？ | 是 |
| 最近的 SOC3 認證日期 |  2021-06-04 |

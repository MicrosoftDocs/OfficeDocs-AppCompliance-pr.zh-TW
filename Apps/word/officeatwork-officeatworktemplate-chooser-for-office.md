---
title: officeatwork 所Office範本選擇器的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Officeatwork |的所有可用安全性與合規性資訊適用于Office的範本選擇器、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
---
# <a name="application-information-for-officeatwork--template-chooser-for-office"></a>officeatwork |的應用程式資訊適用于 Office 的範本選擇器
...
| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | officeatwork - 適用于 Office 的範本選擇器 |
| ID | WA104380050 |
| 支援Office 365用戶端 | Excel在 Mac、Excel 2013 或更新版本上的 iPad、Excel 2016 或更新版本上Windows、Excel 網頁版、iPad上的 Word、Mac 上的Word 2016或更新版本、Word 網頁版、Word 2013 或更新版本Windows，PowerPoint于 Windows 上的 iPad、PowerPoint 2016 或更新版本上的 mac、PowerPoint 網頁版、PowerPoint 2013 或更新版本，Project 2016 年或更新版本于 Windows |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委託 | 啟用我的最愛和OneDrive功能 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| Group.ReadWrite.All | 委託 | 啟用Teams功能 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| GroupMember.Read.All | 委託 | 啟用Teams功能 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
...
>| offline_access | 委託 | 啟用舊版Office主機的自動登入 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |

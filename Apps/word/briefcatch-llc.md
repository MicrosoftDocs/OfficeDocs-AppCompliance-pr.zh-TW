---
title: BriefCatch by BriefCatch LLC 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: 所有可用的安全性與合規性資訊，適用于 BriefCatch、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003725" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

由 BriefCatch LLC 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | BriefCatch LLC |
| 公司的網站 | [https://briefcatch.com](https://briefcatch.com) |
| 應用程式的使用規定 | [https://briefcatch.com/briefcatch-end-user-license-agreemen...](https://briefcatch.com/briefcatch-end-user-license-agreement/) |
| 應用程式的核心功能 | 專家法律編輯由您這邊進行。 |
| 公司總部位置 | 美國美國 |
| 應用程式資訊頁面 | [https://briefcatch.com/version-3/](https://briefcatch.com/version-3/) |
...
此資訊由 BriefCatch LLC 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

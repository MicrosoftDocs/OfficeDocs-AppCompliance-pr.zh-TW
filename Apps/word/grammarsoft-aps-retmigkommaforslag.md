...
GrammarSoft Ap 所提供的資訊給 Microsoft：
...
| 合作夥伴公司名稱 | GrammarSoft Ap |
| 公司的網站 | [https://retmig.dk](https://retmig.dk) |
| App 的使用條款 | [https://retmig.dk/terms](https://retmig.dk/terms) |
...
此資訊是由 GrammarSoft Ap 提供，此應用程式會如何收集和儲存組織資料，以及您的組織將會擁有該應用程式所收集資料的控制項。

---
title: RetMig &amp; Kommaforslag by GrammarSoft ApS 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: RetMig &amp; Kommaforslag 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA104382003" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

GrammarSoft ApS 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | RetMig &amp; Kommaforslag |
| ID | WA104382003 |
| 支援Office 365用戶端 | Windows上的 mac、Word 2016 或更新版本上Word 2016或更新版本，Word 網頁版 |
| 合作夥伴公司名稱 | GrammarSoft ApS |
| 公司的網站 | [https://retmig.dk](https://retmig.dk) |
| 應用程式的使用規定 | [https://retmig.dk/terms](https://retmig.dk/terms) |
| 應用程式的核心功能 | RetMig er en avanceret stave- og grammatikkontrol for dansk， mens Kommaforslag retter kommafejl. |
| 公司總部位置 | 丹麥 |
| 應用程式資訊頁面 | [https://retmig.dk](https://retmig.dk) |
...
此資訊由 GrammarSoft ApS 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

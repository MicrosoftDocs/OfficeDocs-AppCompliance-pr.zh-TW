---
title: 由 N2VEC TECNOLOGIA 提供的 Jus2vec 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/18/2022
...
description: 所有可用的安全性與合規性資訊，適用于 Jus2vec、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
ms.locfileid: "64906413"
---
# <a name="jus2vec"></a>Jus2vec

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2022 年 4 月 18 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002506" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

N2VEC TECNOLOGIA 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | N2VEC TECNOLOGIA |
| 公司的網站 | [https://info.jus2vec.com](https://info.jus2vec.com) |
| 應用程式的使用規定 | [https://info.jus2vec.com/termos-de-uso.html](https://info.jus2vec.com/termos-de-uso.html) |
| 應用程式的核心功能 | Busca por Jurisprud&#234;ncias usando Intelig&#234;ncia Artificial |
| 公司總部位置 | 巴西 |
| 應用程式資訊頁面 | |
...
N2VEC TECNOLOGIA 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

...
description: '[曝光簽章]、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊的所有可用安全性與合規性資訊。'
...
ms.locfileid: "64879570"
---
# <a name="impression-signatures"></a>曝光簽章

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 8 月 31 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003216" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式名稱 | 曝光簽章 |
| ID | WA200003216 |
| 支援Office 365用戶端 | 在 Mac、Excel 2013 或更新版本的 Mac、Windows、Excel 網頁版、Word 2016 或更新版本上的 Mac、Word 網頁版、Word 2013 或更新版本上Excel 2016或更新版本，Windows |
| 合作夥伴公司名稱 | 曝光簽章 |

---
title: ElseVIER LIMITED 的 Mendeley Cite 應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Mendeley Cite 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式類別目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA104382081" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

ELSEVIER LIMITED 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | Mendeley Cite |
| ID | WA104382081 |
| 支援Office 365用戶端 | iPad 上的 Word、Windows 上的Word 2016或更新版本、Mac 上的Word 2016或更新版本、網頁上的 Word |
| 合作夥伴公司名稱 | ELSEVIER LIMITED |
| 公司的網站 | [https://www.mendeley.com/search/](https://www.mendeley.com/search/) |
| 應用程式的使用規定 | [https://www.mendeley.com/terms/](https://www.mendeley.com/terms/) |
| 應用程式的核心功能 | 寫入時使用 Cite。 產生引文和書目，並變更您的引文樣式。 |
| 公司總部位置 | 英國大英國和北愛爾蘭 ()  |
| 應用程式資訊頁面 | [https://www.mendeley.com/guides/mendeley-cite/](https://www.mendeley.com/guides/mendeley-cite/) |
...
此資訊已由 ELSEVIER LIMITED 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://privacy.elsevier.com |

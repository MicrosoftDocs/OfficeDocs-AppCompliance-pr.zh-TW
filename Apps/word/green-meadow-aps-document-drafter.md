...
ms.locfileid: "65269938"
---
# <a name="document-drafter"></a>檔草稿者

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>上次由開發人員更新日期：2021 年 12 月 10 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003634" target="_blank">在 AppSource 中檢視</a>
...
| 應用程式名稱 | 檔草稿者 |
| ID | WA200003634 |
| 支援Office 365用戶端 | 在 Mac、Word 網頁版、Word 2013 或更新版本上的 Word 2016 或更新版本Windows |
...
| 應用程式的核心功能 | 此增益集可讓您直接在 MS Word 中存取檔草稿範本。 |
| 公司總部位置 | 丹麥 |
| 應用程式資訊頁面 | [https://gmeadow.com/addin-support/](https://gmeadow.com/addin-support/) |

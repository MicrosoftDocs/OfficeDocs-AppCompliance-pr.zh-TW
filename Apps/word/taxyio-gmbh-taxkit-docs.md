---
title: Taxy.io GmbH 的 TaxKit 檔應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: 所有可用的安全性與合規性資訊，適用于 TaxKit Docs、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA200002849" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

Taxy.io GmbH 提供給 Microsoft 的資訊：
...
| 合作夥伴公司名稱 | Taxy.io GmbH |
| 公司的網站 | [https://www.taxy.io](https://www.taxy.io) |
| 應用程式的使用規定 | [https://go.microsoft.com](https://go.microsoft.com) |
| 應用程式的核心功能 | TaxKit Docs 可協助稅務顧問尋找其處理中檔和案例的相關法律檔。 這可協助他們更有效地為用戶端提供建議。 |
| 公司總部位置 | 德國 |
| 應用程式資訊頁面 | |
...
此資訊由 Taxy.io GmbH 提供，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。

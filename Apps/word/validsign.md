---
title: ValidSign by ValidSign 的應用程式資訊
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: ValidSign 的所有可用安全性與合規性資訊、其資料處理原則、其Microsoft Cloud App Security應用程式目錄資訊，以及 CSA STAR 登錄中的安全性/合規性資訊。
...
* <a href="https://appsource.microsoft.com/product/office/WA200001890" target="_blank">在 AppSource 中檢視</a>

::: zone pivot="general"

### <a name="general-information"></a>一般資訊

ValidSign 提供給 Microsoft 的資訊：

| **Information** | **回應** |
|:----------------|:-------------|
| 應用程式名稱 | ValidSign |
| ID | WA200001890 |
| 支援Office 365用戶端 | 在 Mac、Word 網頁版、Windows 上的 Word 2013 或更新版本上Word 2016或更新版本 |
| 合作夥伴公司名稱 | ValidSign |
| 公司的網站 | [https://www.validsign.eu](https://www.validsign.eu) |
| 應用程式的使用規定 | [https://www.validsign.eu/word-license-terms/](https://www.validsign.eu/word-license-terms/) |
| 應用程式的核心功能 | 使用 ValidSign Word 增益集更聰明且更有效率地工作 |
| 公司總部位置 | 荷蘭 ()  |
| 應用程式資訊頁面 | [https://www.validsign.eu/connectors/word/](https://www.validsign.eu/connectors/word/) |
...
ValidSign 已提供此資訊，說明此應用程式如何收集和儲存組織資料，以及貴組織對於應用程式所收集資料的控制。
...
| 隱私權原則 URL | https://www.validsign.eu/validsign-privacy-statement/ |
